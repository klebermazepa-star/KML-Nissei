...
&Scoped-define QUERY-STRING-Query-Main FOR EACH esp_integracao NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH esp_integracao NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main esp_integracao
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main esp_integracao
