...
*******************************************************************************/
{include/i-prgvrs.i ESINT0001A-Z01 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esint0001a-z01 MUT}
&ENDIF
...
DEFINE VARIABLE h_esint0001-b02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ajuda AT ROW 16.54 COL 79 NO-TAB-STOP 
...
/* SETTINGS FOR FRAME f-zoom
   FRAME-NAME L-To-R                                                    */
/* SETTINGS FOR BUTTON bt-ajuda IN FRAME f-zoom
   NO-ENABLE                                                            */
ASSIGN 
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'int/esint0001-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint0001-b02 ).
       RUN set-position IN h_esint0001-b02 ( 3.00 , 5.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esint0001-b02. */
       RUN add-link IN adm-broker-hdl ( h_esint0001-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint0001-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ENABLE rt-button bt-implantar bt-ok bt-cancela 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESINT0001A-Z01" "9.99.99.999"}
