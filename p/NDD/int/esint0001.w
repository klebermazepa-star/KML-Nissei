...
*******************************************************************************/
{include/i-prgvrs.i ESINT0001 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESINT0001 MFT}
&ENDIF
...
DEFINE VARIABLE h_esint0001-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint0001-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint0001-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'int/esint0001-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint0001-v01 ).
       RUN set-position IN h_esint0001-v01 ( 2.71 , 1.14 ) NO-ERROR.
       /* Size in UIB:  ( 4.58 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'int/esint0001-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = int\esint0001b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esint0001-b01 ).
       RUN set-position IN h_esint0001-b01 ( 7.50 , 1.14 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 80.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'int/esint0001-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = int\esint0001-z01.w,
                     ProgVaPara = int\esint0001-g01.w,
                     ProgIncMod = int\esint0001a.w,
                     Implantar = no':U ,
             OUTPUT h_esint0001-q01 ).
       RUN set-position IN h_esint0001-q01 ( 1.00 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esint0001-v01. */
       RUN add-link IN adm-broker-hdl ( h_esint0001-q01 , 'Record':U , h_esint0001-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'TableIO':U , h_esint0001-v01 ).

       /* Links to BrowserCadastro2 h_esint0001-b01. */
       RUN add-link IN adm-broker-hdl ( h_esint0001-v01 , 'Record':U , h_esint0001-b01 ).

       /* Links to SmartQuery h_esint0001-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'State':U , h_esint0001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_esint0001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esint0001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esint0001-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadpai , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint0001-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint0001-b01 ,
             h_esint0001-v01 , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESINT0001" "9.99.99.999"}
