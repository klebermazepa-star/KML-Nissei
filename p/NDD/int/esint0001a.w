...
*******************************************************************************/
{include/i-prgvrs.i ESINT001A 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESINT001A MFT}
&ENDIF
...
DEFINE VARIABLE h_esint0001a-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 10.5 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 10.5 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 10.5 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 10.5 COL 78.14
     rt-button AT ROW 10.33 COL 2
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _XFTR "SmartWindowCues" w-incmdp _INLINE
/* Actions: adecomm/_so-cue.w ? adecomm/_so-cued.p ? adecomm/_so-cuew.p */
/*:T SmartWindow,uib,50060
...
DO:
{include/okpai.i h_esint0001a-v01}
END.
...
DO:
{include/salvapai.i h_esint0001a-v01}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'int/esint0001a-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint0001a-v01 ).
       RUN set-position IN h_esint0001a-v01 ( 1.75 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.75 , 88.57 ) */
       ...
       RUN set-position IN h_esint0001-q01 ( 10.25 , 46.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esint0001a-v01. */
       RUN add-link IN adm-broker-hdl ( h_esint0001-q01 , 'Record':U , h_esint0001a-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esint0001a-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint0001a-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESINT001A" "9.99.99.999"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esint0001-q01 (INPUT v-row-table). 
