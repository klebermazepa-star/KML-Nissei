...
&Scoped-define QUERY-STRING-Query-Main FOR EACH esp_servico_integracao NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH esp_servico_integracao NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main esp_servico_integracao
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main esp_servico_integracao
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "Custom.esp_servico_integracao"
