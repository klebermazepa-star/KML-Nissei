...
*******************************************************************************/
{include/i-prgvrs.i ESINT0001B 9.99.99.999}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i esint0001b mut}
&ENDIF
...
DEFINE VARIABLE h_esint0001b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esint0001b-v01-2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 9.08 COL 3 HELP
          "Salva e sai"
     bt-save AT ROW 9.08 COL 13.43 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 9.08 COL 24 HELP
          "Cancela"
     bt-ajuda AT ROW 9.08 COL 71.14
     rt-button AT ROW 8.92 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 90.57 BY 17 WIDGET-ID 100.
...
DO:
{include/okfil.i h_esint0001b-v01-2}
END.
...
DO:
{include/salvafil.i h_esint0001b-v01-2}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'int/esint0001b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esint0001b-v01-2 ).
       RUN set-position IN h_esint0001b-v01-2 ( 1.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'int/esint0001b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esint0001b-q01 ).
       RUN set-position IN h_esint0001b-q01 ( 8.50 , 41.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_esint0001b-v01-2. */
       RUN add-link IN adm-broker-hdl ( h_esint0001b-q01 , 'Record':U , h_esint0001b-v01-2 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esint0001b-v01-2 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esint0001b-v01-2 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ESINT0001B" "9.99.99.999"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_esint0001b-v01-2 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_esint0001b-q01 (input v-row-table).
