                ...
                DO:
                    ...
                    IF AVAIL estabelec AND
                       estabelec.ep-codigo =  "1" THEN DO:   // Apenas nota de estabelecimento VNDA
                        ...
                        IF natur-oper.especie-doc = "NFS" 
                        AND natur-oper.transf = NO 
                        AND natur-oper.tipo = 2 
                        AND natur-oper.cod-mensagem = 2 THEN DO:
                        ...
                        ELSE IF natur-oper.especie-doc = "NFD" 
                        AND natur-oper.transf = NO 
                        AND natur-oper.tipo = 2 THEN DO:
                        ...
                        ELSE IF natur-oper.especie-doc = "NFS" 
                        AND natur-oper.transf = NO 
                        AND natur-oper.tipo = 2 
                        AND natur-oper.cod-mensagem = 7 THEN DO:
                        ...
                        /*
                        IF b-nota-fiscal.serie <> "402" 
                        AND b-nota-fiscal.cod-estabel = "139" 
                        OR (b-nota-fiscal.nome-ab-cli = "NISSEI 139") THEN DO:
                    ...
                    IF AVAIL estabelec AND
                       estabelec.ep-codigo = "10" THEN DO:   // Apenas nota de estabelecimento merco
                        ...
                        AND natur-oper.tipo = 2 THEN DO:
                            ...
                            ASSIGN tipo-nota = "DEVOLUCAO - COMPRA".
                        ...
                        AND natur-oper.transf = NO 
                        AND natur-oper.tipo = 2  
                        AND natur-oper.cod-mensagem = 5 THEN DO:
                            
                            ASSIGN tipo-nota = "DEVOLUCAO - VENDA".
                        ...
                        AND natur-oper.imp-nota = YES THEN DO:
                            ...
                            ASSIGN tipo-nota = "DEVOLUCAO - VENDA - CLIENTE".
                        ...
                        OR(natur-oper.cod-cfop = "6927") THEN DO:
                            
                        
                            ASSIGN tipo-nota = "OUTRAS - SAIDAS".
                        ...
                        AND natur-oper.cod-cfop = "6923" THEN DO:
                            
                        
                            ASSIGN tipo-nota = "VENDA COM ENTREGA FUTURA".
                        ...
                        log-manager:WRITE-MESSAGE("Tipo nota 1:" + string(tipo-nota)) NO-ERROR. //Log para validar o que sai no tipo-nota
                        
                        
                        IF nota-fiscal.cod-estabel = "10001" AND nota-fiscal.nome-ab-cli = "MERCO0004" THEN
                        DO:
                            
                             RUN custom\eswms004.r (INPUT "Saida" ,
                                                    INPUT "ENTRADA - TRANSFERENCIA" ,
                                                    INPUT ROWID(b-nota-fiscal)). // Envio de notas para datahub (MERCO)
                             
                            log-manager:WRITE-MESSAGE("Entrou - ENTRADA TRANSF 1") NO-ERROR.
                            
                        END.
                        
                        IF nota-fiscal.cod-estabel = "10004" AND nota-fiscal.nome-ab-cli = "MERCO0001" THEN
                        DO:
                            ...
                            log-manager:WRITE-MESSAGE("Entrou - ENTRADA TRANSF 2") NO-ERROR. 
