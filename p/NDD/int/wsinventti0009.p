...
DO ON ERROR UNDO, LEAVE:
  ...
  FOR FIRST es-nota-rec-inventi
      ...
      //DISP p-cod-estabel
      //     es-nota-rec-inventi.Serie             
      //     es-nota-rec-inventi.NumeroNotaFiscal  
      //     es-nota-rec-inventi.dEmi
      //     es-nota-rec-inventi.ChaveNFe FORMAT "X(60)" WITH SCROLLABLE. PAUSE 0.
      ...
      IF c-xml <> "" THEN do:
         ...
         IF v-retonro-integracao <> ? THEN do:
            ...
            IF NOT AVAIL tt-erro-retorno THEN do:
               ...
               //MESSAGE 'l-ok ' VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
               IF l-ok = YES  THEN
                  ASSIGN es-nota-rec-inventi.sit-integracao = 2.
            END. //NOT AVAIL tt-erro-retorno
            ELSE ASSIGN es-nota-rec-inventi.sit-integracao = 9.
  ...
  RELEASE tt-erro-retorno .
  RELEASE tt-evento-xml-retornado.
  RELEASE esp_integracao.
  RELEASE esp_servico_integracao.
END.
