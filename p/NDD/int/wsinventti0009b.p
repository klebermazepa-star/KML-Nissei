...
c-arquivo = 'c:\temp\xml_recebimento' + STRING(TIME) + ".xml".


COPY-LOB client:ResponseText TO FILE c-arquivo.
IF client:ResponseText <> "" AND client:ResponseText <>  ? THEN do:
   ASSIGN p-retonro-integracao =  (client:ResponseText) .
          ...
          v-response                =  client:ResponseText .
          p-retonro-integracao  = v-response.
