    ...
    DO WHILE i-qtd-notas = 100:
        ...
        RUN pi-request(INPUT "nfe/api/destinadas/Obter",
                       ...
                       INPUT "<RecepcionarNotasDestinadas>
                                ...
                                <DataEmissaoInicial>2023-01-25T00:00:00</DataEmissaoInicial>
                                <Pagina>" + string(i-pagina) + "</Pagina>
...
PROCEDURE pi-request:
    ...
    DO ON ERROR UNDO, THROW:
       ...
       /* FOR EACH ttHttpRequestHeaders NO-LOCK:
            newRequest:Headers:Add(ttHttpRequestHeaders.headerName, string(ttHttpRequestHeaders.headerValue)).
        END.*/
        //newRequest:Headers:Add("Role-Type", "IMPEXP").
    /*
        ASSIGN certificate = new X509Certificate2(cCertifFile, cPasswordDecode).
     ...
     /*   /*Trata exce??es da biblioteca .Net*/
        CATCH cryptoMsg AS CryptographicException:
            ASSIGN plcRequestResult = "Verifique_se_o_certificado_digital_e_senha_foram_informados_corretamente_para_o_estabelecimento".
        END CATCH.*/
...
PROCEDURE gera_ndd_entryintegration:
 ...
 /*   hDoc:LOAD("file", "C:\TEMP\Kleber\763e438fe032da8f1ec1c46a32cd6ce3.xml" ,FALSE).
    ...
    find first NDD_ENTRYINTEGRATION EXCLUSIVE-LOCK 
