...
*******************************************************************************/
{include/i-prgvrs.i int590 2.06.00.001}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        int590
&GLOBAL-DEFINE Version        1.00.00.000
&GLOBAL-DEFINE VersionLayout  

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   Impress∆o
...
&GLOBAL-DEFINE page6Text      text-destino text-modo text-rtf text-ModelRtf i-qtd-notas
...
&GLOBAL-DEFINE page6Fields    cFile cModelRTF i-qtd-notas
...
DEFINE BUTTON btHelp2  NO-FOCUS
     LABEL "&Ajuda" 
     SIZE 10 BY 1.
...
DEFINE VARIABLE i-qtd-notas AS INTEGER FORMAT ">,>>9":U INITIAL 20 
     LABEL "Quantidade NF" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fpage0
     btHelp2 AT ROW 16.75 COL 80 NO-TAB-STOP 
...
DEFINE FRAME fPage6
     i-qtd-notas AT ROW 11.25 COL 11.29 COLON-ALIGNED WIDGET-ID 2
...
/* SETTINGS FOR BUTTON btHelp2 IN FRAME fpage0
   NO-ENABLE                                                            */
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.i-qtd-notas    = INPUT FRAME fPage6 i-qtd-notas .
    ...
    {report/rprun.i intprg/int590rp.p}
