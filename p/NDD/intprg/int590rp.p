...
FOR EACH es-nota-fiscal-inventti EXCLUSIVE-LOCK
    ...
    IF NOT AVAIL nota-fiscal THEN do:
       ASSIGN es-nota-fiscal-inventti.situacao-integracao = ?.
       NEXT.
    END.

    IF nota-fiscal.dt-cancela <> ? THEN DO:
       ASSIGN es-nota-fiscal-inventti.situacao-integracao = 1.
       NEXT.
    END.
    ...
    ASSIGN i-cont = i-cont + 1
           es-nota-fiscal-inventti.situacao-integracao = 1
           es-nota-fiscal-inventti.dt-ultimo-envio     = TODAY
           es-nota-fiscal-inventti.hr-ultimo-envio     = TIME.
...
FOR EACH es-nota-fiscal-inventti EXCLUSIVE-LOCK
    ...
    ASSIGN i-cont = i-cont + 1.
           es-nota-fiscal-inventti.situacao-integracao = 2.
