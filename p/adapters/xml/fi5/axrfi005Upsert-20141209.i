if  cTranEvent = "add" or cTranAction = "add" then do:
    ...
    CREATE tt_integr_apb_lote_fatura_1. 
    ASSIGN tt_integr_apb_lote_fatura_1.tta_cod_estab                = BranchCode
           tt_integr_apb_lote_fatura_1.tta_cod_refer                = Reference
           tt_integr_apb_lote_fatura_1.tta_cod_espec_docto          = DocumentClassCode
           tt_integr_apb_lote_fatura_1.tta_dat_transacao            = TransactionDate
           tt_integr_apb_lote_fatura_1.tta_ind_origin_tit_ap        = "EXP"
           tt_integr_apb_lote_fatura_1.tta_val_tot_lote_impl_tit_ap = TransactionTotalValue
           tt_integr_apb_lote_fatura_1.tta_cod_empresa              = CompanyCode
           tt_integr_apb_lote_fatura_1.tta_cod_indic_econ           = CurrencyCode
           tt_integr_apb_lote_fatura_1.ttv_cod_empresa_ext          = ""
           tt_integr_apb_lote_fatura_1.tta_cod_finalid_econ_ext     = ""
           tt_integr_apb_lote_fatura_1.tta_cod_estab_ext            = ""
           tt_integr_apb_lote_fatura_1.ttv_log_atualiza_refer_apb   = yes
           tt_integr_apb_lote_fatura_1.ttv_log_elimina_lote         = no
           tt_integr_apb_lote_fatura_1.tta_cdn_fornecedor           = integer(SupplierCode)
           tt_integr_apb_lote_fatura_1.tta_num_fatur_ap             = InvoiceNumber 
           tt_integr_apb_lote_fatura_1.tta_qtd_parcela              = QuantityParcel 
           tt_integr_apb_lote_fatura_1.tta_cod_histor_padr          = StandardHistoryCode
           tt_integr_apb_lote_fatura_1.tta_cod_histor_padr_dupl     = StandartHistoryDescription
           tt_integr_apb_lote_fatura_1.ttv_ind_matriz_fornec        = SupplierMatrix
           tt_integr_apb_lote_fatura_1.ttv_rec_integr_apb_lote_impl = recid(tt_integr_apb_lote_fatura_1).
