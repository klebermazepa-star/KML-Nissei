     ...
     IF (cTranAction = "add") or (cTranAction = "mod") THEN DO:
          RUN PIUpsert.
     ...
     FOR EACH tt_log_erro:
          ...
          RUN setError IN hMessageHandler (INPUT tt_log_erro.ttv_num_cod_erro, INPUT "business_error", INPUT tt_log_erro.ttv_des_msg_erro).
     END.
