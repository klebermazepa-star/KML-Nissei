    ...
    do trans:
        ...
        for each ttCardAccountReceivableIn_00 no-lock:
            ...
            if not avail tit_acr then do:
                ...
                /*****************************************************************************************/
                if can-find(first tit_acr_cartao where tit_acr_cartao.cod_empresa           = ttCardAccountReceivableIn_00.CompanyCode
                                                   ...
                                                   and tit_acr_cartao.cod_admdra            = admdra_cart_esp.cod_admdra) then do:
                    create tt_log_erro.
