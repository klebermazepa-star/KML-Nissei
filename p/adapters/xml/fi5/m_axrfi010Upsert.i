        ...
        for each ttCardAccountReceivableIn_00 no-lock:
            ...
            if not avail tit_acr then do:
                ...
                FIND first tit_acr_cartao where tit_acr_cartao.cod_empresa           = ttCardAccountReceivableIn_00.CompanyCode
                                            ...
                                            and tit_acr_cartao.cod_admdra            = admdra_cart_esp.cod_admdra NO-LOCK NO-ERROR.
        ...
        for each tt_titulos_cartao where tt_titulos_cartao.tot_val_adm_cartao > 0 no-lock:
           ...
           assign tt_alter_tit_acr_base_5.tta_cod_estab                   = tt_titulos_cartao.cod_estab
             ...
             */
             ...
             empty temp-table tt_rateio_un_ff.
           ...
           de-vl-total = (tt_titulos_cartao.val_sdo_tit_acr - tt_titulos_cartao.tot_val_adm_cartao).
           ...
           for each tt_rateio_un_ff
              where tt_rateio_un_ff.cod_estab      = tit_acr.cod_estab
               ...
               de-vl-total = de-vl-total - tt_alter_tit_acr_rateio.tta_val_aprop_ctbl.

           end.

           if de-vl-total > 0 then do:

              find first tt_alter_tit_acr_rateio where recid(tt_alter_tit_acr_rateio) = v_recid_tt_rateio exclusive-lock no-error.

              if available tt_alter_tit_acr_rateio then do:

                 assign tt_alter_tit_acr_rateio.tta_val_aprop_ctbl = tt_alter_tit_acr_rateio.tta_val_aprop_ctbl + de-vl-total.
