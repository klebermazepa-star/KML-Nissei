    ...
    FOR EACH cupom_fiscal:
        ...
        FOR EACH condicao_pagamento:       
            ...
            ASSIGN int_ds_nota_loja_cartao.emissao          = cupom_Fiscal.data_emissao                      
                   int_ds_nota_loja_cartao.condipag         = FndeParaCondPagto(condicao_pagamento.CONDICAO_PAGAMENTO, condicao_pagamento.debito_credito, condicao_pagamento.ADQUIRENTE_ID, condicao_pagamento.pbm_codigo)          
