...
CREATE ALIAS mgadm    FOR DATABASE ems2mult NO-ERROR.
...
CREATE ALIAS mginv    FOR DATABASE ems2mult NO-ERROR.
...
CREATE ALIAS mgven    FOR DATABASE ems2mult NO-ERROR.
CREATE ALIAS mgrac    FOR DATABASE ems2mult NO-ERROR.
CREATE ALIAS mgsop    FOR DATABASE ems2mult NO-ERROR.
CREATE ALIAS mguni    FOR DATABASE ems2mult NO-ERROR.
CREATE ALIAS emsgra   FOR DATABASE ems2mult NO-ERROR.
...
CREATE ALIAS mgsor    FOR DATABASE ems2mult NO-ERROR.
CREATE ALIAS mgmp     FOR DATABASE ems2log  NO-ERROR.
CREATE ALIAS mdtcrm   FOR DATABASE ems2log  NO-ERROR.
CREATE ALIAS neogrid  FOR DATABASE ems2mult NO-ERROR.
CREATE ALIAS movadm   FOR DATABASE ems2mult NO-ERROR.
CREATE ALIAS movrac   FOR DATABASE ems2mult NO-ERROR.
