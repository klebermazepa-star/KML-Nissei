&ANALYZE-SUSPEND _VERSION-NUMBER UIB_v8r12 GUI 12
&ANALYZE-RESUME
...
*******************************************************************************/
{include/i-prgvrs.i escm0001  12.00.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i escm0001 mcm}
&ENDIF
...
DEFINE VARIABLE fi-nome-abrev-ini AS CHARACTER FORMAT "X(12)":U INITIAL "" 
     LABEL "Nome Abrev." 
     VIEW-AS FILL-IN 
     SIZE 17 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-cod-emitente-ini AT ROW 4.75 COL 19 COLON-ALIGNED WIDGET-ID 128
     fi-cod-emitente-fim AT ROW 4.75 COL 42.57 COLON-ALIGNED NO-LABEL WIDGET-ID 130
     fi-nome-abrev-ini AT ROW 5.75 COL 16 COLON-ALIGNED WIDGET-ID 144
     fi-nome-abrev-fim AT ROW 5.75 COL 42.57 COLON-ALIGNED NO-LABEL WIDGET-ID 146
     IMAGE-1 AT ROW 4.75 COL 35.43 WIDGET-ID 132
     IMAGE-2 AT ROW 4.75 COL 41.43 WIDGET-ID 134
     IMAGE-13 AT ROW 5.75 COL 35.29 WIDGET-ID 136
     IMAGE-14 AT ROW 5.75 COL 41.29 WIDGET-ID 138
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
         SIZE 76.29 BY 10.63 WIDGET-ID 100.
...
{utp/ut9000.i "escm0001" "12.00.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-emitente-ini fi-cod-emitente-fim fi-nome-abrev-ini 
          fi-nome-abrev-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-13 IMAGE-14 fi-cod-emitente-ini 
...
define var r-tt-digita as rowid no-undo.
    ...
    do on error undo, return error on stop  undo, return error:
        ...
        ASSIGN  tt-param.usuario                = c-seg-usuario
                ...
                tt-param.cod-emitente-ini       = INTEGER(fi-cod-emitente-ini:SCREEN-VALUE IN FRAME f-pg-sel)
                tt-param.cod-emitente-fim       = INTEGER(fi-cod-emitente-fim:SCREEN-VALUE IN FRAME f-pg-sel)
                tt-param.nome-abrev-ini         = fi-nome-abrev-ini:SCREEN-VALUE IN FRAME f-pg-sel
                tt-param.nome-abrev-fim         = fi-nome-abrev-fim:SCREEN-VALUE IN FRAME f-pg-sel
               .
        ...
        {include/i-rprun.i cmp/escm0001rp.p}
