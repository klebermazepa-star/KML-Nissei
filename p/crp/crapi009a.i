...
/********************************************************************************
***
*** crp/crapi009a.i - Defini‡Æo de temp-tables
***
********************************************************************************/

def temp-table tt-nota-db-cr{1} no-undo
...
def temp-table tt-impto-nota-db-cr{1} no-undo
...
def temp-table tt-retorno-nota{1} no-undo
...
def temp-table tt-ext-lin-i-cr{1} no-undo like lin-i-cr
