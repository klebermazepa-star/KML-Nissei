...
FOR EACH tt-docto NO-LOCK
    ...
    OVERLAY(v_linha, 66, 10)      = "" .              // ALTERAÄ«O kleber solicitaá∆o lorhane IF emitente.ins-municipal = "ISENTO" THEN "" ELSE emitente.ins-municipal . /* 066,075  - N£mero da inscriá∆o municipal do prestador de serviáo. */
