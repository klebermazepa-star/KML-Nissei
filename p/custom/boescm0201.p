...
&GLOBAL-DEFINE DBOName BOCST_CLIENTE_BLOQUEIO
&GLOBAL-DEFINE DBOVersion 
&GLOBAL-DEFINE DBOCustomFunctions 
&GLOBAL-DEFINE TableName cst_cliente_bloqueio
...
PROCEDURE getKey :
/*------------------------------------------------------------------------------
  Purpose:     Retorna valores dos campos do °ndice idx-cliente_bloqueio
  Parameters:  
               retorna valor do campo cod-emitente
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pcod-emitente LIKE cst_cliente_bloqueio.cod-emitente NO-UNDO.
...
------------------------------------------------------------------------------*/
    ...
    CASE pFieldName:
        WHEN "Bloqueio":U THEN ASSIGN pFieldValue = RowObject.Bloqueio.
        OTHERWISE RETURN "NOK":U.
    END CASE.
...
PROCEDURE goToKey :
/*------------------------------------------------------------------------------
  Purpose:     Reposiciona registro com base no °ndice idx-cliente_bloqueio
  Parameters:  
               recebe valor do campo cod-emitente
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pcod-emitente LIKE cst_cliente_bloqueio.cod-emitente NO-UNDO.

    FIND FIRST bfcst_cliente_bloqueio WHERE 
        bfcst_cliente_bloqueio.cod-emitente = pcod-emitente NO-LOCK NO-ERROR.

    /*--- Verifica se registro foi encontrado, em caso de erro ser† retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bfcst_cliente_bloqueio THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atravÇs de rowid e verifica a ocorrància de erros, caso
          existam erros ser† retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bfcst_cliente_bloqueio)).
