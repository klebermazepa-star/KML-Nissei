...
&GLOBAL-DEFINE page2Fields    txtCodItemInicial txtCodItemFinal cbSituacao
...
DEFINE VARIABLE cbSituacao AS INTEGER FORMAT ">9":U INITIAL 0 
     LABEL "Situaá∆o" 
...
DEFINE VARIABLE txtCodItemFinal AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE txtCodItemInicial AS CHARACTER FORMAT "X(15)":U 
     LABEL "Cod.Item" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     txtCodItemInicial AT ROW 3 COL 16.14
     txtCodItemFinal AT ROW 3 COL 45 NO-LABEL
     cbSituacao AT ROW 5 COL 31 COLON-ALIGNED WIDGET-ID 2
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN txtCodItemFinal IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN txtCodItemInicial IN FRAME fPage2
   ALIGN-L                                                              */
...
ASSIGN txtCodItemInicial = txtCodItemInicial :INPUT-VALUE IN FRAME FPage2
       txtCodItemFinal   = txtCodItemFinal   :INPUT-VALUE IN FRAME FPage2
       cbSituacao        = cbSituacao        :INPUT-VALUE IN FRAME FPage2.
...
do on error undo, return error on stop  UNDO, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.codItemInicial  = txtCodItemInicial
           tt-param.codItemFinal    = txtCodItemFinal
    ...
    {report/rprun.i custom\eswms001rp.p}
...
do  on error undo, return error
    ...
    {report/imrun.i custom\eswms001rp.p}
