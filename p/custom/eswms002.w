...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESPWMS001 MPD}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESPWMS001
&GLOBAL-DEFINE Version        1.00.00 - Integraá∆o de produtos com o ProcFit - ESPWMS001
...
&GLOBAL-DEFINE page2Fields    cbSituacao cbTipo txtCodClienteFinal txtCodClienteInicial txtDocFinal ~
                              txtDocInicial txtGrupoFinal txtGrupoInicial txtNomeAbrevFinal txtNomeAbrevInicial
...
DEFINE VARIABLE cbSituacao AS INTEGER FORMAT ">9":U INITIAL 1 
     LABEL "Situaá∆o" 
     VIEW-AS COMBO-BOX INNER-LINES 5
     LIST-ITEM-PAIRS "Somente Alterados",1,
                     "Todos",0
     DROP-DOWN-LIST
     SIZE 17 BY 1 NO-UNDO.

DEFINE VARIABLE cbTipo AS INTEGER FORMAT ">9":U INITIAL 0 
     LABEL "Tipo" 
     VIEW-AS COMBO-BOX INNER-LINES 5
...
DEFINE VARIABLE txtCodClienteFinal AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE txtCodClienteInicial AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 0 
     LABEL "Cod.Emitente" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE txtDocFinal AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE txtDocInicial AS CHARACTER FORMAT "X(15)":U 
     LABEL "CPF / CNPJ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE txtGrupoFinal AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 999999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE txtGrupoInicial AS INTEGER FORMAT ">>>,>>>,>>9":U INITIAL 0 
     LABEL "Grupo" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE txtNomeAbrevFinal AS CHARACTER FORMAT "X(15)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE txtNomeAbrevInicial AS CHARACTER FORMAT "X(15)":U 
     LABEL "Nome Abrev." 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     txtCodClienteInicial AT ROW 3 COL 13.14
     txtCodClienteFinal AT ROW 3 COL 45 NO-LABEL
     txtNomeAbrevInicial AT ROW 4.08 COL 13.28 WIDGET-ID 10
     txtNomeAbrevFinal AT ROW 4.08 COL 45 NO-LABEL WIDGET-ID 8
     txtDocInicial AT ROW 5.17 COL 13.86 WIDGET-ID 18
     txtDocFinal AT ROW 5.17 COL 45 NO-LABEL WIDGET-ID 16
     txtGrupoInicial AT ROW 6.25 COL 18 WIDGET-ID 36
     txtGrupoFinal AT ROW 6.25 COL 45 NO-LABEL WIDGET-ID 34
     cbTipo AT ROW 8.25 COL 30 COLON-ALIGNED WIDGET-ID 2
     cbSituacao AT ROW 9.25 COL 30 COLON-ALIGNED WIDGET-ID 28
     IMAGE-1 AT ROW 3 COL 37.86
     IMAGE-2 AT ROW 3 COL 42
     IMAGE-3 AT ROW 4.08 COL 37.86 WIDGET-ID 4
     IMAGE-4 AT ROW 4.08 COL 42 WIDGET-ID 6
     IMAGE-5 AT ROW 5.17 COL 37.86 WIDGET-ID 12
     IMAGE-6 AT ROW 5.17 COL 42 WIDGET-ID 14
     IMAGE-9 AT ROW 6.25 COL 37.86 WIDGET-ID 30
     IMAGE-10 AT ROW 6.25 COL 42 WIDGET-ID 32
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.57 ROW 2.81
         SIZE 84.43 BY 10.15
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN txtCodClienteFinal IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN txtCodClienteInicial IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN txtDocFinal IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN txtDocInicial IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN txtGrupoFinal IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN txtGrupoInicial IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN txtNomeAbrevFinal IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN txtNomeAbrevInicial IN FRAME fPage2
   ALIGN-L                                                              */
...
ASSIGN cbSituacao           = cbSituacao           :INPUT-VALUE IN FRAME FPage2
       cbTipo               = cbTipo               :INPUT-VALUE IN FRAME FPage2
       txtCodClienteFinal   = txtCodClienteFinal   :INPUT-VALUE IN FRAME FPage2
       txtCodClienteInicial = txtCodClienteInicial :INPUT-VALUE IN FRAME FPage2
       txtDocFinal          = txtDocFinal          :INPUT-VALUE IN FRAME FPage2
       txtDocInicial        = txtDocInicial        :INPUT-VALUE IN FRAME FPage2
       txtGrupoFinal        = txtGrupoFinal        :INPUT-VALUE IN FRAME FPage2
       txtGrupoInicial      = txtGrupoInicial      :INPUT-VALUE IN FRAME FPage2
       txtNomeAbrevFinal    = txtNomeAbrevFinal    :INPUT-VALUE IN FRAME FPage2
       txtNomeAbrevInicial  = txtNomeAbrevInicial  :INPUT-VALUE IN FRAME FPage2
       .
...
do on error undo, return error on stop  UNDO, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.Situacao          = cbSituacao          
           tt-param.Tipo              = cbTipo              
           tt-param.CodClienteFinal   = txtCodClienteFinal  
           tt-param.CodClienteInicial = txtCodClienteInicial
           tt-param.DocFinal          = txtDocFinal         
           tt-param.DocInicial        = txtDocInicial       
           tt-param.GrupoFinal        = txtGrupoFinal       
           tt-param.GrupoInicial      = txtGrupoInicial     
           tt-param.NomeAbrevFinal    = txtNomeAbrevFinal   
           tt-param.NomeAbrevInicial  = txtNomeAbrevInicial 
    ...
    {report/rprun.i custom\eswms002rp.p}
...
do  on error undo, return error
    ...
    if  tt-param.destino = 2 THEN
        ...
        assign tt-param.arq-destino = session:temp-directory + c-programa-mg97 + ".txt":U.
    ...
    {report/imrun.i custom\eswms002rp.p}
