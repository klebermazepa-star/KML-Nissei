...
*******************************************************************************/
{include/i-prgvrs.i zoomescm0201 1.00.00.001KML}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i zoomescm0201 mut}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           zoomescm0201
...
&GLOBAL-DEFINE FieldsRangePage1  custom.cst_cliente_bloqueio.cod-emitente
...
&GLOBAL-DEFINE ttTable1          tt-cst_cliente_bloqueio
&GLOBAL-DEFINE hDBOTable1        hcst_cliente_bloqueio
&GLOBAL-DEFINE DBOTable1         dobcst_cliente_bloqueio
...
&Scoped-define INTERNAL-TABLES tt-cst_cliente_bloqueio

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ~
tt-cst_cliente_bloqueio.cod-emitente tt-cst_cliente_bloqueio.Nome-abrev 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-cst_cliente_bloqueio NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-cst_cliente_bloqueio NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-cst_cliente_bloqueio
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-cst_cliente_bloqueio
...
DEFINE QUERY brTable1 FOR 
      tt-cst_cliente_bloqueio SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-cst_cliente_bloqueio.cod-emitente FORMAT "x(7)":U
      tt-cst_cliente_bloqueio.Nome-abrev FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-cst_cliente_bloqueio"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   = Temp-Tables.tt-cst_cliente_bloqueio.cod-emitente
     _FldNameList[2]   = Temp-Tables.tt-cst_cliente_bloqueio.Nome-abrev
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="custom/escm0201.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "custom/boescm0201.p":U THEN DO:
       
        {btb/btb008za.i1 custom/boescm0201.p YES}
        {btb/btb008za.i2 custom/boescm0201.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="ByCod-emitente"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintByCod-emitente IN {&hDBOTable1} ( INPUT CodigoInicial,
                                                               INPUT CodigoFinal).
