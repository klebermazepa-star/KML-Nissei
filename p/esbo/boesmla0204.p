...
PROCEDURE getKey :
/*------------------------------------------------------------------------------
  Purpose:     Retorna valores dos campos do °ndice idx-item_gera_receb_MLA
  Parameters:  
...
PROCEDURE goToKey :
/*------------------------------------------------------------------------------
  Purpose:     Reposiciona registro com base no °ndice idx-item_gera_receb_MLA
  Parameters:  
    ...
    IF pType = "create" THEN DO:
        ...
        IF AVAIL esp_item_gera_receb_MLA THEN DO:
               {method/svc/errors/inserr.i
                        ...
                        &ErrorType="EMS"
                        &ErrorSubType="ERROR" 
                        &ErrorParameters="'Esse item j† est† cadastrado!'"}
                return "NOK".        
        END.
