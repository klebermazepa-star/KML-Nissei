...
FUNCTION FndeParaCondPagto RETURNS CHAR (INPUT p-cond-pagto AS CHAR ,
    ...
    IF p-cond-pagto = "cartao" THEN DO:
        ...
        FIND FIRST esp_forma_pagto NO-LOCK
            WHERE esp_forma_pagto.cod-bandeira = p-bandeira NO-ERROR.
        IF AVAIL esp_forma_pagto THEN DO:
            RETURN string(esp_forma_pagto.cond-pagto, "99"). 
    ...
    CASE p-cond-pagto:
        ...
        WHEN "pix "     THEN RETURN "92".
        WHEN "convenio"  THEN RETURN "12".
        WHEN "valecredito"  THEN RETURN "13".
...
PROCEDURE pi-gera-cupom:
    ...
    log-manager:write-message("KML - entrou procedure cupom") no-error.
...
PROCEDURE gera-int-ds-nota-loja:
    ...
    FOR EACH cupom_fiscal:
        ...
        ASSIGN int_ds_nota_loja.tipo_movto              = 1                                     
               ...
               int_ds_nota_loja.nfce_status_s           = cupom_Fiscal.status_sefaz                                      
        ...
        FOR EACH itens:
            ...
            ASSIGN int_ds_nota_loja_item.desconto           = itens.valor_desconto                               
                   ...
                   int_ds_nota_loja_item.aliq_icms          = 0                                                  
        ...
        FOR EACH condicao_pagamento:       
            ...
            ASSIGN int_ds_nota_loja_cartao.emissao          = cupom_Fiscal.data_emissao                      
                   int_ds_nota_loja_cartao.condipag         = FndeParaCondPagto(condicao_pagamento.CONDICAO_PAGAMENTO, condicao_pagamento.cod_bandeira)          
