        ...
        DO:
            ...
            IF AVAIL nota-fiscal THEN DO:
                ...
                assign tt-param.usuario         = "RPW"
                       ...
                       tt-param.nro-docto       = int(nota-fiscal.nr-nota-fis)
                       tt-param.serie-docto     = nota-fiscal.serie.
                       
                raw-transfer tt-param to raw-param.     
                RUN intprg/int142rp-ecom.p ( INPUT raw-param,
        ...
        IF nota.tipo_nota = "Entrada" THEN DO:
            ...
            FOR EACH itens:
               ...
               log-manager:write-message("KML - conf - dentro do for each - " +  itens.ean) NO-ERROR.
                ...
                log-manager:write-message("KML - conf - RESPOSTA - " +  string(int_ds_nota_entrada_produt.nen_notafiscal_n)) NO-ERROR. 
            ...
            RUN intprg/int112rp-ecom-v2.p ( INPUT raw-param,
                                         INPUT TABLE tt-raw-digita ,
                                         OUTPUT c-retorno).
