...
PROCEDURE pi-gera-faturamento:
    ...
    DO:
        ...
        ASSIGN tt-nota-fiscal.l-gerada = NO
               tt-nota-fiscal.desc-erro = "Pedido j† est† em processo de integraá∆o".
    ...
    FOR EACH Recebimento:
        ...
        DO TRANS ON ERROR UNDO, LEAVE:
            ...
            IF AVAIL estabelec AND
                (estabelec.cod-estabel > "999" )    // tirado  todas as filiais pois a api da procfit ficou fora do ar
                THEN DO:
...
PROCEDURE pi-integra-loja:
  ...
  //  ASSIGN c-mensagem = c-mensagem + "2 ".
   ...
   // ASSIGN c-mensagem = c-mensagem + "3 ".
    ...
    DEFINE VARIABLE c-retorno AS CHARACTER   NO-UNDO INIT "Api Procfit fora do ar".
    DEFINE VARIABLE c-aux AS CHARACTER   NO-UNDO.
    ASSIGN c-retorno = STRING(oResponse:Entity) NO-ERROR.
    ASSIGN c-aux = "sucesso".

    LOG-MANAGER:WRITE-MESSAGE("KML - retorno conex∆o procfit - " + c-retorno) NO-ERROR.
  ...
  //  ASSIGN c-mensagem = c-mensagem + "4 ".
    ...
    LOG-MANAGER:WRITE-MESSAGE("KML - depois conex∆o procfit - " + c-mensagem) NO-ERROR.
    RETURN "OK".
END PROCEDURE.
