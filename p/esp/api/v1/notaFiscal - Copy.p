    ...
    FOR EACH Recebimento:
        ...
        DO TRANS ON ERROR UNDO, LEAVE:
            ...
            IF AVAIL estabelec AND
                estabelec.cod-estabel = "017" THEN DO:
...
PROCEDURE pi-procfit:
    ...
    assign tt-param-int500.usuario         = c-seg-usuario
           ...
           tt-param-int500.dt-trans-ini    = TODAY
           tt-param-int500.dt-trans-fin    = TODAY
    ...
    log-manager:write-message("KML - depois int500 - cnpj - " + cDest) no-error.
