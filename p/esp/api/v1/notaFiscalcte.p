...
PROCEDURE pi-gera-faturamento:
    ...
    jsonAux:WriteFile("/mnt/shares/TEMP/recebimento_PEDIDO.json") NO-ERROR.    
...
PROCEDURE pi-cancelamento:
    ...
    FOR FIRST nota-fiscal-cancela,
        ...
        IF NOT AVAIL nota-fiscal THEN DO:
            ...
            ASSIGN RowErrors.ErrorNumber = 17001
                   RowErrors.ErrorDescription = "Nota Fiscal nío encontrada!"
                   RowErrors.ErrorHelp = "Nota Fiscal nío encontrada!"
        ...
        IF nota-fiscal.dt-cancela <> ? THEN DO:
            ...
            CREATE RowErrors.
            ASSIGN RowErrors.ErrorNumber = 17001
                   RowErrors.ErrorDescription = "Nota Fiscal jˇ cancelada ou em processo de cancelamento!"
                   RowErrors.ErrorHelp = "Nota Fiscal jˇ cancelada ou em processo de cancelamento!"
                   RowErrors.ErrorSubType = "ERROR". 
        ...
        FOR EACH RowErrors:
            ...
            AND (   RowErrors.ErrorDescription BEGINS "NF-e em processo de Cancelamento"
                 OR RowErrors.ErrorDescription BEGINS "NF-e em processo de Inutiliza? o"
                 OR RowErrors.ErrorDescription BEGINS "Emiss? o da nota fiscal ocorreu hˇ mais de 3 dias"
                 OR RowErrors.ErrorDescription BEGINS "N? o foi poss≠vel desatualizar") THEN
    ...
    FOR FIRST tt-erros:
        ...
        IF l-cancel-ok   = NO THEN DO:
            ...
            jsonOutput:ADD("Descriªío",tt-erros.desc-erro).
