...
output to value ("/mnt/shares/p/cjem8f/KML/KLEBER/Notas_exclusao_saida_973-24a31.csv").   



    
FOR EACH docum-est NO-LOCK
    WHERE docum-est.dt-trans >= 01/24/2026
      AND docum-est.dt-trans <= 01/31/2026
      AND docum-est.esp-docto = 23
      AND docum-est.cod-emitente = 9356:
      
    FIND FIRST estabelec NO-LOCK
        WHERE estabelec.cod-estabel = docum-est.cod-estabel NO-ERROR.     
        
    IF estabelec.estado <> "PR" THEN NEXT.
