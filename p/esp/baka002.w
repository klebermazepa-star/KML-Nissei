...
**
********************************************************************************/
{include/i-prgvrs.i baka002 2.12.01.AVB}                

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        baka002
...
do on error undo, return error on stop  undo, return error:
    ...
    //INPUT FROM VALUE ("X:/RPW/prod/rpw-fila2/svc_datasul/Deposito.csv").
   ...
   // raw-transfer tt-digita to tt-raw-digita.
    ...
    {report/rprun.i esp/baka002rp.r}
