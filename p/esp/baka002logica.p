...
//MESSAGE "KML - int142-ecom - entrou programa" VIEW-AS ALERT-BOX.
log-manager:write-message("KML - int142-ecom - entrou programa" ) NO-ERROR.  
...
FOR LAST int_ds_nota_entrada
    ...
    assign d-data-movimento = 12/31/2025.
...
/*     end.                                                                                            */
    ...
    for FIRST int_ds_nota_entrada_produt no-lock where
        ...
        */
        ...
        IF int_ds_nota_entrada.nen_cnpj_origem_s = "79430682025540" THEN
        DO:
        ...
        if c-nat-principal = "" or 
         ...
         MESSAGE  natur-oper.nat-operacao VIEW-AS ALERT-BOX.
    ...
    if can-find(first tt-movto) then do:
        ...
        //MESSAGE "8" SKIP l-erro VIEW-AS ALERT-BOX.
        if not l-erro then
    ...
    FOR LAST tt-movto
       /*break by tt-movto.serie
        ...
        //if last-of (tt-movto.nr-nota-fis) then do:
            ...
            log-manager:write-message("KML - int142-ecom - antes criar nota" ) NO-ERROR. 
            
            EMPTY TEMP-TABLE tt-erro.
            //MESSAGE "10" VIEW-AS ALERT-BOX.
            DO TRANSACTION: 
               ...
               // run emptyRowErrors in h-boin090.
                ...
                run gotoKey      in h-boin090(input tt-docum-est.serie-docto,  
               ...
               /*     
                MESSAGE "depois deletar" VIEW-AS ALERT-BOX.   
              ...
              //   RUN pi-execute IN h-api.  
                    */
                 FIND first docum-est of tt-docum-est NO-ERROR.
                 
                 //MESSAGE "12" SKIP AVAIL docum-est VIEW-AS ALERT-BOX.
                 ...
                 DO:
                    ...
                    LOG-MANAGER:WRITE-MESSAGE("**API REAPI316B **") NO-ERROR.  
...
procedure pi-gera-log:
    ...
    MESSAGE "KML - int142-ecom - dentro pi-gera-log - " + c-informacao + " - " + string(i-situacao) VIEW-AS ALERT-BOX.
