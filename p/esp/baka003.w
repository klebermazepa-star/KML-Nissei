...
/********************************************************************************
** Programa: int052 - Importa‡Æo de Notas de REtirada Loja do Toturial/Sysfarma
**
** Versao : 12 - 18/10/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i baka003 2.12.01.AVB}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        BAKA003
...
do on error undo, return error on stop  undo, return error:
    ...
    INPUT FROM VALUE ("/mnt/shares/p/cjem8f/KML/KLEBER/reprocessa_equivalencia/NOTASDES.csv").
        
    REPEAT:

        CREATE tt-nota.
        IMPORT DELIMITER ";" tt-nota.
    ...
    FOR EACH tt-nota:
        ...
        FIND FIRST emitente NO-LOCK
            WHERE emitente.cod-emitente = tt-nota.emitente NO-ERROR.

        FIND first docum-est exclusive-lock
            WHERE docum-est.cod-emitente = emitente.cod-emitente
            AND   docum-est.nro-docto    = tt-nota.nota
            AND   docum-est.serie-docto  = tt-nota.serie
            AND   docum-est.nat-operacao = tt-nota.natureza NO-ERROR.
                
         
         CREATE tt-digita.
         ASSIGN tt-digita.r-docum-est = ROWID(docum-est).
         // RUN intprg/Cancela-atualiza-RE0402-RE1005ROWID.p (INPUT ROWID(docum-est)).  
   ...
   // raw-transfer tt-digita to tt-raw-digita.
    
    
    {report/rprun.i esp/baka003rp.p}
