...
/*                                output r-rowid).                             */
        ...
        FIND FIRST docum-est NO-LOCK
             WHERE docum-est.cod-emitente = tt-movto.cod-emitente
             AND docum-est.nro-docto      = tt-movto.nr-nota-fis                     
             AND   docum-est.serie-docto  = tt-movto.serie NO-ERROR.
             
        IF AVAIL docum-est  THEN
        DO:
            ASSIGN c-nat-operacao = docum-est.nat-operacao.
