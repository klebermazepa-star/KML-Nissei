...
/*:T vÿriÿveis de uso globla */
def  var v-row-parent    as rowid no-undo.

/*:T variÿveis de uso local */
...
&Scoped-define INTERNAL-TABLES es-api-app-empresa es-api-empresa

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table es-api-empresa.id-codigo es-api-empresa.id-empresa es-api-empresa.Nome es-api-app-empresa.Ativo   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH es-api-app-empresa NO-LOCK           OF es-api-app-URI, ~
               EACH es-api-empresa     NO-LOCK           OF es-api-app-empresa     ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br-table OPEN QUERY {&SELF-NAME}     FOR EACH es-api-app-empresa NO-LOCK           OF es-api-app-URI, ~
               EACH es-api-empresa     NO-LOCK           OF es-api-app-empresa     ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br-table es-api-app-empresa es-api-empresa
&Scoped-define FIRST-TABLE-IN-QUERY-br-table es-api-app-empresa
&Scoped-define SECOND-TABLE-IN-QUERY-br-table es-api-empresa
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _FREEFORM
  QUERY br-table NO-LOCK DISPLAY
      ...
      es-api-app-empresa.Ativo  VIEW-AS TOGGLE-BOX
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
