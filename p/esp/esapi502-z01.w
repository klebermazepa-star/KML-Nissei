...
*******************************************************************************/
{include/i-prgvrs.i esapi502-Z01 TOTVS}
...
DEFINE VARIABLE h_esapi502-b01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-size IN h_folder ( 11.83 , 88.57 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi502-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi502-b01 ).
       RUN set-position IN h_esapi502-b01 ( 2.54 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 86.00 ) */

       /* Links to SmartBrowser h_esapi502-b01. */
       RUN add-link IN adm-broker-hdl ( h_esapi502-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi502-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esapi502-Z01" "TOTVS"}
