...
*******************************************************************************/
{include/i-prgvrs.i esapi502 TOTVS}
...
DEFINE VARIABLE h_esapi502-b02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapi502-b03 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapi502-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapi502-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi502-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi502-v01 ).
       RUN set-position IN h_esapi502-v01 ( 2.83 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 5.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'APIs|Empresas' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 8.00 , 2.14 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.67 , 88.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi502-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esapi502-z01.w,
                     ProgVaPara = esp/esapi502-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esapi502-q01 ).
       RUN set-position IN h_esapi502-q01 ( 1.50 , 64.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esapi502-v01. */
       RUN add-link IN adm-broker-hdl ( h_esapi502-q01 , 'Record':U , h_esapi502-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esapi502-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartQuery h_esapi502-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esapi502-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esapi502-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi502-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_esapi502-v01 , 'AFTER':U ).
    END. /* Page 0 */
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi502-b03.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/esapi502b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esapi502-b03 ).
       RUN set-position IN h_esapi502-b03 ( 9.33 , 3.14 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 86.00 ) */

       /* Links to BrowserCadastro2 h_esapi502-b03. */
       RUN add-link IN adm-broker-hdl ( h_esapi502-q01 , 'Record':U , h_esapi502-b03 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi502-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi502-b02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     Hide-on-Init = no,
                     Disable-on-Init = no,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = esp/esapi502a.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_esapi502-b02 ).
       RUN set-position IN h_esapi502-b02 ( 9.50 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 86.00 ) */

       /* Initialize other pages that this page requires. */
       RUN init-pages IN THIS-PROCEDURE ('1':U) NO-ERROR.

       /* Links to BrowserCadastro2 h_esapi502-b02. */
       RUN add-link IN adm-broker-hdl ( h_esapi502-b03 , 'Record':U , h_esapi502-b02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi502-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
