...
&Scoped-define INTERNAL-TABLES es-api-app-empresa

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-app-empresa NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-app-empresa NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-app-empresa
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-app-empresa
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "db.es-api-app-empresa"
     _Options          = "NO-LOCK"
