...
&Scoped-define INTERNAL-TABLES es-api-app-URI

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-app-URI NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-app-URI NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-app-URI
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-app-URI
