...
*******************************************************************************/
{include/i-prgvrs.i esapi502B TOTVS}
...
DEFINE VARIABLE h_esapi502b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapi502b-v01 AS HANDLE NO-UNDO.
...
DO:
   {include/okfil.i h_esapi502b-v01}
END.
...
DO:
   {include/salvafil.i h_esapi502b-v01}
END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi502b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi502b-v01 ).
       RUN set-position IN h_esapi502b-v01 ( 3.04 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 4.25 , 77.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi502b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_esapi502b-q01 ).
       RUN set-position IN h_esapi502b-q01 ( 9.25 , 57.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_esapi502b-v01. */
       RUN add-link IN adm-broker-hdl ( h_esapi502b-q01 , 'Record':U , h_esapi502b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_esapi502b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             bt-ok:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi502b-v01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esapi502B" "TOTVS"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_esapi502b-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
   RUN pi-reposiciona-query IN h_esapi502b-q01 (input v-row-table).
