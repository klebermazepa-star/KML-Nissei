...
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-api-URI NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-api-URI NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-api-URI
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-api-URI
