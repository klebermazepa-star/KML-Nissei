...
*******************************************************************************/
{include/i-prgvrs.i esapi503-Z01 TOTVS}
...
&Scoped-Define ENABLED-OBJECTS rt-button bt-ok bt-cancela 
...
DEFINE VARIABLE h_esapi503-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapi503-b02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapi503-b03 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     rt-button AT ROW 13.25 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 110.29 BY 13.96
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'C¢digo|Programas|Descri‡Æo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 11.83 , 108.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi503-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi503-b01 ).
       RUN set-position IN h_esapi503-b01 ( 2.54 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 107.00 ) */

       /* Links to SmartBrowser h_esapi503-b01. */
       RUN add-link IN adm-broker-hdl ( h_esapi503-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi503-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi503-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi503-b02 ).
       RUN set-position IN h_esapi503-b02 ( 2.58 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 107.14 ) */

       /* Links to SmartBrowser h_esapi503-b02. */
       RUN add-link IN adm-broker-hdl ( h_esapi503-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi503-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
    WHEN 3 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi503-b03.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi503-b03 ).
       RUN set-position IN h_esapi503-b03 ( 2.54 , 2.29 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 107.14 ) */

       /* Links to SmartBrowser h_esapi503-b03. */
       RUN add-link IN adm-broker-hdl ( h_esapi503-b03 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi503-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 3 */
...
------------------------------------------------------------------------------*/
  ENABLE rt-button bt-ok bt-cancela 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "esapi503-Z01" "TOTVS"}
