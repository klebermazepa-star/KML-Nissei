...
*******************************************************************************/
{include/i-prgvrs.i esapi505 TOTVS}
...
DEF SHARED VAR hWenController AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
   ...
   do on error undo, return error on stop  undo, return error:
      ...
      AND input frame f-pg-imp rs-execucao = 1 
      then do:
      ...
      {include/i-rprun.i esp/esapi505rp.p}
      {include/i-rpexc.i}
