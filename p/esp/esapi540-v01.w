...
&Scoped-Define DISPLAYED-FIELDS es-bv-param.cod-portador ~
es-bv-param.modalidade es-bv-param.Ativo 
&Scoped-define DISPLAYED-TABLES es-bv-param
&Scoped-define FIRST-DISPLAYED-TABLE es-bv-param
&Scoped-Define DISPLAYED-OBJECTS cPortador 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,ADM-MODIFY-FIELDS,List-4,List-5,List-6 */
&Scoped-define ADM-CREATE-FIELDS es-bv-param.cod-portador ~
es-bv-param.modalidade 
&Scoped-define ADM-ASSIGN-FIELDS es-bv-param.cod-portador ~
es-bv-param.modalidade 
...
DEFINE FRAME f-main
     es-bv-param.cod-portador AT ROW 1.25 COL 15 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 6.86 BY .88
     es-bv-param.modalidade AT ROW 1.25 COL 22.43 COLON-ALIGNED NO-LABEL WIDGET-ID 128
...
/* SETTINGS FOR FILL-IN cPortador IN FRAME f-main
   NO-ENABLE                                                            */
/* SETTINGS FOR COMBO-BOX es-bv-param.modalidade IN FRAME f-main
   NO-ENABLE 1 2                                                        */
...
DO:
   {include/zoomvar.i &prog-zoom=adzoom/z01ad209.w
                      ...
                      &campo2=es-bv-param.modalidade
                      &campozoom2=modalidade
                      }
...
&Scoped-define SELF-NAME es-bv-param.modalidade
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-bv-param.modalidade V-table-Win
ON LEAVE OF es-bv-param.modalidade IN FRAME f-main /* Modalidade */
DO:
   RUN pi-mostrar.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL es-bv-param.modalidade V-table-Win
ON VALUE-CHANGED OF es-bv-param.modalidade IN FRAME f-main /* Modalidade */
DO:
   RUN pi-mostrar.
END.
...
------------------------------------------------------------------------------*/
   ...
   THEN DO:
      FIND FIRST es-bv-param NO-LOCK
           WHERE es-bv-param.cod-portador = INPUT FRAME {&FRAME-NAME} es-bv-param.cod-portador 
             AND es-bv-param.modalidade   = INPUT FRAME {&FRAME-NAME} es-bv-param.modalidade
           NO-ERROR.
   ...
   FIND FIRST mgadm.portador NO-LOCK
        WHERE mgadm.portador.cod-portador = INPUT FRAME {&FRAME-NAME} es-bv-param.cod-portador 
          AND mgadm.portador.modalidade   = INPUT FRAME {&FRAME-NAME} es-bv-param.modalidade
        NO-ERROR.
