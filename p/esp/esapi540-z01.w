...
DEFINE VARIABLE h_esapi540-b01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-ok AT ROW 12 COL 3
     bt-cancela AT ROW 12 COL 14
     rt-button AT ROW 11.75 COL 2
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi540-b01.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi540-b01 ).
       RUN set-position IN h_esapi540-b01 ( 1.33 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.14 ) */

       /* Links to SmartBrowser h_esapi540-b01. */
       RUN add-link IN adm-broker-hdl ( h_esapi540-b01 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi540-b01 ,
