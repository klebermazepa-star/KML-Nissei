...
*******************************************************************************/
{include/i-prgvrs.i ESAPI540 TOTVS}
...
DEFINE VARIABLE h_esapi540-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_esapi540-v01 AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi540-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_esapi540-v01 ).
       RUN set-position IN h_esapi540-v01 ( 2.83 , 1.57 ) NO-ERROR.
       /* Size in UIB:  ( 2.50 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'esp/esapi540-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = esp/esapi540-z01.w,
                     ProgVaPara = esp/esapi540-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_esapi540-q01 ).
       RUN set-position IN h_esapi540-q01 ( 1.50 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'State':U , h_p-exihel ).

       /* Links to SmartViewer h_esapi540-v01. */
       RUN add-link IN adm-broker-hdl ( h_esapi540-q01 , 'Record':U , h_esapi540-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_esapi540-v01 ).

       /* Links to SmartQuery h_esapi540-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_esapi540-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_esapi540-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadsim , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_esapi540-v01 ,
             h_p-exihel , 'AFTER':U ).
    END. /* Page 0 */
