...
&Scoped-define INTERNAL-TABLES es-bv-setup

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH es-bv-setup NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH es-bv-setup NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main es-bv-setup
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main es-bv-setup
