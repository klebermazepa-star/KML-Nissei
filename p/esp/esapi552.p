...
blk: FOR FIRST es-api-log NO-LOCK
   ...
   THEN DO:
      IF es-bv-setup.nenviados
      THEN ASSIGN
         dt-ult-envio[1] = es-bv-setup.dt-nenviados-ini
         dt-ult-envio[2] = es-bv-setup.dt-nenviados-fim
         .                 
   END.

   snd: FOR EACH nota-fiscal NO-LOCK
//       WHERE nota-fiscal.cod-estabel = "152"
//         AND nota-fiscal.serie = "53"
//         AND nota-fiscal.nr-nota-fis = "0099385"
      WHERE nota-fiscal.dt-emis-nota   >= dt-ult-envio[1]
        AND nota-fiscal.dt-emis-nota   <= dt-ult-envio[2]
...
//                VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
            ...
            ASSIGN
               ...
               es-bv-fat-duplic.ind-send     = "".
            ASSIGN
               es-bv-fat-duplic.dt-envio     = nota-fiscal.dt-emis-nota.
         END.
         IF es-bv-fat-duplic.ind-send = ""
         THEN DO:
/*   
            MESSAGE 
