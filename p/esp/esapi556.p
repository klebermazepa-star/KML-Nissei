...
blk: FOR FIRST es-api-log
   ...
   FIND FIRST es-bv-fat-duplic NO-LOCK
        WHERE es-bv-fat-duplic.ind-envio =  2
          AND es-bv-fat-duplic.dt-envio  >= 1/1
       NO-ERROR.
  ...
  */
   ...
   THEN DO:
      IF es-bv-setup.liquidados 
      THEN ASSIGN
         dt-ult-envio[1] = es-bv-setup.dt-liquidados-ini
         dt-ult-envio[2] = es-bv-setup.dt-liquidados-fim
         .                 
   END.
