&SCOPED-DEFINE shardef {1}

/* *** VARIAVEIS GLOBAIS ************************************************/
DEFINE NEW GLOBAL SHARED VARIABLE v_cod_usuar_corren
        AS CHARACTER FORMAT "x(12)":U LABEL "Usu?rio Corrente" COLUMN-LABEL "Usu?rio Corrente" NO-UNDO.

DEFINE NEW GLOBAL SHARED VARIABLE v_cod_dwb_user                
        AS CHARACTER FORMAT "x(21)":U   LABEL "Usu?rio" COLUMN-LABEL "Usu?rio" NO-UNDO.

DEFINE NEW GLOBAL SHARED VARIABLE v_cod_empres_usuar            
        AS CHARACTER FORMAT "x(3)":U    LABEL "Empresa" COLUMN-LABEL "Empresa" NO-UNDO.

DEFINE NEW GLOBAL SHARED VARIABLE v_rec_portador                
        AS RECID  FORMAT ">>>>>>9":U INITIAL ?                              NO-UNDO. 

DEFINE NEW GLOBAL SHARED VARIABLE v_rec_usuar_financ_estab_apb  
        AS RECID FORMAT ">>>>>>9":U                     COLUMN-LABEL "Usr Fin Rec" NO-UNDO.

DEFINE NEW GLOBAL SHARED VARIABLE v_des_contdo_prog_valid_dtsul  
        AS CHARACTER FORMAT "x(40)":U   NO-UNDO.

DEFINE  NEW global shared VARIABLE v_num_control_ult_msg
        AS INTEGER FORMAT ">>>>,>>9":U  NO-UNDO.

DEFINE NEW GLOBAL SHARED VARIABLE v_num_hra_ult_msg 
        AS INTEGER FORMAT ">>>>,>>9":U  NO-UNDO.

DEFINE NEW GLOBAL SHARED VARIABLE v_cod_arq
        AS  CHAR  FORMAT 'x(60)' NO-UNDO.

DEFINE NEW GLOBAL SHARED VARIABLE v_cod_tip_prog
        AS  CHARACTER format 'x(8)' NO-UNDO .


/* temp-table de uso da tabela de integracao */

def temp-table tt_integr_acr_abat_antecip_1 no-undo
...
def {&shardef} temp-table tt_integr_acr_abat_antecip no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field ttv_rec_abat_antecip_acr         as recid format ">>>>>>9"
    field tta_cod_estab                    as character format "x(3)" label "Estabelecimento" column-label "Estab"
    field tta_cod_estab_ext                as character format "x(8)" label "Estabelecimento Exte" column-label "Estabelecimento Ext"
...
def {&shardef} temp-table tt_integr_acr_abat_prev no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_cod_estab                    as character format "x(3)" label "Estabelecimento" column-label "Estab"
    field tta_cod_estab_ext                as character format "x(8)" label "Estabelecimento Exte" column-label "Estabelecimento Ext"
    field tta_cod_espec_docto              as character format "x(3)" label "Esp?cie Documento" column-label "Esp?cie"
...
def temp-table tt_integr_acr_abat_prev_1 no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_cod_estab                    as character format "x(3)" label "Estabelecimento" column-label "Estab"
    field tta_cod_estab_ext                as character format "x(8)" label "Estabelecimento Exte" column-label "Estabelecimento Ext"
    field tta_cod_espec_docto              as character format "x(3)" label "Esp°cie Documento" column-label "Esp°cie"
...
def temp-table tt_integr_acr_aprop_liq_antec_1 no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field ttv_rec_abat_antecip_acr         as recid format ">>>>>>9"
...
def temp-table tt_integr_acr_cheq_1 no-undo
    ...
    field tta_cod_motiv_devol_cheq         as character format "x(5)" label "Motivo Devoluÿ?o" column-label "Motivo Devoluÿ?o"
...
def temp-table tt_integr_acr_liquidac_impto_2 no-undo
    ...
    field tta_cod_pais                     as character format "x(3)" label "Pa›s" column-label "Pa›s"
    field tta_cod_unid_federac             as character format "x(3)" label "Unidade Federaÿ?o" column-label "UF"
    ...
    field tta_dat_cotac_indic_econ         as date format "99/99/9999" initial ? label "Data Cotaÿ?o" column-label "Data Cotaÿ?o"
    field tta_val_cotac_indic_econ         as decimal format ">>>>,>>9.9999999999" decimals 10 initial 0 label "Cotaÿ?o" column-label "Cotaÿ?o"
...
def temp-table tt_integr_acr_liquidac_lote no-undo
    ...
    field tta_dat_transacao                as date format "99/99/9999" initial today label "Data Transaÿ?o" column-label "Dat Transac"
    field tta_dat_gerac_lote_liquidac      as date format "99/99/9999" initial ? label "Data Geraÿ?o" column-label "Data Geraÿ?o"
    ...
    field tta_ind_sit_lote_liquidac_acr    as character format "X(15)" initial "Em Digitaÿ?o" label "Situaÿ?o" column-label "Situaÿ?o"
...
def temp-table tt_integr_acr_liq_desp_rec no-undo
    ...
    field tta_ind_tip_aprop_recta_despes   as character format "x(20)" label "Tipo Apropriaÿ?o" column-label "Tipo Apropriaÿ?o"
...
def temp-table tt_integr_acr_liq_item_lote_3 no-undo
    ...
    field tta_dat_liquidac_tit_acr         as date format "99/99/9999" initial ? label "Liquidaÿ?o" column-label "Liquidaÿ?o"
    field tta_cod_autoriz_bco              as character format "x(8)" label "Autorizaÿ?o Bco" column-label "Autorizacao Bco"
    field tta_val_tit_acr                  as decimal format ">>>,>>>,>>9.99" decimals 2 initial 0 label "Valor" column-label "Valor"
    field tta_val_liquidac_tit_acr         as decimal format ">>>,>>>,>>9.99" decimals 2 initial 0 label "Vl Liquidaÿ?o" column-label "Vl Liquidaÿ?o"
    ...
    field tta_ind_sit_item_lote_liquidac   as character format "X(09)" initial "Gerado" label "Situaÿ?o Item Lote" column-label "Situaÿ?o Item Lote"
    ...
    field tta_log_retenc_impto_liq         as logical format "Sim/N?o" initial no label "Ret°m na Liquidaÿ?o" column-label "Ret na Liq"
...
def temp-table tt_log_erros_import_liquidac no-undo
    ...
    field ttv_num_erro_log                 as integer format ">>>>,>>9" label "Nßmero Erro" column-label "Nœmero Erro"
...
/* Definiÿ?o das temp-tables utilizdas pela API de liquidaÿ?o de t›tulos - acr901zf */
...
def temp-table tt_integr_acr_item_lote_impl_8 no-undo
    ...
    field tta_cod_cart_bcia                as character format "x(3)" label "Carteira" column-label "Carteira"
    field tta_cod_modalid_ext              as character format "x(8)" label "Modalidade Externa" column-label "Modalidade Externa"
    field tta_cod_cond_cobr                as character format "x(8)" label "Condiÿ?o Cobranÿa" column-label "Cond Cobranÿa"
    ...
    field tta_dat_prev_liquidac            as date format "99/99/9999" initial ? label "Prev Liquidaÿ?o" column-label "Prev Liquidaÿ?o"
    ...
    field tta_cod_cond_pagto               as character format "x(8)" label "Condiÿ?o Pagamento" column-label "Condiÿ?o Pagamento"
    field ttv_cdn_agenc_fp                 as Integer format ">>>9" label "Ag¹ncia"
    field tta_ind_sit_tit_acr              as character format "X(13)" initial "Normal" label "Situaÿ?o T›tulo" column-label "Situaÿ?o T›tulo"
    ...
    field tta_cod_autoriz_cartao_cr        as character format "x(6)" label "C«d Pr°-Autorizaÿ?o" column-label "C«d Pr°-Autorizaÿ?o"
    ...
    field tta_cod_refer                    as character format "x(10)" label "Refer¹ncia" column-label "Refer¹ncia"
    field tta_ind_ender_cobr               as character format "X(15)" initial "Cliente" label "Endereÿo Cobranÿa" column-label "Endereÿo Cobranÿa"
    ...
    field tta_log_destinac_cobr            as logical format "Sim/N?o" initial no label "Destin Cobranÿa" column-label "Destin Cobranÿa"
    ...
    field tta_cod_agenc_cobr_bcia          as character format "x(10)" label "Ag¹ncia Cobranÿa" column-label "Ag¹ncia Cobr"
    ...
    field tta_val_abat_tit_acr             as decimal format ">>>>,>>>,>>9.99" decimals 2 initial 0 label "Vl Abatimento" column-label "Vl Abatimento"
    field tta_des_obs_cobr                 as character format "x(40)" label "Obs Cobranÿa" column-label "Obs Cobranÿa"
    field tta_val_cotac_indic_econ         as decimal format ">>>>,>>9.9999999999" decimals 10 initial 0 label "Cotaÿ?o" column-label "Cotaÿ?o"
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_ind_tip_calc_juros           as character format "x(10)" initial "Simples" label "Tipo C?lculo Juros" column-label "Tipo C?lculo Juros"
    ...
    field ttv_cod_autoriz_bco_emissor      as character format "x(6)" label "Codigo Autorizaÿ?o" column-label "Codigo Autorizaÿ?o"
    ...
    field ttv_cod_cond_pagto_vendor        as character format "x(3)" initial "0" label "Condiÿ?o Pagto" column-label "Condiÿ?o Pagto"
    ...
    field tta_cod_proces_export            as character format "x(12)" label "Processo Exportaÿ?o" column-label "Processo Exportaÿ?o"
...
def {&shardef} temp-table tt_log_erros_atualiz no-undo
    field tta_cod_estab                    as character format "x(3)" label "Estabelecimento" column-label "Estab"
    field tta_cod_refer                    as character format "x(10)" label "Refer¹ncia" column-label "Refer¹ncia"
    field tta_num_seq_refer                as integer format ">>>9" initial 0 label "Sequ¹ncia" column-label "Seq"
...
def {&shardef} temp-table tt_integr_acr_lote_impl no-undo 
    field tta_cod_empresa                  as character format "x(3)" label "Empresa" column-label "Empresa" 
    ...
    field tta_ind_tip_cobr_acr             as character format "X(10)" initial "Normal" label "Tipo Cobranÿa" column-label "Tipo Cobranÿa" 
...
def {&shardef} temp-table tt_integr_acr_aprop_ctbl_pend no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_cod_plano_cta_ctbl           as character format "x(8)" label "Plano Contas" column-label "Plano Contas"
    field tta_cod_cta_ctbl                 as character format "x(20)" label "Conta Cont?bil" column-label "Conta Cont?bil"
    field tta_cod_cta_ctbl_ext             as character format "x(20)" label "Conta Contab Extern" column-label "Conta Contab Extern"
...
def {&shardef} temp-table tt_integr_acr_aprop_desp_rec no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_cod_cta_ctbl_ext             as character format "x(20)" label "Conta Contab Extern" column-label "Conta Contab Extern"
    field tta_cod_sub_cta_ctbl_ext         as character format "x(15)" label "Sub Conta Externa" column-label "Sub Conta Externa"
    field tta_cod_unid_negoc_ext           as character format "x(8)" label "Unid Neg«cio Externa" column-label "Unid Neg«cio Externa"
...
def {&shardef} temp-table tt_integr_acr_aprop_relacto no-undo
...
def {&shardef} temp-table tt_integr_acr_impto_impl_pend_1 no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_cod_pais                     as character format "x(3)" label "Pa›s" column-label "Pa›s"
    field tta_cod_pais_ext                 as character format "x(20)" label "Pa›s Externo" column-label "Pa›s Externo"
    field tta_cod_unid_federac             as character format "x(3)" label "Unidade Federaÿ?o" column-label "UF"
...
def {&shardef} temp-table tt_integr_acr_item_lote_impl no-undo
    field ttv_rec_lote_impl_tit_acr        as recid format ">>>>>>9" initial ?
    field tta_num_seq_refer                as integer format ">>>9" initial 0 label "Sequ¹ncia" column-label "Seq"
    field tta_cdn_cliente                  as Integer format ">>>,>>>,>>9" initial 0 label "Cliente" column-label "Cliente"
    field tta_cod_espec_docto              as character format "x(3)" label "Esp°cie Documento" column-label "Esp°cie"
...
def {&shardef} temp-table tt_integr_acr_ped_vda_pend no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
...
def {&shardef} temp-table tt_integr_acr_relacto_pend_cheq no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_cod_banco                    as character format "x(8)" label "Banco" column-label "Banco"
    field tta_cod_agenc_bcia               as character format "x(10)" label "Ag¹ncia Banc?ria" column-label "Ag¹ncia Banc?ria"
    field tta_cod_cta_corren               as character format "x(10)" label "Conta Corrente" column-label "Cta Corrente"
...
def {&shardef} temp-table tt_integr_acr_relacto_pend no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    ...
    field tta_ind_motiv_acerto_val         as character format "X(12)" initial "Alteraÿ?o" label "Motivo Acerto Valor" column-label "Motivo Acerto Valor"
    .

def {&shardef} temp-table tt_integr_acr_repres_pend no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_cdn_repres                   as Integer format ">>>,>>9" initial 0 label "Representante" column-label "Representante"
...
def new global shared var v_hdl_api_integr_acr
 ...
 /**********/
 def {&shardef} temp-table tt_integr_acr_aprop_liq_antec no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field ttv_rec_abat_antecip_acr         as recid format ">>>>>>9"
    field tta_cod_fluxo_financ_ext         as character format "x(20)" label "Tipo Fluxo Externo" column-label "Tipo Fluxo Externo"
...
def {&shardef} temp-table tt_integr_acr_cheq no-undo
    field tta_cod_banco                    as character format "x(8)" label "Banco" column-label "Banco"
    field tta_cod_agenc_bcia               as character format "x(10)" label "Ag?ncia Banc?ria" column-label "Ag?ncia Banc?ria"
    field tta_cod_cta_corren               as character format "x(10)" label "Conta Corrente" column-label "Cta Corrente"
    field tta_num_cheque                   as integer format ">>>>,>>>,>>9" initial ? label "Num Cheque" column-label "Num Cheque"
...
def {&shardef} temp-table tt_integr_acr_impto_impl_pend no-undo
    field ttv_rec_item_lote_impl_tit_acr   as recid format ">>>>>>9"
    field tta_cod_pais                     as character format "x(3)" label "Pa?s" column-label "Pa?s"
    field tta_cod_pais_ext                 as character format "x(20)" label "Pa?s Externo" column-label "Pa?s Externo"
