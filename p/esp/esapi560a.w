...
*******************************************************************************/
{include/i-prgvrs.i esapi560a TOTVS}
...
DEF OUTPUT PARAM c-refer-lote AS c NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS rt-button c-nro-lote bt-ok bt-cancela 
&Scoped-Define DISPLAYED-OBJECTS c-nro-lote 
...
DEFINE VARIABLE c-nro-lote AS CHARACTER FORMAT "x(10)":U 
     LABEL "Lote" 
     VIEW-AS FILL-IN 
     SIZE 21.14 BY 1.25 NO-UNDO.
...
DEFINE FRAME d-vapara
     c-nro-lote AT ROW 1.96 COL 23.57 COLON-ALIGNED WIDGET-ID 2
...
DO:
   IF c-nro-lote:SCREEN-VALUE IN FRAME {&FRAME-NAME}  = ""
   THEN DO:
      RUN utp/ut-msgs.p ("show",17006,"Lote n∆o foi preenchido").
      RETURN NO-APPLY.
   END.
   ASSIGN
      c-refer-lote = c-nro-lote:SCREEN-VALUE IN FRAME {&FRAME-NAME}.
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c-nro-lote 
      WITH FRAME d-vapara.
  ENABLE rt-button c-nro-lote bt-ok bt-cancela 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
