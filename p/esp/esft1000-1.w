...
*******************************************************************************/
{include/i-prgvrs.i ESFT1000 2.00.02.GCJ}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESFT1000
&GLOBAL-DEFINE Version        2.00.02.GCJ
&GLOBAL-DEFINE VersionLayout  

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   Parametros,ImpressÆo
...
&GLOBAL-DEFINE page4Widgets   rs-execucao
...
define temp-table tt-digita no-undo
    field cod-cfop LIKE tt-cfop.cod-cfop
    .
...
/**********************************************************************************/
DEF BUFFER bf-es-log-nexxera FOR es-log-nexxera.
...
DEFINE VARIABLE nom_dir_arqs_aprocessar AS CHARACTER FORMAT "X(256)":U 
     LABEL "Dir. A Processar" 
     VIEW-AS FILL-IN 
     SIZE 68 BY .88 NO-UNDO.

DEFINE VARIABLE nom_dir_arqs_processados AS CHARACTER FORMAT "X(256)":U 
     LABEL "Dir. Processados" 
     VIEW-AS FILL-IN 
     SIZE 68 BY .88 NO-UNDO.

DEFINE VARIABLE rs-execucao AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Concilia‡Æo", 1,
"Liquida‡Æo", 2
     SIZE 38.14 BY 3 NO-UNDO.
...
DEFINE FRAME fpage0
     ...
     btHelp2 AT ROW 18.96 COL 89.57
     rtToolBar AT ROW 18.71 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 102.29 BY 19.46
         FONT 1 WIDGET-ID 100.

DEFINE FRAME fPage4
     nom_dir_arqs_aprocessar AT ROW 5.75 COL 16 COLON-ALIGNED WIDGET-ID 26
     nom_dir_arqs_processados AT ROW 6.75 COL 16 COLON-ALIGNED WIDGET-ID 36
     rs-execucao AT ROW 10.5 COL 7.86 NO-LABEL WIDGET-ID 42
     RECT-12 AT ROW 4.25 COL 4 WIDGET-ID 38
     RECT-13 AT ROW 10.25 COL 4.14 WIDGET-ID 40
...
IF AVAIL es-diretorio-nexxera THEN DO:

    DISP es-diretorio-nexxera.diretorio-processar @ nom_dir_arqs_aprocessar  
         es-diretorio-nexxera.diretorio-processado @ nom_dir_arqs_processados 
        WITH FRAME fPage4.
...
DEFINE VARIABLE i_num_log_di AS INTEGER     NO-UNDO.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*
    IF ( INPUT FRAME fPage2 dtEmisFim - INPUT FRAME fpage2 dtEmisIni ) > 31  THEN DO:

        RUN utp/ut-msgs.p (INPUT "SHOW",
                           INPUT 25997,
                           INPUT "Periodo informado maior do que 30 dias!!").
    ...
    */ 
    ...
    /*:T Coloque aqui a l¢gica de grava‡Æo dos demais campos que devem ser passados
     ...
     ASSIGN tt-param.c-diretorio-processar  = INPUT FRAME fPage4 nom_dir_arqs_aprocessar
            tt-param.c-diretorio-processado = INPUT FRAME fPage4 nom_dir_arqs_processados

            tt-param.rs-execucao = INPUT FRAME fPage4 rs-execucao         
            .
    ...
    FOR EACH tt-cfop
       WHERE tt-cfop.selecionado:

        CREATE tt-digita.
        ASSIGN tt-digita.cod-cfop = tt-cfop.cod-cfop.
    END.
    */
    ...
    {report/rprun.i esp/esft1000rp.p}
    ...
    ASSIGN i_num_log_di = 1.
    FOR LAST bf-es-log-nexxera NO-LOCK
        USE-INDEX idx-1:
        ASSIGN i_num_log_di = bf-es-log-nexxera.num-log + 1.
    END.

    CREATE es-log-nexxera.
    ASSIGN es-log-nexxera.num-log = i_num_log_di
           es-log-nexxera.tipo-log   = 1
           es-log-nexxera.data-log   = NOW
           es-log-nexxera.usuario    = c-seg-usuario.

    COPY-LOB FILE tt-param.arquivo TO es-log-nexxera.log-rp.
