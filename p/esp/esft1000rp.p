...
DEFINE TEMP-TABLE tt-import NO-UNDO
      ...
      FIELD nsu-admin   AS CHAR FORMAT "x(12)" //KML era 10
...
/*
            ...
            */
            ...
            FIND FIRST cst_fat_duplic NO-LOCK
                 WHERE cst_fat_duplic.nsu_numero  = string(DEC(tt-import.nsu-admin), "999999999999") //eram 9
                 AND   cst_fat_duplic.autorizacao = tt-import.autorizacao
                 AND   cst_fat_duplic.parcela     = string(tt-import.parcela, "99") NO-ERROR.
                 
                 .MESSAGE cst_fat_duplic.nsu_numero SKIP
                         tt-import.nsu-admin 
