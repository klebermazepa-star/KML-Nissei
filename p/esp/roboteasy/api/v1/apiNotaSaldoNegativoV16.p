...
DEF TEMP-TABLE tt-retorno NO-UNDO SERIALIZE-NAME "retorno" 
    ...
    FIELD status-versao                 AS INT                      SERIALIZE-NAME "statusVersao" INITIAL 16
.
...
PROCEDURE pi-gerar-nota:
    ...
    DO TRANS ON ERROR UNDO, RETRY:
        ...
        IF  l-erro THEN DO:
            ...
            // se a pi-buscar-notas n∆o encontrar a nota ent∆o confirma a execuá∆o com erro
            ASSIGN tt-retorno.status-cod = "NOK"
    ...
    and avail emitente then do:
        ...
        for each nota-fiscal USE-INDEX ch-distancia no-lock // ler notas da data corrente
            ...
            ASSIGN tt-notas.cod-estab    = nota-fiscal.cod-estabel
                   ...
                   tt-notas.nat-operacao = nota-fiscal.nr-nota-fis
