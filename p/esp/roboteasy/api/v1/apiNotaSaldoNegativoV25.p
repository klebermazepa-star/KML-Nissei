...
DEF TEMP-TABLE tt-retorno NO-UNDO SERIALIZE-NAME "retorno" 
    ...
    FIELD status-versao                 AS INT                      SERIALIZE-NAME "statusVersao" INITIAL 25
.
...
PROCEDURE pi-input-json-retorno :
    ...
    OR  TEMP-TABLE tt-notas:HAS-RECORDS THEN 
        ASSIGN iRet                  = 200    
               tt-retorno.status-cod = "OK".
    ELSE 
        ASSIGN iRet                  = 500    
               tt-retorno.status-cod = "NOK".
