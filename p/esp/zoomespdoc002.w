...
*******************************************************************************/
{include/i-prgvrs.i zoomespdoc002 1.00.00.001KML}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i zoomespdoc002 mut}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           zoomespdoc002
...
&GLOBAL-DEFINE FieldsRangePage1  custom.esp-tipo-doc-emitente.cod-emitente
...
&GLOBAL-DEFINE ttTable1          tt-esp-tipo-doc-emitente
&GLOBAL-DEFINE hDBOTable1        hesp-tipo-doc-emitente
&GLOBAL-DEFINE DBOTable1         dboesp-tipo-doc-emitente
...
&Scoped-define INTERNAL-TABLES tt-esp-tipo-doc-emitente

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ~
tt-esp-tipo-doc-emitente.cod-emitente tt-esp-tipo-doc-emitente.Nome 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt-esp-tipo-doc-emitente NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt-esp-tipo-doc-emitente NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brTable1 tt-esp-tipo-doc-emitente
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt-esp-tipo-doc-emitente
...
DEFINE QUERY brTable1 FOR 
      tt-esp-tipo-doc-emitente SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt-esp-tipo-doc-emitente.cod-emitente COLUMN-LABEL "Emitente" FORMAT "x(25)":U
      tt-esp-tipo-doc-emitente.Nome FORMAT "x(50)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt-esp-tipo-doc-emitente"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _FldNameList[1]   > Temp-Tables.tt-esp-tipo-doc-emitente.cod-emitente
"tt-esp-tipo-doc-emitente.cod-emitente" "Emitente" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   = Temp-Tables.tt-esp-tipo-doc-emitente.Nome
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/espdoc002.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esp/boespdoc002.p":U THEN DO:
       
        {btb/btb008za.i1 esp/boespdoc002.p YES}
        {btb/btb008za.i2 esp/boespdoc002.p '' {&hDBOTable1}} 
    END.
