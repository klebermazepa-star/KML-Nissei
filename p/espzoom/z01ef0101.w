...
DEFINE TEMP-TABLE tt_esp-consu-fornec NO-UNDO LIKE esp-consu-fornec
...
*******************************************************************************/
{include/i-prgvrs.i z01ef0101 1.00.00.001KML}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i z01ef0101 mut}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           z01ef0101
...
&GLOBAL-DEFINE FieldsRangePage1  custom.esp-consu-fornec.cod-estado
...
&GLOBAL-DEFINE ttTable1          tt_esp-consu-fornec
&GLOBAL-DEFINE hDBOTable1        hboconsu-fornec
&GLOBAL-DEFINE DBOTable1         esp-consu-fornec
...
&Scoped-define INTERNAL-TABLES tt_esp-consu-fornec

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 tt_esp-consu-fornec.cod-estado ~
tt_esp-consu-fornec.cod-fornec 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt_esp-consu-fornec NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt_esp-consu-fornec NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt_esp-consu-fornec
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt_esp-consu-fornec
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt_esp-consu-fornec.cod-estado FORMAT "x(5)":U
      tt_esp-consu-fornec.cod-fornec FORMAT ">>>>>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt_esp-consu-fornec T "?" NO-UNDO custom esp-consu-fornec
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
   END-TABLES.
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt_esp-consu-fornec"
     _Options          = "NO-LOCK"
     _FldNameList[1]   = Temp-Tables.tt_esp-consu-fornec.cod-estado
     _FldNameList[2]   = Temp-Tables.tt_esp-consu-fornec.cod-fornec
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/esef0101.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esp/boesef0101.p":U THEN DO:
       
        {btb/btb008za.i1 esp/boesef0101.p YES}
        {btb/btb008za.i2 esp/boesef0101.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    {zoom/openqueries.i &Query="Bycod-estado"
                        &PageNumber="1"}
...
------------------------------------------------------------------------------*/
    ...
    IF AVAILABLE {&ttTable1} THEN DO:
        CASE pcField:
            WHEN "cod-fornec":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-fornec).
            WHEN "cod-estado":U THEN
                ASSIGN pcFieldValue = STRING({&ttTable1}.cod-estado).
        END CASE.
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintBycod-estado IN {&hDBOTable1} (   INPUT CodigoInicial,
                                                               INPUT CodigoFinal).
