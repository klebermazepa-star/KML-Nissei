...
*******************************************************************************/
{include/i-prgvrs.i zesmla0204 1.00.00.001KML}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i zesmla0204 mut}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program           zesmla0204
...
&GLOBAL-DEFINE FieldsRangePage1  custom.esp_item_gera_receb_MLA.it-codigo
...
&GLOBAL-DEFINE ttTable1          tt_esp_item_gera_receb_MLA
&GLOBAL-DEFINE hDBOTable1        h_esp_item_gera_receb_MLA
&GLOBAL-DEFINE DBOTable1         dboesp_item_gera_receb_MLA
...
&Scoped-define INTERNAL-TABLES tt_esp_item_gera_receb_MLA

/* Definitions for BROWSE brTable1                                      */
&Scoped-define FIELDS-IN-QUERY-brTable1 ~
tt_esp_item_gera_receb_MLA.it-codigo 
&Scoped-define ENABLED-FIELDS-IN-QUERY-brTable1 
&Scoped-define QUERY-STRING-brTable1 FOR EACH tt_esp_item_gera_receb_MLA NO-LOCK
&Scoped-define OPEN-QUERY-brTable1 OPEN QUERY brTable1 FOR EACH tt_esp_item_gera_receb_MLA NO-LOCK.
&Scoped-define TABLES-IN-QUERY-brTable1 tt_esp_item_gera_receb_MLA
&Scoped-define FIRST-TABLE-IN-QUERY-brTable1 tt_esp_item_gera_receb_MLA
...
DEFINE QUERY brTable1 FOR 
      tt_esp_item_gera_receb_MLA SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brTable1 wZoom _STRUCTURED
  QUERY brTable1 NO-LOCK DISPLAY
      tt_esp_item_gera_receb_MLA.it-codigo COLUMN-LABEL "Item" FORMAT "x(16)":U
            WIDTH 17.43
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE brTable1
     _TblList          = "Temp-Tables.tt_esp_item_gera_receb_MLA"
     _Options          = "NO-LOCK"
     _FldNameList[1]   > Temp-Tables.tt_esp_item_gera_receb_MLA.it-codigo
"it-codigo" "Item" ? "character" ? ? ? ? ? ? no ? no no "17.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE brTable1 */
&ANALYZE-RESUME
...
DO:
    {zoom/implant.i &ProgramImplant="esp/esmla0204.w"
                    &PageNumber="1"}
END.
...
------------------------------------------------------------------------------*/
    ...
    IF NOT VALID-HANDLE({&hDBOTable1}) OR
       ...
       {&hDBOTable1}:FILE-NAME <> "esbo/boesmla0204.p":U THEN DO:
       
        {btb/btb008za.i1 esbo/boesmla0204.p YES}
        {btb/btb008za.i2 esbo/boesmla0204.p '' {&hDBOTable1}} 
    END.
...
------------------------------------------------------------------------------*/
    ...
    CASE pPageNumber:
        WHEN 1 THEN
            ...
            RUN setConstraintByItem IN {&hDBOTable1} (         INPUT CodigoInicial,
                                                               INPUT CodigoFinal).
