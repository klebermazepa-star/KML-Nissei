    ...
    for each tt-lin-i-cr where tt-lin-i-cr.referencia = tt-doc-i-cr.referencia:
        ...
        FIND FIRST tt_integr_acr_item_lote_impl_8 NO-LOCK
            WHERE  tt_integr_acr_item_lote_impl_8.ttv_rec_lote_impl_tit_acr = recid(tt_integr_acr_lote_impl)
              AND  tt_integr_acr_item_lote_impl_8.tta_num_seq_refer         = tt-lin-i-cr.sequencia NO-ERROR.

        IF NOT AVAIL tt_integr_acr_item_lote_impl_8 THEN DO:
       ...
       /* ----------------------------------------------------------------------------------------
        ...
        for each tt-rep-i-cr no-lock 
            ...
            FIND FIRST tt_integr_acr_repres_pend NO-LOCK
                WHERE tt_integr_acr_repres_pend.ttv_rec_item_lote_impl_tit_acr  = tt_integr_acr_item_lote_impl_8.ttv_rec_item_lote_impl_tit_acr 
                  AND tt_integr_acr_repres_pend.tta_cdn_repres                  = tt-rep-i-cr.cod-rep     NO-ERROR.                                      

            IF NOT AVAIL tt_integr_acr_repres_pend THEN DO:
...
PROCEDURE pi-cria-aprop-contab:
    ...
    for each tt-conta-pend-parcela 
        ...
        IF  tt-conta-pend-parcela.valor > 0 THEN DO:
            ...
            FIND FIRST tt_integr_acr_aprop_ctbl_pend
                WHERE tt_integr_acr_aprop_ctbl_pend.ttv_rec_item_lote_impl_tit_acr = tt_integr_acr_item_lote_impl_8.ttv_rec_item_lote_impl_tit_acr
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_plano_cta_ctbl         = "" 
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_cta_ctbl               = "" 
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_cta_ctbl_ext           = tt-conta-pend-parcela.ct-codigo
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_sub_cta_ctbl_ext       = tt-conta-pend-parcela.sc-codigo 
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_unid_negoc             = tt-conta-pend-parcela.cod-unid-negoc 
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_plano_ccusto           = "" 
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto                 = "" 
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto_ext             = "" 
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ       = "" 
                  and tt_integr_acr_aprop_ctbl_pend.tta_cod_fluxo_financ_ext       = STRING(tt-lin-i-cr.tp-codigo) 
                  and tt_integr_acr_aprop_ctbl_pend.tta_log_impto_val_agreg        = NO NO-ERROR.

            IF NOT AVAIL tt_integr_acr_aprop_ctbl_pend THEN DO:
