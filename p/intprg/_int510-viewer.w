           ...
           natur-oper.nat-vinculada <> "" THEN DO:
            ...
            FIND LAST int_ds_docto_wms /* use-index sequencial */ 
                WHERE int_ds_docto_wms.doc_numero_n = string(int(int_ds_docto_xml.nNF)) 
                  ...
                  AND int_ds_docto_wms.situacao     = 40 NO-ERROR.
            ...
            IF NOT AVAIL int_ds_docto_wms THEN DO:  
                ...
                ASSIGN int_ds_docto_wms.doc_numero_n        = int_ds_docto_xml.nNF 
                       ...
                       int_ds_docto_wms.tipo_nota           = 1
                       int_ds_docto_wms.datamovimentacao_d = TODAY
                       int_ds_docto_wms.situacao            = 2
                       int_ds_docto_wms.id_sequencial       = NEXT-VALUE(SEQ-INT-DS-DOCTO-WMS).
            END.
            ELSE DO:
                ASSIGN int_ds_docto_wms.situacao            = 2.
