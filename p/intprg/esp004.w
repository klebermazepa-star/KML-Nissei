...
*******************************************************************************/
{include/i-prgvrs.i ESP004 2.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ESP004 INTPRG}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        ESP004
...
&GLOBAL-DEFINE page2Fields    c-item-ini c-item-fim c-ncm-ini c-ncm-fim
...
DEFINE VARIABLE c-ncm-fim AS CHARACTER FORMAT "X(20)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE c-ncm-ini AS CHARACTER FORMAT "X(20)":U 
     LABEL "NCM" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     c-item-ini AT ROW 1.5 COL 17.28
     c-item-fim AT ROW 1.5 COL 54.14 NO-LABEL
     c-ncm-ini AT ROW 2.5 COL 16.71 WIDGET-ID 4
     c-ncm-fim AT ROW 2.5 COL 54.14 NO-LABEL WIDGET-ID 2
     IMAGE-1 AT ROW 1.5 COL 35.86
     IMAGE-2 AT ROW 1.5 COL 51.14
     IMAGE-3 AT ROW 2.5 COL 35.86 WIDGET-ID 6
     IMAGE-4 AT ROW 2.5 COL 51.14 WIDGET-ID 8
...
/* SETTINGS FOR FILL-IN c-item-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN c-ncm-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN c-ncm-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.ncm-ini  = input frame fPage2 c-ncm-ini 
           tt-param.ncm-fim  = input frame fPage2 c-ncm-fim 
    ...
    {report/rprun.i intprg/esp004rp.p}
