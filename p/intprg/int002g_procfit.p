...
FOR EACH tt-docto-xml WHERE
    ...
    */
    ...
    for each tt-it-docto-xml where 
        ...
        END.
        if c-it-codigo = "" or c-it-codigo = "0" then
            for first int-ds-ean-item no-lock where 
                int-ds-ean-item.codigo-ean = tt-it-docto-xml.dEan:
                assign c-it-codigo = int-ds-ean-item.it-codigo.
            end.
        ...
        then do:
            ...
            assign int-ds-nota-entrada-produto.nep-percentualicms-n   = tt-it-docto-xml.picms
                   ...
                   int-ds-nota-entrada-produto.nep-cstb-icm-n         = tt-it-docto-xml.cst-icm
                   int-ds-nota-entrada-produto.nep-cstb-ipi-n         = tt-it-docto-xml.cst-ipi.
        end. 
        ...
        /* PROCFIT - Novos Campos - Baccin */
        assign int-ds-nota-entrada-produto.nep-modbcicms-n        = tt-it-docto-xml.modbc
               int-ds-nota-entrada-produto.nep-modbcst-n          = tt-it-docto-xml.modbcst
               int-ds-nota-entrada-produto.nep-pmvast-n           = tt-it-docto-xml.pmvast
               int-ds-nota-entrada-produto.nep-cenq-n             = tt-it-docto-xml.cenq
               int-ds-nota-entrada-produto.nep-cstpis-n           = tt-it-docto-xml.cst-pis
               int-ds-nota-entrada-produto.nep-cstcofins-n        = tt-it-docto-xml.cst-cofins
               int-ds-nota-entrada-produto.nep-vpmc-n             = tt-it-docto-xml.vPMC
               int-ds-nota-entrada-produto.nep-uComForn-s         = tt-it-docto-xml.uCom-forn
               int-ds-nota-entrada-produto.nep-qComForn-n         = tt-it-docto-xml.qCom-forn
               int-ds-nota-entrada-produto.nep-uCom-s             = tt-it-docto-xml.uCom
               int-ds-nota-entrada-produto.nep-vUnCom-n           = tt-it-docto-xml.vUnCom
               int-ds-nota-entrada-produto.nep-picmsst            = tt-it-docto-xml.picmsst.
    ...
    then do:
       ...
       DISPLAY int-ds-nota-entrada.nen-cnpj-origem-s 
               ...
               int-ds-nota-entrada.tipo-movto        
    ...
    assign int-ds-nota-entrada.situacao                 =  if not l-vendavel and not l-sem-item then 2 else 1 /* 1 - Pendente 2 - Integrado */    /* REVER AVB !!!!! lojas Procfit colocar 2 p/ OBLAK n∆o pegar */
           ...
           int-ds-nota-entrada.ped-procfit              =  i-num-pedido                 /* Num pedido dos itens p/ procfit */
    ...
    ASSIGN int-ds-nota-entrada.ped-codigo-n = 0.
    /* PEPSICO preenche pedido - PROCFIT X OLBAK */
    FOR EACH estabelec NO-LOCK WHERE 
        estabelec.cgc = int-ds-nota-entrada.nen-cnpj-origem-s AND
        estabelec.cod-estabel = "973":
        FOR EACH emitente NO-LOCK WHERE 
            emitente.cgc = int-ds-nota-entrada.nen-cnpj-origem-s:
            FIND int-ds-ext-emitente NO-LOCK WHERE
            ...
            IF (AVAIL int-ds-ext-emitente AND  
                      ...
                      tt-docto-xml.tipo-docto = 0
            THEN DO:

                ASSIGN int-ds-nota-entrada.ped-codigo-n = i-num-pedido.                                
    ...
    */
    ...
    assign /*int-ds-nota-entrada.ID_SEQUENCIAL = ?*/
           int-ds-nota-entrada.ENVIO_STATUS  = 1
