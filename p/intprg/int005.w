...
*******************************************************************************/
{include/i-prgvrs.i int005 2.06.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        int005
...
&GLOBAL-DEFINE page2Fields    c-cod-estab-ini c-cod-estab-fin 
...
DEFINE FRAME fPage2
     c-cod-estab-ini AT ROW 2.71 COL 23.57 WIDGET-ID 78
     c-cod-estab-fin AT ROW 2.63 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 76
...
do on error undo, return error on stop  undo, return error:
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.c-cod-estab-ini = INPUT FRAME fpage2 c-cod-estab-ini
           tt-param.c-cod-estab-fin = INPUT FRAME fpage2 c-cod-estab-fin.
    ...
    {report/rprun.i intprg/int005rp.p}
