...
*******************************************************************************/
{include/i-prgvrs.i int007 2.06.00.001}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        int007
...
&GLOBAL-DEFINE page2Fields    dt-trans-ini dt-trans-fin i-cod-estab-ini i-cod-estab-fin
...
DEFINE VARIABLE i-cod-estab-fin AS INTEGER FORMAT ">>9":U INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE i-cod-estab-ini AS INTEGER FORMAT ">>9":U INITIAL 0 
     LABEL "Estabel" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.
...
DEFINE FRAME fPage2
     dt-trans-ini AT ROW 1.5 COL 23.14 COLON-ALIGNED WIDGET-ID 26
     dt-trans-fin AT ROW 1.5 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     i-cod-estab-ini AT ROW 2.63 COL 19.14 WIDGET-ID 70
     i-cod-estab-fin AT ROW 2.63 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 68
     IMAGE-1 AT ROW 1.5 COL 37
     IMAGE-2 AT ROW 1.5 COL 43
     IMAGE-11 AT ROW 2.67 COL 37 WIDGET-ID 74
     IMAGE-12 AT ROW 2.67 COL 43 WIDGET-ID 72
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN i-cod-estab-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    /* FIND LAST int-ds-param-xml NO-LOCK where
              int-ds-param-xml.ep-codigo = i-ep-codigo-usuario NO-ERROR.
    
    IF AVAIL int-ds-param-xml THEN
       FILE-INFO:FILE-NAME = int-ds-param-xml.dir-xml.
    ELSE 
       FILE-INFO:FILE-NAME = "".
    ...
    THEN DO:
       ...
       RUN utp/ut-msgs.p (input "show":U, 
                          input 17006, 
                          input "Diret¢rio para importaá∆o Inv†lido." + "~~" + 
                                "Diret¢rio informado n∆o Ç v†lido ou vocà n∆o possui permiss∆o p/ acessar o diret¢rio.").

       RETURN NO-APPLY.
    END.

    FILE-INFO:FILE-NAME = int-ds-param-xml.dir-xml-proc.
    ...
    THEN DO:
       ...
       RUN utp/ut-msgs.p (input "show":U, 
                          input 17006, 
                          input "Diret¢rio para arquivos XML processados Inv†lido." + "~~" + 
                                "Diret¢rio informado n∆o Ç v†lido ou vocà n∆o possui permiss∆o p/ acessar o diret¢rio.").
    ...
    */
    ...
    /* ASSIGN tt-param-gm.dir-xml = int-ds-param-xml.dir-xml. 

    RUN gmp\gmre1000b.p (INPUT TABLE tt-param-gm).
    ...
    */
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.dt-trans-fin    = input frame fpage2 dt-trans-fin    
           tt-param.i-cod-estab-ini = INPUT FRAME fpage2 i-cod-estab-ini
           tt-param.i-cod-estab-fin = INPUT FRAME fpage2 i-cod-estab-fin.
    ...
    {report/rprun.i intprg/int007rp.p}
