...
log-manager:logfile-name= "\\192.168.200.52\datasul\_custom_teste\Prog_QG\pedido-compra.txt".
log-manager:log-entry-types= "4gltrace".

OUTPUT TO t:\pedidos-de-compra.txt.

for EACH int-ds-ped-compra no-lock WHERE /* 
         int-ds-ped-compra.num-pedido-orig = 56568290 AND  */
