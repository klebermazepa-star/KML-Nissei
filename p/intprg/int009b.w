...
{include/i-prgvrs.i int009b 2.12.00.001}

CREATE WIDGET-POOL.

/* PrenNFrs Definitions ---                                      */
&GLOBAL-DEFINE Program           int009b
&GLOBAL-DEFINE Version           2.12.00.001

&GLOBAL-DEFINE Folder            YES
&GLOBAL-DEFINE InitialPage       1

&GLOBAL-DEFINE FolderLabels      Estabel.

&GLOBAL-DEFINE ttTable           tt-int-ds-cenar-estab
&GLOBAL-DEFINE hDBOTable         h-tt-int-ds-cenar-estab
&GLOBAL-DEFINE DBOTable          dbo-tt-int-ds-cenar-estab
...
&GLOBAL-DEFINE page1Fields       tt-int-ds-cenar-estab.cod-estabel 
...
DEFINE FRAME fPage1
     tt-int-ds-cenar-estab.cod-estabel AT ROW 1.63 COL 13 COLON-ALIGNED WIDGET-ID 36
          VIEW-AS FILL-IN 
          SIZE 7 BY .88
     c-desc-estab AT ROW 1.63 COL 20.29 COLON-ALIGNED NO-LABEL WIDGET-ID 46
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      TABLE: tt-int-ds-cenar-estab T "?" NO-UNDO emsesp int-ds-cenar-estab
      ADDITIONAL-FIELDS:
          fields r-rowid as rowid
      END-FIELDS.
...
&Scoped-define SELF-NAME tt-int-ds-cenar-estab.cod-estabel
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-int-ds-cenar-estab.cod-estabel wMaintenanceNoNavigation
ON F5 OF tt-int-ds-cenar-estab.cod-estabel IN FRAME fPage1 /* Estabel */
DO:

  {include/zoomvar.i &prog-zoom="adzoom/z01ad107.w"
                     &campo=tt-int-ds-cenar-estab.cod-estabel
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-int-ds-cenar-estab.cod-estabel wMaintenanceNoNavigation
ON LEAVE OF tt-int-ds-cenar-estab.cod-estabel IN FRAME fPage1 /* Estabel */
DO:
  
     FIND FIRST estabelec NO-LOCK
        WHERE estabelec.cod-estabel = INPUT FRAME fpage1 tt-int-ds-cenar-estab.cod-estabel NO-ERROR.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-int-ds-cenar-estab.cod-estabel wMaintenanceNoNavigation
ON MOUSE-SELECT-DBLCLICK OF tt-int-ds-cenar-estab.cod-estabel IN FRAME fPage1 /* Estabel */
DO:
  APPLY "f5" TO SELF.
END.
...
tt-int-ds-cenar-estab.cod-estabel:load-mouse-pointer("image/lupa.cur":U) in frame fPage1.
...
------------------------------------------------------------------------------*/
    ...
    APPLY 'leave' TO tt-int-ds-cenar-estab.cod-estabel IN FRAME fpage1.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN tt-int-ds-cenar-estab.cod-cenario  = tt-int-ds-cenario.cod-cenario.       
