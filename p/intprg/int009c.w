...
{include/i-prgvrs.i int009c 2.12.00.001}

CREATE WIDGET-POOL.

/* PrenNFrs Definitions ---                                      */
&GLOBAL-DEFINE Program           int009c
&GLOBAL-DEFINE Version           2.12.00.001

&GLOBAL-DEFINE Folder            YES
&GLOBAL-DEFINE InitialPage       1

&GLOBAL-DEFINE FolderLabels      Fam¡lia.

&GLOBAL-DEFINE ttTable           tt-int-ds-cenar-fam
&GLOBAL-DEFINE hDBOTable         h-tt-int-ds-cenar-fam
&GLOBAL-DEFINE DBOTable          dbo-tt-int-ds-cenar-fam
...
&GLOBAL-DEFINE page1Fields       tt-int-ds-cenar-fam.fm-codigo 
...
DEFINE VARIABLE c-desc-fam AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fpage0
     tt-int-ds-cenario.cod-cenario AT ROW 1.71 COL 14 COLON-ALIGNED WIDGET-ID 36
          VIEW-AS FILL-IN 
          SIZE 18 BY .88
     tt-int-ds-cenario.descricao AT ROW 1.71 COL 32.43 COLON-ALIGNED NO-LABEL WIDGET-ID 34
          VIEW-AS FILL-IN 
          SIZE 50.57 BY .88
...
DEFINE FRAME fPage1
     tt-int-ds-cenar-fam.fm-codigo AT ROW 1.63 COL 13 COLON-ALIGNED WIDGET-ID 36
          VIEW-AS FILL-IN 
          SIZE 12 BY .88
     c-desc-fam AT ROW 1.63 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 46
...
DO:
  ...
  ASSIGN tt-int-ds-cenario.descricao:SCREEN-VALUE IN FRAME fpage0 = tt-int-ds-cenario.descricao.
...
&Scoped-define SELF-NAME tt-int-ds-cenar-fam.fm-codigo
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-int-ds-cenar-fam.fm-codigo wMaintenanceNoNavigation
ON F5 OF tt-int-ds-cenar-fam.fm-codigo IN FRAME fPage1 /* Fam¡lia Item */
DO:

  {include/zoomvar.i &prog-zoom="inzoom/z01in122.w"
                     &campo=tt-int-ds-cenar-fam.fm-codigo
                     &campozoom=fm-codigo
                     &campo2=c-desc-fam
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-int-ds-cenar-fam.fm-codigo wMaintenanceNoNavigation
ON LEAVE OF tt-int-ds-cenar-fam.fm-codigo IN FRAME fPage1 /* Fam¡lia Item */
DO:
  
     FIND FIRST familia NO-LOCK
        WHERE familia.fm-codigo = INPUT FRAME fpage1 tt-int-ds-cenar-fam.fm-codigo NO-ERROR.
   IF AVAIL familia THEN
       ASSIGN c-desc-fam:SCREEN-VALUE IN FRAME fpage1 = familia.descricao.
   ELSE 
       ASSIGN c-desc-fam:SCREEN-VALUE IN FRAME fpage1 = "".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tt-int-ds-cenar-fam.fm-codigo wMaintenanceNoNavigation
ON MOUSE-SELECT-DBLCLICK OF tt-int-ds-cenar-fam.fm-codigo IN FRAME fPage1 /* Fam¡lia Item */
DO:
  APPLY "f5" TO SELF.
END.
...
tt-int-ds-cenar-fam.fm-codigo:load-mouse-pointer("image/lupa.cur":U) in frame fPage1.
...
------------------------------------------------------------------------------*/
    ...
    DISABLE tt-int-ds-cenario.cod-cenario WITH FRAME fpage0.

   
    APPLY 'leave' TO tt-int-ds-cenar-fam.fm-codigo IN FRAME fpage1.
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN tt-int-ds-cenar-fam.cod-cenario  = tt-int-ds-cenario.cod-cenario.       
