...
/********************************************************************************
** Programa: INT010-2 - Importa‡Æo de pedidos do Toturial/Sysfarma
**
** Versao : 12 - 30/01/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT010-2 2.12.01.AVB}
current-language = current-language.
CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT010-2
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/INT010-2rp.p}
