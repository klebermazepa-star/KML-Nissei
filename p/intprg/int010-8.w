...
/********************************************************************************
** Programa: INT010-8 - Importa‡Æo de pedidos do Toturial/Sysfarma
**
** Versao : 12 - 30/01/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT010-8 2.12.01.AVB}
current-language = current-language.
CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT010-8
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/INT010-8rp.p}
