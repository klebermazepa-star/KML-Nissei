...
procedure importa:
    ...
    FOR EACH estabelec NO-LOCK WHERE
        estabelec.cod-estabel = "185" or estabelec.cod-estabel = "165" or estabelec.cod-estabel = "245" or
        estabelec.cod-estabel = "249" or estabelec.cod-estabel = "223" or estabelec.cod-estabel = "222" or
        estabelec.cod-estabel = "187" or estabelec.cod-estabel = "064" or estabelec.cod-estabel = "243" or
        estabelec.cod-estabel = "228" or estabelec.cod-estabel = "206" or estabelec.cod-estabel = "229" or
        estabelec.cod-estabel = "242" or estabelec.cod-estabel = "246" or estabelec.cod-estabel = "262" or
        estabelec.cod-estabel = "260" or estabelec.cod-estabel = "261" or estabelec.cod-estabel = "267" or
        estabelec.cod-estabel = "283"
        :
        for each int-ds-pedido exclusive where 
           ...
           (int-ds-pedido.ped-tipopedido-n = 1 OR
            ...
            int-ds-pedido.ped-cnpj-destino = estabelec.cgc
            ...
            if not can-find(first RowErrors where RowErrors.ErrorSubType = "Error":u) then do:
               ...
               if avail ped-venda then do:
                  ...
                  for each ped-item no-lock of ped-venda:
                      for each tt-ped-item-imp no-lock of ped-item:
                          create cst-ped-item.
                          assign cst-ped-item.nome-abrev    = ped-item.nome-abrev
                                 cst-ped-item.nr-sequencia  = ped-item.nr-sequencia
                                 cst-ped-item.nr-pedcli     = ped-item.nr-pedcli
                                 cst-ped-item.it-codigo     = ped-item.it-codigo
                                 cst-ped-item.cod-refer     = ped-item.cod-refer.
