...
/********************************************************************************
** Programa: int011 - Exportaá∆o de Notas de Sa°da p/ Tutorial/PRS
**
** Versao : 12 - 25/02/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT011 2.12.01.AVB}
...
&GLOBAL-DEFINE FolderLabels   ParÉmetro,Geraá∆o
...
&GLOBAL-DEFINE page2Fields    cod-estabel-fim cod-estabel-ini dt-cancela-fim dt-cancela-ini dt-emis-nota-fim dt-emis-nota-ini   
...
DEFINE VARIABLE dt-cancela-fim AS DATE FORMAT "99/99/9999" 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .79.

DEFINE VARIABLE dt-cancela-ini AS DATE FORMAT "99/99/9999" 
     LABEL "Dt Cancelamento":R18 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .79.

DEFINE VARIABLE dt-emis-nota-fim AS DATE FORMAT "99/99/9999" INITIAL 02/09/16 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .79.

DEFINE VARIABLE dt-emis-nota-ini AS DATE FORMAT "99/99/9999" INITIAL 02/09/16 
...
DEFINE FRAME fPage2
     ...
     dt-cancela-ini AT ROW 3.5 COL 20 COLON-ALIGNED HELP
          "Data de cancelamento da nota" WIDGET-ID 4
     dt-cancela-fim AT ROW 3.5 COL 49 COLON-ALIGNED HELP
          "Data de cancelamento da nota" NO-LABEL WIDGET-ID 20
     IMAGE-1 AT ROW 1.5 COL 31.86
     IMAGE-2 AT ROW 1.5 COL 47.14
     IMAGE-3 AT ROW 2.5 COL 32 WIDGET-ID 10
     IMAGE-4 AT ROW 2.5 COL 47.29 WIDGET-ID 12
     IMAGE-5 AT ROW 3.5 COL 32 WIDGET-ID 16
     IMAGE-6 AT ROW 3.5 COL 47.29 WIDGET-ID 18
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 7 ROW 2.81
         SIZE 76.86 BY 10.15
...
------------------------------------------------------------------------------*/
    ...
    assign dt-emis-nota-ini = today - 7
           dt-emis-nota-fim = today
           dt-cancela-ini = today - 7
           dt-cancela-fim = today.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign     
         ...
         tt-param.dt-cancela-ini   = input frame fPage2 dt-cancela-ini   
         tt-param.dt-cancela-fim   = input frame fPage2 dt-cancela-fim   
    ...
    {report/rprun.i intprg/int011rp-c.p}
