...
procedure pi-saidas:
    ...
    FIND first int_ds_nota_saida where 
        ...
        int_ds_nota_saida.nsa_notafiscal_n = int(nota-fiscal.nr-nota-fis) NO-LOCK NO-ERROR.
...
/*                 nota-fiscal.cod-estabel                         */       // teste funcionamento sem tt-param
/*                 nota-fiscal.serie                               */
/*                 nota-fiscal.nr-nota-fis                         */
/*                 nota-fiscal.dt-emis-nota                        */
/*                 nota-fiscal.dt-cancela                          */
...
/*         END.                                                    */
        ...
        for each it-nota-fisc no-lock of nota-fiscal:
            ...
            FIND FIRST int_ds_nota_saida_item of int_ds_nota_saida where
                int_ds_nota_saida_item.nsp_sequencia_n = it-nota-fisc.nr-seq-fat and
                int_ds_nota_saida_item.nsp_produto_n   = int(it-nota-fisc.it-codigo) NO-LOCK NO-ERROR.
            ...
            if not avail int_ds_nota_saida_item then do:
                ...
                for first natur-oper
                    ...
                    fields (cod-cfop 
                            ...
                            tp-oper-terc 
                            char-2
                            log-ipi-contrib-social 
                            log-ipi-outras-contrib-social)NO-LOCK
...
/*                         b-estabelec.cod-estabel                         */    // teste funcionamento sem tt-param
...
/*                 nota-fiscal.cod-estabel                         */
/*                 nota-fiscal.serie                               */
/*                 nota-fiscal.nr-nota-fis                         */      //teste sem tt-param
/*                 nota-fiscal.dt-emis-nota                        */
/*                 nota-fiscal.dt-cancela                          */
/*                 with frame f-rel.                               */
/*             down with frame f-rel.                              */
...
procedure pi-cancela-saidas:
    ...
    /* cancelar saida */
    for first int_ds_nota_saida NO-LOCK where 
