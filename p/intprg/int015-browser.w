...
*******************************************************************************/
{include/i-prgvrs.i int015-browser 2.12.01.AVB}
...
&Scoped-define INTERNAL-TABLES int-ds-tp-natur-oper

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-cfop                                       */
&Scoped-define FIELDS-IN-QUERY-br-cfop fnTipoPedido(int-ds-tp-natur-oper.tp-pedido) @ c-tp-pedido int-ds-tp-natur-oper.uf-destino int-ds-tp-natur-oper.uf-origem int-ds-tp-natur-oper.cod-estabel int-ds-tp-natur-oper.cod-emitente fnEmitente(int-ds-tp-natur-oper.cod-emitente) @ c-nome-abrev int-ds-tp-natur-oper.cod-cond-pag int-ds-tp-natur-oper.class-fiscal int-ds-tp-natur-oper.nat-operacao fnNatureza(int-ds-tp-natur-oper.nat-operacao) @ c-denominacao int-ds-tp-natur-oper.cod-portador fnModalidade(int-ds-tp-natur-oper.modalidade) @ c-modalidade int-ds-tp-natur-oper.serie   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-cfop   
&Scoped-define SELF-NAME br-cfop
&Scoped-define QUERY-STRING-br-cfop FOR EACH int-ds-tp-natur-oper WHERE     int-ds-tp-natur-oper.tp-pedido = i-tp-pedido and (     int-ds-tp-natur-oper.cod-estabel = ? or (     int-ds-tp-natur-oper.cod-estabel >= c-estab-ini   and     int-ds-tp-natur-oper.cod-estabel <= c-estab-fim)) and (     int-ds-tp-natur-oper.uf-destino = ? or (     int-ds-tp-natur-oper.uf-destino >= c-uf-destino-ini   and     int-ds-tp-natur-oper.uf-destino <= c-uf-destino-fim)) and (     int-ds-tp-natur-oper.uf-origem = ? or (     int-ds-tp-natur-oper.uf-origem >= c-uf-origem-ini    and     int-ds-tp-natur-oper.uf-origem <= c-uf-origem-fim))  NO-LOCK     ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define OPEN-QUERY-br-cfop OPEN QUERY {&SELF-NAME} FOR EACH int-ds-tp-natur-oper WHERE     int-ds-tp-natur-oper.tp-pedido = i-tp-pedido and (     int-ds-tp-natur-oper.cod-estabel = ? or (     int-ds-tp-natur-oper.cod-estabel >= c-estab-ini   and     int-ds-tp-natur-oper.cod-estabel <= c-estab-fim)) and (     int-ds-tp-natur-oper.uf-destino = ? or (     int-ds-tp-natur-oper.uf-destino >= c-uf-destino-ini   and     int-ds-tp-natur-oper.uf-destino <= c-uf-destino-fim)) and (     int-ds-tp-natur-oper.uf-origem = ? or (     int-ds-tp-natur-oper.uf-origem >= c-uf-origem-ini    and     int-ds-tp-natur-oper.uf-origem <= c-uf-origem-fim))  NO-LOCK     ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-cfop int-ds-tp-natur-oper
&Scoped-define FIRST-TABLE-IN-QUERY-br-cfop int-ds-tp-natur-oper
...
DEFINE QUERY br-cfop FOR 
      int-ds-tp-natur-oper SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-cfop B-table-Win _FREEFORM
  QUERY br-cfop NO-LOCK DISPLAY
      fnTipoPedido(int-ds-tp-natur-oper.tp-pedido) @  c-tp-pedido FORMAT "X(45)":U column-label "Tipo Pedido"
      int-ds-tp-natur-oper.uf-destino FORMAT "x(2)":U
      int-ds-tp-natur-oper.uf-origem FORMAT "x(2)":U
      int-ds-tp-natur-oper.cod-estabel FORMAT "x(5)":U
      int-ds-tp-natur-oper.cod-emitente FORMAT ">>>>>>>>9":U WIDTH 8.86
      fnEmitente(int-ds-tp-natur-oper.cod-emitente) @ c-nome-abrev COLUMN-LABEL "Nome" FORMAT "X(12)":U
      int-ds-tp-natur-oper.cod-cond-pag FORMAT ">>9":U WIDTH 9.86
      int-ds-tp-natur-oper.class-fiscal FORMAT "9999.99.99":U WIDTH 13.29
      int-ds-tp-natur-oper.nat-operacao FORMAT "X(8)":U WIDTH 9.72
      fnNatureza(int-ds-tp-natur-oper.nat-operacao) @ c-denominacao COLUMN-LABEL "Denominacao" FORMAT "x(65)":U
          WIDTH 40
      int-ds-tp-natur-oper.cod-portador FORMAT ">>>>9":U
      fnModalidade(int-ds-tp-natur-oper.modalidade) @ c-modalidade FORMAT "X(12)":U column-label "Modalid"
      int-ds-tp-natur-oper.serie FORMAT "x(5)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   Type: SmartBrowser
   External Tables: emsesp.int-ds-tp-natur-oper
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br-cfop
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH int-ds-tp-natur-oper WHERE
    int-ds-tp-natur-oper.tp-pedido = i-tp-pedido and (
    int-ds-tp-natur-oper.cod-estabel = ? or (
    int-ds-tp-natur-oper.cod-estabel >= c-estab-ini   and
    int-ds-tp-natur-oper.cod-estabel <= c-estab-fim)) and (
    int-ds-tp-natur-oper.uf-destino = ? or (
    int-ds-tp-natur-oper.uf-destino >= c-uf-destino-ini   and
    int-ds-tp-natur-oper.uf-destino <= c-uf-destino-fim)) and (
    int-ds-tp-natur-oper.uf-origem = ? or (
    int-ds-tp-natur-oper.uf-origem >= c-uf-origem-ini    and
    int-ds-tp-natur-oper.uf-origem <= c-uf-origem-fim))  NO-LOCK
...
DEFINE INPUT PARAMETER P-CAMPO AS CHARACTER NO-UNDO.
    ...
    if  avail emsesp.int-ds-tp-natur-oper then do:
        case p-campo:
            when "tp-pedido" then
                assign p-valor = string(int-ds-tp-natur-oper.tp-pedido).
            when "uf-origem" then
                assign p-valor = string(int-ds-tp-natur-oper.uf-origem).
            when "uf-destino" then
                assign p-valor = string(int-ds-tp-natur-oper.uf-destino).
            when "cod-estabel" then
                assign p-valor = string(int-ds-tp-natur-oper.cod-estabel).
            when "cod-emitente" then
                assign p-valor = string(int-ds-tp-natur-oper.cod-emitente).
            when "class-fiscal" then
                assign p-valor = string(int-ds-tp-natur-oper.class-fiscal).
            when "nat-operacao" then
                assign p-valor = string(int-ds-tp-natur-oper.nat-operacao).
        end.
    end.
    return p-valor.
END PROCEDURE.
...
case p-tp-pedido:
    ...
    when "46" then return "RETIRADA FILIAL => PROPRIA FILIAL".
    when "48" then return "SUBSTITUIۂO DE CUPOM".
    when "51" then return "ESTORNO".
    when "52" then return "ESTORNO".
    when "53" then return "ESTORNO".
    otherwise return "".
end case.
