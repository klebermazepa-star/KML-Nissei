...
*******************************************************************************/
{include/i-prgvrs.i INT018-Query.w 2.06.01.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_loja_cond_pag NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_loja_cond_pag NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_loja_cond_pag
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_loja_cond_pag
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "custom.int_ds_loja_cond_pag"
     _Options          = "NO-LOCK"
