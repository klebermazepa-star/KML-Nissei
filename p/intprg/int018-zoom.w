...
*******************************************************************************/
{include/i-prgvrs.i ZINT018 2.06.01.AVB}
...
DEFINE VARIABLE h_INT018-browser AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/INT018-browser.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_INT018-browser ).
       RUN set-position IN h_INT018-browser ( 3.75 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 84.57 ) */

       /* Links to SmartBrowser h_INT018-browser. */
       RUN add-link IN adm-broker-hdl ( h_INT018-browser , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_INT018-browser ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ZINT018" "2.06.01.AVB"}
