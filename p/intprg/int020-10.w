...
/********************************************************************************
** Programa: int020-10.w - EmissÆo de notas fiscais a partir de CUPONS PRS
**
** Versao : 12 - 18/03/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT020-10 2.12.01.AVB}

CREATE WIDGET-POOL.
current-language = current-language.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT020-10
...
&GLOBAL-DEFINE page6Fields    fi-alteraCupom fi-alteraConvenio cFile
...
DEFINE VARIABLE fi-alteraCupom AS DATE FORMAT "99/99/9999":U 
     LABEL "Altera Dt Cupom" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-alteraConvenio AS LOGICAL INITIAL no 
     LABEL "Altera Convenio" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage6
     ...
     fi-alteraCupom AT ROW 7.63 COL 12.43 COLON-ALIGNED WIDGET-ID 2
     fi-alteraConvenio AT ROW 7.63 COL 26.43 WIDGET-ID 4
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.altera-cupom    = input frame fpage6 fi-alteraCupom
           tt-param.altera-convenio = input frame fpage6 fi-alteraConvenio.    
    ...
    {report/rprun.i intprg/int020-10rp.p}
