...
&Scoped-define INTERNAL-TABLES cst_fat_duplic cst_nota_fiscal

/* Definitions for BROWSE brCartao                                      */
&Scoped-define FIELDS-IN-QUERY-brCartao cst_fat_duplic.parcela cst_fat_duplic.condipag cst_fat_duplic.cod_cond_pag cst_fat_duplic.adm_cartao cst_fat_duplic.cod_portador cst_fat_duplic.modalidade cst_fat_duplic.nsu_admin cst_fat_duplic.nsu_numero cst_fat_duplic.taxa_admin /* Table: cst_fat_duplic Field Name Data Type Flg ---------- --- -------------------------------- cod_estabel char im x(3) serie char im x(5) parcela char im x(02) nr_fatura char im x(16) condipag char x(2) adm_cartao char x(3) nsu_admin char x(10) nsu_numero char i x(10) autorizacao char x(20) taxa_admin deci-2 ->>>,>>>,>>9.99 cod_cond_pag inte >>9 cod_portador inte >>>>9 modalidade inte 9 num_id_tit_acr inte 9999999999 conciliado_sitef logi Sim/Nao */   
&Scoped-define ENABLED-FIELDS-IN-QUERY-brCartao   
&Scoped-define SELF-NAME brCartao
&Scoped-define QUERY-STRING-brCartao FOR EACH cst_fat_duplic WHERE TRUE /* Join to cst_nota_fiscal incomplete */ NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brCartao OPEN QUERY {&SELF-NAME} FOR EACH cst_fat_duplic WHERE TRUE /* Join to cst_nota_fiscal incomplete */ NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brCartao cst_fat_duplic
&Scoped-define FIRST-TABLE-IN-QUERY-brCartao cst_fat_duplic
...
cst_nota_fiscal.cpf_cupom cst_nota_fiscal.valor_cartao ~
...
&Scoped-Define ENABLED-FIELDS cst_nota_fiscal.cpf_cupom ~
cst_nota_fiscal.valor_cartao cst_nota_fiscal.valor_dinheiro ~
cst_nota_fiscal.valor_chq cst_nota_fiscal.valor_chq_pre ~
cst_nota_fiscal.valor_convenio cst_nota_fiscal.valor_ticket ~
cst_nota_fiscal.valor_vale cst_nota_fiscal.cartao_manual ~
...
&Scoped-Define DISPLAYED-FIELDS cst_nota_fiscal.cpf_cupom ~
cst_nota_fiscal.convenio cst_nota_fiscal.condipag ~
cst_nota_fiscal.valor_cartao cst_nota_fiscal.valor_dinheiro ~
cst_nota_fiscal.valor_chq cst_nota_fiscal.valor_chq_pre ~
cst_nota_fiscal.valor_convenio cst_nota_fiscal.valor_ticket ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brCartao C-Win _FREEFORM
  QUERY brCartao NO-LOCK DISPLAY
      cst_fat_duplic.parcela
    cst_fat_duplic.condipag
    cst_fat_duplic.cod_cond_pag 
    cst_fat_duplic.adm_cartao
    cst_fat_duplic.cod_portador
    cst_fat_duplic.modalidade
    cst_fat_duplic.nsu_admin FORMAT "x(12)"
    cst_fat_duplic.nsu_numero FORMAT "x(12)"
    cst_fat_duplic.taxa_admin



/*
Table: cst_fat_duplic

Field Name                  Data Type  Flg Format
--------------------------- ---------- --- --------------------------------
cod_estabel                 char       im  x(3)
serie                       char       im  x(5)
parcela                     char       im  x(02)
nr_fatura                   char       im  x(16)
condipag                    char           x(2)
adm_cartao                  char           x(3)
nsu_admin                   char           x(10)
nsu_numero                  char       i   x(10)
autorizacao                 char           x(20)
taxa_admin                  deci-2         ->>>,>>>,>>9.99
cod_cond_pag                inte           >>9
cod_portador                inte           >>>>9
modalidade                  inte           9
num_id_tit_acr              inte           9999999999
conciliado_sitef            logi           Sim/Nao
*/
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 81 BY 6.25
...
DEFINE FRAME DEFAULT-FRAME
     ...
     cst_nota_fiscal.id_pedido_convenio AT ROW 6.75 COL 63 COLON-ALIGNED WIDGET-ID 40
          VIEW-AS FILL-IN 
          SIZE 12 BY .79
     brCartao AT ROW 8.5 COL 2 WIDGET-ID 200
...
/* Query rebuild information for BROWSE brCartao
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH cst_fat_duplic WHERE TRUE /* Join to cst_nota_fiscal incomplete */ NO-LOCK INDEXED-REPOSITION.
     _END_FREEFORM
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE cst_nota_fiscal THEN 
    DISPLAY cst_nota_fiscal.cpf_cupom cst_nota_fiscal.convenio 
          ...
          cst_nota_fiscal.cartao_manual cst_nota_fiscal.id_pedido_convenio 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE RECT-2 cst_nota_fiscal.cpf_cupom cst_nota_fiscal.valor_cartao 
         cst_nota_fiscal.valor_dinheiro cst_nota_fiscal.valor_chq 
         cst_nota_fiscal.valor_chq_pre cst_nota_fiscal.valor_convenio 
         cst_nota_fiscal.valor_ticket cst_nota_fiscal.valor_vale 
         cst_nota_fiscal.cartao_manual cst_nota_fiscal.id_pedido_convenio 
