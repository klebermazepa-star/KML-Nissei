...
/********************************************************************************
** Programa: int023 - Exporta‡Æo de Dados Tribit rios Legado
**
** Versao : 12 - 18/04/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT023 2.12.01.AVB}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT023
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int023rp.p}
