...
/********************************************************************************
** Programa: INT027 - Importa‡Æo de Notas de Devolu‡Æo CUPOM do Toturial/Sysfarma
**
** Versao : 12 - 04/05/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT027 2.12.01.AVB}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT027
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int027rp.p}
