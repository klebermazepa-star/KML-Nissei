...
/*             c-origem-FIM = "ZZZZZZZZ".                                                                                                                                        */
    ...
    assign  c-origem-ini:list-items in frame fPage0 = ",ABCFARMA,CLI,CUPOM,DEV PROC,FFIXO,FISC,FuroCX,ITEMFORN,NF Balan,NF CANC,NF PED,NF PROC,NF Retor,NFDCUP,NFE,NFENDD,PCOMPR,PED,PRECOBASE,RETNFE,RETNFNDD,WMS,ECOM Retor"
            c-origem-FIM:list-items in frame fPage0 = "ABCFARMA,CLI,CUPOM,DEV PROC,FFIXO,FISC,FuroCX,ITEMFORN,NF Balan,NF CANC,NF PED,NF PROC,NF Retor,NFDCUP,NFE,NFENDD,PCOMPR,PED,PRECOBASE,RETNFE,RETNFNDD,WMS,ECOM Reto,ZZZZZZZZ"
            c-origem-FIM = "ZZZZZZZZ".
