...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_msg_usuario WHERE int_ds_msg_usuario.origem = int_ds_origem.origem NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_msg_usuario WHERE int_ds_msg_usuario.origem = int_ds_origem.origem NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_msg_usuario
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_msg_usuario
...
<FOREIGN-KEYS>
cod-usuario||y|mgesp.int_ds_msg_usuario.cod-usuario
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
