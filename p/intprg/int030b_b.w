...
*******************************************************************************/
{include/i-prgvrs.i INT030B_B 2.09.00.001}
...
DEFINE VARIABLE h_int030b_b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_int030b_b-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 7.54 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 7.54 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 7.54 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 7.54 COL 70.72
     rt-button AT ROW 7.38 COL 1.57
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 89.86 BY 17 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Mensagem x Usu rio"
         HEIGHT             = 8.08
         WIDTH              = 89.57
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Mensagem x Usu rio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Mensagem x Usu rio */
DO:
...
DO:
{include/okfil.i h_int030b_b-v01}
END.
...
DO:
{include/salvafil.i h_int030b_b-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/int030b_b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_int030b_b-v01 ).
       RUN set-position IN h_int030b_b-v01 ( 1.21 , 1.29 ) NO-ERROR.
       /* Size in UIB:  ( 6.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/int030b_b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_int030b_b-q01 ).
       RUN set-position IN h_int030b_b-q01 ( 1.00 , 66.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_int030b_b-v01. */
       RUN add-link IN adm-broker-hdl ( h_int030b_b-q01 , 'Record':U , h_int030b_b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_int030b_b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_int030b_b-v01 ,
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE local-create-record w-cadsim 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "INT030B_B" "2.09.00.001"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_int030b_b-v01 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_int030b_b-q01 (input v-row-table).
