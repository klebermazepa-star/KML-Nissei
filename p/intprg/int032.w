...
DEFINE TEMP-TABLE tt-ped_exec_hist NO-UNDO LIKE ped_exec
       field r-rowid as rowid
       field desc_prog like int_ds_prog_rpw.desc_prog
       index ordem
       cod_prog_dtsul
       cod_servid_exec
       num_ped_exec DESC
...
define temp-table tt-param-int155 no-undo
    field destino          as integer
    field arquivo          as char format "x(35)"
    field usuario          as char format "x(12)"
    field data-exec        as date
...
define temp-table tt-param-int091 NO-UNDO
       FIELD DESTINO            AS INTEGER 
       FIELD ARQUIVO            AS CHAR FORMAT "x(35)"
       FIELD USUARIO            AS CHAR FORMAT "x(12)"
       FIELD DATA-EXEC          AS DATE 
...
define temp-table tt-param-int601 no-undo
    field destino          as integer
...
define temp-table tt-param-int590 no-undo
    field destino          as integer
    field arquivo          as char format "x(35)":U
    field usuario          as char format "x(12)":U
    field data-exec        as date
...
&Scoped-define FIELDS-IN-QUERY-Br-prog tt-int_ds_prog_rpw.cod_prog tt-int_ds_prog_rpw.desc_prog tt-int_ds_prog_rpw.nome_ext tt-ped_exec.num_ped_exec tt-ped_exec.cod_servid_exec tt-ped_exec.ind_sit_ped_exec tt-ped_exec.dat_criac_ped_exec tt-ped_exec.dat_exec_ped_exec tt-ped_exec.hra_exec_ped_exec tt-ped_exec.dat_inic_exec_servid_exec tt-ped_exec.hra_inic_exec_servid_exec tt-ped_exec.hra_fim_exec_servid_exec tt-ped_exec.des_text_erro   
...
&Scoped-define FIELDS-IN-QUERY-brPedexec tt-ped_exec_hist.cod_prog_dtsul tt-ped_exec_hist.desc_prog tt-ped_exec_hist.num_ped_exec tt-ped_exec_hist.cod_servid_exec tt-ped_exec_hist.ind_sit_ped_exec tt-ped_exec_hist.dat_exec_ped_exec tt-ped_exec_hist.hra_exec_ped_exec tt-ped_exec_hist.dat_inic_exec_servid_exec tt-ped_exec_hist.hra_inic_exec_servid_exec tt-ped_exec_hist.hra_fim_exec_servid_exec tt-ped_exec_hist.des_text_erro   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS Br-prog wWindow _FREEFORM
  QUERY Br-prog NO-LOCK DISPLAY
    ...
    tt-int_ds_prog_rpw.nome_ext FORMAT "x(22)":U WIDTH 16.43
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brPedexec wWindow _FREEFORM
  QUERY brPedexec NO-LOCK DISPLAY
    ...
    tt-ped_exec_hist.desc_prog COLUMN-LABEL "Descri»’o" FORMAT "X(65)":U WIDTH 34
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: tt-ped_exec T "?" NO-UNDO emsfnd ped_exec
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
      END-FIELDS.
      TABLE: tt-ped_exec_hist T "?" NO-UNDO emsfnd ped_exec
      ADDITIONAL-FIELDS:
          field r-rowid as rowid
          field desc_prog like int_ds_prog_rpw.desc_prog
          index ordem
...
DO:
      if avail tt-int_ds_prog_rpw then do:
        ...
        else if tt-int_ds_prog_rpw.cod_prog begins "int072" then do:
            create  tt-param-int072.
            assign  tt-param-int072.destino          = 2
                    tt-param-int072.arquivo          = tt-int_ds_prog_rpw.cod_prog + ".LST"
                    tt-param-int072.usuario          = "rpw"
                    tt-param-int072.data-exec        = today
                    tt-param-int072.hora-exec        = time
                    tt-param-int072.classifica       = 0
                    tt-param-int072.desc-classifica  = ""
                    tt-param-int072.cod-emitente-fim = 999999999
                    tt-param-int072.cod-emitente-ini = 0
                    tt-param-int072.cod-estabel-fim  = "ZZZZZ"
                    tt-param-int072.cod-estabel-ini  = ""
                    tt-param-int072.dt-trans-fim     = ?
                    tt-param-int072.dt-trans-ini     = ?
                    tt-param-int072.dt-emis-nota-fim = ?
                    tt-param-int072.dt-emis-nota-ini = ?
                    tt-param-int072.nro-docto-fim    = "999999999"
                    tt-param-int072.nro-docto-ini    = "0"
                    tt-param-int072.serie-docto-fim  = "ZZZZZ"
                    tt-param-int072.serie-docto-ini  = "".
            raw-transfer tt-param-int072 to raw-param.
        end.
        else if tt-int_ds_prog_rpw.cod_prog begins "int110" then do:
        ...
        else if tt-int_ds_prog_rpw.cod_prog begins "int155" then do:
            create  tt-param-int155.
            assign  tt-param-int155.destino          = 2
                    tt-param-int155.arquivo          = tt-int_ds_prog_rpw.cod_prog + ".LST"
                    tt-param-int155.usuario          = "rpw"
                    tt-param-int155.data-exec        = today
                    tt-param-int155.hora-exec        = time
                    tt-param-int155.classifica       = 0
                    tt-param-int155.desc-classifica  = ""
                    tt-param-int155.it-codigo-ini    = ""
                    tt-param-int155.it-codigo-fim    = "ZZZZZZZZZZZ"
                    tt-param-int155.cod-estabel-ini  = ""
                    tt-param-int155.cod-estabel-fim  = "ZZZ".
            raw-transfer tt-param-int155 to raw-param.
        end.
        else if tt-int_ds_prog_rpw.cod_prog begins "int091" then do:
            create  tt-param-int091.
            assign  tt-param-int091.destino          = 2
                    tt-param-int091.arquivo          = tt-int_ds_prog_rpw.cod_prog + ".LST"
                    tt-param-int091.usuario          = "rpw"
                    tt-param-int091.data-exec        = today
                    tt-param-int091.hora-exec        = time
                    tt-param-int091.cod-emitente-ini = ""
                    tt-param-int091.cod-emitente-fim = "ZZZZZZZZZZZZZZ"
                    tt-param-int091.cod-cnpj-ini     = ""
                    tt-param-int091.cod-cnpj-fim     = "ZZZZZZZZZZZZZZZZ".
            raw-transfer tt-param-int091 to raw-param.
        end.
        else if tt-int_ds_prog_rpw.cod_prog begins "int601" then do:
            create  tt-param-int601.
            assign  tt-param-int601.destino             = 2
                    tt-param-int601.arquivo             = tt-int_ds_prog_rpw.cod_prog + ".LST"
                    tt-param-int601.usuario             = "rpw"
                    tt-param-int601.data-exec           = today
                    tt-param-int601.hora-exec           = time
                    tt-param-int601.classifica          = 0  
                    tt-param-int601.desc-classifica     = ""
                    tt-param-int601.cod-estabel-ini     = ""
                    tt-param-int601.cod-estabel-fim     = "ZZZZZ"
                    tt-param-int601.estado-ini          = ""
                    tt-param-int601.estado-fim          = "ZZZZZ"
                    tt-param-int601.dt-emis-nota-ini    = ?
                    tt-param-int601.dt-emis-nota-fim    = ?
                    tt-param-int601.ult-dias            = 0
                    .

            raw-transfer tt-param-int601 to raw-param.
        end.
        else if tt-int_ds_prog_rpw.cod_prog begins "int590" then do:
            create  tt-param-int590.
            assign  tt-param-int590.destino             = 2
                    tt-param-int590.arquivo             = tt-int_ds_prog_rpw.cod_prog + ".LST"
                    tt-param-int590.usuario             = "rpw"
                    tt-param-int590.data-exec           = today
                    tt-param-int590.hora-exec           = time
                    tt-param-int590.classifica          = 0  
                    tt-param-int590.desc-classifica     = ""
                    tt-param-int590.modelo              = ""
                    tt-param-int590.l-habilitaRTF       = NO
                    tt-param-int590.dt-trans-ini        = TODAY - 7
                    tt-param-int590.i-qtd-notas         = 1000
                    .

            raw-transfer tt-param-int590 to raw-param.
        end.
        else if tt-int_ds_prog_rpw.cod_prog begins "int090" then do:

            create  tt-param-int090.
            assign  tt-param-int090.DESTINO             = 2
                    tt-param-int090.ARQUIVO             = tt-int_ds_prog_rpw.cod_prog + ".LST"
                    ...
                    tt-param-int090.it-codigo-ini       = ""
                    tt-param-int090.it-codigo-fim       = "ZZZZZZZZZ"
                    ...
                    tt-param-int090.forc-integ          = YES
                    .
...
for each int_ds_prog_rpw no-lock where
    ...
    for each ped_exec no-lock where 
        ...
        BY ped_exec.hra_exec_ped_exec DESC
        :
        ...
        buffer-copy ped_exec to tt-ped_exec_hist
            assign tt-ped_exec_hist.desc_prog = int_ds_prog_rpw.desc_prog.
...
for each int_ds_prog_rpw no-lock:
    ...
    for last ped_exec no-lock
        where lower(ped_exec.cod_prog_dtsul) = lower(int_ds_prog_rpw.cod_prog)  and
    ...
    if not avail ped_exec then do:
        for last ped_exec no-lock
            where lower(ped_exec.cod_prog_dtsul) = lower(int_ds_prog_rpw.cod_prog)
            :
            create tt-ped_exec.
            buffer-copy ped_exec to tt-ped_exec.
        end.
...
if can-find (first tt-int_ds_prog_rpw) then do:
    ...
    IF rs-ordena:SCREEN-VALUE IN FRAME fpage0 = "1" THEN DO:
        open query br-Prog 
            for each tt-int_ds_prog_rpw no-lock, 
                each tt-ped_exec no-lock 
                where lower(tt-ped_exec.cod_prog_dtsul) = lower(tt-int_ds_prog_rpw.cod_prog)
            outer-join 
