...
*******************************************************************************/
{include/i-prgvrs.i int033 2.12.00.001}  /**/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i int033 MOF}
&ENDIF
...
&GLOBAL-DEFINE page4Widgets   rs-modo  ~
...
&GLOBAL-DEFINE page2Fields    c-estabel-ini c-estabel-fim periodo-ini periodo-fim 
&GLOBAL-DEFINE page3Fields    
&GLOBAL-DEFINE page4Fields    rs-modo   
...
&Scoped-define QUERY-STRING-fPage2 FOR EACH estabelec SHARE-LOCK
&Scoped-define OPEN-QUERY-fPage2 OPEN QUERY fPage2 FOR EACH estabelec SHARE-LOCK.
...
DEFINE VARIABLE rs-modo AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Por CFOP", 1,
"Por Natureza de Opera‡Æo", 2,
"Por Documento Fiscal", 3,
"Por Classifica‡Æo Fiscal", 4
     SIZE 22 BY 3.75 NO-UNDO.
...
DEFINE FRAME fPage4
     rs-modo AT ROW 3.25 COL 16 NO-LABEL
     "Modo Execu‡Æo" VIEW-AS TEXT
          SIZE 12 BY .54 AT ROW 2.5 COL 15
     RECT-23 AT ROW 2.75 COL 14
...
DEFINE FRAME fPage2
     c-estabel-ini AT ROW 2 COL 25.86 COLON-ALIGNED HELP
          "" WIDGET-ID 2
          LABEL "Estabelecimento":R15
     c-estabel-fim AT ROW 2 COL 46.43 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     periodo-ini AT ROW 3 COL 15.71
     periodo-fim AT ROW 3 COL 48.43 NO-LABEL
     IMAGE-1 AT ROW 3.04 COL 36.43
     IMAGE-2 AT ROW 3.04 COL 44.29
     IMAGE-3 AT ROW 2 COL 36.57 WIDGET-ID 6
     IMAGE-4 AT ROW 2 COL 44.43 WIDGET-ID 8
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3.5 ROW 2.81
         SIZE 84.43 BY 10.15
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Demonstrativo Auxiliar de  PIS/COFINS"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF wReport /* Demonstrativo Auxiliar de  PIS/COFINS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Demonstrativo Auxiliar de  PIS/COFINS */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int033rp.p}
