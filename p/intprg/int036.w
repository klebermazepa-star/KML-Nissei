...
*******************************************************************************/
{include/i-prgvrs.i int036 2.12.00.001}  /**/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i int036 MOF}
&ENDIF
...
&GLOBAL-DEFINE page2Fields    c-estabel-ini c-estabel-fim periodo-ini periodo-fim transacao-ini transacao-fim rs-tipo
...
DEFINE VARIABLE transacao-fim AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE transacao-ini AS DATE FORMAT "99/99/9999":U 
     LABEL "Dt Transa‡Æo" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     ...
     periodo-ini AT ROW 3.04 COL 17.57
     periodo-fim AT ROW 3 COL 47 NO-LABEL
     rs-tipo AT ROW 5.67 COL 17 NO-LABEL WIDGET-ID 10
     transacao-ini AT ROW 4.13 COL 13.86 WIDGET-ID 22
     transacao-fim AT ROW 4.08 COL 47 NO-LABEL WIDGET-ID 20
     ...
     IMAGE-5 AT ROW 4.13 COL 36.43 WIDGET-ID 16
     IMAGE-6 AT ROW 4.13 COL 42.86 WIDGET-ID 18
...
/* SETTINGS FOR FILL-IN periodo-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN transacao-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN transacao-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
ON END-ERROR OF wReport /* Lista Notas Recebimento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Lista Notas Recebimento */
DO:
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN transacao-ini:SCREEN-VALUE IN FRAME fPage2 = periodo-ini:SCREEN-VALUE IN FRAME fPage2
           transacao-fim:SCREEN-VALUE IN FRAME fPage2 = periodo-fim:SCREEN-VALUE IN FRAME fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario             = c-seg-usuario
           ...
           tt-param.dt-transacao-ini    = input frame fPage2 transacao-ini
           tt-param.dt-transacao-fim    = input frame fPage2 transacao-fim
    ...
    {report/rprun.i intprg/int036rp.p}
