...
*******************************************************************************/
{include/i-prgvrs.i int039 2.12.00.001}  /**/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i int039 MRE}
&ENDIF
...
&GLOBAL-DEFINE Program        int039
&GLOBAL-DEFINE Version        2.12.00.001
&GLOBAL-DEFINE VersionLayout  

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   Sele��o,Impress�o
...
&GLOBAL-DEFINE page2Fields  c-estabel-ini c-estabel-fim periodo-ini periodo-fim i-pedido-ini i-pedido-fim rs-tipo rs-tipo-ped l-cancelados
...
DEFINE VARIABLE rs-tipo AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Resumido", 1,
"Detalhado", 2
     SIZE 31 BY 1.25 NO-UNDO.

DEFINE VARIABLE rs-tipo-ped AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Pendentes", 1,
"Atualizados", 2,
"Todos", 3
     SIZE 44 BY 1.25 NO-UNDO.

DEFINE VARIABLE l-cancelados AS LOGICAL INITIAL no 
...
DEFINE FRAME fPage2
     l-cancelados AT ROW 7.46 COL 22 WIDGET-ID 26
     ...
     i-pedido-ini AT ROW 4.08 COL 23.86 COLON-ALIGNED WIDGET-ID 18
     i-pedido-fim AT ROW 4.08 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     rs-tipo-ped AT ROW 6.04 COL 22 NO-LABEL WIDGET-ID 10
     rs-tipo AT ROW 8.58 COL 22 NO-LABEL WIDGET-ID 14
...
ON END-ERROR OF wReport /* Lista Pedidos Balan�o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Lista Pedidos Balan�o */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.rs-tipo-ped     = INPUT FRAME fpage2 rs-tipo-ped  
           ...
           tt-param.cancelados      = input frame fPage2 l-cancelados.
    ...
    {report/rprun.i intprg/int039rp.p}
