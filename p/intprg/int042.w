...
/********************************************************************************
** Programa: int012 - Importaá∆o de Notas de Transferencia do Toturial/Sysfarma
**
** Versao : 12 - 14/09/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT042 2.12.01.AVB}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT042
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int042rp-old.p}
