...
&GLOBAL-DEFINE page0Widgets   btQueryJoins btReportsJoins btExit btHelp ~
                              btOK btCancel btHelp2 btSelecao c-intervalo btAtualiza btSerie rs-consulta btItens btIndica bt-mdfe
...
DEF BUFFER bfmdfe-docto     FOR mdfe-docto.
...
btHelp btSelecao btAtualiza bt-mdfe rs-consulta btSerie btOK btCancel ~
btItens btIndica btHelp2 
...
DEFINE FRAME fpage0
     ...
     bt-mdfe AT ROW 1.25 COL 151 WIDGET-ID 86
...
&Scoped-define FRAME-NAME fpage0
&Scoped-define SELF-NAME bt-mdfe
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-mdfe wWindow
ON CHOOSE OF bt-mdfe IN FRAME fpage0 /* Gera MDF-e */
DO:

    RUN intprg/int050m.p ( INPUT TABLE tt-int_ds_pedido).
...
num-seq                     inte       im  >>>>9
dat-emis-mdfe               date           99/99/9999
cod-estab-nfe               char       i   x(8)
cod-ser-nfe                 char       i   x(8)
cod-num-nfe                 char       i   x(20)
cod-chave-nfe               char       i   x(60)
val-tot-nfe                 deci-2         ->>>,>>>,>>>,>>9.99
cod-pin                     char           x(20)
cod-livre-1                 char           x(500)
cod-livre-2                 char           x(500)
cod-livre-3                 char           x(500)
cod-livre-4                 char           x(500)
cod-livre-5                 char           x(500)
dat-livre-1                 date           99/99/9999
dat-livre-2                 date           99/99/9999
dat-livre-3                 date           99/99/9999
dat-livre-4                 date           99/99/9999
dat-livre-5                 date           99/99/9999
val-livre-1                 deci-10        ->>>>>>>>>>>9.9999
val-livre-2                 deci-10        ->>>>>>>>>>>9.9999
val-livre-3                 deci-8         ->>>>>>>>>>>9.99999999
val-livre-4                 deci-8         ->>>>>>>>>>>9.99999999
val-livre-5                 deci-8         ->>>>>>>>>>>9.99999999
...
cod-num-mdfe                char       im  x(20)
dat-emis-mdfe               date           99/99/9999
cod-num-modal               char       im  x(20)
cod-condut                  char       im  x(20)
nom-condut                  char           x(200)
cod-cpf                     char           x(19)
cod-livre-1                 char           x(500)
cod-livre-2                 char           x(500)
cod-livre-3                 char           x(500)
...
cod-ser-mdfe                char       im  x(5)
cod-num-mdfe                char       im  x(20)
dat-emis-mdfe               date       i   99/99/9999
hra-emis-mdfe               char           99:99:99
idi-ambien-mdfe             inte           9
ind-tip-emit                char           X(02)
cod-uf-orig                 char           x(2)
cod-uf-dest                 char           X(4)
cod-un-medid                char           x(12)
num-aleat-mdfe              inte           >>>>>>>>9
idi-sit-mdfe                inte           >9
idi-tip-emis-mdfe           inte           >9
cod-chave-mdfe              char       i   x(60)
cod-mod-frete               char       i   x(2)
cod-num-modal               char           x(20)
cod-munpio-ibge-carreg      char       i   x(8)
nom-munpio-carreg           char       i   x(100)
cod-protoc-autoriz          char           x(50)
dat-autoriz                 date           99/99/9999
hra-autoriz                 char           99:99:99
cod-protoc-cancel           char           x(50)
dat-cancel                  date           99/99/9999
hra-cancel                  char           99:99:99
cod-protoc-encert           char           x(50)
dat-encert                  date       m   99/99/9999
hra-encert                  char           99:99:99
dsl-xml-sefaz               char           x(30000)
cod-livre-1                 char           x(500)
cod-livre-2                 char           x(500)
cod-livre-3                 char           x(500)
cod-livre-4                 char           x(500)
...
for FIRST b-estabelec fields (cod-estabel estado cgc) /* KML - acrecentado um OR para vericar os dois CDs */
    no-lock where (b-estabelec.cod-estabel = "973" OR b-estabelec.cod-estabel = "977") QUERY-TUNING(NO-LOOKAHEAD):

END.    
    
for each bf-int_ds_pedido no-lock USE-INDEX dt_cnpj where
         ...
         bf-int_ds_pedido.ped_codigo_n     <= i-pedido-fim AND
         bf-int_ds_pedido.situacao          = 1 QUERY-TUNING(NO-LOOKAHEAD):
    ...
    for EACH estab-rota-entreg WHERE                /* KML - acrecentado um OR para vericar os dois CDs */
              (estab-rota-entreg.cod-estabel = "973" OR estab-rota-entreg.cod-estabel = "977") AND
...
FOR EACH b-estabelec fields (cod-estabel estado cgc)
    no-lock where (b-estabelec.cod-estabel = "973" OR b-estabelec.cod-estabel = "977") QUERY-TUNING(NO-LOOKAHEAD): 
...
for each int_ds_pedido no-lock USE-INDEX dt_cnpj where
         ...
         (int_ds_pedido.ped_tipopedido_n = 1 OR 
          ...
          int_ds_pedido.ped_tipopedido_n = 5 OR
    ...
    OR i-situacao  = 4 THEN DO:     
       ...
       OR i-situacao = 4 THEN DO:
          ...
          FOR FIRST nota-fiscal USE-INDEX ch-pedido WHERE 
                    ...
                    nota-fiscal.idi-sit-nf-eletro <> 7 NO-LOCK: 
             ...
             FOR FIRST estabelec WHERE
                ...
                FOR EACH int_ds_nota_saida WHERE 
                   ...
                   IF int_ds_nota_saida.envio_Status = 3 THEN
                      ASSIGN c-nota-destino = "Recusado Procfit".
                END.
             END.
          END.
       END.
