...
/********************************************************************************
** Programa: int052 - Importaá∆o de Notas de REtirada Loja do Toturial/Sysfarma
**
** Versao : 12 - 18/10/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT052 2.12.01.AVB}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT052
&GLOBAL-DEFINE Version        2.12.01.AVB
&GLOBAL-DEFINE VersionLayout  1

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   ParÉmetros, Geraá∆o
...
dt-emis-nota-fim dt-emis-nota-ini nro-docto-fim nro-docto-ini serie-docto-fim serie-docto-ini dt-transacao-ini dt-transacao-fim
...
DEFINE VARIABLE dt-transacao-fim AS DATE FORMAT "99/99/9999" 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .79.

DEFINE VARIABLE dt-transacao-ini AS DATE FORMAT "99/99/9999" 
     LABEL "Dt Transacao":R12 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .79.
...
DEFINE FRAME fPage2
     ...
     dt-transacao-ini AT ROW 3.58 COL 20 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" WIDGET-ID 48
     dt-transacao-fim AT ROW 3.58 COL 49 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" NO-LABEL WIDGET-ID 46
     serie-docto-ini AT ROW 4.58 COL 24 COLON-ALIGNED WIDGET-ID 24
     serie-docto-fim AT ROW 4.58 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     nro-docto-ini AT ROW 5.58 COL 19 COLON-ALIGNED WIDGET-ID 22
     nro-docto-fim AT ROW 5.58 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     cod-emitente-ini AT ROW 6.58 COL 17 COLON-ALIGNED WIDGET-ID 20
     cod-emitente-fim AT ROW 6.58 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     ...
     IMAGE-7 AT ROW 4.58 COL 32 WIDGET-ID 26
     IMAGE-8 AT ROW 4.58 COL 47.29 WIDGET-ID 28
     IMAGE-9 AT ROW 5.58 COL 32 WIDGET-ID 32
     IMAGE-10 AT ROW 5.58 COL 47.29 WIDGET-ID 34
     IMAGE-11 AT ROW 6.58 COL 32 WIDGET-ID 40
     IMAGE-12 AT ROW 6.58 COL 47.29 WIDGET-ID 38
     IMAGE-13 AT ROW 3.58 COL 32 WIDGET-ID 50
     IMAGE-14 AT ROW 3.58 COL 47.29 WIDGET-ID 52
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.dt-transacao-fim = input frame fPage2 dt-transacao-fim
           tt-param.dt-transacao-ini = input frame fPage2 dt-transacao-ini           
    ...
    {report/rprun.i intprg/int052rp-transacao.p}
