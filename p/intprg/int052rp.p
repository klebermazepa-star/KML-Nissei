...
for each int_ds_docto_xml no-lock where
    ...
    IF i-cont-notas >= 300 THEN LEAVE.            
    ...
    FIND LAST int_ds_docto_wms no-lock /* use-index sequencial */ 
        WHERE int_ds_docto_wms.doc_numero_n = string(int(int_ds_docto_xml.nNF)) 
          ...
          AND int_ds_docto_wms.doc_origem_n = int_ds_docto_xml.cod_emitente NO-ERROR.
    ...
    */       
    ...
    for EACH tt-movto
        ...
        FIND FIRST tt-docum-est where 
            ...
            tt-docum-est.cod-emitente      = tt-movto.cod-emitente no-error.
        ...
        FIND FIRST tt-item-doc-est where 
            tt-item-doc-est.serie-docto       = tt-movto.serie                  and
            tt-item-doc-est.nro-docto         = tt-movto.nr-nota-fis            and
            tt-item-doc-est.cod-emitente      = tt-movto.cod-emitente           AND
            tt-item-doc-est.nat-operacao      = tt-docum-est.nat-operacao  AND      
            tt-item-doc-est.sequencia         = tt-movto.nr-sequencia          
            NO-ERROR.

        IF NOT AVAIL tt-item-doc-est  THEN DO: 

            create tt-item-doc-est.
            assign tt-item-doc-est.registro           = 3
                   tt-item-doc-est.it-codigo          = tt-movto.it-codigo
                   tt-item-doc-est.cod-refer          = ""
                   tt-item-doc-est.numero-ordem       = 0
                   tt-item-doc-est.parcela            = 1
                   tt-item-doc-est.encerra-pa         = yes  
                   ...
                   tt-item-doc-est.qt-do-forn         = tt-movto.qt-recebida
                   tt-item-doc-est.quantidade         = tt-movto.qt-recebida
                   tt-item-doc-est.preco-total        = tt-movto.valor-mercad
                   tt-item-doc-est.desconto           = tt-movto.desconto
                   tt-item-doc-est.vl-frete-cons      = 0
                   tt-item-doc-est.despesas           = tt-movto.vl-despesas
                   tt-item-doc-est.peso-liquido       = tt-movto.peso-liquido * tt-movto.qt-recebida
                   tt-item-doc-est.cod-depos          = IF tt-movto.cod-depos <> "" THEN tt-movto.cod-depos ELSE "LOJ"
                   tt-item-doc-est.cod-localiz        = ""
                   tt-item-doc-est.lote               = tt-movto.lote
                   tt-item-doc-est.dt-vali-lote       = tt-movto.dt-vali-lote
                   tt-item-doc-est.class-fiscal       = tt-movto.class-fisc 
                   tt-item-doc-est.aliquota-ipi       = tt-movto.aliquota-ipi
                   tt-item-doc-est.cd-trib-ipi        = tt-movto.cd-trib-ipi 
                   tt-item-doc-est.base-ipi           = if tt-movto.cd-trib-ipi = 1
                                                             then tt-movto.vl-bipi-it
                                                             else 0
                   tt-item-doc-est.ipi-outras         = if tt-movto.cd-trib-ipi = 3 
                                                             then tt-movto.vl-bipi-it    
                                                             else 0                      
                   tt-item-doc-est.ipi-ntrib          = if tt-movto.cd-trib-ipi = 2
                                                             then tt-movto.vl-bipi-it    
                                                             else 0                      
                   tt-item-doc-est.valor-ipi          = tt-movto.vl-ipi-it
                   tt-item-doc-est.cd-trib-iss        = tt-movto.cd-trib-iss
                   tt-item-doc-est.aliquota-icm       = tt-movto.aliquota-icm
                   tt-item-doc-est.cd-trib-icm        = tt-movto.cd-trib-icm 
                   tt-item-doc-est.base-icm           = if tt-movto.cd-trib-icm = 1 or 
                                                                tt-movto.cd-trib-icm = 4 
                                                             then tt-movto.vl-bicms-it
                                                             else 0
                   tt-item-doc-est.icm-outras         = if (tt-movto.cd-trib-icm = 3 or tt-movto.cd-trib-icm = 5)
                                                             then tt-movto.vl-bicms-it       
                                                             else if tt-movto.cd-trib-icm = 4 then
                                                                  (tt-movto.valor-mercad - tt-movto.vl-bicms-it)
                                                             else 0 
                   tt-item-doc-est.icm-ntrib          = if tt-movto.cd-trib-icm = 2     
                                                             then tt-movto.vl-bicms-it       
                                                             else 0 
                   tt-item-doc-est.valor-icm          = tt-movto.vl-icms-it
                   tt-item-doc-est.base-subs          = tt-movto.vl-bsubs-it  
                   tt-item-doc-est.valor-subs         = tt-movto.vl-icmsub-it 
                   tt-item-doc-est.icm-complem        = 0
                   tt-item-doc-est.ind-icm-ret        = if tt-movto.vl-icmsub-it <> 0 then yes else no
                   tt-item-doc-est.narrativa          = p-narrativa
                   tt-item-doc-est.iss-outras         = 0
                   tt-item-doc-est.iss-ntrib          = 0 
                   tt-item-doc-est.serie-docto        = tt-movto.serie
                   tt-item-doc-est.nro-docto          = tt-movto.nr-nota-fis
                   tt-item-doc-est.cod-emitente       = tt-movto.cod-emitente
                   tt-item-doc-est.nat-operacao       = tt-docum-est.nat-operacao /* natureza da nota - chave */
                   tt-item-doc-est.nat-of             = tt-movto.nat-operacao /* natureza do item */
                   tt-item-doc-est.sequencia          = tt-movto.nr-sequencia
                   tt-item-doc-est.nr-proc-imp        = ""
                   tt-item-doc-est.nr-ato-concessorio = ""
                   tt-item-doc-est.val-perc-red-ipi   = 0
                   tt-item-doc-est.val-perc-red-icm   = tt-movto.perc-red-icms.
            assign tt-item-doc-est.base-pis           = tt-movto.base-pis          
                   tt-item-doc-est.valor-pis          = tt-movto.valor-pis         
                   tt-item-doc-est.cd-trib-pis        = tt-movto.cd-trib-pis       
                   tt-item-doc-est.aliquota-pis       = tt-movto.aliquota-pis      
                   tt-item-doc-est.base-cofins        = tt-movto.base-cofins       
                   tt-item-doc-est.valor-cofins       = tt-movto.valor-cofins      
                   tt-item-doc-est.cd-trib-cofins     = tt-movto.cd-trib-cofins    
                   tt-item-doc-est.aliquota-cofins    = tt-movto.aliquota-cofins.
    
            assign tt-docum-est.valor-mercad          = tt-docum-est.valor-mercad 
                                                           + tt-item-doc-est.preco-total.
    
            if tt-movto.ct-codigo <> "" then do:
                assign tt-item-doc-est.ct-codigo = tt-movto.ct-codigo
                       tt-item-doc-est.sc-codigo = tt-movto.sc-codigo.
            end.
                ...
                do transaction:
                    ...
                    for each item-doc-est  of docum-est EXCLUSIVE-LOCK:
                        ...
                        FIND first item-uni-estab no-lock where 
                                   ...
                                   item-uni-estab.it-codigo = string(item-doc-est.it-codigo) NO-ERROR.
                            if not avail item-uni-estab THEN DO:
                               FIND first item-estab NO-LOCK where 
                                         item-estab.cod-estabel = docum-est.cod-estabel and
                                         item-estab.it-codigo = string(item-doc-est.it-codigo)  NO-ERROR.
                            END.
                        ...
                        ASSIGN item-doc-est.cod-depos          = if avail item-uni-estab and trim(item-uni-estab.deposito-pad) <> "" and trim(item-uni-estab.deposito-pad) <> ?
                                                                then item-uni-estab.deposito-pad
                                                                else if avail item-estab and trim(item-estab.deposito-pad) <> "" and trim(item-estab.deposito-pad) <> ? then item-estab.deposito-pad else "LOJ".
                    ...
                    for each rat-lote  of docum-est EXCLUSIVE-LOCK:
                        ...
                        ASSIGN rat-lote.cod-depos          = if avail item-uni-estab and trim(item-uni-estab.deposito-pad) <> "" and trim(item-uni-estab.deposito-pad) <> ?
                                                             then item-uni-estab.deposito-pad
                                                             else if avail item-estab and trim(item-estab.deposito-pad) <> "" and trim(item-estab.deposito-pad) <> ? then item-estab.deposito-pad else "LOJ".
