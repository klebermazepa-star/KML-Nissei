...
define temp-table tt-est-ncm-pis-cofins no-undo
...
def var  vl-tot-item       like tt-ncm-pis-cofins.vl-tot-item no-undo.
...
find first ems2mult.empresa where 
           ems2mult.empresa.ep-codigo = param-global.empresa-prin no-lock no-error.
...
PROCEDURE pi-gera-relatorio:
    ...
    DEFINE VARIABLE ChExcel       AS office.iface.excel.ExcelWrapper. /* Documento Excel */
    DEFINE VARIABLE ChBook        AS office.iface.excel.Workbook. /* Abas da Planilha */
    DEFINE VARIABLE ChSheet       AS office.iface.excel.WorkSheet. /* Planilha */
    ...
    DEF VAR xlinha AS INTEGER INIT 1 NO-UNDO.
        ...
        ASSIGN ChSheet = ChExcel:ActiveSheet
               ChExcel:DisplayAlerts = FALSE
               ChExcel:VISIBLE       = FALSE.
               ChBook  = ChExcel:WorkBooks:ADD(search("layout\Modelo_int999.xls")).
...
/*     chWorkBook      = chExcel:WorkBooks:ADD(search("layout\Modelo_int999.xls")). /*Adiciona a primeira aba*/ */
    ...
    chbook:Worksheets(xsheet):Activate.
    chsheet = chbook:Worksheets(xsheet).
    ...
    BREAK BY tt-ncm-pis-cofins.aba :
        ...
        IF FIRST-OF(tt-ncm-pis-cofins.aba) THEN DO:
            ASSIGN 
                   ChSheet:range("A1:J1"):Font:Bold = TRUE.
                   ChSheet:range("A2:J2"):Font:Bold = TRUE.
                   ChSheet:Range("A" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.aba).         
                   xlinha                                         = xlinha + 1.
                   ChSheet:range("A" + STRING(xlinha)):Font:Bold = TRUE. 
                   ChSheet:Range("A" + STRING(xlinha)):SetValue("NCM").
                   ChSheet:range("B" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("B" + STRING(xlinha)):SetValue("Valor Cont bil":U). 
                   ChSheet:range("C" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("C" + STRING(xlinha)):SetValue("Base PIS").
                   ChSheet:range("D" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("D" + STRING(xlinha)):SetValue("Valor PIS").
                   ChSheet:range("E" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("E" + STRING(xlinha)):SetValue("Base COFINS").
                   ChSheet:range("F" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("F" + STRING(xlinha)):SetValue("Valor COFINS").
                   ChSheet:range("G" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("G" + STRING(xlinha)):SetValue("Trib. PIS").
                   ChSheet:range("H" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("H" + STRING(xlinha)):SetValue("Trib. COFINS").  
                   ChSheet:range("I" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("I" + STRING(xlinha)):SetValue("CFOP").   
                   ChSheet:range("J" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("J" + STRING(xlinha)):SetValue("Natureza").
                   xlinha                                         = xlinha + 1 .
        ...
        END.
                    ...
                    ChSheet:Range("A" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.class-fisc)           .
                    ChSheet:Range("A" + STRING(xlinha)):NumberFormat = "####.##.##"                      .
                    ChSheet:Range("B" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.vl-tot-item)          .
                    ChSheet:Range("C" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.val-base-calc-pi)     .
                    ChSheet:Range("D" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.val-pis)              .
                    ChSheet:Range("E" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.val-base-calc-cofins) .
                    ChSheet:Range("F" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.val-cofins)           .
                    ChSheet:Range("G" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.tp-trib-pis)          .
                    ChSheet:Range("H" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.tp-trib-cofins)       .
                    ChSheet:Range("I" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.COD-CFOP)             .
                    ChSheet:Range("J" + STRING(xlinha)):SetValue(tt-ncm-pis-cofins.nat-operacao)         .
        ...
        IF LAST-OF(tt-ncm-pis-cofins.aba) THEN DO:
             ...
             ASSIGN ChSheet:Range("A1:F1"):Font:Bold = TRUE.
                    ChSheet:range("A2:F2"):Font:Bold = TRUE.
                    ChSheet:Range("A" + STRING(xlinha)):SetValue("Totais:").
                    ChSheet:range("A" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("B" + STRING(xlinha)):SetValue(dTot-vl-tot-item). 
                    ChSheet:range("B" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("C" + STRING(xlinha)):SetValue(dTot-val-base-calc-pis).
                    ChSheet:range("C" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("D" + STRING(xlinha)):SetValue(dTot-val-pis). 
                    ChSheet:range("D" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("E" + STRING(xlinha)):SetValue(dTot-val-base-calc-cofins). 
                    ChSheet:range("E" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("F" + STRING(xlinha)):SetValue(dTot-val-cofins).
                    ChSheet:range("F" + STRING(xlinha)):Font:Bold = TRUE .
        END.
    ...
    /* INICIO - IMPRESSÇO ABA Resumo */
    /* Seleciona Aba da Planilha */
    assign xsheet = 9.
    //ChSheet = ChBook:Sheets:ADD().
    //ChSheet:NAME = "ResumoXFilial".
    chbook:Worksheets(xsheet):Activate.
    chsheet = chbook:Worksheets(xsheet).
    ...
    /* INICIO - IMPRESSÇO ABA Resumo */ 
    FOR EACH tt-est-ncm-pis-cofins NO-lOCK
        BREAK BY tt-est-ncm-pis-cofins.cod-estabel
                by tt-est-ncm-pis-cofins.ABA:
    
        IF FIRST-OF(tt-est-ncm-pis-cofins.cod-estabel) THEN DO:
            ASSIGN dTot-vl-tot-item          = 0
                   dTot-val-base-calc-pis    = 0
                   dTot-val-pis              = 0
                   dTot-val-base-calc-cofins = 0
                   ...
                   ChSheet:Range("A1:G1"):Font:Bold = TRUE.
                   ChSheet:range("A2:G2"):Font:Bold = TRUE.
                   ChSheet:Range("A" + STRING(xlinha)):SetValue("Filial " + trim(tt-est-ncm-pis-cofins.cod-estabel) + ":").
                   ChSheet:Range("B" + STRING(xlinha)):SetValue("Opera‡Æo")                                               .
                   //ChSheet:range("B" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("C" + STRING(xlinha)):SetValue("Valor Cont bil")                                         .
                   //ChSheet:range("C" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("D" + STRING(xlinha)):SetValue("Base PIS")                                               .
                   //ChSheet:range("D" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("E" + STRING(xlinha)):SetValue("Valor PIS")                                              .
                   //ChSheet:range("E" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("F" + STRING(xlinha)):SetValue("Base COFINS")                                            .
                   //ChSheet:range("F" + STRING(xlinha)):Font:Bold = TRUE.
                   ChSheet:Range("G" + STRING(xlinha)):SetValue("Valor COFINS")                                           .
                   //ChSheet:range("G" + STRING(xlinha)):Font:Bold = TRUE .
                   xlinha = xlinha + 1.
        end.

        if first-of(tt-est-ncm-pis-cofins.aba) THEN DO:
            assign  vl-BasePIS        = 0
                    vl-PIS            = 0
                    vl-BaseCOFINS     = 0
                    vl-COFINS         = 0
        ...
        ASSIGN dTot-vl-tot-item          = dTot-vl-tot-item          + tt-est-ncm-pis-cofins.vl-tot-item            
               dTot-val-base-calc-pis    = dTot-val-base-calc-pis    + tt-est-ncm-pis-cofins.val-base-calc-pi 
               dTot-val-pis              = dTot-val-pis              + tt-est-ncm-pis-cofins.val-pis       
               dTot-val-base-calc-cofins = dTot-val-base-calc-cofins + tt-est-ncm-pis-cofins.val-base-calc-cofins 
               dTot-val-cofins           = dTot-val-cofins           + tt-est-ncm-pis-cofins.val-cofins .                  

        ASSIGN vl-tot-item               = vl-tot-item               + tt-est-ncm-pis-cofins.vl-tot-item            
               vl-basepis                = vl-basepis                + tt-est-ncm-pis-cofins.val-base-calc-pi 
               vl-pis                    = vl-pis                    + tt-est-ncm-pis-cofins.val-pis       
               vl-basecofins             = vl-basecofins             + tt-est-ncm-pis-cofins.val-base-calc-cofins 
               vl-cofins                 = vl-cofins                 + tt-est-ncm-pis-cofins.val-cofins .                  


        IF last-of(tt-est-ncm-pis-cofins.aba) THEN DO:
                   ChSheet:Range("A" + STRING(xlinha)):SetValue(tt-est-ncm-pis-cofins.cod-estabel).
                   ChSheet:Range("B" + STRING(xlinha)):SetValue(tt-est-ncm-pis-cofins.aba)        .
                   ChSheet:Range("C" + STRING(xlinha)):SetValue(vl-tot-item)                      .
                   ChSheet:Range("D" + STRING(xlinha)):SetValue(vl-basepis)                       .
                   ChSheet:Range("E" + STRING(xlinha)):SetValue(vl-pis)                           .
                   ChSheet:Range("F" + STRING(xlinha)):SetValue(vl-basecofins)                    .
                   ChSheet:Range("G" + STRING(xlinha)):SetValue(vl-cofins)                        .
                   xlinha = xlinha + 1                                                            .
        end.

        IF LAST-OF(tt-est-ncm-pis-cofins.cod-estabel) THEN DO:
             ASSIGN ChSheet:Range("A1:G1"):Font:Bold = TRUE.
                    ChSheet:range("A2:G2"):Font:Bold = TRUE.
                    ChSheet:Range("A" + STRING(xlinha)):SetValue("Totais Filial " + trim(tt-est-ncm-pis-cofins.cod-estabel) + ":").
                    ChSheet:range("A" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("B" + STRING(xlinha)):SetValue("")                                                               .
                    ChSheet:range("B" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("C" + STRING(xlinha)):SetValue(dTot-vl-tot-item)                                                 .
                    ChSheet:range("C" + STRING(xlinha)):Font:Bold = TRUE.                                                        
                    ChSheet:Range("D" + STRING(xlinha)):SetValue(dTot-val-base-calc-pis)                                           .
                    ChSheet:range("D" + STRING(xlinha)):Font:Bold = TRUE.                                                        
                    ChSheet:Range("E" + STRING(xlinha)):SetValue(dTot-val-pis)                                                     .
                    ChSheet:range("E" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("F" + STRING(xlinha)):SetValue(dTot-val-base-calc-cofins)                                        .
                    ChSheet:range("F" + STRING(xlinha)):Font:Bold = TRUE.
                    ChSheet:Range("G" + STRING(xlinha)):SetValue(dTot-val-cofins)                                                  .
                    ChSheet:range("G" + STRING(xlinha)):Font:Bold = TRUE .
                    xlinha = xlinha + 1                                                                                            .
        END.
    END.
    ...
    for EACH doc-fiscal FIELDS (ind-sit-doc cod-estabel cod-emitente nat-operacao serie nr-doc-fis dt-docto tipo-nat cod-cfop esp-docto)
       ...
       where doc-fiscal.dt-docto  >= tt-param.data-ini
        ...
        for each it-doc-fisc fields (vl-tot-item nat-operacao it-codigo class-fiscal
            ...
            FOR EACH natur-oper FIELDS (nat-operacao tipo-compra especie-doc char-1)
                NO-LOCK where 
             ...
             IF doc-fiscal.esp-docto = "NFS" THEN DO:
                 ...
                 if tt-param.l-reducaoz and 
                    estabelec.estado <> 'PR' THEN DO:
                     FOR EACH natur-oper FIELDS (nat-operacao tipo-compra especie-doc char-1 cod-model-nf-eletro) no-lock
                         where natur-oper.nat-operacao = it-doc-fisc.nat-operacao
...
PROCEDURE gravaDados:
    ...
    FIND FIRST tt-est-ncm-pis-cofins
             WHERE tt-est-ncm-pis-cofins.cod-estabel     = doc-fiscal.cod-estabel
               AND tt-est-ncm-pis-cofins.aba             = aba
               AND tt-est-ncm-pis-cofins.class-fiscal    = it-doc-fisc.class-fiscal
               AND tt-est-ncm-pis-cofins.tp-trib-pis     = {ininc/i11in172.i 04 TribPIS /*it-doc-fisc.cd-trib-pis*/ } 
               AND tt-est-ncm-pis-cofins.tp-trib-cofins  = {ininc/i11in172.i 04 TribCOFINS /*it-doc-fisc.cd-trib-cofins*/ } 
               AND tt-est-ncm-pis-cofins.nat-operacao    = it-doc-fisc.nat-operacao   
               AND tt-est-ncm-pis-cofins.cod-cfop        = doc-fiscal.cod-cfop NO-ERROR.

        IF NOT AVAIL tt-est-ncm-pis-cofins THEN DO:            
            CREATE tt-est-ncm-pis-cofins.
            ASSIGN tt-est-ncm-pis-cofins.aba                   = aba
                   tt-est-ncm-pis-cofins.class-fiscal          = it-doc-fisc.class-fiscal
                   tt-est-ncm-pis-cofins.tp-trib-pis           = {ininc/i11in172.i 04 TribPIS}
                   tt-est-ncm-pis-cofins.tp-trib-cofins        = {ininc/i11in172.i 04 TribCOFINS}
                   tt-est-ncm-pis-cofins.nat-operacao          = it-doc-fisc.nat-operacao 
                   tt-est-ncm-pis-cofins.cod-cfop              = doc-fiscal.cod-cfop
                   tt-est-ncm-pis-cofins.cod-estabel           = doc-fiscal.cod-estabel
                   .        
        END.
        ASSIGN tt-est-ncm-pis-cofins.vl-tot-item           = tt-est-ncm-pis-cofins.vl-tot-item          +  it-doc-fisc.vl-tot-item
               tt-est-ncm-pis-cofins.val-base-calc-pis     = tt-est-ncm-pis-cofins.val-base-calc-pis    +  vl-BasePIS
               tt-est-ncm-pis-cofins.val-pis               = tt-est-ncm-pis-cofins.val-pis              +  vl-PIS
               tt-est-ncm-pis-cofins.val-base-calc-cofins  = tt-est-ncm-pis-cofins.val-base-calc-cofins +  vl-BaseCOFINS
               tt-est-ncm-pis-cofins.val-cofins            = tt-est-ncm-pis-cofins.val-cofins           +  vl-COFINS
               .        
