...
DEFINE FRAME f-pg-sel
     fi-cod-estabel AT ROW 2.17 COL 18.14 COLON-ALIGNED WIDGET-ID 40
     fi-serie AT ROW 3.25 COL 18 COLON-ALIGNED WIDGET-ID 60
     fi-nr-nota-fis AT ROW 4.33 COL 18 COLON-ALIGNED WIDGET-ID 62
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
ON END-ERROR OF w-relat /* Alterar CST PIS/Cofins */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Alterar CST PIS/Cofins */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-cod-estabel fi-serie fi-nr-nota-fis 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE fi-cod-estabel fi-serie fi-nr-nota-fis 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign 
           ...
           tt-param.nr-nota-fis         = input frame f-pg-sel fi-nr-nota-fis.
    ...
    {include/i-rprun.i intprg/int067rp.p} 
