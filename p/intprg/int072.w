...
/********************************************************************************
** Programa: int072 - Importaá∆o de Notas de Entrada do Toturial/Sysfarma
**
** Versao : 12 - 03/01/2017 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT072 2.12.01.AVB}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT072
...
dt-emis-nota-fim dt-emis-nota-ini nro-docto-fim nro-docto-ini serie-docto-fim serie-docto-ini dt-trans-ini dt-trans-fim
...
DEFINE VARIABLE dt-trans-fim AS DATE FORMAT "99/99/9999" 
     VIEW-AS FILL-IN 
     SIZE 11 BY .79.

DEFINE VARIABLE dt-trans-ini AS DATE FORMAT "99/99/9999" 
     LABEL "Dt Transaá∆o":R12 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .79.

DEFINE VARIABLE nro-docto-fim AS CHARACTER FORMAT "X(12)" INITIAL "999999999" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .79.

DEFINE VARIABLE nro-docto-ini AS CHARACTER FORMAT "X(12)" 
     LABEL "Documento":R11 
     VIEW-AS FILL-IN 
     SIZE 10 BY .79.
...
DEFINE FRAME fPage2
     ...
     dt-trans-ini AT ROW 3.5 COL 20 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" WIDGET-ID 48
     dt-trans-fim AT ROW 3.5 COL 49 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" NO-LABEL WIDGET-ID 46
     serie-docto-ini AT ROW 4.54 COL 24 COLON-ALIGNED WIDGET-ID 24
     serie-docto-fim AT ROW 4.54 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     nro-docto-ini AT ROW 5.54 COL 19 COLON-ALIGNED WIDGET-ID 22
     nro-docto-fim AT ROW 5.54 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     cod-emitente-ini AT ROW 6.54 COL 17 COLON-ALIGNED WIDGET-ID 20
     cod-emitente-fim AT ROW 6.54 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     ...
     IMAGE-7 AT ROW 4.54 COL 32 WIDGET-ID 26
     IMAGE-8 AT ROW 4.54 COL 47.29 WIDGET-ID 28
     IMAGE-9 AT ROW 5.54 COL 32 WIDGET-ID 32
     IMAGE-10 AT ROW 5.54 COL 47.29 WIDGET-ID 34
     IMAGE-11 AT ROW 6.54 COL 32 WIDGET-ID 40
     IMAGE-12 AT ROW 6.54 COL 47.29 WIDGET-ID 38
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int072rp.p}
