...
for each int_ds_docto_xml no-lock USE-INDEX idx_tipo_estab
    ...
    int_ds_docto_xml.tipo_nota <> 3 /* transferencia faz no int052 */ AND  /* 973 */   /*10001*/                                      /* 977 */                                         /* 10004*/                                      /* 10008 */
    (int_ds_docto_xml.CNPJ_dest = "79430682025540" OR int_ds_docto_xml.CNPJ_dest = "05912018000183" OR int_ds_docto_xml.CNPJ_dest = "79430682057400" OR int_ds_docto_xml.CNPJ_dest = "05912018000426" OR int_ds_docto_xml.CNPJ_dest = "05912018000850"),
    last int_ds_docto_wms no-lock use-index documento where 
    ...
    int_ds_docto_wms.datamovimentacao_d >= tt-param.dt-trans-ini AND
    int_ds_docto_wms.datamovimentacao_d <= tt-param.dt-trans-fim and
    ...
    if int_ds_docto_wms.situacao <> 40 /* movimentada PRS */ and
       int_ds_docto_wms.situacao <> 3 /* movimentada PRS INT002 */ then do:
        run pi-gera-log (input "Fase da Nota fiscal nÆo permite integraÆo com RE1001: " + string(int_ds_docto_xml.nNF) + " Srie: " + string(int_ds_docto_xml.serie) + " Fornec: " + string(int_ds_docto_xml.cod_emitente),
                         input 1).
    end.
    ...
    for first ems2mult.emitente no-lock where 
        ...
        FIRST ems2mult.dist-emitente no-lock of emitente where dist-emitente.idi-sit-fornec = 1: end.
    ...
    for first int_ds_docto_xml_dup no-lock of bint_ds_docto_xml where
        ...
        if not avail impto_vincul_fornec then do:
            run pi-gera-log (input "Imposto nÆo vinculado ao fornecedor. Forn: " + string(int_ds_docto_xml.cod_emitente) + " Imposto: 9999 - SubstituiÆo Tribut ria " + " Tipo Opcional. Vide Fornecedor Financeiro",
                             input 1).
            empty temp-table tt-movto.
            next.
        end.
    ...
    */
    ...
    DO:
       ...
       FIND FIRST b_int_ds_docto_xml NO-LOCK
            ...
            AND    b_int_ds_docto_xml.chnfe      = int_ds_docto_xml.chave-ref-oper-triangular NO-ERROR. 
                ...
                FIND FIRST natur-oper NO-LOCK
                 ...
                 DO:
                        ...
                        FIND LAST bint_ds_docto_wms EXCLUSIVE-LOCK
                             WHERE bint_ds_docto_wms.doc_numero_n = STRING(b_int_ds_docto_xml.nNF)
                             AND   bint_ds_docto_wms.doc_serie_s  = b_int_ds_docto_xml.serie
                             AND   bint_ds_docto_wms.doc_origem_n = b_int_ds_docto_xml.cod_emitente
                             AND   bint_Ds_docto_wms.situacao     = 40 NO-ERROR.

                        IF NOT AVAIL bint_ds_docto_wms  THEN DO:


                            CREATE bint_ds_docto_wms.
                            ASSIGN bint_ds_docto_wms.doc_numero_n        = b_int_ds_docto_xml.nNF
                                   bint_ds_docto_wms.doc_serie_s         = b_int_Ds_docto_xml.serie
                                   bint_ds_docto_wms.doc_origem_n        = b_int_ds_docto_xml.cod_emitente
                                   bint_ds_docto_wms.cnpj_cpf            = b_int_ds_docto_xml.CNPJ
                                   bint_ds_docto_wms.tipo_fornecedor     = "2"
                                   bint_ds_docto_wms.situacao            = 40
                                   bint_ds_docto_wms.datamovimentacao_d  = TODAY
                                   bint_ds_docto_wms.horamovimentacao_s  = string(DATETIME(TODAY, TIME))
                                   bint_ds_docto_wms.ID_SEQUENCIAL       = NEXT-VALUE (seq-int-ds-docto-wms)
                                   bint_ds_docto_wms.ENVIO_STATUS        = 8
                                   bint_ds_docto_wms.ENVIO_DATA_HORA     = TODAY
                                   bint_ds_docto_wms.ENVIO_ERRO          = ""
                                   bint_ds_docto_wms.retorno_validacao   = ""
                                   bint_ds_docto_wms.tipo_nota           = 1.
    ...
    for each int_ds_it_docto_xml no-lock where
        ...
        assign tt-movto.CNPJ_dest           = int_ds_docto_xml.CNPJ_dest
               ...
               tt-movto.vbcstret            = int_ds_it_docto_xml.vbcstret     
               tt-movto.vicmsstret          = int_ds_it_docto_xml.vicmsstret
               tt-movto.cst_icms            = int_ds_it_docto_xml.cst_icms 
               tt-movto.vICMSSubs           = int_ds_it_docto_xml.vICMSSubs
               tt-movto.picmsst             = int_ds_it_docto_xml.picmsst.  
        ...
        if not avail item then do:
            run pi-gera-log (input "Item nÆo cadastrado: " + int_ds_it_docto_xml.it_codigo,
                             input 1).
            next.
        end.
        ...
        */
        ...
        if not avail item-estab and not avail item-uni-estab then do:
           run pi-gera-log (input "Item nÆo cadastrado no estabelecimento. Item: " + string(int_ds_it_docto_xml.it_codigo) + " Estab.: " + tt-movto.cod-estabel,
                            input 1).
           next.
        end.
        i-cfop = int_ds_it_docto_xml.cfop.
        if i-cfop = ? then do:
            run pi-gera-log (input "CFOP do Item nÆo informada. Item: " + string(int_ds_it_docto_xml.it_codigo),
                             input 1).
            next.
        end.
        ...
        */
        ...
        assign tt-movto.it-codigo       = string(int_ds_it_docto_xml.it_codigo)
               ...
               tt-movto.dat-fabricc-lote = int_ds_it_docto_xml.dFab.                //gui
        ...
        IF v_cdn_empres_usuar =  "10" THEN
        DO:
            ASSIGN tt-movto.cod-depos       = "REC". // FIXO REC para depois vir dep¢sito da procfit via WMS
        END.
        ...
        */
        ...
        //recalcular o pis cofins merco
        IF v_cod_empres_usuar = "10" THEN
        DO:
            ASSIGN 
               tt-movto.aliquota-pis    = int_ds_it_docto_xml.ppis   
               tt-movto.base-pis        = int_ds_it_docto_xml.vbc_pis
               tt-movto.valor-pis       = int_ds_it_docto_xml.vpis   .
        
            ASSIGN 
                   tt-movto.aliquota-cofins = int_ds_it_docto_xml.pcofins    
                   tt-movto.base-cofins     = int_ds_it_docto_xml.vbc_cofins 
                   tt-movto.valor-cofins    = int_ds_it_docto_xml.vcofins    .
...
procedure PiGeraMovimento:
    ...
    for each tt-movto
        ...
        assign tt-item-doc-est-nova.base-pis           = tt-movto.base-pis          
               ...
               tt-item-doc-est-nova.dat-fabricc-lote   = tt-movto.dat-fabricc-lote.
       ...
       END.
        ...
        IF v_cdn_empres_usuar =  "10" THEN
        DO:
            ASSIGN tt-item-doc-est-nova.cod-depos       = "REC". // FIXO REC para depois vir dep¢sito da procfit via WMS
        END.              
            ...
            for first docum-est no-lock of tt-docum-est-nova:
                    ...
                    for each int_ds_it_docto_xml NO-LOCK 
                        ...
                        IF AVAIL btt-movto THEN DO:
                            ...
                            DO:                     //gui
                                    ...
                                    ASSIGN 
                                       btt-movto.aliquota-pis    = int_ds_it_docto_xml.ppis   
                                       btt-movto.base-pis        = int_ds_it_docto_xml.vbc_pis
                                       btt-movto.valor-pis       = int_ds_it_docto_xml.vpis   .
                                
                                    ASSIGN 
                                           btt-movto.aliquota-cofins = int_ds_it_docto_xml.pcofins    
                                           btt-movto.base-cofins     = int_ds_it_docto_xml.vbc_cofins 
                                           btt-movto.valor-cofins    = int_ds_it_docto_xml.vcofins    .   
                            
                                    
                                ASSIGN item-doc-est.base-pis                    = btt-movto.base-pis          
                                       item-doc-est.valor-pis                   = btt-movto.valor-pis              
                                       item-doc-est.val-base-calc-cofins        = btt-movto.base-cofins       
                                       item-doc-est.val-cofins                  = btt-movto.valor-cofins 
                                       item-doc-est.valor-icm[1]                = int_ds_it_docto_xml.vicms.
                ...
                DO:
                    ...
                    FOR EACH tt-item-doc-est-nova:
                        ...
                        FIND FIRST rat-lote 
                            WHERE rat-lote.serie-docto  = tt-item-doc-est-nova.serie-docto
                              AND rat-lote.nro-docto    = tt-item-doc-est-nova.nro-docto
                              AND rat-lote.cod-emitente = tt-item-doc-est-nova.cod-emitente
                              AND rat-lote.it-codigo    = tt-item-doc-est-nova.it-codigo NO-ERROR.


                        IF AVAIL rat-lote THEN
                        DO:

                           ASSIGN  rat-lote.dat-fabricc-lote        = tt-item-doc-est-nova.dat-fabricc-lote.
...
procedure pi-gera-log:
    ...
    if avail tt-movto then do: 
        ...
        //Comentado ap�s update TOTVS 25/01/2026
