...
*******************************************************************************/
{include/i-prgvrs.i INT081 1.00.00.001KML}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i INT081 MFT}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT081
...
&GLOBAL-DEFINE page2Fields    fnFornecedorIni fnFornecedorFim
...
DEFINE VARIABLE fnFornecedorFim AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE fnFornecedorIni AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 0 
     LABEL "Fornecedor" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     fnFornecedorIni AT ROW 1.5 COL 12.43
     fnFornecedorFim AT ROW 1.5 COL 54.14 NO-LABEL
...
/* SETTINGS FOR FRAME fPage1
   NOT-VISIBLE                                                          */
ASSIGN 
       edLayout:HIDDEN IN FRAME fPage1           = TRUE
       edLayout:RETURN-INSERTED IN FRAME fPage1  = TRUE
       edLayout:READ-ONLY IN FRAME fPage1        = TRUE.

/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN fnFornecedorFim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN fnFornecedorIni IN FRAME fPage2
   ALIGN-L                                                              */
...
ASSIGN 
       brDigita:HIDDEN  IN FRAME fPage5                = TRUE.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.cod-fornec-ini  = INPUT FRAME fPage2 fnFornecedorIni
           tt-param.cod-fornec-fim  = INPUT FRAME fPage2 fnFornecedorFim
           &endif
           .
    ...
    {report/rprun.i intprg/int081rp.p}
