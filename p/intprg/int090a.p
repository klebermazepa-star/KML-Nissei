...
{include/i-prgvrs.i "INT090A" 2.00.00.000}
...
PROCEDURE atualiza-UF:
    ...
    FOR EACH tt-processo USE-INDEX est-trib WHERE
             tt-processo.cod-estado-orig = "" query-tuning(no-lookahead):
...
PROCEDURE cria-tt-processo:
    ...
    FOR FIRST ITEM FIELDS( it-codigo fm-codigo ge-codigo class-fiscal codigo-orig desc-item aliquota-ipi char-2 CD-TRIB-ICM cod-obsoleto )   
        WHERE ITEM.it-codigo = b-item-trigger.it-codigo:
        ...
        for each item-uf  NO-LOCK where 
                 ...
                 ITEM-UF.ESTADO          <> ""                          AND
                 ITEM-UF.COD-ESTADO-ORIG <> ""                          USE-INDEX ch-item-uf QUERY-TUNING(NO-LOOKAHEAD):
