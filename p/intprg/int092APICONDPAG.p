...
FUNCTION fnDeParaCodEsp RETURNS CHAR (INPUT p-cond-pagto AS CHAR):
    ...
    CASE p-cond-pagto:
        ...
        WHEN "picpay"   THEN RETURN "CC".
        WHEN "ifood"    THEN RETURN "CC".
...
FUNCTION fnDeParaCodPortador RETURN INT (INPUT p-cond-pagto AS CHAR):
    ...
    CASE p-cond-pagto:
        ...
        WHEN "cashback_especial" THEN RETURN 99201.
    END CASE.
