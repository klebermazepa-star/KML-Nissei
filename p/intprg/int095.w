...
{include/i-prgvrs.i INT095 1.00.00.000KML}
...
{utp/ut9000.i "INT095" "1.00.00.001KML"}

{include/i-rpini.i}

ASSIGN c-planilha      = SESSION :TEMP-DIRECTORY + 'int095.xlsx'.


    ASSIGN c-Objetivo = "O objetivo deste especifico e realizar a importaá∆o de um arquivo excel, inativando itens nas tabelas de preáo do CD1508 : ":U + CHR(10) + CHR(10) +
                        "A-tabela de preáo (preco-item.nr-tabpre - cd1508)":U + CHR(10) + 
                        "B-Item (preco-item.it-codigo - cd1508)":U + CHR(10) +  
                        "C-Preáo (preco-item.preco-venda - cd1508)":U + CHR(10) +  
                        "D-Data (preco-item.dt-inival - cd1508)":U + CHR(10) + 
                        "E-Inativar (preco-item.situacao - cd1508)":U + CHR(10) + CHR(10).
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY it-codigo-ini it-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE it-codigo-ini it-codigo-fim IMAGE-1 IMAGE-2 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
/*             END.                                                                                                               */
        ...
        {include/i-rprun.i intprg/int095rp.p}
