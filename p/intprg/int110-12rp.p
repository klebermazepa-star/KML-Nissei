/************************************************************************************
** Programa: INT110-12RP.P - Faturamento de Pedidos CD->Lojas do Tutorial/Sysfarma
**
** Geraá∆o Notas Fiscais SêRIE 12 
**
** Vers∆o: 12 - 08/11/2016 - Alessandro V Baccin
************************************************************************************/

/* include de controle de versao */
{include/i-prgvrs.i int110-12rp 2.12.01.AVB}
...
IF tt-param.arquivo = "" THEN 
    ASSIGN tt-param.arquivo = "int110-12.txt"
           tt-param.destino = 3
           tt-param.data-exec = TODAY
           tt-param.hora-exec = TIME.

ASSIGN tt-param.serie = "12"
       c-prog-log     = "int110-12rp.p".
...
DO TRANS:
   ...
   END.
   ASSIGN cst_mon_fat_serie.serie_12 = YES.
...
DO TRANS:
   ...
   IF AVAIL cst_mon_fat_serie THEN DO:
      ASSIGN cst_mon_fat_serie.serie_12 = NO.
   END.
   RELEASE cst_mon_fat_serie.
END.
