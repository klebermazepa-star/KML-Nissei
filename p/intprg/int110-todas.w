...
**
********************************************************************************/
{include/i-prgvrs.i INT110-TODAS 2.12.01.AVB}
current-language = current-language.
CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT110-TODAS
...
DEFINE VARIABLE c-serie AS CHARACTER FORMAT "X(5)":U INITIAL "10" 
     LABEL "S‚rie" 
     VIEW-AS FILL-IN 
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int110-todasrp.p}
