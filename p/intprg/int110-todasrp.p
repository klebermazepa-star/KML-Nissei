...
**
** Gera‡Æo Notas Fiscais SRIE 10 
**
** VersÆo: 12 - 08/11/2016 - Alessandro V Baccin
************************************************************************************/

/* include de controle de versao */
{include/i-prgvrs.i int110-10rp 2.12.01.AVB}
...
DO TRANS:
   ...
   END.
   ASSIGN cst_mon_fat_serie.serie_10 = YES
          cst_mon_fat_serie.serie_11 = YES
          cst_mon_fat_serie.serie_12 = YES 
          cst_mon_fat_serie.serie_13 = YES 
          cst_mon_fat_serie.serie_14 = YES.
...
procedure importa:
    ...
    for each int_ds_mod_pedido no-lock where int_ds_mod_pedido.cod_prog_dtsul = "int110",
        ...
        for EACH int_ds_pedido no-lock where 
              ...
              //AND INT_ds_pedido.ped_codigo_n = 2746744
    ...
    .MESSAGE "7"
        VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
            ...
            .MESSAGE "antes finaliza pedidos"
                VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
            run finaliza-pedido.
...
procedure pi-gera-itens-nota:
    ...
    for each tt-ped-item-imp no-lock of tt-ped-venda-imp:
        ...
        FIND first item-uni-estab no-lock where 
            ...
            item-uni-estab.cod-estabel = tt-ped-venda-imp.cod-estabel NO-ERROR.
...
PROCEDURE pi-quebra-item-st:
    ...
    IF l-RegimeEspecial = YES THEN DO:
        ...
        FOR EACH esp-item-entr-st NO-LOCK USE-INDEX id-ult-data
            ...
            AND   esp-item-entr-st.cod-estab     = c-cod-estabel  //KML DESCOMENTAR CASO DE PROBLEMA NA BUSCA DE NOTA
