...
//DEFINE VARIABLE c-direct AS CHARACTER   NO-UNDO.
//ASSIGN c-direct = SESSION:TEMP-DIRECTORY + "Log_ST.txt".

//OUTPUT TO VALUE (c-direct) APPEND.
...
if tt-param.dt-emis-nota-ini = ? then
    assign tt-param.dt-emis-nota-ini = today - 90
            ...
            for each bint_ds_nota_entrada where
                ...
                IF AVAIL b-int_dp_nota_entrada_ret THEN DO: 
                    ...
                    assign  b-int_dp_nota_entrada_ret.situacao     = 2
                            b-int_dp_nota_entrada_ret.envio_status = 8.
...
/*         end.                                                                              */
    ...
    // KML - Processar apenas 400 notas por ciclo
    ASSIGN i-cont-notas = i-cont-notas + 1.
    
    IF  i-cont-notas >= 400 THEN DO:
    ...
    for each int_ds_nota_entrada_produt exclusive-lock of int_ds_nota_entrada:
        ...
        */
        ...
        for each int_dp_nota_entrada_ret_it NO-LOCK of int_dp_nota_entrada_ret where
            ...
            for first docum-est no-lock of tt-docum-est-nova:
                ...
                */
                ...
                assign 
                    ...
                    tt-param-re1005.arquivo            = session:temp-directory + "int112-re1005.txt"
    ...
    if avail tt-movto then do: 
        ...
        IF AVAIL int_ds_nota_entrada THEN DO:
           IF int_ds_nota_entrada.situacao = 2 THEN DO:
                ...
                FIND FIRST b-int_dp_nota_entrada_ret 
                    WHERE b-int_dp_nota_entrada_ret.nen_cnpj_origem_s = int_ds_nota_entrada.nen_cnpj_origem_s 
                      AND b-int_dp_nota_entrada_ret.nen_notafiscal_n  = int_ds_nota_entrada.nen_notafiscal_n 
                      AND b-int_dp_nota_entrada_ret.nen_serie_s       = int_ds_nota_entrada.nen_serie_s
                   EXCLUSIVE-LOCK NO-ERROR.

               IF AVAIL b-int_dp_nota_entrada_ret THEN DO:                                         
                   ASSIGN b-int_dp_nota_entrada_ret.envio_status      = 8
                          b-int_dp_nota_entrada_ret.retorno_validacao = "".
               END.

           END.
           ELSE IF int_ds_nota_entrada.situacao = 1 THEN DO:
                ...
                FIND FIRST b-int_dp_nota_entrada_ret 
                   ...
                   EXCLUSIVE-LOCK NO-ERROR.
               IF AVAIL b-int_dp_nota_entrada_ret THEN DO:                                         
                   ASSIGN b-int_dp_nota_entrada_ret.envio_status      = 9
                          b-int_dp_nota_entrada_ret.retorno_validacao = substring(c-informacao,1,500).
               END.
