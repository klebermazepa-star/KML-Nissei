...
*******************************************************************************/
{include/i-prgvrs.i INT115B 2.12.01.AVB}
...
DEFINE VARIABLE h_int115b-query AS HANDLE NO-UNDO.
DEFINE VARIABLE h_int115b-viewer AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 28.04 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 28.04 COL 13.57 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 28.04 COL 24.14 HELP
          "Cancela"
     bt-ajuda AT ROW 28.04 COL 81.72
     rt-button AT ROW 27.88 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 92.14 BY 28.63 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Tipo Pedido Natureza"
         HEIGHT             = 28.71
         WIDTH              = 92.43
         MAX-HEIGHT         = 29.96
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Tipo Pedido Natureza */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Tipo Pedido Natureza */
DO:
...
DO:
{include/okfil.i h_int115b-viewer}
END.
...
DO:
{include/salvafil.i h_int115b-viewer}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/int115b-viewer.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_int115b-viewer ).
       RUN set-position IN h_int115b-viewer ( 1.04 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 20.17 , 92.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/int115b-query.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_int115b-query ).
       RUN set-position IN h_int115b-query ( 27.33 , 71.00 ) NO-ERROR.
       /* Size in UIB:  ( 2.00 , 7.00 ) */

       /* Links to SmartViewer h_int115b-viewer. */
       RUN add-link IN adm-broker-hdl ( h_int115b-query , 'Record':U , h_int115b-viewer ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_int115b-viewer ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_int115b-viewer ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "INT115B" "2.12.01.AVB"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_int115b-viewer(input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_int115b-query (input v-row-table).
