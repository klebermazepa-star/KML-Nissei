...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_tp_nat_origem NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_tp_nat_origem NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_tp_nat_origem
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_tp_nat_origem
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "custom.int_ds_tp_nat_origem"
     _Options          = "NO-LOCK"
