...
*******************************************************************************/
{include/i-prgvrs.i INT118 2.12.01.AVB}
...
DEFINE VARIABLE rs-classif AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Por NCM", 1,
"Por C¢digo Tributaá∆o", 2
     SIZE 23.86 BY 3.46 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     class-fiscal-ini AT ROW 1.25 COL 20 COLON-ALIGNED HELP
          "C¢digo da classificaá∆o fiscal" WIDGET-ID 170
     class-fiscal-fim AT ROW 1.25 COL 44 COLON-ALIGNED HELP
          "C¢digo da classificaá∆o fiscal" NO-LABEL WIDGET-ID 172
     IMAGE-42 AT ROW 1.25 COL 32 WIDGET-ID 166
     IMAGE-43 AT ROW 1.25 COL 43 WIDGET-ID 168
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
DEFINE FRAME f-pg-par
     cd-trib-icm AT ROW 3.5 COL 9 HELP
          "C¢digo de tributaá∆o do ICMS" NO-LABEL WIDGET-ID 174
     "Tributaá∆o ICMS" VIEW-AS TEXT
          SIZE 13 BY .54 AT ROW 2.5 COL 9 WIDGET-ID 182
     RECT-2 AT ROW 2.75 COL 6 WIDGET-ID 180
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
ON END-ERROR OF w-relat /* Relat¢rio Tipo Pedido */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio Tipo Pedido */
DO:
...
{utp/ut9000.i "INT118" "2.12.01.AVB"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY class-fiscal-ini class-fiscal-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-42 IMAGE-43 class-fiscal-ini class-fiscal-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    /*:T Coloque aqui a/l¢gica de gravaá∆o dos demais campos que devem ser passados
     ...
     assign  tt-param.cd-trib-icm      = cd-trib-icm:input-value in frame f-pg-par
             tt-param.class-fiscal-ini = class-fiscal-ini:screen-value in frame f-pg-sel
             tt-param.class-fiscal-fim = class-fiscal-fim:screen-value in frame f-pg-sel.
    ...
    {include/i-rprun.i intprg/int118rp.p}
