...
DO:
FIND int_ds_mod_pedido NO-LOCK
    WHERE int_ds_mod_pedido.cod_mod_pedido EQ INPUT FRAME {&FRAME-NAME} c_cod-mod-pedido NO-ERROR.

IF NOT AVAILABLE int_ds_mod_pedido THEN DO:
    {utp/ut-table.i emsesp int_ds_mod_pedido 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int_ds_mod_pedido).
END.
