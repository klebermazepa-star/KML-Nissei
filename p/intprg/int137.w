...
/********************************************************************************
** Programa: int137 - EmissÆo de notas fiscais RETIRADA LJ->CD de pedidos PRS
**
** Versao : 12 - 10/09/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT137 2.12.01.AVB}
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT137
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/INT137rp.p}
