...
/********************************************************************************
** Programa: int142 - Importaá∆o de Notas de Transferencia do Procfit
**
** Versao : 12 - 09/03/2018 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT142-transacao 2.12.01.AVB}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT142-transacao
...
DEFINE FRAME fPage2
     ...
     dt-transacao-ini AT ROW 3.5 COL 20 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" WIDGET-ID 48
     dt-transacao-fim AT ROW 3.5 COL 49 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" NO-LABEL WIDGET-ID 46
     serie-docto-ini AT ROW 4.5 COL 24 COLON-ALIGNED WIDGET-ID 24
     serie-docto-fim AT ROW 4.5 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     nro-docto-ini AT ROW 5.5 COL 19 COLON-ALIGNED WIDGET-ID 22
     nro-docto-fim AT ROW 5.5 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     cod-emitente-ini AT ROW 6.5 COL 17 COLON-ALIGNED WIDGET-ID 20
     cod-emitente-fim AT ROW 6.5 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     ...
     IMAGE-7 AT ROW 4.5 COL 32 WIDGET-ID 26
     IMAGE-8 AT ROW 4.5 COL 47.29 WIDGET-ID 28
     IMAGE-9 AT ROW 5.5 COL 32 WIDGET-ID 32
     IMAGE-10 AT ROW 5.5 COL 47.29 WIDGET-ID 34
     IMAGE-11 AT ROW 6.5 COL 32 WIDGET-ID 40
     IMAGE-12 AT ROW 6.5 COL 47.29 WIDGET-ID 38
     IMAGE-13 AT ROW 3.5 COL 32 WIDGET-ID 50
     IMAGE-14 AT ROW 3.5 COL 47.29 WIDGET-ID 52
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int142rp-transacao.p}
