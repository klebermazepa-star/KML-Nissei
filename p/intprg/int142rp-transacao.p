...
for each int_ds_nota_entrada no-lock where
    ...
    int_ds_nota_entrada.nen_datamovimentacao_d >= tt-param.dt-transacao-ini AND
    int_ds_nota_entrada.nen_datamovimentacao_d <= tt-param.dt-transacao-fim AND
  ...
  //  IF i-volume-notas >= 200 THEN LEAVE.
