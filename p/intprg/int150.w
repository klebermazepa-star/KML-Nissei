...
{include/i-prgvrs.i INT150 9.99.99.999}
...
DEFINE FRAME f-pg-sel
     ...
     c-serie-ini AT ROW 3.67 COL 24 COLON-ALIGNED WIDGET-ID 76
     c-serie-fim AT ROW 3.67 COL 41 COLON-ALIGNED NO-LABEL WIDGET-ID 74
     c-data-ini AT ROW 4.58 COL 22 COLON-ALIGNED WIDGET-ID 10
     c-data-fim AT ROW 4.58 COL 41 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     IMAGE-5 AT ROW 4.58 COL 33.72 WIDGET-ID 14
     IMAGE-6 AT ROW 4.58 COL 39.86 WIDGET-ID 16
     IMAGE-11 AT ROW 2.75 COL 33.72 WIDGET-ID 72
     IMAGE-12 AT ROW 2.75 COL 39.86 WIDGET-ID 70
     IMAGE-13 AT ROW 3.67 COL 33.72 WIDGET-ID 78
     IMAGE-14 AT ROW 3.67 COL 39.86 WIDGET-ID 80
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.88
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Exclus∆o - Contingància do LF0203"
         HEIGHT             = 15
         WIDTH              = 81
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Exclus∆o - Contingància do LF0203 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Exclus∆o - Contingància do LF0203 */
DO:
...
{utp/ut9000.i "INT150" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-estab-fim c-serie-ini c-serie-fim c-data-ini c-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-5 IMAGE-6 IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 c-estab-ini 
         c-estab-fim c-serie-ini c-serie-fim c-data-ini c-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i intprg/int150rp.p}
