...
*******************************************************************************/
{include/i-prgvrs.i INT155 1.00.00.001KML}
...
DEFINE VARIABLE it-codigo-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Atualiza‡Æo pre‡o m‚dio - Procfit"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Rel. de IPI das Notas Fiscais de Consumidor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Rel. de IPI das Notas Fiscais de Consumidor */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i intprg/int155rp.p} 
