...
DEFINE VARIABLE it-codigo-fim AS INTEGER FORMAT ">>>>>>>9":U INITIAL 9999999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE it-codigo-ini AS INTEGER FORMAT ">>>>>>>9":U INITIAL 0 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     it-codigo-ini AT ROW 2.71 COL 17.14 COLON-ALIGNED WIDGET-ID 40
     it-codigo-fim AT ROW 2.75 COL 43.29 COLON-ALIGNED NO-LABEL WIDGET-ID 54
     cod-estabel-ini AT ROW 3.88 COL 17.14 COLON-ALIGNED WIDGET-ID 48
     cod-estabel-fim AT ROW 3.88 COL 43.29 COLON-ALIGNED NO-LABEL WIDGET-ID 46
     IMAGE-1 AT ROW 2.71 COL 34.43 WIDGET-ID 42
     IMAGE-2 AT ROW 2.71 COL 42.14 WIDGET-ID 44
     IMAGE-11 AT ROW 3.88 COL 34.43 WIDGET-ID 50
     IMAGE-12 AT ROW 3.88 COL 42.14 WIDGET-ID 52
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio pre‡o m‚dio - Barramento Procfit"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Relat¢rio pre‡o m‚dio - Barramento Procfit */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio pre‡o m‚dio - Barramento Procfit */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY it-codigo-ini it-codigo-fim cod-estabel-ini cod-estabel-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-11 IMAGE-12 it-codigo-ini it-codigo-fim 
         cod-estabel-ini cod-estabel-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i intprg/int156rp.p} 
