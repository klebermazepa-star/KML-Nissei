...
*******************************************************************************/
{include/i-prgvrs.i INT157 1.00.00.001KML}
...
DEFINE VARIABLE fi-tp-transf AS INTEGER 
     VIEW-AS RADIO-SET HORIZONTAL
     RADIO-BUTTONS 
          "Transferˆncias Lojas", 1,
"Transferˆncias CD", 2
     SIZE 37 BY 1.25 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-tp-transf AT ROW 2 COL 21.86 NO-LABEL WIDGET-ID 56
     fi-dt-emissao-ini AT ROW 4.42 COL 18.14 COLON-ALIGNED WIDGET-ID 40
     fi-dt-emissao-fim AT ROW 4.46 COL 44.29 COLON-ALIGNED NO-LABEL WIDGET-ID 54
     IMAGE-1 AT ROW 4.42 COL 35.43 WIDGET-ID 42
     IMAGE-2 AT ROW 4.42 COL 43.14 WIDGET-ID 44
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio de entradas de transferˆncia"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Relat¢rio de entradas de transferˆncia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio de entradas de transferˆncia */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-tp-transf fi-dt-emissao-ini fi-dt-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 fi-tp-transf fi-dt-emissao-ini fi-dt-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign 
           tt-param.dt-emissao-ini      = input frame f-pg-sel fi-dt-emissao-ini
           tt-param.dt-emissao-fim      = input frame f-pg-sel fi-dt-emissao-fim
           tt-param.tp-transf           = input frame f-pg-sel fi-tp-transf.
    ...
    {include/i-rprun.i intprg/int157rp.p} 
