...
*******************************************************************************/
{include/i-prgvrs.i INT158 1.00.00.001KML}
...
DEFINE VARIABLE it-codigo-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE it-codigo-ini AS CHARACTER FORMAT "X(16)":U INITIAL "0" 
     LABEL "Item" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE tab-preco-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.

DEFINE VARIABLE tab-preco-ini AS CHARACTER FORMAT "X(16)":U 
...
DEFINE FRAME f-pg-sel
     tab-preco-ini AT ROW 3.17 COL 17.14 COLON-ALIGNED WIDGET-ID 48
     tab-preco-fim AT ROW 3.17 COL 43.29 COLON-ALIGNED NO-LABEL WIDGET-ID 46
     it-codigo-ini AT ROW 4.29 COL 17.14 COLON-ALIGNED WIDGET-ID 40
     it-codigo-fim AT ROW 4.33 COL 43.29 COLON-ALIGNED NO-LABEL WIDGET-ID 54
     IMAGE-1 AT ROW 4.29 COL 34.43 WIDGET-ID 42
     IMAGE-2 AT ROW 4.29 COL 42.14 WIDGET-ID 44
     IMAGE-11 AT ROW 3.17 COL 34.43 WIDGET-ID 50
     IMAGE-12 AT ROW 3.17 COL 42.14 WIDGET-ID 52
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio Tabela de Pre‡o"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Relat¢rio Tabela de Pre‡o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio Tabela de Pre‡o */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tab-preco-ini tab-preco-fim it-codigo-ini it-codigo-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-11 IMAGE-12 tab-preco-ini tab-preco-fim 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign 
           tt-param.tab-preco-ini       = input frame f-pg-sel tab-preco-ini 
           tt-param.tab-preco-fim       = input frame f-pg-sel tab-preco-fim
    ...
    {include/i-rprun.i intprg/int158rp.p} 
