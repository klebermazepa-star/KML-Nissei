...
/********************************************************************************
** Programa: int201 - Envio pre‡os dos itens p/ Procfit
**
** Versao : 12 - 24/02/2018 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT201 2.12.01.AVB}

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT201
&GLOBAL-DEFINE Version        2.12.01.AVB
&GLOBAL-DEFINE VersionLayout  1

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   Sele‡Æo, Gera‡Æo
...
&GLOBAL-DEFINE page0Widgets   btOk ~
                              btCancel ~
                              btHelp2
&GLOBAL-DEFINE page2Widgets   it-codigo-ini it-codigo-fim
...
DEFINE FRAME fPage2
     it-codigo-ini AT ROW 1.5 COL 12 COLON-ALIGNED HELP
          "C¢digo do Item"
     it-codigo-fim AT ROW 1.5 COL 49 COLON-ALIGNED HELP
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.it-codigo-ini    = input frame fPage2 it-codigo-ini
    ...
    {report/rprun.i intprg/int201rp.p}
