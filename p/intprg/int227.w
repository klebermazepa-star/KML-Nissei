...
/********************************************************************************
** Programa: INT227 - Importa‡Æo de Notas de Devolu‡Æo CUPOM do PROCFIT
**
** Versao : 12 - 19/03/2018 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT227 2.12.01.AVB}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT227
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int227rp.p}
