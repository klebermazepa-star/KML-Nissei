...
DEFINE TEMP-TABLE itens NO-UNDO
    ...
    FIELD valor_cstb            AS CHAR
    FIELD valor_csta            AS CHAR
    ...
    FIELD custo_transferencia   AS DEC.
...
DEFINE TEMP-TABLE condicao_pagamento NO-UNDO
   ...
   // FIELD status                AS LOG
    ...
    FIELD data_atualizacao      AS DATETIME
    FIELD condicao_pagamento_id AS INT.
    
DEFINE TEMP-TABLE produtos_fornecedores NO-UNDO
    FIELD ID                    AS INT
    FIELD origem                AS CHAR
    FIELD entidade_id           AS INT
    FIELD produto_id            AS INT
    FIELD sku_fornecedor        AS CHAR
    //FIELD DSTATUS               AS LOG
    .
    
DEFINE TEMP-TABLE tt-cidades NO-UNDO
    FIELD cidade                AS CHAR
    FIELD estado_id             AS CHAR
    FIELD cep                   AS CHAR
    FIELD pais_id               AS INT
    FIELD pais_descricao        AS CHAR
    FIELD ibge_id               AS INT
    FIELD origem                AS CHAR
    //FIELD STATUS                AS LOG
    FIELD data_criacao          AS DATETIME
    FIELD data_atualizacao      AS DATETIME
...
DEFINE TEMP-TABLE tt-representantes_comerciais NO-UNDO
    FIELD id                    AS INT64
    FIELD origem                AS CHAR
    FIELD cidade_id             AS INT64
    FIELD nome                  AS CHAR
    FIELD razao_social          AS CHAR
    FIELD endereco_logradouro   AS CHAR
    FIELD endereco_bairro       AS CHAR
    FIELD endereco_cep          AS CHAR
    FIELD telefone1             AS CHAR
    FIELD telefone2             AS CHAR
    FIELD email                 AS CHAR
    FIELD regiao_id             AS INT64
    FIELD regiao_nome           AS CHAR
    FIELD cgc                   AS CHAR
    FIELD ie                    AS CHAR
    //FIELD STATUS                AS LOG
    FIELD data_criacao          AS DATETIME
...
DEFINE TEMP-TABLE tt-fretes        NO-UNDO
    FIELD ID                    AS INT
    FIELD origem                AS CHAR
    FIELD modalidade_id         AS INT
    FIELD modalidade_nome       AS CHAR
    .
    
DEFINE TEMP-TABLE tt-produtos_precos NO-UNDO
    FIELD id                 AS INT
    FIELD origem             AS CHAR
    FIELD tabela_preco_id    AS INT
    FIELD tabela_preco_nome  AS CHAR
    FIELD preco              AS DEC
    FIELD data_criacao       AS DATETIME
    FIELD data_atualizacao   AS DATETIME
    //FIELD STATUS             AS LOG
...
DEFINE TEMP-TABLE tt-estoques NO-UNDO
    FIELD produto_id       AS INT
    FIELD local_id         AS INT
    FIELD local_desc       AS CHAR
    FIELD lote             AS CHAR
    FIELD saldo            AS DEC
    FIELD saldo_reserva    AS DEC
