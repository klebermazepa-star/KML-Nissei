...
/*         DO:                                                      */
            ...
            FOR FIRST ems2dis.cidade 
                ...
                IF AVAIL cidade THEN DO:
                    ...
                    FIND FIRST ems2mult.pais NO-LOCK
                        WHERE pais.nome-pais = cidade.pais NO-ERROR.
                    ...
                    IF AVAIL pais THEN DO:
                        ...
                        ASSIGN tt-cidades.cidade           = cidade.cidade
                               ...
                               tt-cidades.cep              = ""
                               tt-cidades.pais_id          = pais.cod-pais //INT(cidade.pais) // verificar pois ‚ char em campo inteiro 
