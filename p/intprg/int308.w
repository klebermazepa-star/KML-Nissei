...
/********************************************************************************
** Programa: int217 - Importa‡Æo notas fiscais de saida Loja Procfit
**
** Versao : 12 - 26/02/2018 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT308w 1.00.00.001KML}
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT308
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int308Estoque.p}
