...
*******************************************************************************/
{include/i-prgvrs.i INT309 2.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i INT309 INTPRG}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT309
...
&GLOBAL-DEFINE page2Fields    c-item-ini c-item-fim
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int309rp.p}
