...
*******************************************************************************/
{include/i-prgvrs.i INT310 2.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i INT310 INTPRG}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT310
...
&GLOBAL-DEFINE page2Fields    c-data-ini c-data-fim
...
DEFINE VARIABLE c-data-fim AS DATE FORMAT "99/99/9999":U INITIAL ? 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE c-data-ini AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Data" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     c-data-ini AT ROW 1.5 COL 16.86
     c-data-fim AT ROW 1.5 COL 54.14 NO-LABEL
...
/* SETTINGS FOR FRAME fPage2
                                                                        */
/* SETTINGS FOR FILL-IN c-data-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN c-data-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.data-ini = input frame fPage2 c-data-ini
           tt-param.data-fim = input frame fPage2 c-data-fim 
