...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i INT310W UTB}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT310W
&GLOBAL-DEFINE Version        1.00.00 - Integraá∆o de Fornecedores com o Datahub - INT310W
...
do on error undo, return error on stop  UNDO, return error:
    ...
    {report/rprun.i intprg\INT310rp.p}
...
do  on error undo, return error
    ...
    {report/imrun.i intprg\INT310rp.p}
