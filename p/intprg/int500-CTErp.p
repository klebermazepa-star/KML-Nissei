/******************************************************************************/
{include/i-prgvrs.i int500rp 1.00.00.001}  
{include/i_fnctrad.i}
/******************************************************************************
**
**       PROGRAMA: int500RP
...
IF tt-param.i-nro-docto-ini = "0" OR tt-param.i-nro-docto-ini = ""  THEN 
    ASSIGN tt-param.destino = 3
           tt-param.arquivo = "INT002brp.txt"
...
THEN DO:
   ...
   IF AVAIL int_ds_it_docto_xml THEN DO:
      ...
      FIND FIRST int_ds_docto_xml NO-LOCK WHERE
                 ...
                 int_ds_docto_xml.nNF          = int_ds_it_docto_xml.nNF          AND
...
function PrintChar returns longchar
    ...
    /* necess rio para que a fun‡Æo seja case-sensitive */
    ...
    assign c-string = replace(c-string,"…","a").
    assign c-string = replace(c-string,"Æ","a").
    assign c-string = replace(c-string,"ƒ","a").
    assign c-string = replace(c-string,"„","a").

    assign c-string = replace(c-string,"‚","e").
    assign c-string = replace(c-string,"Š","e").
    assign c-string = replace(c-string,"ˆ","e").
    assign c-string = replace(c-string,"‰","e").

    assign c-string = replace(c-string,"¡","i").
    assign c-string = replace(c-string,"","i").
    assign c-string = replace(c-string,"Œ","i").
    assign c-string = replace(c-string,"‹","i").
    ...
    assign c-string = replace(c-string,"“","o").
    assign c-string = replace(c-string,"”","o").
    assign c-string = replace(c-string,"ä","o").
    ...
    assign c-string = replace(c-string,"‡","c").
    ...
    assign c-string = replace(c-string,"·","A").
    assign c-string = replace(c-string,"Ç","A").
    assign c-string = replace(c-string,"¶","A").
    assign c-string = replace(c-string,"Ž","A").

    assign c-string = replace(c-string,"","E").
    assign c-string = replace(c-string,"Ô","E").
    assign c-string = replace(c-string,"Ò","E").
    assign c-string = replace(c-string,"Ó","E").

    assign c-string = replace(c-string,"Ö","I").
    assign c-string = replace(c-string,"Þ","I").
    assign c-string = replace(c-string,"×","I").
    assign c-string = replace(c-string,"Ø","I").

    assign c-string = replace(c-string,"à","O").
    assign c-string = replace(c-string,"ã","O").
    assign c-string = replace(c-string,"â","O").
    assign c-string = replace(c-string,"™","O").
    assign c-string = replace(c-string,"å","O").

    assign c-string = replace(c-string,"é","U").
    assign c-string = replace(c-string,"ë","U").
    assign c-string = replace(c-string,"ê","U").
    assign c-string = replace(c-string,"š","U").

    assign c-string = replace(c-string,"€","C").
    assign c-string = replace(c-string,"¥","N").
                                        
    assign c-string = replace(c-string,"í","Y").

    assign c-string = replace(c-string,CHR(13),"").
    assign c-string = replace(c-string,CHR(10),"").

    assign c-string = replace(c-string,"û","").
    assign c-string = replace(c-string,"­","").
    assign c-string = replace(c-string,"ý","2").
    assign c-string = replace(c-string,"ü","3").
    assign c-string = replace(c-string,"Ï","o").
    assign c-string = replace(c-string,"°","E").
    assign c-string = replace(c-string,"¬","1/4").
    assign c-string = replace(c-string,"«","1/2").
    assign c-string = replace(c-string,"ó","3/4").
    assign c-string = replace(c-string,"¾","Y").
    assign c-string = replace(c-string,"ž","x").
    assign c-string = replace(c-string,"ç","p").
    assign c-string = replace(c-string,"©","r").
    assign c-string = replace(c-string,"†","a").
    assign c-string = replace(c-string,"á","B").
    assign c-string = replace(c-string,"Ð","y").
    assign c-string = replace(c-string,"›","o").
    assign c-string = replace(c-string,"ô","").
    assign c-string = replace(c-string,"‘","ae").
    assign c-string = replace(c-string,"æ","u").
    assign c-string = replace(c-string,"¨","").
    assign c-string = replace(c-string,"º","").
    assign c-string = replace(c-string,"õ","").
    assign c-string = replace(c-string,"","A").
    assign c-string = replace(c-string,"©","").
    assign c-string = replace(c-string,"è","p").
    assign c-string = replace(c-string,"®","-").
    assign c-string = replace(c-string,"¯","-").
    assign c-string = replace(c-string,"ª","").
    assign c-string = replace(c-string,"ª","").
    assign c-string = replace(c-string,"ô","").
    assign c-string = replace(c-string,"","0").
    assign c-string = replace(c-string,"Ñ","D").
    assign c-string = replace(c-string,"á","B").
    assign c-string = replace(c-string,"’","").
    assign c-string = replace(c-string,"¸","").
    assign c-string = replace(c-string,"œ","").
    assign c-string = replace(c-string,"õ","").

    assign c-string = replace(c-string,"ö","").
    assign c-string = replace(c-string,"Ý","").
...
procedure pi-grava-nota:       
    ...
    FOR EACH tt-docto-xml NO-LOCK
        WHERE tt-docto-xml.tipo_estab    = 1 /* Destino CD */ 
          AND tt-docto-xml.dEmi         >= date(STRING(tt-param.dt-trans-ini,"99/99/9999")) 
          AND tt-docto-xml.dEmi         <= DATE(STRING(tt-param.dt-trans-fin,"99/99/9999")) 
          AND tt-docto-xml.NNF          >= tt-param.i-nro-docto-ini 
          AND tt-docto-xml.NNF          <= tt-param.i-nro-docto-fim 
          AND tt-docto-xml.cod_emitente >= tt-param.i-cod-emit-ini  
          AND tt-docto-xml.cod_emitente <= tt-param.i-cod-emit-fin 
          AND (tt-docto-xml.cod_estab     = "973" OR tt-docto-xml.cod_estab     = "977") //teste CTE
        ...
        FIND FIRST int_ds_docto_xml NO-LOCK  
            WHERE int_ds_docto_xml.tipo_nota = tt-docto-xml.tipo_nota  
              AND int_ds_docto_xml.CNPJ      = tt-docto-xml.CNPJ       
              AND int_ds_docto_xml.nNF       = tt-docto-xml.nNF   
              AND int_ds_docto_xml.serie     = tt-docto-xml.serie NO-ERROR.
        ...
        IF AVAIL int_ds_docto_xml THEN DO:
         ...
         /*   IF l-altera = NO THEN DO:
               ...
               FIND FIRST b-int_ds_docto_xml EXCLUSIVE-LOCK
                   WHERE ROWID(b-int_ds_docto_xml) = ROWID(int_ds_docto_xml) NO-ERROR.
        ...
        FOR EACH int_ds_doc_erro EXCLUSIVE-LOCK WHERE
                 ...
                 int_ds_doc_erro.nro_docto    = tt-docto-xml.NNF          AND 
                 int_ds_doc_erro.tipo_nota    = tt-docto-xml.tipo_nota    AND 
                 int_ds_doc_erro.sequencia    = 0:
            DELETE int_ds_doc_erro.
        END.
        RELEASE int_ds_doc_erro.
        ...
        IF l-altera = NO THEN DO:
          ...
          /* Prepara‡Æo para integra‡Æo com Procfit */
          ASSIGN int_ds_docto_xml.id_sequencial = NEXT-VALUE(seq-int-ds-docto-xml)
                 int_ds_docto_xml.envio_status  = 0
        ...
        // KML - coloca importa‡Æo do pedido - projeto PN014
        ASSIGN int_ds_docto_xml.num_pedido = i-num-pedido.

        FIND FIRST serie NO-LOCK
            WHERE serie.serie = tt-docto-xml.serie  NO-ERROR.
        ...
        FIND FIRST natur-oper NO-LOCK 
            WHERE natur-oper.nat-operacao = int_ds_docto_xml.nat_operacao NO-ERROR.
        ...
        FOR EACH emitente USE-INDEX cgc NO-LOCK 
            WHERE emitente.identific > 1 
              AND emitente.cgc       = tt-docto-xml.cnpj:
        ...
        IF AVAIL emitente THEN DO:
           IF AVAIL int_ds_docto_xml THEN DO:
                ...
                FIND FIRST b-tt-docto-xml EXCLUSIVE-LOCK
                    WHERE ROWID(b-tt-docto-xml) = ROWID(tt-docto-xml) NO-ERROR.
                IF AVAIL b-tt-docto-xml THEN DO:
                    ASSIGN tt-docto-xml.cod_emitente     = emitente.cod-emitente
                           tt-docto-xml.CNPJ             = emitente.cgc.
                END.
                RELEASE b-tt-docto-xml.
        ...
        ELSE DO:
           RUN pi-gera-erro(INPUT 3,    
                            INPUT "Estabelecimento nÆo cadastrado com o CNPJ " + STRING(tt-docto-xml.CNPJ_dest)).
        END. 
        ...
        /* KML - Projeto PN014 - Integra‡Æo duplicata XML */ 

        FOR EACH tt-xml-dup:   

  
            CREATE int_ds_docto_xml_dup.
            ASSIGN int_ds_docto_xml_dup.InfNFe          = tt-xml-dup.InfNFe         
                   int_ds_docto_xml_dup.Cobr            = tt-xml-dup.Cobr
                   int_ds_docto_xml_dup.nDup            = tt-xml-dup.nDup
                   int_ds_docto_xml_dup.dVenc           = ENTRY(3,string(tt-xml-dup.dVenc),"-") + "/" + ENTRY(2,string(tt-xml-dup.dVenc),"-")  + "/" + ENTRY(1,string(tt-xml-dup.dVenc),"-")
                   int_ds_docto_xml_dup.vDup            = tt-xml-dup.vDup
                   int_ds_docto_xml_dup.serie           = tt-xml-dup.serie
                   int_ds_docto_xml_dup.nNF             = tt-xml-dup.nNF
                   int_ds_docto_xml_dup.tipo_nota       = tt-xml-dup.tipo_nota
                   int_ds_docto_xml_dup.cod_emitente    = tt-xml-dup.cod_emitente
                   int_ds_docto_xml_dup.cnpj_cpf        = tt-xml-dup.cnpj_cpf .


        END.

        FOR EACH tt-it-docto-xml NO-LOCK
            WHERE tt-it-docto-xml.tipo_nota  = tt-docto-xml.tipo_nota AND
            ...
            FOR EACH int_ds_doc_erro EXCLUSIVE-LOCK WHERE
                     ...
                     int_ds_doc_erro.nro_docto    = tt-docto-xml.NNF          AND 
                     int_ds_doc_erro.tipo_nota    = tt-docto-xml.tipo_nota    AND 
                     int_ds_doc_erro.sequencia    = tt-it-docto-xml.sequencia:
              DELETE int_ds_doc_erro.
            END.
            RELEASE int_ds_doc_erro. 
            ...
            FIND FIRST int_ds_it_docto_xml EXCLUSIVE-LOCK WHERE
                       ...
                       int_ds_it_docto_xml.nNF         = tt-it-docto-xml.nNF       AND
            ...
            IF l-altera = NO THEN DO:   
                IF AVAIL emitente THEN 
                    ASSIGN tt-it-docto-xml.cod_emitente = emitente.cod-emitente. 
            ...
            ASSIGN int_ds_it_docto_xml.lote          = if tt-it-docto-xml.lote            = ?   then "" else  tt-it-docto-xml.lote
                   ...
                   int_ds_it_docto_xml.vICMSSubs        = tt-it-docto-xml.vICMSSubs.                                                   
                ...
                if l-valida AND tt-it-docto-xml.num_pedido <> ? then do:
                    ...
                    IF NOT AVAIL pedido-compr THEN DO:
                           RUN pi-gera-erro(INPUT 4,    
                                            INPUT "Pedido " + string(int_ds_it_docto_xml.num_pedido) + " NÆo cadastrado").   
                    END.
                end.
            END.

            FIND FIRST natur-oper NO-LOCK WHERE
                      natur-oper.nat-operacao = (tt-it-docto-xml.nat_operacao) NO-ERROR.

            IF NOT AVAIL natur-oper 
            THEN DO:
               RUN pi-gera-erro(INPUT 8,    
                                INPUT "Natureza de Opera‡Æo do item" + string(int_ds_it_docto_xml.nat_operacao) + " nÆo cadastrada!"). 
            END. 
            ...
            ELSE DO: 
                ...
                if not avail item-fornec then do:
                    ...
                    FIND first item-fornec-umd where
                              ...
                              item-fornec-umd.log-ativo NO-LOCK NO-ERROR.
            ...
            THEN DO:
                  ...
                  ELSE DO:
                     RUN pi-gera-erro(INPUT 7,    
                                      INPUT "Item NÆo cadastrado " + string(tt-it-docto-xml.it_codigo)). 
                  END.
            END.
            ELSE DO:
                  RUN pi-gera-erro(INPUT 5,    
                                   INPUT "Relacionamento item x fornecedor nÆo cadastrado. Item: " + string(tt-it-docto-xml.item_do_forn) + " Fornecedor: " + STRING(int_ds_it_docto_xml.cod_emitente)). 
            END.

            IF tt-docto-xml.tipo_docto = 5  /* Balan‡o */
            THEN DO:
            ...
            OR int_ds_it_docto_xml.lote = ? THEN DO:
               ...
               FIND FIRST rat-lote WHERE
                         ...
                         rat-lote.sequencia    = int_ds_it_docto_xml.sequencia    NO-ERROR.
               
               IF AVAIL rat-lote THEN DO:
                  FIND FIRST natur-oper WHERE
                            natur-oper.nat-operacao = rat-lote.nat-operacao NO-LOCK NO-ERROR.
        ...
        IF tt-docto-xml.tipo_docto = 5 /* Notas Balan‡o atualiza o estoque automatico */ OR
           CAN-FIND(FIRST estabelec NO-LOCK WHERE estabelec.cgc = emitente.cgc AND estabelec.ep-codigo = "1") /* retiradas de loja p/ CD */
        THEN DO:
                     
           CREATE int_ds_docto_wms.
           ASSIGN int_ds_docto_wms.doc_numero_n   = tt-docto-xml.nnf
    ...
    FOR EACH tt-docto-xml:
        ...
        LOG-MANAGER:WRITE-MESSAGE("KML NFE - antes envio int002g - eEmi: " + STRING(tt-docto-xml.dEmi)) NO-ERROR.
        LOG-MANAGER:WRITE-MESSAGE("KML NFE - antes envio int002g - nNF: " + STRING(tt-docto-xml.NNF)) NO-ERROR.
        LOG-MANAGER:WRITE-MESSAGE("KML NFE - antes envio int002g - emitente: " + STRING(tt-docto-xml.cod_emitente)) NO-ERROR.
        LOG-MANAGER:WRITE-MESSAGE("KML NFE - antes envio int002g - cod_estab: " + STRING(tt-docto-xml.cod_estab)) NO-ERROR.
        LOG-MANAGER:WRITE-MESSAGE("KML NFE - antes envio int002g - tipo_estab: " + STRING(tt-docto-xml.tipo_estab)) NO-ERROR.
        LOG-MANAGER:WRITE-MESSAGE("KML NFE - antes envio int002g - tipo_docto: " + STRING(tt-docto-xml.tipo_docto)) NO-ERROR.
    
    END.
       
    /* Integrar notas direto com o PRS gerando int_ds_nota_entrada */
    ...
    FOR EACH tt-docto-xml:
        ...
        MESSAGE "Entrou ap¢s int002g"
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
    
        FIND FIRST int_ds_nota_entrada 
             WHERE int_ds_nota_entrada.nen_notafiscal_n   = int(tt-docto-xml.NNF)
             AND   int_ds_nota_entrada.nen_serie_s        = tt-docto-xml.serie
             AND   int_ds_nota_entrada.nen_cnpj_origem_s  = tt-docto-xml.CNPJ NO-ERROR.
             
         IF AVAIL int_ds_nota_entrada  THEN
         DO:
         
            FIND FIRST ttVPrest NO-ERROR.
            
            IF AVAIL ttVPrest AND ttVPrest.vTPrest <> 0 THEN
            DO:
                MESSAGE "ttVPrest" SKIP
                        vTPrest
                    VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
                    
                ASSIGN int_ds_nota_entrada.nen_valortotalprodutos_n = ttVPrest.vTPrest.    
            ...
            ELSE DO:
                ...
                FIND FIRST ttComp NO-ERROR.

                IF AVAIL ttComp  THEN
                DO:
                
                    ASSIGN int_ds_nota_entrada.nen_valortotalprodutos_n = ttComp.vComp.
...
PROCEDURE pi-gera-erro:
     ...
     FIND FIRST int_ds_doc_erro NO-LOCK WHERE
                ...
                int_ds_doc_erro.nro_docto    = tt-docto-xml.nNF   AND 
                int_ds_doc_erro.tipo_nota    = tt-docto-xml.tipo_nota  AND
                int_ds_doc_erro.descricao    = p-desc-erro NO-ERROR.
...
PROCEDURE pi-notas-pepsico:
   ...
   FOR EACH int_ds_docto_xml NO-LOCK
       WHERE int_ds_docto_xml.tipo_docto = 4 
         AND int_ds_docto_xml.tipo_estab = 1 
         AND int_ds_docto_xml.chnfe      = ? :
        
         ASSIGN int_ds_docto_xml.num_pedido = 0.

         CREATE tt-docto-xml.
         BUFFER-COPY int_ds_docto_xml TO tt-docto-xml.
         ASSIGN tt-docto-xml.chnfe    = IF int_ds_docto_xml.chnfe    = ? then "" else int_ds_docto_xml.chnfe  
                tt-docto-xml.xnome    = IF int_ds_docto_xml.xnome    = ? then "" else int_ds_docto_xml.xnome
                tt-docto-xml.modFrete = IF int_ds_docto_xml.modFrete = ? then 0 else int_ds_docto_xml.modFrete
                tt-docto-xml.arquivo  = STRING(int_ds_docto_xml.nnf)
                tt-docto-xml.chnft    = int_ds_docto_xml.serie. /* Grava a s‚rie Original do PRS */     
         ...
         FOR EACH int_ds_it_docto_xml WHERE 
               ...
               FIND FIRST serie NO-LOCK WHERE
                         serie.serie = int_ds_it_docto_xml.serie NO-ERROR.

               IF NOT AVAIL serie THEN DO: 
                  ASSIGN int_ds_it_docto_xml.serie = string(int(int_ds_it_docto_xml.serie),"999").
               END.

               ASSIGN int_ds_it_docto_xml.qCom_forn    = int_ds_it_docto_xml.qCom
                      int_ds_it_docto_xml.uCom_forn    = int_ds_it_docto_xml.uCom
                      int_ds_it_docto_xml.num_pedido   = 0 
                      int_ds_it_docto_xml.numero_ordem = 0.

               CREATE tt-it-docto-xml.
               BUFFER-COPY int_ds_it_docto_xml TO tt-it-docto-xml.
              
               ASSIGN tt-it-docto-xml.arquivo       = STRING(int_ds_docto_xml.nnf)
                      tt-it-docto-xml.xprod         = IF int_ds_it_docto_xml.xprod           = ? then ""   else  int_ds_it_docto_xml.xprod
                      tt-it-docto-xml.uCom          = if int_ds_it_docto_xml.uCom            = ? then ""   else  int_ds_it_docto_xml.uCom           
                      tt-it-docto-xml.nat_operacao  = if int_ds_it_docto_xml.nat_operacao    = ? then ""   else  int_ds_it_docto_xml.nat_operacao
                      tt-it-docto-xml.qOrdem        = if int_ds_it_docto_xml.qOrdem          = ? then 0    else  int_ds_it_docto_xml.qOrdem        
                      tt-it-docto-xml.vtottrib      = if int_ds_it_docto_xml.vtottrib        = ? then 0    else  int_ds_it_docto_xml.vtottrib      
                      tt-it-docto-xml.vbc_icms      = if int_ds_it_docto_xml.vbc_icms        = ? then 0    else  int_ds_it_docto_xml.vbc_icms      
                      tt-it-docto-xml.picms         = if int_ds_it_docto_xml.picms           = ? then 0    else  int_ds_it_docto_xml.picms         
                      tt-it-docto-xml.pmvast        = if int_ds_it_docto_xml.pmvast          = ? then 0    else  int_ds_it_docto_xml.pmvast        
                      tt-it-docto-xml.vbcst         = if int_ds_it_docto_xml.vbcst           = ? then 0    else  int_ds_it_docto_xml.vbcst         
                      tt-it-docto-xml.picmsst       = if int_ds_it_docto_xml.picmsst         = ? then 0    else  int_ds_it_docto_xml.picmsst       
                      tt-it-docto-xml.vicmsst       = if int_ds_it_docto_xml.vicmsst         = ? then 0    else  int_ds_it_docto_xml.vicmsst       
                      tt-it-docto-xml.vbcstret      = if int_ds_it_docto_xml.vbcstret        = ? then 0    else  int_ds_it_docto_xml.vbcstret      
                      tt-it-docto-xml.vicmsstret    = if int_ds_it_docto_xml.vicmsstret      = ? then 0    else  int_ds_it_docto_xml.vicmsstret    
                      tt-it-docto-xml.ppis          = if int_ds_it_docto_xml.ppis            = ? then 0    else  int_ds_it_docto_xml.ppis          
                      tt-it-docto-xml.pipi          = if int_ds_it_docto_xml.pipi            = ? then 0    else  int_ds_it_docto_xml.pipi          
                      tt-it-docto-xml.pcofins       = if int_ds_it_docto_xml.pcofins         = ? then 0    else  int_ds_it_docto_xml.pcofins       
                      tt-it-docto-xml.orig_icms     = if int_ds_it_docto_xml.orig_icms       = ? then 0    else  int_ds_it_docto_xml.orig_icms     
                      tt-it-docto-xml.ncm           = if int_ds_it_docto_xml.ncm             = ? then 0    else  int_ds_it_docto_xml.ncm           
                      tt-it-docto-xml.item_do_forn  = if TRIM(int_ds_it_docto_xml.item_do_forn) = ? then ""   else  trim(int_ds_it_docto_xml.item_do_forn)
                      tt-it-docto-xml.uCom_forn     = if int_ds_it_docto_xml.uCom_forn       = ? then ""   else  int_ds_it_docto_xml.uCom_forn     
                      tt-it-docto-xml.qCom_forn     = if int_ds_it_docto_xml.qCom_forn       = ? then 0    else  int_ds_it_docto_xml.qCom_forn  
                      tt-it-docto-xml.narrativa     = if int_ds_it_docto_xml.narrativa       = "0" then "" else  int_ds_it_docto_xml.narrativa
                      tt-it-docto-xml.lote          = if int_ds_it_docto_xml.lote            = ? then ""   else  int_ds_it_docto_xml.lote.

         END. 

         FIND FIRST serie NO-LOCK WHERE
                   serie.serie = int_ds_docto_xml.serie NO-ERROR.
         ...
         IF NOT AVAIL serie THEN DO: 
             ...
             FIND FIRST b-int_ds_docto_xml EXCLUSIVE-LOCK
                 WHERE ROWID (b-int_ds_docto_xml) = ROWID(int_ds_docto_xml) NO-ERROR.
             IF AVAIL b-int_ds_docto_xml THEN
                ASSIGN b-int_ds_docto_xml.serie = string(int(int_ds_docto_xml.serie),"999").
             RELEASE b-int_ds_docto_xml.
             ASSIGN tt-docto-xml.serie     = int_ds_docto_xml.serie. 
         END.
         
   END. /* int_ds_docto_xml */

   /* gravar int_ds_docto_xml e int_ds_nota_entrada */
...
PROCEDURE pi-IntegracaoNDD:
    ...
    log-manager:write-message("KML - pi-IntegracaoNDD") no-error.

    IF VALID-HANDLE(h-acomp) THEN
       RUN pi-acompanhar IN h-acomp(INPUT "Baixando XML NDD...").

    /* Chamada WebServices NDD*/
    /*run intprg/int500a.p.*/ /* A chamada do WebService para buscar os XMLs na NDD foi agendado para rodar no RPW */

    FOR EACH NDD_ENTRYINTEGRATION USE-INDEX idx_status NO-LOCK  
        WHERE NDD_ENTRYINTEGRATION.kind            = 0 /* Envio */       
          AND NDD_ENTRYINTEGRATION.status_         = 0 /* campo status pendente */ 
          AND NDD_ENTRYINTEGRATION.documentnumber  <> ?
          AND NDD_ENTRYINTEGRATION.documentnumber  >= int(tt-param.i-nro-docto-ini)
          AND NDD_ENTRYINTEGRATION.documentnumber  <= int(tt-param.i-nro-docto-fim)
      //    AND NDD_ENTRYINTEGRATION.CNPJEMIT        = 73856593000166
        BY NDD_ENTRYINTEGRATION.ENTRYINTEGRATIONID DESC
        ON ERROR UNDO, NEXT:
        
        log-manager:write-message("KML - pi-IntegracaoNDD - dentro ndd_entryintegration - " +  string(NDD_ENTRYINTEGRATION.documentnumber) ) no-error.
        ...
        if can-find (first estabelec no-lock where estabelec.cgc = STRING(NDD_ENTRYINTEGRATION.CNPJEMIT) and (
                     estabelec.cod-estabel = "973" OR estabelec.cod-estabel = "977" )) then do transaction: //TESTE LOHAN KMLCTE
                   
            IF NDD_ENTRYINTEGRATION.CNPJEMIT <> NDD_ENTRYINTEGRATION.CNPJDEST /* Notas de Balan‡o tem o CNPJ iguais */ 
            THEN DO: 
                FOR FIRST b-NDD_ENTRYINTEGRATION EXCLUSIVE-LOCK 
                    WHERE ROWID(b-NDD_ENTRYINTEGRATION) = ROWID(NDD_ENTRYINTEGRATION):
                    ASSIGN b-NDD_ENTRYINTEGRATION.status_ = 3 NO-ERROR.   
                END.    
        ...
        log-manager:write-message("KML - pi-IntegracaoNDD 3") no-error.
        ...
        IF pXMLResult = "" OR
           pXMLResult = ?  THEN DO:
            FOR first b-NDD_ENTRYINTEGRATION EXCLUSIVE-LOCK
                WHERE rowid(b-NDD_ENTRYINTEGRATION) = rowid(NDD_ENTRYINTEGRATION):
                assign b-NDD_ENTRYINTEGRATION.status_ = 2 NO-ERROR. 
            END.
            RELEASE b-NDD_ENTRYINTEGRATION.
            NEXT.
        END.
        
        log-manager:write-message("KML - pi-IntegracaoNDD 4 ") no-error.
        ...
        log-manager:write-message("KML - pi-IntegracaoNDD 5 ") no-error.
        /* trata xml - gera tt-docto-xml */
        run pi-abre-xml(INPUT STRING(NDD_ENTRYINTEGRATION.ENTRYINTEGRATIONID),
                        INPUT c-xml).
                        
        log-manager:write-message("KML - pi-IntegracaoNDD 6 ") no-error.  
        
        MESSAGE STRING(c-doc) 
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
       ...
       DO WHILE SEARCH(c-xml) <> ?:
        ...
        MESSAGE "KD O NO RECORD? - 2"
                SKIP tt-docto-xml.tipo_estab
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
        ...
        MESSAGE "KD O NO RECORD? - 3"
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
        
        
        log-manager:write-message("KML - pi-IntegracaoNDD 7 ") no-error.
        ...
        MESSAGE "KD O NO RECORD? - 5"
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
        
        log-manager:write-message("KML - pi-IntegracaoNDD 7.5 " + string(AVAIL tt-docto-xml) ) no-error.
        IF AVAIL tt-docto-xml THEN
        DO:
            ...
            THEN do:
                ...
                log-manager:write-message("KML - pi-IntegracaoNDD 8 " + string(AVAIL tt-docto-xml)) no-error.
                ...
                log-manager:write-message("KML - pi-IntegracaoNDD 8.1 " + string(AVAIL tt-docto-xml)) no-error.
                IF L-GRAVA THEN run pi-grava-nota.
                
                RUN pi-valida-nota.
                
                log-manager:write-message("KML - pi-IntegracaoNDD 8.2 " + string(AVAIL tt-docto-xml)) no-error.
                
                for first b-NDD_ENTRYINTEGRATION EXCLUSIVE-LOCK where 
                    rowid(b-NDD_ENTRYINTEGRATION) = rowid(NDD_ENTRYINTEGRATION):
                    
                    log-manager:write-message("KML - pi-IntegracaoNDD 8.3 " + STRING(AVAIL tt-docto-xml)) no-error.
                    ...
                    IF AVAIL tt-docto-xml THEN DO:
                        ...
                        if  int(tt-docto-xml.nNF)       <> ? and
                            ...
                            log-manager:write-message("KML - pi-IntegracaoNDD 8.4 ") no-error.
                        ...
                        log-manager:write-message("KML - pi-IntegracaoNDD 8.5 ") no-error.
            ...
            END.
         END.
        log-manager:write-message("KML - pi-IntegracaoNDD 9 ") no-error.
...
PROCEDURE pi-abre-xml:
    ...
    dataset dsCTe:empty-dataset no-error.
    ...
    assign retOK = dataset dsCte:read-xml(cSourceType,
    cFile,
    cReadMode,
    cSchemaLocation,
    lOverrideDefaultMapping,
    ...
    FIND FIRST ttinfnfe NO-ERROR.
   
    IF AVAIL ttinfnfe THEN
       ASSIGN c-versao-xml = ttinfnfe.versao.
       
    FIND FIRST ttInfCte NO-ERROR.
   
    IF AVAIL ttInfCte THEN
       ASSIGN c-versao-xml = ttInfCte.versao. 
    ...
    /* AVB - Iniciar variavel para evitar pegar pedido da nota anterior quando nÆo tem tt-compra - 19/06/2017 */
    ASSIGN i-num-pedido = 0.
    
    /* inicio tratamento temp-tables geradas pelo XML */
    ASSIGN i-seq-item = 0. 
    
    MESSAGE "Dentro ABRE XML"  SKIP
            c-versao-xml 
        VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
    
    for first ttIde:      //  ON ERROR UNDO, RETURN ERROR
    
        MESSAGE "DENTRO FOR FIRST"
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
        ...
        END.
        LOG-MANAGER:WRITE-MESSAGE("KML NFE - entrou for each int002g - nnfe: " + STRING(ttIde.nnf,">>>9999999")) NO-ERROR.
        
        
        ASSIGN tt-docto-xml.nNF = trim(STRING(ttIde.nCT,">>>9999999")). //era nnf 
        ...
        LOG-MANAGER:WRITE-MESSAGE("KML NFE - entrou for each int002g - eEmi: " + STRING(tt-docto-xml.dEmi)) NO-ERROR.
        ...
        for first ttEmit:
           ...
           FOR EACH emitente NO-LOCK WHERE 
               ...
               FIND FIRST tt-dist-emitente NO-LOCK WHERE
                          tt-dist-emitente.cod-emitente = emitente.cod-emitente NO-ERROR.
               IF NOT AVAIL tt-dist-emitente 
               THEN DO:
           ...
           FOR EACH tt-dist-emitente NO-LOCK:
           ...
           END. 
           ELSE DO:
               FIND FIRST tt-dist-emitente NO-LOCK
                   WHERE tt-dist-emitente.situacao = 1 NO-ERROR.
        ...
        // KML 18/09/2023 - Importa‡Æo nota referenciada - opera‡Æo triangular
        FOR EACH ttNFref:

            ASSIGN tt-docto-xml.chave-ref-oper-triangular = ttNFref.refNFe.
        END.
        ...
        for first ttDest:
             ...
             IF AVAIL estabelec THEN DO:
                 ...
                 IF estabelec.cod-estabel = "973"  OR estabelec.cod-estabel = "977" THEN   //TESTE CTE DENOVO
             ...
             FIND FIRST b-int_ds_docto_xml NO-LOCK WHERE
                       b-int_ds_docto_xml.tipo_nota    = tt-docto-xml.tipo_nota    AND 
                       b-int_ds_docto_xml.CNPJ         = tt-docto-xml.CNPJ         AND                             
                       b-int_ds_docto_xml.nNF          = tt-docto-xml.nNF          AND
                       b-int_ds_docto_xml.serie        = tt-docto-xml.serie NO-ERROR.
             ...
             THEN DO:
                   FIND FIRST int_ds_nota_entrada NO-LOCK WHERE
                             ...
                             int_ds_nota_entrada.nen_cfop_n        = tt-docto-xml.cfop NO-ERROR.
                   IF AVAIL int_ds_nota_entrada THEN
        ...
        FIND FIRST ttICMS00 NO-ERROR.
        
        IF AVAIL ttICMS00 THEN
        DO:
             ASSIGN tt-docto-xml.vbc        = ttICMS00.vBC.
             ASSIGN tt-docto-xml.valor_icms = ttICMS00.vicms.
             //ASSIGN tt-it-docto-xml.picms   = ttICMS00.pICMS. 
        ...
        /* chave da NFe */
        ASSIGN l-chave-nfe = NO.
        FOR FIRST ttinfprot:
            
            MESSAGE "DENTRO ttinfprot" SKIP
                    ttinfprot.ChCTe
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
        
        
            ASSIGN tt-docto-xml.chNfe = ttinfprot.ChCTe
                   l-chave-nfe        = YES.
        END.
        
        MESSAGE "ttinfprot" SKIP
                tt-docto-xml.chNfe
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
        
        IF l-chave-nfe        = NO 
        OR tt-docto-xml.chNfe = "" THEN DO:
           IF AVAIL ttInfCte THEN
              ASSIGN tt-docto-xml.chNfe = substr(ttInfCte.id,4,44).
        END. 
        
        MESSAGE "Depois l-chave-nfe" SKIP
                 tt-docto-xml.chNfe
            VIEW-AS ALERT-BOX INFORMATION BUTTONS OK.
        ...
        FOR EACH ttprod 
           ...
           for first ttICMS60 WHERE 
               ...
               ASSIGN  i-orig-icms         = ttICMS60.orig
                       ...
                       //de-valor-base-fcp-st = ttICMS60.vBCFCPSTRet
                      // de-perc-fcp-st       = ttICMS60.pFCPSTRet    
                   .  
           ...
           ASSIGN tt-it-docto-xml.orig_icms     = i-orig-icms 
                  ...
                  tt-it-docto-xml.vICMSSubs     = de-vICMSSubs
           ...
           assign tt-it-docto-xml.vicmsDeson       = de-vicmsDeson
                  ...
                  tt-it-docto-xml.vOutro           = ttProd.vOutro + ttProd.vFrete      
           ...
           ASSIGN tt-it-docto-xml.cst_pis    = 0
            ...
            LOG-MANAGER:WRITE-MESSAGE("KML - 9 - zerou variavel pis" ) NO-ERROR. 
    
            FOR FIRST natur-oper NO-LOCK 
                WHERE natur-oper.nat-operacao = tt-it-docto-xml.nat_operacao: 
           ...
           LOG-MANAGER:WRITE-MESSAGE("KML - 1 - Antes de find item-fornec - c-item_do_forn - " + c-item_do_forn) NO-ERROR.
           ...
           then do:
                ...
                LOG-MANAGER:WRITE-MESSAGE("KML - 2 - nao achou item-fornec procurando na umd - c-item_do_forn - " + c-item_do_forn) NO-ERROR.
           ...
           LOG-MANAGER:WRITE-MESSAGE("KML - 3 - achou ou nÆo item fornec - c-item_do_forn - " + 
                                     c-item_do_forn + 
                                     " - avail item-fornec - " + 
                                     STRING(AVAIL item-fornec)) NO-ERROR.

           IF AVAIL item-fornec 
           THEN DO:
           
              LOG-MANAGER:WRITE-MESSAGE("KML - 4 - dentro avail item-fornec - c-item_do_forn - " + 
                                         c-item_do_forn ) NO-ERROR.
              for first ITEM no-lock where 
                  ITEM.it-codigo  = item-fornec.it-codigo:
                  
                    LOG-MANAGER:WRITE-MESSAGE("KML - 5 - dentro item - item.it-codigo - " + 
                                            ITEM.it-codigo ) NO-ERROR.
    
                    ASSIGN de-aliq-pis = dec(substr(item.char-2,31,5)).
                    ASSIGN de-aliq-cofins = dec(substr(item.char-2,36,5)).
                  
                    LOG-MANAGER:WRITE-MESSAGE("KML - 6 - achou aliquota pis/cofins - c-item_do_forn - " + 
                                             c-item_do_forn + 
                                             " -  item.it-codigo - " + ITEM.it-codigo + 
                                             " -  de-aliq-pis - " + string(de-aliq-pis) + 
                                             " -  de-aliq-cofins - " + string(de-aliq-cofins) ) NO-ERROR.
    
                    IF de-aliq-pis > 0 THEN DO:
                  
                         FIND FIRST ttPISAliq WHERE
                                    ttPISAliq.nItem = ttprod.nitem NO-ERROR.
                         IF AVAIL ttPISAliq and
                            ttPISAliq.vBC > 0 THEN DO:
                        ...
                        END.
                        ELSE DO: // KML - Kleber Mazepa - 28/01/2025 caso nÆo tenha base de pis no xml calcula manualmente
                        
                            ASSIGN tt-it-docto-xml.cst_pis = 1 // For‡a como CST tributado por ter aliquota
                                   tt-it-docto-xml.vbc_pis = ttprod.vprod
                                   tt-it-docto-xml.ppis    = de-aliq-pis
                                   tt-it-docto-xml.vpis    = ttprod.vprod * de-aliq-pis / 100.
                    ...
                    IF de-aliq-cofins > 0 THEN DO:
                        ...
                        IF AVAIL ttCOFINSAliq and
                           ttCOFINSAliq.vBC > 0 THEN DO:
                        ...
                        ELSE DO: // KML - Kleber Mazepa - 28/01/2025 caso nÆo tenha base de pis no xml calcula manualmente
                            ...
                            ASSIGN tt-it-docto-xml.cst_cofins = 1 // For‡a como CST tributado por ter aliquota
                                   tt-it-docto-xml.vbc_cofins = ttprod.vprod
                                   tt-it-docto-xml.pcofins    = de-aliq-cofins
                                   tt-it-docto-xml.vcofins    = ttprod.vprod * de-aliq-cofins / 100.
                ...
                END. /* item */
            END. /* item-fornec */
            ELSE DO: // KML - 06/01/2025 - Se nÆo encontrar item-fornec procura o item pelo EAN
           
                LOG-MANAGER:WRITE-MESSAGE("KML - 14 - dentro ELSE avail item-fornec - c-item_do_forn - " + 
                                         c-item_do_forn + 
                                         " codigo EAN do xml - " + string(tt-it-docto-xml.ean) ) NO-ERROR.
                                         
                FIND FIRST int_ds_ean_item NO-LOCK
                    WHERE int_ds_ean_item.codigo_ean = tt-it-docto-xml.ean NO-ERROR.
                
                IF NOT AVAIL int_ds_ean_item THEN
                    FIND FIRST int_ds_ean_item NO-LOCK
                        WHERE int_ds_ean_item.codigo_ean = tt-it-docto-xml.eanTrib NO-ERROR.  
                
                IF AVAIL int_ds_ean_item THEN DO:
              
                    for first ITEM no-lock 
                        WHERE ITEM.it-codigo  =  int_ds_ean_item.it_codigo:
                  
                        LOG-MANAGER:WRITE-MESSAGE("KML - 15 - dentro item - item.it-codigo - " + 
                                                ITEM.it-codigo ) NO-ERROR.
        ...
        for each ttDup:
            FIND first tt-xml-dup where 
                ...
                tt-xml-dup.dVenc        = ttDup.dVenc NO-ERROR.
        ...
        THEN DO:
            FOR FIRST b-tt-xml-dup 
                WHERE b-tt-xml-dup.serie        = tt-docto-xml.serie        
                  ...
                  AND b-tt-xml-dup.tipo_nota    = tt-docto-xml.tipo_nota:
		...
		/* KML - 01/10/2024 - em consulta na base não foi identificado utilização dessa tabela com as migrações para API. e estava causando lock no cloud
        ...
        then do:
		  ...
		  FIND first int_ds_xml_nfe exclusive-lock
				where int_ds_xml_nfe.cnpj_origem = tt-docto-xml.CNPJ 
				  and int_ds_xml_nfe.serie       = tt-docto-xml.serie 
				  and int_ds_xml_nfe.notafiscal  = tt-docto-xml.nnf NO-ERROR.
            ...
            /* necess rio transa‡äes separadas para tratamento na trigger de after-update no Oracle */
            do transaction:
