...
procedure pi-grava-nota:       
    ...
    FOR EACH tt-docto-xml NO-LOCK
        ...
        // KML - coloca importaá∆o do pedido - projeto PN014
        ...
        /* KML - Projeto PN014 - Integraá∆o duplicata XML */ 
   ...
   FOR EACH int_ds_docto_xml NO-LOCK
       WHERE int_ds_docto_xml.tipo_docto = 4 
         ...
         ASSIGN tt-docto-xml.chnfe    = IF int_ds_docto_xml.chnfe    = ? then "" else int_ds_docto_xml.chnfe  
                ...
                tt-docto-xml.chnft    = int_ds_docto_xml.serie. /* Grava a sÇrie Original do PRS */     
    ...
    FOR EACH NDD_ENTRYINTEGRATION USE-INDEX idx_status NO-LOCK  
      ...
      //    AND NDD_ENTRYINTEGRATION.CNPJEMIT        = 73856593000166
        ...
        if can-find (first ems2mult.estabelec no-lock where estabelec.cgc = STRING(NDD_ENTRYINTEGRATION.CNPJEMIT) and
                     ( estabelec.cod-estabel = "10001"  OR estabelec.cod-estabel = "10004" OR estabelec.cod-estabel = "10008") )  then do transaction:
...
PROCEDURE pi-abre-xml:
    ...
    for first ttIde ON ERROR UNDO, RETURN ERROR:
        ...
        // KML 18/09/2023 - Importaá∆o nota referenciada - operaá∆o triangular
        FOR EACH ttNFref:
        ...
        FOR EACH ttprod 
           ...
           then do:
            ...
            // KML - 05/11/2024 - Alterado leitura do pis/cofins para n∆o validar item fornecedor e ler pis/cofins do XML
		...
		/* KML - 01/10/2024 - em consulta na base n„o foi identificado utilizaÁ„o dessa tabela com as migraÁıes para API. e estava causando lock no cloud
