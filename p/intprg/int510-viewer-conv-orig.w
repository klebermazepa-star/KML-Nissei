    ...
    for first b-int_ds_docto_xml exclusive-lock where 
        ...
        if trim(b-int_ds_docto_xml.cnpj_dest) = "" or 
           b-int_ds_docto_xml.cnpj_dest = ? then do:
            ...
            for first ems2mult.estabelec no-lock where estabelec.cod-estabel = "973" OR estabelec.cod-estabel = "977" OR estabelec.cod-estabel = "10001" OR estabelec.cod-estabel = "10004"
                :
        ...
        if b-int_ds_docto_xml.cnpj   = "" or 
           ...
           b-int_ds_docto_xml.xNome  = ?  then do:
            for first ems2mult.emitente no-lock where emitente.cod-emitente = b-int_ds_docto_xml.cod_emitente
                query-tuning(no-lookahead):
...
------------------------------------------------------------------------------*/
    ...
    */
    ...
    if avail estabelec and estabelec.cod-estabel <> "973" and estabelec.cod-estabel <> "977" AND estabelec.cod-estabel <> "10001" AND estabelec.cod-estabel <> "10004" then do:
       run pi-gera-erro(INPUT 3,    
            ...
            THEN DO:
                ...
                then 
                    assign b-int_ds_docto_xml-guia-st.base_guia_st  = int_ds_docto_xml.base_guia_st  + de-base-st-calc
                           ...
                           int_ds_it_docto_xml.vicmsst              = de-valor_st-calc - int_ds_it_docto_xml.vicms
