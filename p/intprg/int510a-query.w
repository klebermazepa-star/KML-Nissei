...
*******************************************************************************/
{include/i-prgvrs.i int510a-query 1.12.00.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_docto_xml ~
      WHERE  rowid (int_ds_docto_xml) = v-row-docto NO-LOCK INDEXED-REPOSITION QUERY-TUNING(NO-LOOKAHEAD)
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = " rowid (int_ds_docto_xml) = v-row-docto NO-LOCK "
