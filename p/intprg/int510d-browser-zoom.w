...
&Scoped-define QUERY-STRING-br-table FOR EACH int_ds_docto_xml WHERE         int_ds_docto_xml.cnpj >= c-cnpjorigem-ini     and int_ds_docto_xml.cnpj <= c-cnpjorigem-fim     and int_ds_docto_xml.serie >= c-serie-ini     and int_ds_docto_xml.serie <= c-serie-fim     and int_ds_docto_xml.nNF >= i-notafiscal-ini     and int_ds_docto_xml.nNF <= i-notafiscal-fim     and int_ds_docto_xml.cod_emitente >= i-emitente-ini     and int_ds_docto_xml.cod_emitente <= i-emitente-fim     and int_ds_docto_xml.situacao = 9     and int_ds_docto_xml.tipo_nota <> 3     and (int_ds_docto_xml.cnpj_dest  = "79430682025540" OR int_ds_docto_xml.cnpj_dest  = "79430682057400" OR int_ds_docto_xml.cnpj_dest  = "05912018000183"  OR int_ds_docto_xml.cnpj_dest  = "05912018000426" ) /* 973 */     ~{&SORTBY-PHRASE} INDEXED-REPOSITION QUERY-TUNING(NO-LOOKAHEAD)
...
DEFINE VARIABLE i-notafiscal-fim AS CHARACTER FORMAT "X(16)":U INITIAL "ZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 13.14 BY .88 NO-UNDO.

DEFINE VARIABLE i-notafiscal-ini AS CHARACTER FORMAT "X(16)":U 
     LABEL "Nota" 
     VIEW-AS FILL-IN 
     SIZE 13.14 BY .88 NO-UNDO.
...
OPEN QUERY {&SELF-NAME} FOR EACH int_ds_docto_xml WHERE
    ...
    and ( int_ds_docto_xml.CNPJ_dest = "79430682025540" or int_ds_docto_xml.CNPJ_dest = "79430682057400" )  /* 973 */
...
------------------------------------------------------------------------------*/
  ...
  /* Code placed here will execute AFTER standard behavior.    */
    OPEN QUERY br-table FOR EACH int_ds_docto_xml NO-LOCK WHERE
        ...
        and int_ds_docto_xml.situacao = 9
        and int_ds_docto_xml.tipo_nota <> 3
        and (int_ds_docto_xml.cnpj_dest  = "79430682025540" OR 
           int_ds_docto_xml.cnpj_dest  = "79430682057400"  OR 
		   int_ds_docto_xml.cnpj_dest  = "05912018000183"  OR 
           int_ds_docto_xml.cnpj_dest  = "05912018000426") /* 973 */
