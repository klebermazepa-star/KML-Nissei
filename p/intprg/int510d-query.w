...
*******************************************************************************/
{include/i-prgvrs.i int510d-query 1.12.00.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_docto_xml ~
      WHERE  int_ds_docto_xml.tipo_nota <> 3 ~
 AND (int_ds_docto_xml.CNPJ_dest = "79430682025540" or int_ds_docto_xml.CNPJ_dest = "79430682057400" ) ~
 AND int_ds_docto_xml.situacao = 9 NO-LOCK INDEXED-REPOSITION QUERY-TUNING(NO-LOOKAHEAD)
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_docto_xml ~
      WHERE  int_ds_docto_xml.tipo_nota <> 3 ~
 AND (int_ds_docto_xml.CNPJ_dest = "79430682025540" or int_ds_docto_xml.CNPJ_dest = "79430682057400" )~
 AND int_ds_docto_xml.situacao = 9 NO-LOCK INDEXED-REPOSITION QUERY-TUNING(NO-LOOKAHEAD).
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_docto_xml
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_docto_xml
...
<FOREIGN-KEYS>
ep-codigo||y|custom.int_ds_docto_xml.ep-codigo
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = " custom.int_ds_docto_xml.tipo_nota <> 3
 AND (custom.int_ds_docto_xml.CNPJ-dest = ""79430682025540"" or custom.int_ds_docto_xml.CNPJ-dest = ""79430682057400"")
 AND custom.int_ds_docto_xml.situacao = 9"
