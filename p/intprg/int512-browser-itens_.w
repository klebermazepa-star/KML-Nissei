...
int-ds-it-docto-xml.xProd int-ds-it-docto-xml.numero-ordem ~
int-ds-it-docto-xml.Lote int-ds-it-docto-xml.qCom-forn ~
int-ds-it-docto-xml.uCom-forn int-ds-it-docto-xml.vUnCom ~
int-ds-it-docto-xml.qCom int-ds-it-docto-xml.uCom int-ds-it-docto-xml.vDesc ~
int-ds-it-docto-xml.vipi int-ds-it-docto-xml.vicms ~
int-ds-it-docto-xml.vicmsdeson int-ds-it-docto-xml.vicmsst ~
int-ds-it-docto-xml.vpis int-ds-it-docto-xml.pcofins ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      ...
      int-ds-it-docto-xml.vUnCom FORMAT ">>>>,>>>,>>9.99999":U
            WIDTH 7.43
      int-ds-it-docto-xml.qCom FORMAT ">>>>,>>>,>>9.99999":U WIDTH 13.43
...
"int-ds-it-docto-xml.xProd" ? ? "character" ? ? ? ? ? ? no ? no no "40" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   = emsesp.int-ds-it-docto-xml.numero-ordem
     _FldNameList[6]   > emsesp.int-ds-it-docto-xml.Lote
"int-ds-it-docto-xml.Lote" ? ? "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > emsesp.int-ds-it-docto-xml.qCom-forn
"int-ds-it-docto-xml.qCom-forn" "Qtde" ? "decimal" ? ? ? ? ? ? no ? no no "6.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > emsesp.int-ds-it-docto-xml.uCom-forn
"int-ds-it-docto-xml.uCom-forn" ? ? "character" ? ? ? ? ? ? no ? no no "2.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > emsesp.int-ds-it-docto-xml.vUnCom
"int-ds-it-docto-xml.vUnCom" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > emsesp.int-ds-it-docto-xml.qCom
"int-ds-it-docto-xml.qCom" ? ? "decimal" ? ? ? ? ? ? no ? no no "13.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   = emsesp.int-ds-it-docto-xml.uCom
     _FldNameList[12]   > emsesp.int-ds-it-docto-xml.vDesc
"int-ds-it-docto-xml.vDesc" ? ? "decimal" ? ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > emsesp.int-ds-it-docto-xml.vipi
"int-ds-it-docto-xml.vipi" "Vlr IPI" ? "decimal" ? ? ? ? ? ? no ? no no "5.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > emsesp.int-ds-it-docto-xml.vicms
"int-ds-it-docto-xml.vicms" "Vlr ICMS" ? "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > emsesp.int-ds-it-docto-xml.vicmsdeson
"int-ds-it-docto-xml.vicmsdeson" "Vlr ICMS Deson" ? "decimal" ? ? ? ? ? ? no ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > emsesp.int-ds-it-docto-xml.vicmsst
"int-ds-it-docto-xml.vicmsst" "Vlr ST" ? "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > emsesp.int-ds-it-docto-xml.vpis
"int-ds-it-docto-xml.vpis" "Vlr PIS" ? "decimal" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > emsesp.int-ds-it-docto-xml.pcofins
"int-ds-it-docto-xml.pcofins" "% Cofins" ? "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > emsesp.int-ds-it-docto-xml.vcofins
"int-ds-it-docto-xml.vcofins" "Vlr Cofins" ? "decimal" ? ? ? ? ? ? no ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > emsesp.int-ds-it-docto-xml.vOutro
"int-ds-it-docto-xml.vOutro" ? ? "decimal" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > emsesp.int-ds-it-docto-xml.vProd
