...
DEFINE FRAME f-cad
     btIntegra AT ROW 1.4 COL 64.63 WIDGET-ID 2
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 128.63 ) NO-ERROR.
       /* Size in UIB:  ( 1.27 , 16.00 ) */
       ...
       RUN set-position IN h_int520-viewer ( 2.83 , 1.50 ) NO-ERROR.
       /* Size in UIB:  ( 11.27 , 143.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Itens|Duplicatas|Totais' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 14.60 , 1.50 ) NO-ERROR.
       RUN set-size IN h_folder ( 11.60 , 143.50 ) NO-ERROR.
       ...
       RUN set-position IN h_int520-query ( 13.80 , 136.00 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_int520-browser-itens ( 15.60 , 2.50 ) NO-ERROR.
       /* Size in UIB:  ( 10.77 , 142.63 ) */
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_int520-browser-duplicatas ( 15.80 , 16.00 ) NO-ERROR.
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_int520-viewer-totais ( 16.00 , 2.75 ) NO-ERROR.
       /* Size in UIB:  ( 4.00 , 141.63 ) */
