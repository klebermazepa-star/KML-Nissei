...
*******************************************************************************/
{include/i-prgvrs.i int520b-query 1.12.01.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_nota_entrada_produt NO-LOCK WHERE rowid(int_ds_nota_entrada_produt) = v-row-item query-tuning(no-lookahead)
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_nota_entrada_produt NO-LOCK WHERE rowid(int_ds_nota_entrada_produt) = v-row-item query-tuning(no-lookahead).
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_nota_entrada_produt
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_nota_entrada_produt
...
<FOREIGN-KEYS>
ped_codigo_n||y|custom.int_ds_nota_entrada_produt.ped_codigo_n
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "custom.int_ds_nota_entrada_produt"
     _START_FREEFORM
     OPEN QUERY {&SELF-NAME} FOR EACH int_ds_nota_entrada_produt no-lock WHERE rowid(int_ds_nota_entrada_produt) = v-row-item
     _END_FREEFORM
     _Options          = "NO-LOCK"
     _Design-Parent    is WINDOW q-tables @ ( 1.17 , 9.88 )
*/  /* QUERY Query-Main */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "ped_codigo_n" "int_ds_nota_entrada_produt" "ped_codigo_n"}
