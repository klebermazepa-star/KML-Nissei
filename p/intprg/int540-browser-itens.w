...
int_ds_it_docto_xml.xProd int_ds_it_docto_xml.nat_operacao ~
int_ds_it_docto_xml.cfop int_ds_it_docto_xml.qCom_forn ~
int_ds_it_docto_xml.vUnCom int_ds_it_docto_xml.vDesc ~
int_ds_it_docto_xml.vbc_icms int_ds_it_docto_xml.vicms ~
int_ds_it_docto_xml.vbcst int_ds_it_docto_xml.vicmsst ~
int_ds_it_docto_xml.vProd int_ds_it_docto_xml.ncm ~
int_ds_it_docto_xml.cst_icms int_ds_it_docto_xml.uCom_forn ~
int_ds_it_docto_xml.qCom int_ds_it_docto_xml.uCom ~
int_ds_it_docto_xml.vbc_ipi int_ds_it_docto_xml.pipi ~
int_ds_it_docto_xml.vipi int_ds_it_docto_xml.predBc ~
int_ds_it_docto_xml.picms int_ds_it_docto_xml.vicmsdeson ~
int_ds_it_docto_xml.picmsst int_ds_it_docto_xml.vPMC ~
...
int_ds_it_docto_xml.nat_operacao int_ds_it_docto_xml.cfop ~
int_ds_it_docto_xml.qCom_forn int_ds_it_docto_xml.vUnCom ~
int_ds_it_docto_xml.vDesc int_ds_it_docto_xml.vbc_icms ~
int_ds_it_docto_xml.vicms int_ds_it_docto_xml.vbcst ~
int_ds_it_docto_xml.vicmsst int_ds_it_docto_xml.vProd 
...
bt-altera-browse bt-eliminar bt-item-fornec 
...
DEFINE BUTTON bt-item-fornec 
     LABEL "Ajusta Item Fornec" 
     SIZE 19 BY 1.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      ...
      int_ds_it_docto_xml.it_codigo FORMAT "x(16)":U WIDTH 7.57
      int_ds_it_docto_xml.item_do_forn FORMAT "x(60)":U WIDTH 9.43
      int_ds_it_docto_xml.xProd FORMAT "x(60)":U WIDTH 30.43
      ...
      int_ds_it_docto_xml.vicmsst COLUMN-LABEL "Vlr ST" FORMAT ">>>>,>>>,>>9.99999":U
            WIDTH 7.43
      int_ds_it_docto_xml.vProd FORMAT ">>>>,>>>,>>9.99999":U WIDTH 9.14
...
DEFINE FRAME F-Main
     ...
     bt-item-fornec AT ROW 11 COL 52 WIDGET-ID 8
...
"int_ds_it_docto_xml.it_codigo" ? ? "character" ? ? ? ? ? ? no ? no no "7.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > custom.int_ds_it_docto_xml.item_do_forn
"int_ds_it_docto_xml.item_do_forn" ? ? "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > custom.int_ds_it_docto_xml.xProd
"int_ds_it_docto_xml.xProd" ? ? "character" ? ? ? ? ? ? no ? no no "30.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > custom.int_ds_it_docto_xml.nat_operacao
...
"int_ds_it_docto_xml.cfop" ? ? "integer" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > custom.int_ds_it_docto_xml.qCom_forn
"int_ds_it_docto_xml.qCom_forn" "Qtde" ? "decimal" ? ? ? ? ? ? yes ? no no "6.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > custom.int_ds_it_docto_xml.vUnCom
"int_ds_it_docto_xml.vUnCom" ? ? "decimal" ? ? ? ? ? ? yes ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > custom.int_ds_it_docto_xml.vDesc
"int_ds_it_docto_xml.vDesc" ? ? "decimal" ? ? ? ? ? ? yes ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > custom.int_ds_it_docto_xml.vbc_icms
"int_ds_it_docto_xml.vbc_icms" "Base ICMS" ? "decimal" ? ? ? ? ? ? yes ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > custom.int_ds_it_docto_xml.vicms
"int_ds_it_docto_xml.vicms" "Vlr ICMS" ? "decimal" ? ? ? ? ? ? yes ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > custom.int_ds_it_docto_xml.vbcst
"int_ds_it_docto_xml.vbcst" "Base ST" ? "decimal" ? ? ? ? ? ? yes ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > custom.int_ds_it_docto_xml.vicmsst
"int_ds_it_docto_xml.vicmsst" "Vlr ST" ? "decimal" ? ? ? ? ? ? yes ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   > custom.int_ds_it_docto_xml.vProd
"int_ds_it_docto_xml.vProd" ? ? "decimal" ? ? ? ? ? ? yes ? no no "9.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[15]   > custom.int_ds_it_docto_xml.ncm
"int_ds_it_docto_xml.ncm" ? ">>>>>>>>9" "integer" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[16]   > custom.int_ds_it_docto_xml.cst_icms
"int_ds_it_docto_xml.cst_icms" ? ">>>9" "integer" ? ? ? ? ? ? no ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > custom.int_ds_it_docto_xml.uCom_forn
"int_ds_it_docto_xml.uCom_forn" ? ? "character" ? ? ? ? ? ? no ? no no "2.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > custom.int_ds_it_docto_xml.qCom
"int_ds_it_docto_xml.qCom" ? ? "decimal" ? ? ? ? ? ? no ? no no "11" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   = custom.int_ds_it_docto_xml.uCom
     _FldNameList[20]   > custom.int_ds_it_docto_xml.vbc_ipi
"int_ds_it_docto_xml.vbc_ipi" "Base IPI" ? "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > custom.int_ds_it_docto_xml.pipi
"int_ds_it_docto_xml.pipi" "% IPI" ? "decimal" ? ? ? ? ? ? no ? no no "4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[22]   > custom.int_ds_it_docto_xml.vipi
"int_ds_it_docto_xml.vipi" "Vlr IPI" ? "decimal" ? ? ? ? ? ? no ? no no "5.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[23]   > custom.int_ds_it_docto_xml.predBc
"int_ds_it_docto_xml.predBc" "Red. BC" ? "decimal" ? ? ? ? ? ? no ? no no "8.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[24]   > custom.int_ds_it_docto_xml.picms
"int_ds_it_docto_xml.picms" "% ICMS" ? "decimal" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[25]   > custom.int_ds_it_docto_xml.vicmsdeson
"int_ds_it_docto_xml.vicmsdeson" "Vlr ICMS Deson" ? "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[26]   > custom.int_ds_it_docto_xml.picmsst
"int_ds_it_docto_xml.picmsst" "% ST" ? "decimal" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[27]   > custom.int_ds_it_docto_xml.vPMC
"int_ds_it_docto_xml.vPMC" ? ? "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[28]   > custom.int_ds_it_docto_xml.pmvast
"int_ds_it_docto_xml.pmvast" "% VaST" ? "decimal" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[29]   > custom.int_ds_it_docto_xml.vbc_pis
"int_ds_it_docto_xml.vbc_pis" "Vlr Base PIS" ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[30]   > custom.int_ds_it_docto_xml.ppis
"int_ds_it_docto_xml.ppis" "% PIS" ? "decimal" ? ? ? ? ? ? no ? no no "4.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[31]   > custom.int_ds_it_docto_xml.vpis
"int_ds_it_docto_xml.vpis" "Vlr PIS" ? "decimal" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[32]   > custom.int_ds_it_docto_xml.vbc_cofins
"int_ds_it_docto_xml.vbc_cofins" "Base Cofins" ? "decimal" ? ? ? ? ? ? no ? no no "10.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[33]   > custom.int_ds_it_docto_xml.pcofins
"int_ds_it_docto_xml.pcofins" "% Cofins" ? "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[34]   > custom.int_ds_it_docto_xml.vcofins
"int_ds_it_docto_xml.vcofins" "Vlr Cofins" ? "decimal" ? ? ? ? ? ? no ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[35]   > custom.int_ds_it_docto_xml.vOutro
"int_ds_it_docto_xml.vOutro" ? ? "decimal" ? ? ? ? ? ? no ? no no "11.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[36]   > custom.int_ds_it_docto_xml.Lote
"int_ds_it_docto_xml.Lote" ? ? "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO:
   ...
   {src/adm/template/brsleave.i}
    ...
    if avail int_ds_it_docto_xml and 
       ...
       for FIRST b-int_ds_it_docto_xml exclusive-lock where
           ...
           b-int_ds_it_docto_xml.item_do_forn = int_ds_it_docto_xml.item_do_forn:
            ...
            assign  b-int_ds_it_docto_xml.nat_operacao    = input browse br-table int_ds_it_docto_xml.nat_operacao 
                    b-int_ds_it_docto_xml.cfop            = input browse br-table int_ds_it_docto_xml.cfop         
...
DO:
 ...
 /*   if can-find (first usuar_grp_usuar no-lock where 
                 ...
                 usuar_grp_usuar.cod_grp_usuar = "TAX") then DO:
    ...
    */
    apply "entry":u to int_ds_it_docto_xml.nat_operacao in browse br-table.
END.
...
&Scoped-define SELF-NAME bt-item-fornec
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-item-fornec B-table-Win
ON CHOOSE OF bt-item-fornec IN FRAME F-Main /* Ajusta Item Fornec */
DO:
    DEFINE BUFFER b2int_ds_it_docto_xml FOR int_ds_it_docto_xml.
    DEFINE VARIABLE c-item-do-forn AS CHARACTER   NO-UNDO.

    IF AVAIL int_ds_docto_xml and int_ds_docto_xml.tipo_nota <> 3 THEN DO:
        ...
        for each int_ds_it_docto_xml NO-LOCK where
           ...
           int_ds_it_docto_xml.serie        = int_ds_docto_xml.serie:
            ...
            /* PEPSICO */
            if  int_ds_it_docto_xml.it_codigo <> "" and
               avail int_ds_ext_emitente 
            then do:

                ASSIGN c-item-do-forn = int_ds_it_docto_xml.it_codigo.
                for first item-fornec no-lock where
                    ...
                    FIND FIRST b2int_ds_it_docto_xml EXCLUSIVE-LOCK
                        WHERE ROWID(b2int_ds_it_docto_xml) = ROWID(int_ds_it_docto_xml) NO-ERROR.

                    IF AVAIL b2int_ds_it_docto_xml THEN DO:
                        assign b2int_ds_it_docto_xml.item_do_forn = item-fornec.item-do-forn.
                    END.
                    RELEASE b2int_ds_it_docto_xml.
                end.
            end.
    ...
    do i-ind = 1 to browse br-table:NUM-ENTRIES:
        ...
        if avail int_ds_it_docto_xml then do:
            ...
            ASSIGN    int_ds_it_docto_xml.item_do_forn :screen-value IN BROWSE br-table = STRING(int_ds_it_docto_xml.item_do_forn ).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi-atualiza-fornec B-table-Win 
PROCEDURE pi-atualiza-fornec :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
    ...
    if avail int_ds_docto_xml and int_ds_docto_xml.tipo_nota <> 3 /* NFT */ then do:
        ...
        /* PEPSICO */
        if  int_ds_it_docto_xml.it_codigo:screen-value in BROWSE br-table <> "" and
           (avail int_ds_ext_emitente and int_ds_ext_emitente.gera_nota) or
                  int_ds_docto_xml.tipo_docto = 0
        then do:
        
            c-item-do-forn = int_ds_it_docto_xml.it_codigo:screen-value IN BROWSE br-table.
            for first item-fornec no-lock where
                      item-fornec.cod-emitente = int_ds_docto_xml.cod_emitente and
                      item-fornec.it-codigo    = c-item-do-forn and
                      item-fornec.ativo = yes:
                assign int_ds_it_docto_xml.item_do_forn:screen-value IN BROWSE br-table = item-fornec.item-do-forn.
            end.
        end.
    ...
    do i-ind = 1 to browse br-table:NUM-ENTRIES:
        ...
        if avail int_ds_it_docto_xml then do:
            ...
            assign 
                ...
                int_ds_it_docto_xml.item_do_forn :screen-value IN BROWSE br-table = STRING(int_ds_it_docto_xml.item_do_forn )
