...
*******************************************************************************/
{include/i-prgvrs.i INT540-query 1.12.00.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_docto_xml ~
 ...
 AND int_ds_docto_xml.situacao <> 3 NO-LOCK ~
    BY int_ds_docto_xml.CNPJ ~
       BY int_ds_docto_xml.serie ~
        BY int_ds_docto_xml.nNF INDEXED-REPOSITION
...
/* Query rebuild information for QUERY Query-Main
     ...
     _OrdList          = "custom.int_ds_docto_xml.CNPJ|yes,custom.int_ds_docto_xml.serie|yes,custom.int_ds_docto_xml.nNF|yes"
     _Where[1]         = "custom.int_ds_docto_xml.tipo_nota <> 3
 AND custom.int_ds_docto_xml.situacao <> 9
 AND custom.int_ds_docto_xml.CNPJ_dest <> ""79430682025540""
 AND custom.int_ds_docto_xml.situacao <> 3"
