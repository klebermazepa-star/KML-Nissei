...
*******************************************************************************/
{include/i-prgvrs.i INT540-viewer-1 1.12.00.AVB}
...
DO:
    ...
    cUnFor = "".
    */
    for first int_ds_docto_xml no-lock where rowid(int_ds_docto_xml) = v-row-parent: end.
...
------------------------------------------------------------------------------*/
    ...
    for first int_ds_docto_xml where rowid(int_ds_docto_xml) = v-row-parent:
        if int_ds_it_docto_xml.num_pedido:screen-value in frame f-main = "" or
           int_ds_it_docto_xml.num_pedido:screen-value in frame f-main = "0" then do:
            assign int_ds_it_docto_xml.num_pedido:screen-value in frame f-main = string(int_ds_docto_xml.num_pedido).
        end.
    end.
