...
*******************************************************************************/
{include/i-prgvrs.i INT540b-viewer-5 1.12.00.AVB}
...
------------------------------------------------------------------------------*/
    ...
    if i-sit-re >= 10 and i-sit-re <> 60 then do:
        ...
        assign int_ds_it_docto_xml.cst_ipi  :sensitive in frame f-Main = no  
               int_ds_it_docto_xml.pipi     :sensitive in frame f-Main = no  
               int_ds_it_docto_xml.vbc_ipi  :sensitive in frame f-Main = no  
               int_ds_it_docto_xml.vipi     :sensitive in frame f-Main = no
               int_ds_it_docto_xml.vtottrib :sensitive in frame f-Main = no. 
    end.
