...
DEFINE FRAME D-Dialog
     int_ds_docto_xml.cod_emitente AT ROW 2 COL 13 COLON-ALIGNED WIDGET-ID 2
          ...
          VIEW-AS FILL-IN 
          SIZE 10.13 BY .87
     cFornecedor AT ROW 2 COL 23.13 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     int_ds_docto_xml.serie AT ROW 3 COL 13.13 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 9.13 BY .87
     int_ds_docto_xml.nNF AT ROW 4 COL 13.13 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 17.13 BY .87
     c-nova-serie AT ROW 6.5 COL 13.13 COLON-ALIGNED WIDGET-ID 14
     c-novo-numero AT ROW 7.5 COL 13.13 COLON-ALIGNED WIDGET-ID 20
     bt-ok AT ROW 9.5 COL 3
     bt-cancela AT ROW 9.5 COL 14
     bt-ajuda AT ROW 9.5 COL 68
     "Nova Numera‡Æo" VIEW-AS TEXT
          SIZE 16 BY .67 AT ROW 5.27 COL 2 WIDGET-ID 24
     "Numera‡Æo Atual" VIEW-AS TEXT
          SIZE 16 BY .67 AT ROW 1 COL 2 WIDGET-ID 18
     rt-buttom AT ROW 9.27 COL 2
     RECT-25 AT ROW 1.2 COL 1 WIDGET-ID 16
        ...
        for each int_ds_docto_xml EXCLUSIVE where rowid(int_ds_docto_xml) = p-rowid
            ...
            */
            for each int_ds_docto_wms exclusive where 
                ...
                query-tuning(no-lookahead):
                assign int_ds_docto_wms.doc_numero_n = c-novo-numero
