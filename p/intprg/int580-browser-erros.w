...
*******************************************************************************/
{include/i-prgvrs.i int580-browser-erros 1.12.01.AVB}
...
&Scoped-define QUERY-STRING-br-table FOR EACH int_ds_doc_erro no-lock where     int_ds_doc_erro.serie_docto  = int_ds_docto_xml.serie AND     int_ds_doc_erro.nro_docto    = int_ds_docto_xml.nNF AND     int_ds_doc_erro.tipo_nota    = int_ds_docto_xml.tipo_nota AND     int_ds_doc_erro.CNPJ         = int_ds_docto_xml.CNPJ     by int_ds_doc_erro.cod_erro QUERY-TUNING(NO-LOOKAHEAD)
