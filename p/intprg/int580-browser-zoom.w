...
&Scoped-define QUERY-STRING-br-table FOR EACH int_ds_docto_xml WHERE         int_ds_docto_xml.cnpj >= c-cnpjorigem-ini     and int_ds_docto_xml.cnpj <= c-cnpjorigem-fim     and int_ds_docto_xml.serie >= c-serie-ini     and int_ds_docto_xml.serie <= c-serie-fim     and INT_ds_docto_xml.nNF >= i-notafiscal-ini     and INT_ds_docto_xml.nNF <= i-notafiscal-fim     and int_ds_docto_xml.cod_emitente >= i-emitente-ini     and int_ds_docto_xml.cod_emitente <= i-emitente-fim     and int_ds_docto_xml.situacao <> 9     and int_ds_docto_xml.tipo_nota <> 3     and int_ds_docto_xml.CNPJ_dest = "79430682025540" /* 973 */     ~{&SORTBY-PHRASE} INDEXED-REPOSITION QUERY-TUNING(NO-LOOKAHEAD)
