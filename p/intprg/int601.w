...
*******************************************************************************/
{include/i-prgvrs.i INT601 2.00.00.000}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i INT601 INTPRG}
&ENDIF

CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT601
...
DEFINE VARIABLE d-dt-emis-nota-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/2999 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88
     FONT 1 NO-UNDO.
...
DEFINE VARIABLE i-ult-dias AS INTEGER FORMAT ">>>9":U INITIAL 0 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE tg-ult-dias AS LOGICAL INITIAL no 
     LABEL "Executar £ltimos dias:" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME fPage2
     c-cod-estabel-ini AT ROW 1.5 COL 9
     c-cod-estabel-fim AT ROW 1.5 COL 54.14 NO-LABEL
     c-estado-ini AT ROW 2.5 COL 18.14 WIDGET-ID 4
     c-estado-fim AT ROW 2.5 COL 54.29 NO-LABEL WIDGET-ID 2
     d-dt-emis-nota-ini AT ROW 3.5 COL 10.86 WIDGET-ID 12
     d-dt-emis-nota-fim AT ROW 3.5 COL 54.29 NO-LABEL WIDGET-ID 10
     tg-ult-dias AT ROW 4.75 COL 21 WIDGET-ID 18
     i-ult-dias AT ROW 4.75 COL 37 COLON-ALIGNED NO-LABEL WIDGET-ID 20
...
/* SETTINGS FOR FILL-IN c-cod-estabel-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN c-estado-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN c-estado-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN d-dt-emis-nota-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN d-dt-emis-nota-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
&Scoped-define SELF-NAME tg-ult-dias
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL tg-ult-dias wReport
ON VALUE-CHANGED OF tg-ult-dias IN FRAME fPage2 /* Executar £ltimos dias: */
DO:
    IF SELF:CHECKED THEN DO:
        DISABLE d-dt-emis-nota-ini
                d-dt-emis-nota-fim
            WITH FRAME fPage2.
        ENABLE i-ult-dias
            WITH FRAME fPage2.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.estado-ini       = INPUT FRAME fPage2 c-estado-ini      
           tt-param.estado-fim       = INPUT FRAME fPage2 c-estado-fim      
           tt-param.dt-emis-nota-ini = INPUT FRAME fPage2 d-dt-emis-nota-ini
           tt-param.dt-emis-nota-fim = INPUT FRAME fPage2 d-dt-emis-nota-fim
           tt-param.lg-ult-dias      = INPUT FRAME fPage2 tg-ult-dias
           tt-param.ult-dias         = INPUT FRAME fPage2 i-ult-dias
           .
    ...
    {report/rprun.i intprg/int601rp.p}
