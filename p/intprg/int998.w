...
*******************************************************************************/
{include/i-prgvrs.i INT998 2.12.01.001}
...
DEFINE VARIABLE c-fim-estab AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 NO-UNDO.

DEFINE VARIABLE c-fim-ncm AS CHARACTER FORMAT "9999.99.99":U INITIAL "99999999" 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE c-ini-estab AS CHARACTER FORMAT "X(5)":U 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 8 BY .88 NO-UNDO.

DEFINE VARIABLE c-ini-NCM AS CHARACTER FORMAT "9999.99.99":U INITIAL "00000000" 
     LABEL "NCM" 
     VIEW-AS FILL-IN 
     SIZE 15 BY .88 NO-UNDO.
...
DEFINE VARIABLE l-NFCe AS LOGICAL INITIAL YES 
     LABEL "NFC-e" 
     VIEW-AS TOGGLE-BOX
     SIZE 15 BY .94 NO-UNDO.

DEFINE RECTANGLE RECT-10
     EDGE-PIXELS 2 GRAPHIC-EDGE  NO-FILL   
     SIZE 30 BY 5.8.

DEFINE VARIABLE c-listar AS CHARACTER FORMAT "X(6)":U 
     LABEL "Listar" 
     VIEW-AS TEXT 
     SIZE 1 BY .50 NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-digita w-relat _FREEFORM
  QUERY br-digita DISPLAY
      tt-digita.nat-operacao COLUMN-LABEL "Nat Operaá∆o"
tt-digita.denominacao  COLUMN-LABEL "Denominaá∆o"
ENABLE
...
DEFINE FRAME f-pg-dig
     br-digita AT ROW 1.75 COL 1
     bt-inserir AT ROW 10.75 COL 1
     bt-alterar AT ROW 10.75 COL 16
     bt-retirar AT ROW 10.75 COL 31
     bt-salvar AT ROW 10.75 COL 46
     bt-recuperar AT ROW 10.75 COL 61
     "Natureza(s) de Operaá‰es - Perdas" VIEW-AS TEXT
          SIZE 33.72 BY .67 AT ROW 1.08 COL 1.29 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
DEFINE FRAME f-pg-imp
     ...
     rs-execucao AT ROW 4.92 COL 2.86 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-destino AT ROW 1.04 COL 3.86 NO-LABEL
     text-modo AT ROW 4.17 COL 1.14 COLON-ALIGNED NO-LABEL
     RECT-7 AT ROW 1.33 COL 2.14
     RECT-9 AT ROW 4.38 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
...
DEFINE FRAME f-pg-sel
     c-ini-estab AT ROW 1.25 COL 21.57 COLON-ALIGNED
     c-fim-estab AT ROW 1.25 COL 41.14 COLON-ALIGNED NO-LABEL
     c-ini-data AT ROW 2.21 COL 15.57 COLON-ALIGNED WIDGET-ID 4
     c-fim-data AT ROW 2.21 COL 41.14 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-ini-NCM AT ROW 3.17 COL 14.57 COLON-ALIGNED WIDGET-ID 12
     c-fim-ncm AT ROW 3.17 COL 41.14 COLON-ALIGNED NO-LABEL WIDGET-ID 10
     l-compras AT ROW 5.17 COL 14.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     l-devol-cliente AT ROW 6.00 COL 14.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     l-devol-forn AT ROW 6.83 COL 14.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     l-perdas AT ROW 7.66 COL 14.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     l-reducaoz AT ROW 8.49 COL 14.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     l-nfce AT ROW 9.32 COL 14.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     c-listar AT ROW 4.60 COL 12
     RECT-10 AT ROW 4.80 COL 10
     IMAGE-1 AT ROW 1.25 COL 31.86
     IMAGE-2 AT ROW 1.25 COL 40
     IMAGE-3 AT ROW 2.21 COL 31.86 WIDGET-ID 6
     IMAGE-4 AT ROW 2.21 COL 40 WIDGET-ID 8
     IMAGE-5 AT ROW 3.17 COL 31.86 WIDGET-ID 14
     IMAGE-6 AT ROW 3.17 COL 40 WIDGET-ID 16
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ASSIGN c-ini-data:SCREEN-VALUE IN FRAME f-pg-sel = STRING(date(month(today),01,year(today)))
       c-fim-data:SCREEN-VALUE IN FRAME f-pg-sel = if month(date(c-ini-data:screen-value in frame f-pg-sel)) < 12
                                                              then string(date(month(date(c-ini-data:screen-value in frame f-pg-sel)) + 1,01,year(date(c-ini-data:screen-value in frame f-pg-sel))) - 1)
                                                              else string(date(01,01,year(date(c-ini-data:screen-value in frame f-pg-sel)) + 1) - 1).
...
/*    */
/*                    assign c-arquivo:screen-value in frame f-pg-imp = session:TEMP-directory + "INT998.xls". */
/*                    . */
/*    */
/*                    message "" */
/*                     view-as alert-box. */
...
{utp/ut9000.i "INT998" "2.12.01.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-ini-estab c-fim-estab c-ini-data c-fim-data c-ini-NCM c-fim-ncm 
       l-compras l-devol-cliente l-devol-forn l-perdas l-reducaoz l-nfce RECT-10 c-listar
       WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 c-ini-estab 
         c-fim-estab c-ini-data c-fim-data c-ini-NCM c-fim-ncm 
         l-compras l-devol-cliente l-devol-forn l-perdas l-reducaoz l-nfce 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.estab-ini = input frame f-pg-sel c-ini-estab
           tt-param.estab-fim = input frame f-pg-sel c-fim-estab
           tt-param.data-ini  = input frame f-pg-sel c-ini-data
           tt-param.data-fim  = input frame f-pg-sel c-fim-data 
           tt-param.ncm-ini   = input frame f-pg-sel c-ini-ncm
           tt-param.ncm-fim   = input frame f-pg-sel c-fim-ncm
    ...
    {include/i-rprun.i intprg/int998rp.p}
