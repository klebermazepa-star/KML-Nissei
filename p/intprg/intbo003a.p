...
&GLOBAL-DEFINE TableName int_ds_param_fundo_fixo
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE OUTPUT PARAMETER pcod-emppresa  LIKE int_ds_param_fundo_fixo.cod_empresa NO-UNDO.
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
    DEFINE INPUT PARAMETER pcod-empresa LIKE int_ds_param_fundo_fixo.cod_empresa NO-UNDO. 
   
    FIND FIRST bfint_ds_param_fundo_fixo NO-LOCK WHERE 
               bfint_ds_param_fundo_fixo.cod_empresa = pcod-empresa NO-ERROR. 
       
    /*--- Verifica se registro foi encontrado, em caso de erro ser† retornada flag "NOK":U ---*/
    IF NOT AVAILABLE bfint_ds_param_fundo_fixo THEN 
        RETURN "NOK":U.

    /*--- Reposiciona query atravÇs de rowid e verifica a ocorrància de erros, caso
          existam erros ser† retornada flag "NOK":U ---*/
    RUN repositionRecord IN THIS-PROCEDURE (INPUT ROWID(bfint_ds_param_fundo_fixo)).
...
------------------------------------------------------------------------------*/
    ...
    IF pType = "create" THEN DO:
        ...
        FIND FIRST int_ds_param_fundo_fixo NO-LOCK WHERE 
                   int_ds_param_fundo_fixo.cod_empresa = RowObject.cod_empresa NO-ERROR.
        IF AVAIL int_ds_param_fundo_fixo THEN DO:
