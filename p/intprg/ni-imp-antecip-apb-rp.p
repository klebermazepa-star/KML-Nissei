...
for each tt-antecip WHERE 
    ...
    FOR FIRST ems5.fornecedor WHERE
              fornecedor.cod_empresa    = "1" AND
              fornecedor.cdn_fornecedor = tt-antecip.cdn_fornecedor NO-LOCK:
    END.
    IF NOT AVAIL ems5.fornecedor THEN DO:
       CREATE tt-erro.
            ...
            REPEAT:
               ...
               IF NOT AVAIL antecip_pef_pend THEN DO:
                  ...
                  ASSIGN antecip_pef_pend.cod_estab             = tt-antecip.cod_estab        
                         ...
                         antecip_pef_pend.num_pessoa            = IF AVAIL ems5.fornecedor THEN ems5.fornecedor.num_pessoa ELSE 0
