...
*******************************************************************************/
{include/i-prgvrs.i NI-IMP-IT-CARAC-TEC 2.00.00.000}  /*** 010009 ***/
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o de Caracter°sticas TÇcnicas do Item"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Importaá∆o de Carac. Tec. */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o de Carac. Tec. */
DO:
...
{utp/ut9000.i "NI-IMP-IT-CARAC-TEC" "2.00.00.000"}
...
do  on error undo, return error
    ...
    {include/i-imrun.i intprg/ni-imp-it-carac-tec-rp.p}
