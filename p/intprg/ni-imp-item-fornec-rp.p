/********************************************************************************
**
**  Programa - NI-IMP-ITEM-FORNEC-RP.P - Importaá∆o Item X Fornecedor
**
********************************************************************************/ 

{include/i-prgvrs.i NI-IMP-ITEM-FORNEC-RP 2.00.00.000 } 
...
DEF TEMP-TABLE tt-item-fornec
    ...
    FIELD item-do-forn LIKE ITEM.it-codigo
...
run pi-inicializar in h-acomp (input "Importaá∆o Item x Fornecedor").
...
REPEAT:  
   ...
   run pi-acompanhar in h-acomp (input "Criando tt-item-fornec: " + string(i-cont,">>>,>>>,>>9")).
        ...
        ELSE DO:
               ...
               THEN DO:
                  ...
                  ASSIGN tt-erro.cod-emitente = emitente.cod-emitente
                         tt-erro.cnpj         = tt-item-fornec.cnpj
                         tt-erro.it-codigo    = tt-item-fornec.it-codigo
                         tt-erro.desc-erro    = "Item x Fornecedor Secund†rio j† cadastrado".
                   NEXT. 
               END.
               ELSE DO:
