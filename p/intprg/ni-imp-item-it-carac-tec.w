...
*******************************************************************************/
{include/i-prgvrs.i NI-IMP-ITEM-IT-CARAC-TEC 2.00.00.000}  /*** 010009 ***/
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o de Cliente Matriz"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Importaá∆o de Naturezas de Operaá∆o */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o de Naturezas de Operaá∆o */
DO:
...
{utp/ut9000.i "NI-IMP-ITEM-IT-CARAC-TEC" "2.00.00.000"}
...
do  on error undo, return error
    ...
    {include/i-imrun.i intprg/ni-imp-item-it-carac-tec-rp.p}
