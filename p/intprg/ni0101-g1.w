...
*******************************************************************************/
{include/i-prgvrs.i NI0101-G1 2.00.00.000}
...
&Scoped-define FIELDS-IN-QUERY-d-vapara int_ds_leadtime_fornec.cod_estabel ~
int_ds_leadtime_fornec.cod_emitente 
&Scoped-define ENABLED-FIELDS-IN-QUERY-d-vapara ~
int_ds_leadtime_fornec.cod_estabel int_ds_leadtime_fornec.cod_emitente 
&Scoped-define ENABLED-TABLES-IN-QUERY-d-vapara int_ds_leadtime_fornec
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-d-vapara int_ds_leadtime_fornec
&Scoped-define QUERY-STRING-d-vapara FOR EACH int_ds_leadtime_fornec SHARE-LOCK
&Scoped-define OPEN-QUERY-d-vapara OPEN QUERY d-vapara FOR EACH int_ds_leadtime_fornec SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-d-vapara int_ds_leadtime_fornec
&Scoped-define FIRST-TABLE-IN-QUERY-d-vapara int_ds_leadtime_fornec


/* Standard List Definitions                                            */
&Scoped-Define ENABLED-FIELDS int_ds_leadtime_fornec.cod_estabel ~
int_ds_leadtime_fornec.cod_emitente 
...
DEFINE QUERY d-vapara FOR 
      int_ds_leadtime_fornec SCROLLING.
&ANALYZE-RESUME

/* ************************  Frame Definitions  *********************** */

DEFINE FRAME d-vapara
     int_ds_leadtime_fornec.cod_estabel AT ROW 1.25 COL 23.14 COLON-ALIGNED WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     int_ds_leadtime_fornec.cod_emitente AT ROW 2.25 COL 23.14 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V  para Lead Time Fornecedor"
...
/* Query rebuild information for DIALOG-BOX d-vapara
     _TblList          = "mgespe.int_ds_leadtime_fornec"
     _Options          = "SHARE-LOCK"
...
ON GO OF FRAME d-vapara /* V  para Lead Time Fornecedor */
DO:
  find FIRST int_ds_leadtime_fornec no-lock 
      where int_ds_leadtime_fornec.cod_estabel  = input frame {&frame-name} int_ds_leadtime_fornec.cod_estabel AND
            int_ds_leadtime_fornec.cod_emitente = input frame {&frame-name} int_ds_leadtime_fornec.cod_emitente no-error.
  if  not avail int_ds_leadtime_fornec then do:
  ...
  assign p-row-tabela = rowid(int_ds_leadtime_fornec).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  para Lead Time Fornecedor */
DO:  
...
------------------------------------------------------------------------------*/
  IF AVAILABLE int_ds_leadtime_fornec THEN 
    DISPLAY int_ds_leadtime_fornec.cod_estabel int_ds_leadtime_fornec.cod_emitente 
      WITH FRAME d-vapara.
  ENABLE rt-button int_ds_leadtime_fornec.cod_estabel 
         int_ds_leadtime_fornec.cod_emitente bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
{utp/ut9000.i "NI0101-G1" "2.00.00.000"}
