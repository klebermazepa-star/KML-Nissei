...
{include/i-prgvrs.i NI0101 2.00.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Lead Time Fornecedor por Estabelecimento"
         HEIGHT             = 5.92
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Lead Time Fornecedor por Estabelecimento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Lead Time Fornecedor por Estabelecimento */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 73.86 ) NO-ERROR.
       /* Size in UIB:  ( 1.25 , 16.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/ni0101-v1.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_V02IN047 ).
       RUN set-position IN h_V02IN047 ( 2.75 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 4.08 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/ni0101-q1.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = intprg/ni0101-z1.w,
                     ProgVaPara = intprg/ni0101-g1.w,
                     ProgIncMod = ':U ,
             OUTPUT h_Q01IN047 ).
...
------------------------------------------------------------------------------*/
  ...
  /* Dispatch standard ADM method.                             */
  {utp/ut9000.i "NI0101" "2.00.00.000"}
