...
*******************************************************************************/
{include/i-prgvrs.i NI0105-Z1 2.00.00.000}  /*** 010010 ***/
...
ON END-ERROR OF w-pesquisa /* Pesquisa Programa RPW */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa Programa RPW */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Programa RPW' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.67 , 80.29 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/ni0105-b1.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b03ad101 ).
       RUN set-position IN h_b03ad101 ( 2.71 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 10.75 , 77.86 ) */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NI0105-Z1" "2.00.00.000"}
