...
*******************************************************************************/
{include/i-prgvrs.i NI0108-Z1 2.00.00.000}
...
DEFINE VARIABLE h_ni0108-b2 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 14.96 COL 1.43
     bt-ok AT ROW 16.5 COL 3
     bt-cancela AT ROW 16.5 COL 14
     bt-ajuda AT ROW 16.5 COL 57.57
     rt-button AT ROW 16.21 COL 1.43
...
ON END-ERROR OF w-pesquisa /* Pesquisa Rota */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa Rota */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Rota Ve¡culo' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.00 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.75 , 67.43 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/ni0108-b2.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_ni0108-b2 ).
       RUN set-position IN h_ni0108-b2 ( 2.75 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 11.63 , 65.00 ) */

       /* Links to SmartBrowser h_ni0108-b2. */
       RUN add-link IN adm-broker-hdl ( h_ni0108-b2 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_ni0108-b2 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
{utp/ut9000.i "NI0108-Z1" "2.00.00.000"}
