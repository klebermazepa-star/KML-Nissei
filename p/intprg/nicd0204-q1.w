...
{include/i-prgvrs.i NICD0204-Q1 2.00.00.000}  /*** 010002 ***/
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_ean_item NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_ean_item NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_ean_item
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_ean_item
...
<FOREIGN-KEYS>
it-codigo||y|int_ds_ean_item.it-codigo
codigo-ean||y|int_ds_ean_item.codigo-ean
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "it-codigo,codigo-ean"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgespe.int_ds_ean_item"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "it_codigo" "int_ds_ean_item" "it_codigo"}
  {src/adm/template/sndkycas.i "codigo_ean" "int_ds_ean_item" "codigo_ean"}
