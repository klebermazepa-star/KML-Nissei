...
*******************************************************************************/
{include/i-prgvrs.i NICD0204A 2.00.00.000}  /*** 010009 ***/
...
DEFINE FRAME f-cad
     bt-ok AT ROW 10.75 COL 2.29
     bt-save AT ROW 10.75 COL 12.72
     bt-cancela AT ROW 10.75 COL 2.29
     bt-ajuda AT ROW 10.75 COL 78.29
     rt-button AT ROW 10.54 COL 1
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Consulta C¢digo EAN Item"
         HEIGHT             = 11.08
         WIDTH              = 88.86
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Consulta C¢digo EAN Item */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Consulta C¢digo EAN Item */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicd0204-v1.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_v02in164 ).
       RUN set-position IN h_v02in164 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 9.38 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicd0204-q1.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_q01in164 ).
       RUN set-position IN h_q01in164 ( 9.79 , 64.57 ) NO-ERROR.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NICD0204A" "2.00.00.000"}
