...
tg-excecao rs-tipo-trib da-dt-bloqueio c-eancnpj i-prazo bt-ok bt-ajuda 
...
DO:    
    ...
    IF AVAIL emitente THEN DO:
       ...
       ASSIGN int_ds_fornecedor.envio_status           = 0
              ...
              int_ds_fornecedor.envio_status           = 1.
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 RECT-2 RECT-3 tg-protocolo tg-emitedanfe tg-biometria 
         tg-microempresa tg-industria tg-notadevolucao tg-excecao rs-tipo-trib 
         da-dt-bloqueio c-eancnpj i-prazo bt-ok bt-ajuda 
      WITH FRAME F-Main IN WINDOW w-window.
