...
{include/i-prgvrs.i NICN0201-Q1 2.00.00.000}  /*** 010002 ***/
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_arq_contrato NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_arq_contrato NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_arq_contrato
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_arq_contrato
...
<FOREIGN-KEYS>
nr-contrato||y|int_ds_arq_contrato.nr-contrato
sequencia||y|int_ds_arq_contrato.sequencia
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "nr-contrato,sequencia"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgespe.int_ds_arq_contrato"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "nr_contrato" "int_ds_arq_contrato" "nr_contrato"}
  {src/adm/template/sndkycas.i "sequencia" "int_ds_arq_contrato" "sequencia"}
