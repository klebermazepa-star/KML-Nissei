...
&Scoped-define INTERNAL-TABLES portador_agrupador

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table portador_agrupador.cod_portador ~
portador_agrupador.descricao portador_agrupador.prefixo ~
portador_agrupador.ind_devol_dat_emis 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH portador_agrupador OF emitente_agrupador WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH portador_agrupador OF emitente_agrupador WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table portador_agrupador
&Scoped-define FIRST-TABLE-IN-QUERY-br-table portador_agrupador
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      portador_agrupador.cod_portador FORMAT "x(5)":U
      portador_agrupador.descricao FORMAT "x(60)":U WIDTH 44
      portador_agrupador.prefixo FORMAT "x(4)":U WIDTH 8.43
      portador_agrupador.ind_devol_dat_emis COLUMN-LABEL "Devoluá∆o Dt Emiss∆o" FORMAT "Sim/Nao":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ASSIGN SEPARATORS SIZE 85 BY 7.5.
...
DEFINE FRAME F-Main
     ...
     bt-incluir AT ROW 8.58 COL 1.14
     bt-modificar AT ROW 8.58 COL 11.14
     bt-eliminar AT ROW 8.58 COL 21.14
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "emsesp.portador_agrupador OF emsesp.emitente_agrupador"
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = emsesp.portador_agrupador.cod-portador
     _FldNameList[2]   > emsesp.portador_agrupador.descricao
"emsesp.portador_agrupador.descricao" ? ? "character" ? ? ? ? ? ? no ? no no "44" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > emsesp.portador_agrupador.prefixo
"emsesp.portador_agrupador.prefixo" ? ? "character" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > emsesp.portador_agrupador.ind-devol-dat-emis
"emsesp.portador_agrupador.ind-devol-dat-emis" "Devoluá∆o Dt Emiss∆o" ? "logical" ? ? ? ? ? ? no "Devoluá∆o Dt Emiss∆o" no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
