...
&Scoped-define QUERY-STRING-Query-Main FOR EACH portador_agrupador WHERE portador_agrupador.cod_empresa = emitente_agrupador.cod_empresa ~
  AND portador_agrupador.cod_emitente = emitente_agrupador.cod_emitente NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH portador_agrupador WHERE portador_agrupador.cod_empresa = emitente_agrupador.cod_empresa ~
  AND portador_agrupador.cod_emitente = emitente_agrupador.cod_emitente NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main portador_agrupador
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main portador_agrupador
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.portador_agrupador WHERE mgesp.emitente_agrupador ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _JoinCode[1]      = "mgesp.portador_agrupador.cod-empresa = mgesp.emitente_agrupador.cod-empresa
  AND mgesp.portador_agrupador.cod_emitente = mgesp.emitente_agrupador.cod_emitente"
