...
&Scoped-define QUERY-STRING-Query-Main FOR EACH portador_agrupador NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH portador_agrupador NO-LOCK INDEXED-REPOSITION.
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "mgesp.portador_agrupador"
