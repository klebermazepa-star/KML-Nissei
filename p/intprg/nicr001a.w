...
*******************************************************************************/
{include/i-prgvrs.i NICR0001A 9.99.99.999}
...
DEFINE FRAME f-cad
     bt-ok AT ROW 4.79 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 4.79 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 4.79 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 4.79 COL 78.14
     rt-button AT ROW 4.63 COL 2
...
DO:
{include/salvapai.i h_nicr001-v01}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_nicr001-v01 ( 1.25 , 1.86 ) NO-ERROR.
       ...
       RUN set-position IN h_nicr001-q01 ( 1.25 , 84.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.00 ) */

       /* Links to SmartViewer h_nicr001-v01. */
       RUN add-link IN adm-broker-hdl ( h_nicr001-q01 , 'Record':U , h_nicr001-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_nicr001-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "XX9999A" "9.99.99.999"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_nicr001-q01 (INPUT v-row-table). 
