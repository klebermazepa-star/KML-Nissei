...
{include/i-prgvrs.i NICR002 9.99.99.999}
...
DEFINE VARIABLE c-emissao-fim AS DATE FORMAT "99/99/9999":U INITIAL 12/31/9999 
     VIEW-AS FILL-IN 
     SIZE 12.43 BY .88 NO-UNDO.

DEFINE VARIABLE c-emissao-ini AS DATE FORMAT "99/99/9999":U INITIAL 01/01/15 
     LABEL "Data EmissÆo" 
     VIEW-AS FILL-IN 
     SIZE 12.43 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     ...
     c-portador-ini AT ROW 3.63 COL 17.86 COLON-ALIGNED WIDGET-ID 10
     c-portador-fim AT ROW 3.63 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     c-emissao-ini AT ROW 4.63 COL 17.86 COLON-ALIGNED WIDGET-ID 20
     c-emissao-fim AT ROW 4.63 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     ...
     IMAGE-7 AT ROW 4.63 COL 32.57 WIDGET-ID 22
     IMAGE-8 AT ROW 4.63 COL 38.72 WIDGET-ID 24
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* Gera‡Æo T¡tulo Pai */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Gera‡Æo T¡tulo Pai */
DO:
...
{utp/ut9000.i "NICR002" "9.99.99.999"}
...
assign c-emissao-ini:screen-value in frame f-pg-sel = string(date(today - 1),"99/99/9999")
       c-emissao-fim:screen-value in frame f-pg-sel = string(date(today - 1),"99/99/9999").
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-estab-fim c-cliente-ini c-cliente-fim c-portador-ini 
          c-portador-fim c-emissao-ini c-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         c-estab-ini c-estab-fim c-cliente-ini c-cliente-fim c-portador-ini 
         c-portador-fim c-emissao-ini c-emissao-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.c-estab-ini         = INPUT FRAME f-pg-sel c-estab-ini
           ...
           tt-param.c-data-emissao-ini  = INPUT FRAME f-pg-sel c-emissao-ini
           tt-param.c-data-emissao-fim  = INPUT FRAME f-pg-sel c-emissao-fim
    ...
    {include/i-rprun.i intprg/nicr002rp.p}
