...
*******************************************************************************/
{include/i-prgvrs.i NICR005a 2.00.00.000}  /*** 010000 ***/

/* &IF "{&EMSFND_VERSION}" >= "1.00"          */
/* &THEN                                      */
/* {include/i-license-manager.i NICR005a MRE} */
/* &ENDIF                                     */
...
&GLOBAL-DEFINE Program        NICR005a
...
&GLOBAL-DEFINE page2Fields    da-trans-ini da-trans-fim c-estab-ini c-estab-fim
...
DEF VAR l-ativo            AS LOG INIT NO NO-UNDO.
...
DEFINE VARIABLE da-trans-ini AS DATE FORMAT "99/99/9999":U INITIAL ? 
...
DEFINE FRAME fPage2
     da-trans-ini AT ROW 1.5 COL 9.71
     da-trans-fim AT ROW 1.5 COL 54.14 NO-LABEL
     c-estab-ini AT ROW 2.5 COL 9
     c-estab-fim AT ROW 2.5 COL 54.14 NO-LABEL
...
/* SETTINGS FOR FILL-IN c-estab-ini IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN da-trans-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN da-trans-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
------------------------------------------------------------------------------*/
    ...
    ASSIGN da-trans-ini:SCREEN-VALUE IN FRAME fPage2 = string(TODAY,"99/99/9999").

    IF  NOT l-acr-ems2 THEN DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.c-destino       = entry((tt-param.destino - 1) * 2 + 1, rsDestiny:radio-buttons in frame fPage6)
           tt-param.dt-trans-ini    = INPUT FRAME fPage2 da-trans-ini
           tt-param.dt-trans-fim    = INPUT FRAME fPage2 da-trans-fim
    ...
    {report/rprun.i intprg/NICR005arp.p}
