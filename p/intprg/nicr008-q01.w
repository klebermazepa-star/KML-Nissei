...
&Scoped-define QUERY-STRING-Query-Main FOR EACH tit_acr WHERE ~{&KEY-PHRASE} ~
     AND tit_acr.cod_espec_docto = "DI" NO-LOCK , ~
      FIRST movto_tit_acr OF tit_acr  ~
      WHERE movto_tit_acr.ind_trans_acr_abrev = "AVMN" NO-LOCK  INDEXED-REPOSITION~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH tit_acr WHERE ~{&KEY-PHRASE} ~
    AND tit_acr.cod_espec_docto = "DI" NO-LOCK, ~
      FIRST movto_tit_acr OF tit_acr  ~
      WHERE movto_tit_acr.ind_trans_acr_abrev = "AVMN" NO-LOCK INDEXED-REPOSITION ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-Query-Main tit_acr movto_tit_acr
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main tit_acr
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main movto_tit_acr
...
<FOREIGN-KEYS>
cod_banco||y|emscad.tit_acr.cod_banco
cod_cart_bcia||y|emscad.tit_acr.cod_cart_bcia
cod_portador||y|emscad.tit_acr.cod_portador
cod_cta_corren||y|emscad.tit_acr.cod_cta_corren
cod_empresa||y|emscad.tit_acr.cod_empresa
cod_espec_docto||y|emscad.tit_acr.cod_espec_docto
cod_estab||y|emscad.tit_acr.cod_estab
nom_abrev||y|emscad.tit_acr.nom_abrev
cod_grp_clien||y|emscad.tit_acr.cod_grp_clien
cod_indic_econ||y|emscad.tit_acr.cod_indic_econ
num_id_movto_cta_corren||y|emscad.tit_acr.num_id_movto_cta_corren
cod_refer||y|emscad.tit_acr.cod_refer
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emscad.tit_acr,emscad.movto_tit_acr OF emscad.tit_acr "
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _TblOptList       = ", FIRST"
     _Where[1]         = "emscad.tit_acr.cod_espec_docto = ""DI"""
     _Where[2]         = "emscad.movto_tit_acr.ind_trans_acr_abrev = ""AVMN"""
