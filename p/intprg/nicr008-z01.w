...
DEFINE VARIABLE h_nicr008-b02 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa de T¡tulos Conferˆncia"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-pesquisa /* Pesquisa de T¡tulos Conferˆncia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de T¡tulos Conferˆncia */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr008-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr008-b02 ).
       RUN set-position IN h_nicr008-b02 ( 2.71 , 4.43 ) NO-ERROR.
       /* Size in UIB:  ( 11.50 , 80.14 ) */

       /* Links to SmartBrowser h_nicr008-b02. */
       RUN add-link IN adm-broker-hdl ( h_nicr008-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr008-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
