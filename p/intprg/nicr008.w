...
*******************************************************************************/
{include/i-prgvrs.i NICR008 9.99.99.999}
...
&Scoped-Define ENABLED-OBJECTS rt-button bt-hitstorico 
...
DEFINE VARIABLE h_nicr008-b01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr008-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr008-v01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-exihel AS HANDLE NO-UNDO.
DEFINE VARIABLE h_p-navega AS HANDLE NO-UNDO.

/* Definitions of the field level widgets                               */
DEFINE BUTTON bt-hitstorico 
     LABEL "Hist¢rico" 
     SIZE 15 BY 1.13.
...
DEFINE FRAME f-cad
     bt-hitstorico AT ROW 1.17 COL 71.86 WIDGET-ID 2
     rt-button AT ROW 1 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 103.43 BY 17 WIDGET-ID 100.
...
ON END-ERROR OF w-cadpaifilho-filho /* Conferˆncia Furo Caixa */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-filho w-cadpaifilho-filho
ON WINDOW-CLOSE OF w-cadpaifilho-filho /* Conferˆncia Furo Caixa */
DO:
...
&Scoped-define SELF-NAME bt-hitstorico
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-hitstorico w-cadpaifilho-filho
ON CHOOSE OF bt-hitstorico IN FRAME f-cad /* Hist¢rico */
DO:
  RUN intprg/nicr008c.w.
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.13 , 87.29 ) NO-ERROR.
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr008-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr008-v01 ).
       RUN set-position IN h_nicr008-v01 ( 2.54 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 3.50 , 101.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Movimentos' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 6.13 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 11.38 , 103.00 ) NO-ERROR.

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr008-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr008-b01 ).
       RUN set-position IN h_nicr008-b01 ( 7.42 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 10.04 , 101.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr008-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = intprg/nicr008-z01.w,
                     ProgVaPara = intprg/nicr008-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_nicr008-q01 ).
       RUN set-position IN h_nicr008-q01 ( 1.00 , 66.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartPanel h_p-exihel. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , THIS-PROCEDURE ).

       /* Links to SmartViewer h_nicr008-v01. */
       RUN add-link IN adm-broker-hdl ( h_nicr008-q01 , 'Record':U , h_nicr008-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to BrowserCadastro2 h_nicr008-b01. */
       RUN add-link IN adm-broker-hdl ( h_nicr008-q01 , 'Record':U , h_nicr008-b01 ).

       /* Links to SmartQuery h_nicr008-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_nicr008-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_nicr008-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             bt-hitstorico:HANDLE IN FRAME f-cad , 'BEFORE':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-navega ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr008-v01 ,
             bt-hitstorico:HANDLE IN FRAME f-cad , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_nicr008-v01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr008-b01 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ENABLE rt-button bt-hitstorico 
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NICR008" "9.99.99.999"}
  ...
  ASSIGN  gh-movto-furo = h_nicr008-q01:HANDLE.
