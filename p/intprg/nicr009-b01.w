...
&Scoped-define INTERNAL-TABLES movto_vale_manual tit_acr

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table movto_vale_manual.seq_movto ~
...
tit_acr.val_sdo_tit_acr movto_vale_manual.val_movto 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH movto_vale_manual OF vale_manual WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH tit_acr WHERE tit_acr.num_id_tit_acr = movto_vale_manual.num_id_tit_acr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH movto_vale_manual OF vale_manual WHERE ~{&KEY-PHRASE} NO-LOCK, ~
      EACH tit_acr WHERE tit_acr.num_id_tit_acr = movto_vale_manual.num_id_tit_acr NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-br-table movto_vale_manual tit_acr
&Scoped-define FIRST-TABLE-IN-QUERY-br-table movto_vale_manual
...
<FOREIGN-KEYS>
num_vale||y|custom.movto_vale_manual.num_vale
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      movto_vale_manual.seq_movto COLUMN-LABEL "Seq." FORMAT "999":U
            WIDTH 5.43
      ...
      movto_vale_manual.val_movto FORMAT "->>>,>>>,>>9.99":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   External Tables: custom.vale_manual
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "custom.movto_vale_manual OF custom.vale_manual,emscad.tit_acr WHERE custom.movto_vale_manual ..."
     _Options          = "NO-LOCK INDEXED-REPOSITION KEY-PHRASE SORTBY-PHRASE"
     _JoinCode[2]      = "emscad.tit_acr.num_id_tit_acr = custom.movto_vale_manual.num_id_tit_acr"
     _FldNameList[1]   > custom.movto_vale_manual.seq_movto
"custom.movto_vale_manual.seq_movto" "Seq." ? "integer" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"emscad.tit_acr.nom_abrev" ? ? "character" ? ? ? ? ? ? no ? no no "16.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     ...
     _FldNameList[12]   = custom.movto_vale_manual.val_movto
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "num_vale" "movto_vale_manual" "num_vale"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "movto_vale_manual"}
