...
&Scoped-define QUERY-STRING-Query-Main FOR EACH vale_manual NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH vale_manual NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main vale_manual
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main vale_manual
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE pi-recarrega-tela q-tables 
PROCEDURE pi-recarrega-tela :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
