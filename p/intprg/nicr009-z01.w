...
DEFINE VARIABLE h_nicr009-b02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr009-b03 AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Funcion rio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Funcion rio */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Matr¡cula|Nome' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr009-b02.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr009-b02 ).
       RUN set-position IN h_nicr009-b02 ( 2.75 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 11.75 , 86.43 ) */

       /* Links to SmartBrowser h_nicr009-b02. */
       RUN add-link IN adm-broker-hdl ( h_nicr009-b02 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr009-b02 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
    WHEN 2 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr009-b03.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr009-b03 ).
       RUN set-position IN h_nicr009-b03 ( 2.71 , 2.72 ) NO-ERROR.
       /* Size in UIB:  ( 11.75 , 86.00 ) */

       /* Links to SmartBrowser h_nicr009-b03. */
       RUN add-link IN adm-broker-hdl ( h_nicr009-b03 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr009-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 2 */
