...
DEFINE VARIABLE h_nicr009-b04 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Vale Manual' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr009-b04.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr009-b04 ).
       RUN set-position IN h_nicr009-b04 ( 2.71 , 3.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.75 , 86.00 ) */

       /* Links to SmartBrowser h_nicr009-b04. */
       RUN add-link IN adm-broker-hdl ( h_nicr009-b04 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr009-b04 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
