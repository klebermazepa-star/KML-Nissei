...
{include/i-prgvrs.i NICR009E 9.99.99.999}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Impress∆o Vale Funcion†rio"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Impress∆o Vale Funcion†rio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Impress∆o Vale Funcion†rio */
DO:
...
{utp/ut9000.i "NICR009E" "2.06.00.001"}
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i intprg/nicr009erp.p}
