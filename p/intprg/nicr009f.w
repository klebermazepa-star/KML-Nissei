...
*******************************************************************************/
{include/i-prgvrs.i NICR009F 9.99.99.999}
...
IMAGE-8 IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 fi-estab-ini ~
fi-estab-fim fi-especie-ini fi-especie-fim fi-serie-ini fi-serie-fim ~
fi-titulo-ini fi-titulo-fim fi-data-ini fi-data-fim bt-ok bt-cancela ~
bt-ajuda 
...
DEFINE VARIABLE fi-data-fim AS DATE FORMAT "99/99/9999":U INITIAL ? 
     VIEW-AS FILL-IN 
...
DEFINE FRAME D-Dialog
     ...
     bt-ok AT ROW 7.17 COL 3
     bt-cancela AT ROW 7.17 COL 14
     bt-ajuda AT ROW 7.17 COL 41.57
     rt-buttom AT ROW 6.96 COL 1.57
...
------------------------------------------------------------------------------*/
  ...
  ENABLE rt-buttom RECT-16 IMAGE-1 IMAGE-2 IMAGE-7 IMAGE-8 IMAGE-9 IMAGE-10 
         IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 fi-estab-ini fi-estab-fim 
         fi-especie-ini fi-especie-fim fi-serie-ini fi-serie-fim fi-titulo-ini 
         fi-titulo-fim fi-data-ini fi-data-fim bt-ok bt-cancela bt-ajuda 
      WITH FRAME D-Dialog.
  VIEW FRAME D-Dialog.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NICR009F" "9.99.99.999"}
