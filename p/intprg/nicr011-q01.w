...
&Scoped-define INTERNAL-TABLES cst-nota-fiscal

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH cst-nota-fiscal ~
      WHERE cst-nota-fiscal.cartao-manual = TRUE NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH cst-nota-fiscal ~
      WHERE cst-nota-fiscal.cartao-manual = TRUE NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main cst-nota-fiscal
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main cst-nota-fiscal
...
<FOREIGN-KEYS>
cod-estabel||y|emsesp.cst-nota-fiscal.cod-estabel
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.cst-nota-fiscal"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "emsesp.cst-nota-fiscal.cartao-manual = TRUE"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod-estabel" "cst-nota-fiscal" "cod-estabel"}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "cst-nota-fiscal"}
