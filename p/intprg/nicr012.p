 ...
 .
           ...
           for       
              each movto_tit_acr no-lock
                   ...
                   FIRST cst_furo_caixa NO-LOCK
                   WHERE cst_furo_caixa.cod_estab            = movto_tit_acr.cod_estab
                     AND cst_furo_caixa.num_id_tit_acr       = movto_tit_acr.num_id_tit_acr
                     AND cst_furo_caixa.num_id_movto_tit_acr = movto_tit_acr.num_id_movto_tit_acr
                     AND INT(cst_furo_caixa.mat_colabor) >= v_cod_colab_inic 
                     AND INT(cst_furo_caixa.mat_colabor) <= v_cod_colab_final:
...
/*                    WHERE VR034FUN.NUMCAD = INT(cst_furo_caixa.mat-colabor) NO-ERROR. */
              ...
              assign tt_rpt_motiv_movto_tit_acr_dem.ttv_rec_motiv_movto_tit_acr = recid(tt_rpt_motiv_movto_tit_acr_dem)
                     ...
                     tt_rpt_motiv_movto_tit_acr_dem.ttv_cod_colaborador     = INT(cst_furo_caixa.mat_colabor)
                     tt_rpt_motiv_movto_tit_acr_dem.ttv_nom_colaborador     = cst_furo_caixa.nome_func /* IF AVAIL VR034FUN THEN CAPS(VR034FUN.NOMFUN) ELSE "N∆o Encontrado!" */
