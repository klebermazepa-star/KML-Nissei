...
&Scoped-define INTERNAL-TABLES cst_fat_duplic

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table cst_fat_duplic.cod_portador ~
cst_fat_duplic.condipag cst_fat_duplic.parcela cst_fat_duplic.nr_fatura 
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table 
&Scoped-define QUERY-STRING-br-table FOR EACH cst_fat_duplic WHERE TRUE /* Join to cst_nota_fiscal incomplete */ NO-LOCK ~
    ~{&SORTBY-PHRASE}
&Scoped-define OPEN-QUERY-br-table OPEN QUERY br-table FOR EACH cst_fat_duplic WHERE TRUE /* Join to cst_nota_fiscal incomplete */ NO-LOCK ~
    ~{&SORTBY-PHRASE}.
&Scoped-define TABLES-IN-QUERY-br-table cst_fat_duplic
&Scoped-define FIRST-TABLE-IN-QUERY-br-table cst_fat_duplic
...
<FOREIGN-KEYS>
cod_cond_pag||y|emsesp.cst_fat_duplic.cod_cond_pag
cod_estabel||y|emsesp.cst_fat_duplic.cod_estabel
CONDIPAG||y|emsesp.cst_fat_duplic.CONDIPAG
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod_cond_pag,cod_estabel,CONDIPAG"':U).
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      cst_fat_duplic.cod_portador FORMAT ">>>>9":U
      cst_fat_duplic.condipag FORMAT "x(2)":U
      cst_fat_duplic.parcela FORMAT "x(02)":U
      cst_fat_duplic.nr_fatura FORMAT "x(16)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Settings for THIS-PROCEDURE
   ...
   External Tables: shemsesp.cst_nota_fiscal
   Allow: Basic,Browse
   Frames: 1
...
/* Query rebuild information for BROWSE br-table
     _TblList          = "emsesp.cst_fat_duplic WHERE shemsesp.cst_nota_fiscal <external> ..."
     _Options          = "NO-LOCK KEY-PHRASE SORTBY-PHRASE"
     _FldNameList[1]   = emsesp.cst_fat_duplic.cod_portador
     _FldNameList[2]   = emsesp.cst_fat_duplic.condipag
     _FldNameList[3]   = emsesp.cst_fat_duplic.parcela
     _FldNameList[4]   = emsesp.cst_fat_duplic.nr_fatura
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cod_cond_pag" "cst_fat_duplic" "cod_cond_pag"}
  {src/adm/template/sndkycas.i "cod_estabel" "cst_fat_duplic" "cod_estabel"}
  {src/adm/template/sndkycas.i "CONDIPAG" "cst_fat_duplic" "CONDIPAG"}
