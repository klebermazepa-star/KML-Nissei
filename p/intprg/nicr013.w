...
*******************************************************************************/
{include/i-prgvrs.i NICR013 9.99.99.999}
...
DEFINE VARIABLE h_nicr013-b01-4 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr013-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr013-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 91 BY 22.08 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadpaifilho-filho ASSIGN
         HIDDEN             = YES
         TITLE              = "Manutená∆o Cart∆o Manual"
         HEIGHT             = 22.08
         WIDTH              = 91
         MAX-HEIGHT         = 26.83
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-cadpaifilho-filho /* Manutená∆o Cart∆o Manual */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-filho w-cadpaifilho-filho
ON WINDOW-CLOSE OF w-cadpaifilho-filho /* Manutená∆o Cart∆o Manual */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Duplicatas' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 13.75 , 1.72 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.00 , 89.29 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr013-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr013-v01 ).
       RUN set-position IN h_nicr013-v01 ( 2.58 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 11.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr013-b01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     Create-On-Add = ?,
                     ProgAtributo = ,
                     ProgIncMod = intprg/nicr013b.w,
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_nicr013-b01-4 ).
       RUN set-position IN h_nicr013-b01-4 ( 15.21 , 2.43 ) NO-ERROR.
       /* Size in UIB:  ( 7.50 , 87.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr013-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = intprg/nicr013-z01.w,
                     ProgVaPara = intprg/nicr013-g01.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_nicr013-q01 ).
       RUN set-position IN h_nicr013-q01 ( 1.25 , 63.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_nicr013-v01. */
       RUN add-link IN adm-broker-hdl ( h_nicr013-q01 , 'Record':U , h_nicr013-v01 ).

       /* Links to BrowserCadastro2 h_nicr013-b01-4. */
       RUN add-link IN adm-broker-hdl ( h_nicr013-q01 , 'Record':U , h_nicr013-b01-4 ).

       /* Links to SmartQuery h_nicr013-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_nicr013-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_nicr013-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_nicr013-q01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr013-v01 ,
             h_p-navega , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr013-b01-4 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NICR013" "9.99.99.999"}
