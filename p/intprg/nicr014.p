                            ...
                            IF AVAIL docum-est THEN DO:
                                ...
                                IF AVAIL item-doc-est THEN DO:
                                    FIND FIRST cst_nota_fiscal NO-LOCK
                                         WHERE cst_nota_fiscal.cod_estabel = docum-est.cod-estabel
                                           AND cst_nota_fiscal.serie       = item-doc-est.serie-comp
                                           AND cst_nota_fiscal.nr_nota_fis = item-doc-est.nro-comp  NO-ERROR.
                                    IF AVAIL cst_nota_fiscal THEN DO:
                                        ASSIGN v_cod_convenio = cst_nota_fiscal.convenio.

                                        FIND FIRST int_ds_convenio NO-LOCK
                                             WHERE int_ds_convenio.cod_convenio = INT(cst_nota_fiscal.convenio) NO-ERROR.
                                        IF AVAIL int_ds_convenio THEN DO:
                                            FIND FIRST cliente USE-INDEX cliente_idfedercli
                                                 WHERE cliente.cod_pais     = "BRA"
                                                   AND cliente.cod_id_feder = int_ds_convenio.cnpj NO-ERROR.
        ...
        IF v_cod_convenio = "" THEN DO:
            FOR FIRST nota-fiscal
                ...
                IF AVAIL cst_nota_fiscal THEN DO:
                    ...
                    IF AVAIL int_ds_convenio THEN DO:
                        FIND FIRST cliente
                             WHERE cliente.cod_id_feder = int_ds_convenio.cnpj NO-ERROR.
                        IF AVAIL cliente THEN DO:
                            ASSIGN v_cod_cli_convenio = cliente.cdn_cliente.
                        END.
                    END.
