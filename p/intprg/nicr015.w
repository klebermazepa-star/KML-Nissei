...
&Scoped-define FIELDS-IN-QUERY-br-convenio /* int_ds_convenio.cnpj */ tt-convenio.cod_convenio tt-convenio.cod-emitente tt-convenio.nome-abrev tt-convenio.nome-emit tt-convenio.dia_fechamento tt-convenio.dia_vencimento tt-convenio.log_envia_cupom tt-convenio.ENVIO_DATA_HORA tt-convenio.TIPO tt-convenio.origem /* tt-convenio.receita */   
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-convenio W-Win _FREEFORM
  QUERY br-convenio DISPLAY
     ...
     tt-convenio.ENVIO_DATA_HORA COLUMN-LABEL "Data Registro"
     tt-convenio.TIPO 
     tt-convenio.origem
