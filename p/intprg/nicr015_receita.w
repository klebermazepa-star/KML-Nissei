...
{&OPEN-QUERY-BR-CONVENIO}
    ...
    FOR EACH int_ds_convenio
       ...
       WHERE emitente.cgc = int_ds_convenio.cnpj
         ...
         IF int_ds_convenio.tipo_venda = 1 THEN DO:
             ASSIGN tt-convenio.receita = "Com Receita".
         END.
         ELSE IF int_ds_convenio.tipo_venda = 2 THEN DO:
             ASSIGN tt-convenio.receita = "Sem Receita".
         END.
         ELSE IF int_ds_convenio.tipo_venda = 0 OR int_ds_convenio.tipo_venda = 3 THEN DO:
