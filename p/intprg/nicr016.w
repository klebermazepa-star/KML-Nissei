...
{include/i-prgvrs.i NICR016 9.99.99.999}
...
DEFINE VARIABLE c-nota-fim AS CHARACTER FORMAT "X(12)":U INITIAL "ZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME f-pg-sel
     ...
     c-nota-ini AT ROW 4.67 COL 20 COLON-ALIGNED WIDGET-ID 52
     c-nota-fim AT ROW 4.67 COL 41 COLON-ALIGNED NO-LABEL WIDGET-ID 50
     c-data-ini AT ROW 5.63 COL 21.43 COLON-ALIGNED WIDGET-ID 10
     c-data-fim AT ROW 5.63 COL 41 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     IMAGE-5 AT ROW 5.63 COL 33.72 WIDGET-ID 14
     IMAGE-6 AT ROW 5.63 COL 39.86 WIDGET-ID 16
     IMAGE-7 AT ROW 4.67 COL 33.72 WIDGET-ID 54
     IMAGE-8 AT ROW 4.67 COL 39.86 WIDGET-ID 56
...
ON END-ERROR OF w-relat /* Cupom - Cart∆o Manual */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Cupom - Cart∆o Manual */
DO:
...
{utp/ut9000.i "NICR016" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i intprg/nicr016rp.p}
