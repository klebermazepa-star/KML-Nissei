...
DEFINE TEMP-TABLE tt-tit-acr     LIKE tit_acr
    ...
    FIELD receita      AS CHAR FORMAT "x(12)" COLUMN-LABEL "Receita?"
    FIELD categoria    LIKE cst_nota_fiscal.categoria
    FIELD orgao        LIKE  cst_nota_fiscal.orgao
...
&Scoped-define FIELDS-IN-QUERY-br-tit-acr tt-tit-acr.marca tt-tit-acr.cod_estab tt-tit-acr.cdn_cliente tt-tit-acr.razao-social tt-tit-acr.cod_espec_docto tt-tit-acr.cod_ser_docto tt-tit-acr.cod_tit_acr tt-tit-acr.cod_parcela tt-tit-acr.id-pedido tt-tit-acr.dat_emis_docto tt-tit-acr.dat_vencto_origin_tit_acr tt-tit-acr.val_sdo_tit_acr tt-tit-acr.orgao tt-tit-acr.categoria   
...
&Scoped-define FIELDS-IN-QUERY-br-tit-acr-sel tt-tit-acr-sel.marca tt-tit-acr-sel.cod_estab tt-tit-acr-sel.cdn_cliente tt-tit-acr-sel.razao-social tt-tit-acr-sel.cod_espec_docto tt-tit-acr-sel.cod_ser_docto tt-tit-acr-sel.cod_tit_acr tt-tit-acr-sel.cod_parcela tt-tit-acr-sel.id-pedido tt-tit-acr-sel.dat_emis_docto tt-tit-acr-sel.dat_vencto_origin_tit_acr tt-tit-acr-sel.val_sdo_tit_acr tt-tit-acr-sel.orgao DROP-DOWN-LIST tt-tit-acr-sel.categoria DROP-DOWN-LIST   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-tit-acr-sel tt-tit-acr-sel.orgao tt-tit-acr-sel.categoria   
&Scoped-define ENABLED-TABLES-IN-QUERY-br-tit-acr-sel tt-tit-acr-sel
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-br-tit-acr-sel tt-tit-acr-sel
...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 rt-button fi-estab fi-cliente ~
cb-convenio bt-carrega-tit fi-dt-emis br-tit-acr br-tit-acr-sel bt-executar ~
bt-cancelar 
&Scoped-Define DISPLAYED-OBJECTS fi-estab fi-cliente fi-nome-cliente ~
cb-convenio fi-dt-emis 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-tit-acr W-Win _FREEFORM
 ...
 tt-tit-acr.dat_emis_docto            WIDTH 8.5
 tt-tit-acr.dat_vencto_origin_tit_acr WIDTH 8.5 COLUMN-LABEL "Dat Vencto"
 tt-tit-acr.val_sdo_tit_acr
 tt-tit-acr.orgao        WIDTH 8 COLUMN-LABEL "Org∆o"
 tt-tit-acr.categoria            COLUMN-LABEL "Categoria"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 117.72 BY 9.75
         FONT 1 ROW-HEIGHT-CHARS .55 FIT-LAST-COLUMN.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-tit-acr-sel W-Win _FREEFORM
 ...
 tt-tit-acr-sel.dat_emis_docto            WIDTH 8.5
 tt-tit-acr-sel.dat_vencto_origin_tit_acr WIDTH 8.5 COLUMN-LABEL "Dat Vencto"
 tt-tit-acr-sel.val_sdo_tit_acr
 tt-tit-acr-sel.orgao         COLUMN-LABEL "Org∆o"
 WIDTH-CHARS 8
 VIEW-AS COMBO-BOX
 INNER-LINES 5
 DROP-DOWN-LIST
 tt-tit-acr-sel.categoria            COLUMN-LABEL "Categoria"
 WIDTH-CHARS 6
 VIEW-AS COMBO-BOX
 INNER-LINES 4
 DROP-DOWN-LIST
 ENABLE
 tt-tit-acr-sel.orgao
 tt-tit-acr-sel.categoria
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 117.72 BY 11.5 ROW-HEIGHT-CHARS .55 FIT-LAST-COLUMN.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME F-Main
     fi-estab AT ROW 2 COL 15.72 COLON-ALIGNED WIDGET-ID 10
     fi-cliente AT ROW 2.96 COL 15.72 COLON-ALIGNED WIDGET-ID 24
     fi-nome-cliente AT ROW 2.96 COL 30.14 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     cb-convenio AT ROW 2.96 COL 102.72 COLON-ALIGNED NO-LABEL WIDGET-ID 52
     bt-carrega-tit AT ROW 3.75 COL 119 WIDGET-ID 34
     fi-dt-emis AT ROW 3.92 COL 15.72 COLON-ALIGNED WIDGET-ID 12
     br-tit-acr AT ROW 5.33 COL 2.29 WIDGET-ID 200
     bt-filtro AT ROW 5.38 COL 120.29 WIDGET-ID 28
     bt-marca AT ROW 6.38 COL 120.29 WIDGET-ID 36
     bt-desmarca AT ROW 7.38 COL 120.29 WIDGET-ID 38
     bt-incluir AT ROW 8.33 COL 120.29 WIDGET-ID 40
     br-tit-acr-sel AT ROW 15.25 COL 2.29 WIDGET-ID 300
     bt-filtro-sel AT ROW 15.33 COL 120.29 WIDGET-ID 54
     bt-marca-sel AT ROW 16.33 COL 120.29 WIDGET-ID 44
     bt-desmarca-sel AT ROW 17.33 COL 120.29 WIDGET-ID 46
     bt-excluir AT ROW 18.33 COL 120.29 WIDGET-ID 48
     bt-soma AT ROW 25.79 COL 120.29 WIDGET-ID 56
     bt-executar AT ROW 27.25 COL 2 HELP
          "Dispara a execuá∆o do relat¢rio" WIDGET-ID 32
     bt-cancelar AT ROW 27.25 COL 13 HELP
          "Fechar" WIDGET-ID 30
     "ParÉmetros" VIEW-AS TEXT
          SIZE 9.57 BY .67 AT ROW 1.04 COL 2.43 WIDGET-ID 8
     RECT-1 AT ROW 1.25 COL 1.29 WIDGET-ID 2
     RECT-2 AT ROW 5.13 COL 1.43 WIDGET-ID 4
     rt-button AT ROW 27.04 COL 1.29 WIDGET-ID 6
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 124.57 BY 27.5 WIDGET-ID 100.
...
/* SETTINGS FOR FRAME F-Main
   FRAME-NAME                                                           */
/* BROWSE-TAB br-tit-acr fi-dt-emis F-Main */
...
ON END-ERROR OF W-Win /* Geraá∆o Convànio - ICS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL W-Win W-Win
ON WINDOW-CLOSE OF W-Win /* Geraá∆o Convànio - ICS */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br-tit-acr-sel W-Win
ON ROW-ENTRY OF br-tit-acr-sel IN FRAME F-Main
DO:
  DEFINE VARIABLE clista     AS CHARACTER NO-UNDO.
  DEFINE VARIABLE clistaOrgao AS CHARACTER NO-UNDO.

    ASSIGN cLista      = "LEI" + "," + "TRAB" + "," + "HOSP" + "," + "ALTO".
    ASSIGN clistaOrgao = "PMC"  + "," + "IPPUC" + "," + "FCC" + "," +
                         "URBS" + "," + "FAS" + "," + "CIC" + "," +
                         "COHAB" + "," + "IPMC" + "," + "IMAP" + "," +
                         "IMT" + "," + "CMC". 
...
/*     END.                                       */
    ...
    ASSIGN
    tt-tit-acr-sel.categoria:LIST-ITEMS IN BROWSE {&BROWSE-NAME} = clista
    tt-tit-acr-sel.orgao:LIST-ITEMS     IN BROWSE {&BROWSE-NAME} = clistaOrgao     .
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br-tit-acr-sel W-Win
ON ROW-LEAVE OF br-tit-acr-sel IN FRAME F-Main
DO:
  DEFINE BUFFER b-cst_nota_fiscal FOR cst_nota_fiscal.

  ASSIGN tt-tit-acr-sel.categoria = tt-tit-acr-sel.categoria:SCREEN-VALUE IN BROWSE br-tit-acr-sel.
  ASSIGN tt-tit-acr-sel.orgao     = tt-tit-acr-sel.orgao:SCREEN-VALUE     IN BROWSE br-tit-acr-sel.

  FIND FIRST b-cst_nota_fiscal
       WHERE b-cst_nota_fiscal.cod_estabel = tt-tit-acr-sel.cod_estab           
         AND b-cst_nota_fiscal.serie       = tt-tit-acr-sel.cod_ser_docto 
         AND b-cst_nota_fiscal.nr_nota_fis = tt-tit-acr-sel.cod_tit_acr
         AND b-cst_nota_fiscal.convenio    = INPUT FRAME {&FRAME-NAME} cb-convenio EXCLUSIVE-LOCK NO-ERROR.
  IF AVAIL b-cst_nota_fiscal THEN DO:
      IF tt-tit-acr-sel.categoria = "LEI" THEN DO:
          ASSIGN b-cst_nota_fiscal.categoria = "LEI".
      END.
      ELSE IF tt-tit-acr-sel.categoria = "TRAB" THEN DO:
          ASSIGN b-cst_nota_fiscal.categoria = "TRAB".
      END.
      ELSE IF tt-tit-acr-sel.categoria = "HOSP" THEN DO:
          ASSIGN b-cst_nota_fiscal.categoria = "HOSP".
      END.
      ELSE IF tt-tit-acr-sel.categoria = "ALTO" THEN DO:
          ASSIGN b-cst_nota_fiscal.categoria = "ALTO".
      END.

      ASSIGN b-cst_nota_fiscal.orgao = tt-tit-acr-sel.orgao.
  END.
  RELEASE b-cst_nota_fiscal.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL br-tit-acr-sel W-Win
ON VALUE-CHANGED OF br-tit-acr-sel IN FRAME F-Main
DO:
    DEFINE BUFFER b-cst_nota_fiscal FOR cst_nota_fiscal.
    ...
    IF CAN-FIND(FIRST tt-tit-acr-sel
        ...
        FOR EACH tt-tit-acr-sel
         ...
         IF AVAIL tt-tit-acr THEN DO:
             ...
             ASSIGN tt-tit-acr.receita = tt-tit-acr-sel.receita.
...
------------------------------------------------------------------------------*/
  DISPLAY fi-estab fi-cliente fi-nome-cliente cb-convenio fi-dt-emis 
      WITH FRAME F-Main IN WINDOW W-Win.
  ENABLE RECT-1 RECT-2 rt-button fi-estab fi-cliente cb-convenio bt-carrega-tit 
         fi-dt-emis br-tit-acr br-tit-acr-sel bt-executar bt-cancelar 
      WITH FRAME F-Main IN WINDOW W-Win.
...
FOR EACH tit_acr NO-LOCK USE-INDEX titacr_cliente
   ...
   WHERE cst_nota_fiscal.cod_estabel = tit_acr.cod_estab           
    ...
    IF NOT AVAIL tt-tit-acr THEN DO:
       ...
       /* INICIO - Alteraá∆o SM... para inclus∆o da informaá∆o de Categoria para o Convànio ICS*/
        ASSIGN tt-tit-acr.orgao = cst_nota_fiscal.orgao.

        IF cst_nota_fiscal.categoria = "LEI" THEN DO:
            ASSIGN tt-tit-acr.categoria = "LEI".
        END.
        ELSE IF cst_nota_fiscal.categoria = "TRAB" THEN DO:
            ASSIGN tt-tit-acr.categoria = "TRAB".
        END.
        ELSE IF cst_nota_fiscal.categoria = "HOSP" THEN DO:
            ASSIGN tt-tit-acr.categoria = "HOSP".
        END.
        ELSE IF cst_nota_fiscal.categoria = "ALTO" THEN DO:
            ASSIGN tt-tit-acr.categoria = "ALTO".
        END.
        /* FIM    - Alteraá∆o SM... para inclus∆o da informaá∆o de Categoria para o Convànio ICS*/
...
ASSIGN fi-cliente:SCREEN-VALUE IN FRAME {&FRAME-NAME} = "1001089".
APPLY "LEAVE" TO fi-cliente IN FRAME {&FRAME-NAME}.
