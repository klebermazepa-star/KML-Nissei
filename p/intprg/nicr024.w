...
*******************************************************************************/
{include/i-prgvrs.i NICR024 1.00.00.001}
...
&Scoped-Define ENABLED-OBJECTS RECT-10 RECT-7 RECT-9 rs-destino ~
bt-config-impr bt-arquivo c-arquivo c-modelo bt-modelo rs-execucao ~
text-modelo 
...
DEFINE VARIABLE cod-emitente-fim AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 9999999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE cod-gr-forn-fim AS INTEGER FORMAT ">>9":U INITIAL 5 
     VIEW-AS FILL-IN 
     SIZE 14.14 BY .88 NO-UNDO.

DEFINE VARIABLE cod-gr-forn-ini AS INTEGER FORMAT ">>9":U INITIAL 5 
...
DEFINE VARIABLE dt-emis-nota-ini AS DATE FORMAT "99/99/9999":U 
     LABEL "Dt EmissÆo (NFD)" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE nr-nota-fis-fim AS CHARACTER FORMAT "X(10)":U INITIAL "ZZZZZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 14.14 BY .88 NO-UNDO.

DEFINE VARIABLE nr-nota-fis-ini AS CHARACTER FORMAT "X(10)":U 
     LABEL "Nota Fiscal (NFD)" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.

DEFINE VARIABLE serie-fim AS CHARACTER FORMAT "X(5)":U INITIAL "ZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 14.14 BY .88 NO-UNDO.

DEFINE VARIABLE serie-ini AS CHARACTER FORMAT "X(5)":U 
     LABEL "S‚rie (NFD)" 
     VIEW-AS FILL-IN 
     SIZE 13 BY .88 NO-UNDO.
...
DEFINE VARIABLE tgConsideraMatriz AS LOGICAL INITIAL no 
     LABEL "Considerar a matriz do fornecedor" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     ...
     nr-nota-fis-ini AT ROW 2.79 COL 19 COLON-ALIGNED
     nr-nota-fis-fim AT ROW 2.79 COL 45 COLON-ALIGNED NO-LABEL
     serie-ini AT ROW 3.92 COL 19 COLON-ALIGNED WIDGET-ID 8
     serie-fim AT ROW 3.92 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     cod-emitente-ini AT ROW 4.96 COL 19 COLON-ALIGNED WIDGET-ID 30
     cod-emitente-fim AT ROW 4.96 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     cod-gr-forn-ini AT ROW 6.04 COL 19 COLON-ALIGNED WIDGET-ID 42
     cod-gr-forn-fim AT ROW 6.04 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 40
     tgConsideraMatriz AT ROW 7.13 COL 21.14 WIDGET-ID 38
     dt-emis-nota-ini AT ROW 8.29 COL 19 COLON-ALIGNED WIDGET-ID 22
     dt-emis-nota-fim AT ROW 8.29 COL 45 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     IMAGE-1 AT ROW 2.79 COL 34.29
     IMAGE-2 AT ROW 2.79 COL 44
     IMAGE-3 AT ROW 3.92 COL 34.29 WIDGET-ID 2
     IMAGE-4 AT ROW 3.92 COL 44 WIDGET-ID 4
     IMAGE-5 AT ROW 1.71 COL 34.29 WIDGET-ID 16
     IMAGE-6 AT ROW 1.71 COL 44 WIDGET-ID 18
     IMAGE-7 AT ROW 8.29 COL 34.29 WIDGET-ID 24
     IMAGE-8 AT ROW 8.29 COL 44 WIDGET-ID 26
     IMAGE-9 AT ROW 4.96 COL 34.29 WIDGET-ID 32
     IMAGE-10 AT ROW 4.96 COL 44 WIDGET-ID 34
     IMAGE-11 AT ROW 6.04 COL 34.29 WIDGET-ID 46
     IMAGE-12 AT ROW 6.04 COL 44 WIDGET-ID 44
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Relat¢rio de notas fiscais de devolu‡Æo"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Relat¢rio de notas fiscais de devolu‡Æo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Relat¢rio de notas fiscais de devolu‡Æo */
DO:
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY cod-estabel-ini cod-estabel-fim nr-nota-fis-ini nr-nota-fis-fim 
          serie-ini serie-fim cod-emitente-ini cod-emitente-fim cod-gr-forn-ini 
          cod-gr-forn-fim tgConsideraMatriz dt-emis-nota-ini dt-emis-nota-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 IMAGE-7 IMAGE-8 
         IMAGE-9 IMAGE-10 IMAGE-11 IMAGE-12 cod-estabel-ini cod-estabel-fim 
         nr-nota-fis-ini nr-nota-fis-fim serie-ini serie-fim cod-emitente-ini 
         cod-emitente-fim cod-gr-forn-ini cod-gr-forn-fim tgConsideraMatriz 
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.cod-estabel-ini     = input frame f-pg-sel cod-estabel-ini 
           ...
           tt-param.tgConsideraMatriz   = input frame f-pg-sel tgConsideraMatriz
           tt-param.cod-gr-forn-ini     = input frame f-pg-sel cod-gr-forn-ini
           tt-param.cod-gr-forn-fim     = input frame f-pg-sel cod-gr-forn-fim  .
    ...
    {include/i-rprun.i intprg/nicr024rp.p} 
