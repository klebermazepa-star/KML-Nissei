...
{include/i-prgvrs.i NICR025 9.99.99.999}
...
DEFINE VARIABLE fi-convenio-fim AS INTEGER FORMAT ">>>>>>>>9":U INITIAL 9999999 
     VIEW-AS FILL-IN 
...
DEFINE VARIABLE fi-dia-vencimento AS INTEGER FORMAT "99":U INITIAL 1 
...
DEFINE FRAME f-pg-sel
     fi-convenio-ini AT ROW 2 COL 22 COLON-ALIGNED WIDGET-ID 8
     fi-convenio-fim AT ROW 2 COL 39.43 COLON-ALIGNED NO-LABEL WIDGET-ID 82
     fi-dia-vencimento AT ROW 2.96 COL 22 COLON-ALIGNED WIDGET-ID 2
     IMAGE-15 AT ROW 2 COL 34.29 WIDGET-ID 78
     IMAGE-16 AT ROW 2 COL 38.29 WIDGET-ID 80
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Verificaá∆o ID Pedido Convànio"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Verificaá∆o ID Pedido Convànio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Verificaá∆o ID Pedido Convànio */
DO:
...
{utp/ut9000.i "NICR025" "2.06.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-convenio-ini fi-convenio-fim fi-dia-vencimento 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-15 IMAGE-16 fi-convenio-ini fi-convenio-fim fi-dia-vencimento 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           .
    ASSIGN tt-param.dia-vencimento = INPUT FRAME f-pg-sel fi-dia-vencimento
           tt-param.convenio-ini  = INPUT FRAME f-pg-sel fi-convenio-ini
           tt-param.convenio-fim  = INPUT FRAME f-pg-sel fi-convenio-fim
        .
    ...
    {include/i-rprun.i intprg/nicr025rp.p}
