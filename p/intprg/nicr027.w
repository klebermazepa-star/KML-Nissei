...
/********************************************************************************
** Programa: NICR099 - Integra‡Æo das duplicatas de acordos comerciais
**
** Versao : 1 - 18/07/2019 - Kleber Mazepa de Lima
**
********************************************************************************/
{include/i-prgvrs.i NICR027 1.00.01.KML}

CREATE WIDGET-POOL.
current-language = current-language.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        NICR027
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/nicr027rp.p}
