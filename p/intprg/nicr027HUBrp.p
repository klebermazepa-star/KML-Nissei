{include/i-prgvrs.i NICR027HUBRP 1.00.00.001}  
{include/i_fnctrad.i}
...
DEF INPUT PARAMETER TABLE FOR acordos_comerciais.
...
assign c-programa = "nicr027HUBrp"
       c-versao   = "2.06"
       c-revisao  = "001"
...
DEFINE TEMP-TABLE tt-tit-criados  
 ...
 FOR EACH acordos_comerciais :

    FOR LAST int_dp_acordos_duplicatas NO-LOCK
        WHERE int_dp_acordos_duplicatas.CNPJ_emitente = acordos_comerciais.cnpj_emitente
         AND  int_dp_acordos_duplicatas.especie       = acordos_comerciais.especie
         AND  int_dp_acordos_duplicatas.serie         = acordos_comerciais.serie
         AND  int_dp_acordos_duplicatas.titulo        = string(acordos_comerciais.titulo)
         AND  int_dp_acordos_duplicatas.parcela       = string(acordos_comerciais.parcela):
...
PROCEDURE pi-cria-tit-acr:
    ...
    IF CAN-FIND(FIRST tt_log_erros_atualiz) THEN DO:
        ...
        CREATE tt-valida.
        ASSIGN tt-valida.identifi-msg = tt-erro.mensagem
               tt-valida.cod-erro     = tt-erro.cd-erro
              //tt-valida.tabela       = tt-erro.
               tt-valida.desc-erro    = tt-erro.ajuda
               tt-valida.l-erro       = l-erro.
