...
&Scoped-Define ENABLED-OBJECTS rect-2 RECT-10 rs-destino c-arquivo ~
bt-config-impr bt-arquivo rs-execucao 
...
DEFINE FRAME f-pg-imp
     rs-destino AT ROW 3.25 COL 7 HELP
          "Destino de Impress∆o do Relat¢rio" NO-LABEL
     rs-excel AT ROW 3.33 COL 52 NO-LABEL WIDGET-ID 4
     c-arquivo AT ROW 4.5 COL 7 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL WIDGET-ID 10
     bt-config-impr AT ROW 4.5 COL 47 HELP
          "Configuraá∆o da impressora" WIDGET-ID 8
     bt-arquivo AT ROW 4.5 COL 47 HELP
          "Escolha do nome do arquivo" WIDGET-ID 16
     rs-execucao AT ROW 7.17 COL 6.86 HELP
          "Modo de Execuá∆o" NO-LABEL
     text-modo AT ROW 6.5 COL 5 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     " Destino" VIEW-AS TEXT
          SIZE 10 BY .88 AT ROW 2.21 COL 7 WIDGET-ID 2
     rect-2 AT ROW 2.67 COL 6 WIDGET-ID 6
     RECT-10 AT ROW 6.75 COL 6 WIDGET-ID 14
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 75.14 BY 10.54.
...
/* SETTINGS FOR FRAME f-pg-imp
   FRAME-NAME                                                           */
/* SETTINGS FOR RADIO-SET rs-excel IN FRAME f-pg-imp
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       rs-excel:HIDDEN IN FRAME f-pg-imp           = TRUE.
...
/* SETTINGS FOR FILL-IN FILL-IN-1 IN FRAME f-pg-par
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       FILL-IN-1:HIDDEN IN FRAME f-pg-par           = TRUE
       FILL-IN-1:PRIVATE-DATA IN FRAME f-pg-par     = 
                "Preáo Item".

/* SETTINGS FOR RECTANGLE RECT-38 IN FRAME f-pg-par
   NO-ENABLE                                                            */
ASSIGN 
       RECT-38:HIDDEN IN FRAME f-pg-par           = TRUE.

/* SETTINGS FOR RADIO-SET rs-preco IN FRAME f-pg-par
   NO-DISPLAY NO-ENABLE                                                 */
ASSIGN 
       rs-preco:HIDDEN IN FRAME f-pg-par           = TRUE.
...
/* Query rebuild information for FRAME f-pg-sel
     _TblList          = "emsfnd.item,emsfnd.familia WHERE emsfnd.item ..."
     _Query            is NOT OPENED
*/  /* FRAME f-pg-sel */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ...
  {&OPEN-QUERY-f-pg-par}
  GET FIRST f-pg-par.
  DISPLAY rs-item c-cod-estabel c-nome 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE RECT-39 RECT-9 rs-item c-cod-estabel 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ...
  ENABLE rect-2 RECT-10 rs-destino c-arquivo bt-config-impr bt-arquivo 
         rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW C-Win.
