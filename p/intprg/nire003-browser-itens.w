...
tt-int_ds_it_docto_xml.nat-oper-cad @ tt-int_ds_it_docto_xml.nat-oper-cad ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      ...
      tt-int_ds_it_docto_xml.nat_operacao COLUMN-LABEL "Nat Oper NF" FORMAT "x(6)":U
            WIDTH 9.43
      tt-int_ds_it_docto_xml.nat-oper-cad @ tt-int_ds_it_docto_xml.nat-oper-cad COLUMN-LABEL "Nat Oper Cad"
            WIDTH 10.29
...
"tt-int_ds_it_docto_xml.nat_operacao" "Nat Oper NF" ? "character" ? ? ? ? ? ? no ? no no "9.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[7]   > "_<CALC>"
"tt-int_ds_it_docto_xml.nat-oper-cad @ tt-int_ds_it_docto_xml.nat-oper-cad" "Nat Oper Cad" ? ? ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.tt-int_ds_it_docto_xml.ncm
...
"fn-base-icm() @ tt-int_ds_it_docto_xml.de-base-icm-calc" "Base ICMS Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > Temp-Tables.tt-int_ds_it_docto_xml.predBc
...
"tt-int_ds_it_docto_xml.de-per-red-bc-calc @ tt-int_ds_it_docto_xml.de-per-red-bc-calc" "% Red BC Cad" ">>9.99" ? ? ? ? ? 2 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[22]   > Temp-Tables.tt-int_ds_it_docto_xml.picms
...
"tt-int_ds_it_docto_xml.de-aliq-icms @ tt-int_ds_it_docto_xml.de-aliq-icms" "% ICMS Cad" ">>9.99" ? ? ? ? ? 2 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[24]   > Temp-Tables.tt-int_ds_it_docto_xml.vicms
...
"tt-int_ds_it_docto_xml.de-valor-icms-cad @ tt-int_ds_it_docto_xml.de-valor-icms-cad" "Vl ICMS Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[26]   > Temp-Tables.tt-int_ds_it_docto_xml.vicmsdeson
"tt-int_ds_it_docto_xml.vicmsdeson" "Vl ICMS Deson NF" ">>>,>>>,>>9.99" "decimal" ? ? ? ? 9 ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[27]   > Temp-Tables.tt-int_ds_it_docto_xml.vbcst
...
"tt-int_ds_it_docto_xml.de-base-st-calc @ tt-int_ds_it_docto_xml.de-base-st-calc" "Base ST Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[29]   > Temp-Tables.tt-int_ds_it_docto_xml.pmvast
...
"tt-int_ds_it_docto_xml.de-per-sub-tri @ tt-int_ds_it_docto_xml.de-per-sub-tri" "%MVA Cad" ">>9.99" ? ? ? ? ? 2 ? no ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[31]   > Temp-Tables.tt-int_ds_it_docto_xml.vPMC
...
"tt-int_ds_it_docto_xml.de-tabela-pauta @ tt-int_ds_it_docto_xml.de-tabela-pauta" "Vl PMC Cad" ">>>,>>9.99" ? ? ? ? ? 2 ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[33]   > Temp-Tables.tt-int_ds_it_docto_xml.picmsst
...
"tt-int_ds_it_docto_xml.de-perc-va-st @ tt-int_ds_it_docto_xml.de-perc-va-st" "% Red Cad" ">>>9.99" ? ? ? ? ? 2 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[36]   > Temp-Tables.tt-int_ds_it_docto_xml.vicmsst
...
"tt-int_ds_it_docto_xml.de-valor-st-calc @ tt-int_ds_it_docto_xml.de-valor-st-calc" "Valor ST Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[38]   > Temp-Tables.tt-int_ds_it_docto_xml.vbc_pis
...
"fn-base-pis() @ de-base-pis-cad" "Base Pis Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[40]   > Temp-Tables.tt-int_ds_it_docto_xml.ppis
...
"tt-int_ds_it_docto_xml.de-aliq-pis @ tt-int_ds_it_docto_xml.de-aliq-pis" "% PIS Cad" ">>9.99" ? ? ? ? ? 2 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[42]   > Temp-Tables.tt-int_ds_it_docto_xml.vpis
...
"tt-int_ds_it_docto_xml.de-valor-pis-cad @ tt-int_ds_it_docto_xml.de-valor-pis-cad" "Valor PIS Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[44]   > Temp-Tables.tt-int_ds_it_docto_xml.vbc_cofins
...
"fn-base-cofins() @ de-base-cofins-cad" "Base Cofins Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[46]   > Temp-Tables.tt-int_ds_it_docto_xml.pcofins
...
"tt-int_ds_it_docto_xml.de-aliq-cofins @ tt-int_ds_it_docto_xml.de-aliq-cofins" "% COFINS Cad" ">>9.99" ? ? ? ? ? 2 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[48]   > Temp-Tables.tt-int_ds_it_docto_xml.vcofins
...
"tt-int_ds_it_docto_xml.de-valor-cofins-cad @ tt-int_ds_it_docto_xml.de-valor-cofins-cad" "Valor COFINS Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[50]   > Temp-Tables.tt-int_ds_it_docto_xml.vbc_ipi
...
"de-base-ipi-cad @ de-base-ipi-cad" "Base IPI Cad" ">>>,>>>,>>9.99" ? ? ? ? ? 2 ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[52]   > Temp-Tables.tt-int_ds_it_docto_xml.pipi
...
"tt-int_ds_it_docto_xml.de-aliq-ipi @ tt-int_ds_it_docto_xml.de-aliq-ipi" "% IPI Cad" ">>9.99" ? ? ? ? ? 2 ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[54]   > Temp-Tables.tt-int_ds_it_docto_xml.vipi
...
"tt-int_ds_it_docto_xml.demi @ tt-int_ds_it_docto_xml.demi" "Emiss∆o" "99/99/9999" ? ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[59]   > Temp-Tables.tt-int_ds_it_docto_xml.nNF
"tt-int_ds_it_docto_xml.nNF" "NF" ? "character" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[60]   = Temp-Tables.tt-int_ds_it_docto_xml.serie
     _FldNameList[61]   > Temp-Tables.tt-int_ds_it_docto_xml.cod_emitente
...
DO:
    ...
    THEN DO:
        ...
        FIND FIRST int_ds_ext_emitente NO-LOCK
           WHERE  int_ds_ext_emitente.cod_emitente = tt-int_ds_it_docto_xml.cod_emitente 
           AND    int_ds_ext_emitente.industria = NO 
           AND    int_ds_ext_emitente.excecaoindustria = NO  NO-ERROR.
        IF AVAIL int_ds_ext_emitente THEN DO:
 
            ASSIGN tt-int_ds_it_docto_xml.de-aliq-ipi:SCREEN-VALUE IN BROWSE br-table = "0". 
    ...
    IF tt-int_ds_it_docto_xml.nat_operacao <> tt-int_ds_it_docto_xml.nat-oper-cad THEN
       ASSIGN tt-int_ds_it_docto_xml.nat_operacao:BGCOLOR IN BROWSE br-table = 14 
              tt-int_ds_it_docto_xml.nat-oper-cad:BGCOLOR IN BROWSE br-table = 14.

    IF  tt-int_ds_it_docto_xml.nat_operacao = "" 
    AND tt-int_ds_it_docto_xml.nat-oper-cad = "" THEN
        ASSIGN tt-int_ds_it_docto_xml.nat_operacao:BGCOLOR IN BROWSE br-table = 14 
               tt-int_ds_it_docto_xml.nat-oper-cad:BGCOLOR IN BROWSE br-table = 14.
...
FIND FIRST int_ds_ext_emitente NO-LOCK
       WHERE  int_ds_ext_emitente.cod_emitente = tt-int_ds_it_docto_xml.cod_emitente 
       AND    int_ds_ext_emitente.industria = YES 
       AND    int_ds_ext_emitente.excecaoindustria = YES  NO-ERROR.
IF AVAIL int_ds_ext_emitente THEN DO:

    if  tt-int_ds_it_docto_xml.de-aliq-ipi <> 0 
    then 
        RETURN tt-int_ds_it_docto_xml.de-aliq-ipi.
