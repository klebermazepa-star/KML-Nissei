...
IF AVAIL b-emitente THEN DO:
    ...
    IF v_cdn_empres_usuar = "10" THEN DO:
        ...
        assign tt-param.usuario           = "RPW"
               tt-param.Tipo              = b-emitente.identific 
               ...
               tt-param.GrupoFinal        = b-emitente.cod-gr-cli
               tt-param.GrupoInicial      = b-emitente.cod-gr-cli
         ...
         RUN custom/eswms002rp.p (INPUT raw-param , 
...
IF (b-emitente.identific = 1 OR b-emitente.identific = 3) THEN DO: /* Fornecedor e Ambos */
...
/*         FIND FIRST integra-fornecedor EXCLUSIVE-LOCK                                  */
/*             WHERE integra-fornecedor.cod-emitente = b-emitente.cod-emitente NO-ERROR. */
/*                                                                                       */
/*          IF NOT AVAIL integra-fornecedor THEN                                         */
/*          DO:                                                                          */
/*                                                                                       */
/*             CREATE integra-fornecedor.                                                */
/*             ASSIGN integra-fornecedor.cod-emitente = b-emitente.cod-emitente          */
...
/*          END.                                                                         */
        ...
        assign tt-param.usuario           = "RPW"
         ...
         RUN intprg/int310rp.p (INPUT raw-param , 
                                INPUT TABLE tt-raw-digita).
