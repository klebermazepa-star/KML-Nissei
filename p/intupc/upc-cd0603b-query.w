...
*******************************************************************************/
{include/i-prgvrs.i CD0603BQ 1.12.00.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-ncm-cd-trib-uf NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-ncm-cd-trib-uf NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-ncm-cd-trib-uf
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-ncm-cd-trib-uf
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.int-ds-ncm-cd-trib-uf"
     _Options          = "NO-LOCK"
