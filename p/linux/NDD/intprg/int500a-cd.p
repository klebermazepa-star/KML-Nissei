/********************************************************************************
** Programa: int500a-cd - ConexÆo E leitura WebServer NDD - Entradas - CD
**
...
if l-log then output stream str-log to value(cCaminhoTMP + "int500a_CD" + "_" + replace(string(time,"HH:MM:SS"),':','_') + ".LOG").
