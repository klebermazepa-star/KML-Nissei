    ...
    for first it-nota-fisc no-lock where rowid(it-nota-fisc) = r-rowid-axsep037 query-tuning(no-lookahead):
        ...
        for first nota-fiscal no-lock of it-nota-fisc query-tuning(no-lookahead):
            ...
            if cXML <> "" then do:
                ...
                if l-log then do: 
                    cFile = cCaminhoTMP + "eformsInserirDocumento" + "-" + c-seg-usuario + "-" +
                                string(today,"99-99-9999") + replace(string(time,"HH:MM:SS"),':','-') + ".xml".
                ...
                if l-log then do: 
                    cFile = cCaminhoTMP + "eformsInserirHeader" + "-" + c-seg-usuario + "-" +
                                string(today,"99-99-9999") + replace(string(time,"HH:MM:SS"),':','-') + ".xml".
                ...
                if l-connected then do:
                    ...
                    if l-log then do:
                        cFile = cCaminhoTMP + "eformsInserirRetorno" + "-" + c-seg-usuario + "-" +
                                string(today,"99-99-9999") + replace(string(time,"HH:MM:SS"),':','-') + ".xml".
