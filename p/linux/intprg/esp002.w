...
DEFINE VARIABLE tg-PR AS LOGICAL INITIAL no 
     LABEL "PR" 
     VIEW-AS TOGGLE-BOX
     SIZE 7 BY .83 NO-UNDO.

DEFINE VARIABLE tg-PR-dest AS LOGICAL INITIAL no 
     LABEL "PR" 
     VIEW-AS TOGGLE-BOX
     SIZE 7 BY .83 NO-UNDO.

DEFINE VARIABLE tg-SC AS LOGICAL INITIAL no 
     LABEL "SC" 
     VIEW-AS TOGGLE-BOX
     SIZE 7 BY .83 NO-UNDO.

DEFINE VARIABLE tg-SC-Dest AS LOGICAL INITIAL no 
     LABEL "SC" 
     VIEW-AS TOGGLE-BOX
     SIZE 7 BY .83 NO-UNDO.

DEFINE VARIABLE tg-SP AS LOGICAL INITIAL no 
     LABEL "SP" 
     VIEW-AS TOGGLE-BOX
     SIZE 7 BY .83 NO-UNDO.

DEFINE VARIABLE tg-SP-Dest AS LOGICAL INITIAL no 
     LABEL "SP" 
     VIEW-AS TOGGLE-BOX
     SIZE 7 BY .83 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     tg-PR AT ROW 10.25 COL 7 WIDGET-ID 152
     com-subst-tribut AT ROW 7.75 COL 30.14 WIDGET-ID 148
     sem-subst-tribut AT ROW 8.63 COL 30 WIDGET-ID 150
     ...
     tg-PR-dest AT ROW 10.25 COL 42 WIDGET-ID 154
     tg-SP AT ROW 10.25 COL 18 WIDGET-ID 156
     tg-SP-Dest AT ROW 10.25 COL 53 WIDGET-ID 158
     tg-SC AT ROW 10.25 COL 28 WIDGET-ID 160
     tg-SC-Dest AT ROW 10.25 COL 63 WIDGET-ID 162
     "Origem" VIEW-AS TEXT
          SIZE 8 BY .67 AT ROW 9.5 COL 6 WIDGET-ID 166
     "Destino" VIEW-AS TEXT
          SIZE 8 BY .67 AT ROW 9.67 COL 41 WIDGET-ID 170
     ...
     RECT-10 AT ROW 10 COL 5 WIDGET-ID 164
     RECT-11 AT ROW 10 COL 40 WIDGET-ID 168
     RECT-12 AT ROW 7.5 COL 27 WIDGET-ID 172
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY tg-PR com-subst-tribut sem-subst-tribut cod-estab-ini cod-estab-fim 
          ...
          tg-PR-dest tg-SP tg-SP-Dest tg-SC tg-SC-Dest 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE tg-PR com-subst-tribut sem-subst-tribut cod-estab-ini cod-estab-fim 
         it-codigo-ini it-codigo-fim ge-codigo-ini ge-codigo-fim fm-codigo-ini 
         fm-codigo-fim clas-fiscal-ini clas-fiscal-fim cst-ini cst-fim IMAGE-1 
         IMAGE-2 IMAGE-5 IMAGE-6 IMAGE-11 IMAGE-12 IMAGE-13 IMAGE-14 IMAGE-15 
         IMAGE-16 IMAGE-17 IMAGE-18 RECT-10 tg-PR-dest RECT-11 tg-SP RECT-12 
         tg-SP-Dest tg-SC tg-SC-Dest 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
