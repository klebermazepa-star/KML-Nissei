...
/*  FIELD col-ab      AS CHAR */ /* descricao familia **********************nao importa*****************************************/
    ...
    FIELD col-aj      AS CHAR    /* status            **********************nao importa*****************************************/ 
    FIELD DESCricao   AS CHAR    FORMAT "x(100)"
    ...
    ASSIGN chExcel     =  chExcel:APPLICATION 
     ...
     REPEAT ON ENDKEY UNDO, LEAVE:
        ...
        IF chExcel:Range("A"  + STRING(i-linha)):TEXT  >= tt-param.it-codigo-ini      AND  /* item */
           ...
           chExcel:Range("AJ" + STRING(i-linha)):TEXT  <> ""                          THEN DO:           
            ...
            ASSIGN tt-imp.col-a                       = chExcel        :Range("A"  + STRING(i-linha)):TEXT   /* 1 - coluna a - Codigo item - chave */   
               ...
               /*  tt-imp.col-u                       = decimal(chExcel:Range("U"  + STRING(i-linha)):TEXT)  /* 21- coluna U - RBEST */  */                          
                   tt-imp.col-v                       =         chExcel:Range("V"  + STRING(i-linha)):TEXT   /* 22- coluna V - IPI */                               
               ...
               /*  tt-imp.col-AB                      =         chExcel:Range("AB" + STRING(i-linha)):TEXT   /* 28- coluna AB- Descricao */  */
                   ...
                   tt-imp.col-AJ                      =         chExcel:Range("AJ" + STRING(i-linha)):TEXT . /* 36- coluna AJ- STATUS a-alteracao, e-exclusao, i-inclusao */                                                                                                    
...
/**************************************************************************************************************************************                                                                                                                                                                   *****************************************************/
 ...
 PROCEDURE pi-atualiza :
     ...
     for each tt-imp:
         ...
         ASSIGN i-zeros = 8 - LENGTH(tt-imp.COL-x).

         IF i-zeros <> 0 THEN DO:

            DO i-cont = 1 TO i-zeros:
               ASSIGN c-zeros = "0" + c-zeros.
            END.

            ASSIGN c-class      = c-zeros + tt-imp.COL-x
                   tt-imp.COL-x = c-class.
         END.
         ...
         /************************************************************************************************************************************************/
         IF tt-imp.col-aj = "A" THEN DO: /* Alteracao */
            ...
            IF AVAIL   ITEM THEN DO:                 
               ...
               IF ITEM.cd-trib-icm <> tt-imp.col-g THEN DO: /* se houve alteracao do codigo de tributacao, 1,2,3,4 ou 5 */
                  ...
                  END.
                  ELSE DO: /* alteracao de 5 para 1,2,3,4 iremos retirar do cadastro cd904a item-uf */
                     ...
                     IF AVAIL   item-uf THEN 
                        DELETE item-uf.
                     ELSE RUN pi-cria-msg( INPUT "Item-uf nao encontrado." ).
         ...
         END.
         /************************************************************************************************************************************************/
         ELSE IF tt-imp.col-aj = "E" THEN DO: /* exclusao do registro na tabela item-uf  */
         ...
         END.
         /************************************************************************************************************************************************/
         ELSE IF tt-imp.col-aj = "I" THEN DO: /* inclusao do registro na tabela item-uf */
...
DEF INPUT PARAM msg AS CHAR NO-UNDO.
   ...
   create tt-msg.
   assign tt-msg.tipo            = tt-imp.col-aj
