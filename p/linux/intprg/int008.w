...
*******************************************************************************/
{include/i-prgvrs.i int008 2.12.00.001}  /**/

&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i int008 INT}
&ENDIF
...
&GLOBAL-DEFINE page2Fields    c-estabel-ini c-estabel-fim periodo-ini periodo-fim i-nr-pedido-ini i-nr-pedido-fim
...
define temp-table tt-param no-undo
    ...
    FIELD cod-estabel-ini  AS integer
    FIELD cod-estabel-fim  AS integer
...
DEFINE VARIABLE c-estabel-fim AS INTEGER FORMAT "999" INITIAL 999 
     VIEW-AS FILL-IN 
     SIZE 7.14 BY .88 NO-UNDO.

DEFINE VARIABLE c-estabel-ini AS INTEGER FORMAT ">>9" INITIAL 0 
     LABEL "Estabelecimento":R15 
     VIEW-AS FILL-IN 
     SIZE 7.14 BY .88 NO-UNDO.

DEFINE VARIABLE i-nr-pedido-fim AS INTEGER FORMAT ">>>>>>>9":U INITIAL 99999999 
     VIEW-AS FILL-IN 
     SIZE 8.43 BY .88
     FONT 1 NO-UNDO.

DEFINE VARIABLE i-nr-pedido-ini AS INTEGER FORMAT ">>>>>>>9":U INITIAL 0 
     LABEL "Pedido Sysfarma" 
     VIEW-AS FILL-IN 
     SIZE 8.43 BY .88
     FONT 1 NO-UNDO.
...
DEFINE FRAME fPage2
     c-estabel-ini AT ROW 3.25 COL 25.86 COLON-ALIGNED WIDGET-ID 2
     c-estabel-fim AT ROW 3.25 COL 46.43 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     periodo-ini AT ROW 4.25 COL 15.71
     periodo-fim AT ROW 4.25 COL 48.43 NO-LABEL
     i-nr-pedido-ini AT ROW 5.29 COL 14.43 WIDGET-ID 22
     i-nr-pedido-fim AT ROW 5.25 COL 48.57 NO-LABEL WIDGET-ID 24
     IMAGE-1 AT ROW 4.29 COL 36.43
     IMAGE-2 AT ROW 4.29 COL 44.29
     IMAGE-3 AT ROW 3.25 COL 36.57 WIDGET-ID 6
     IMAGE-4 AT ROW 3.25 COL 44.43 WIDGET-ID 8
     IMAGE-5 AT ROW 5.33 COL 36.43 WIDGET-ID 16
     IMAGE-6 AT ROW 5.33 COL 44.29 WIDGET-ID 18
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW wReport ASSIGN
         HIDDEN             = YES
         TITLE              = "Integra‡Æo de Pedidos de Compra"
         HEIGHT             = 17
         WIDTH              = 90
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 195.14
...
/* SETTINGS FOR FRAME fPage2
   Custom                                                               */
/* SETTINGS FOR FILL-IN i-nr-pedido-fim IN FRAME fPage2
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN i-nr-pedido-ini IN FRAME fPage2
   ALIGN-L                                                              */
...
ON END-ERROR OF wReport /* Integra‡Æo de Pedidos de Compra */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL wReport wReport
ON WINDOW-CLOSE OF wReport /* Integra‡Æo de Pedidos de Compra */
DO:
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.nr-pedido-ini   = input frame fPage2 i-nr-pedido-ini
           tt-param.nr-pedido-fim   = input frame fPage2 i-nr-pedido-fim.
    ...
    {report/rprun.i intprg/int008rp.p}
