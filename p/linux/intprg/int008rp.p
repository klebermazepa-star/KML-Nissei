...
DEF NEW GLOBAL SHARED VAR i-ep-codigo-usuario  LIKE ems2log.empresa.ep-codigo NO-UNDO.
...
for EACH int_ds_ped_compra WHERE  
    ...
    IF int_ds_ped_compra.cod_estabel = 973 THEN
       ...
       FOR EACH item-doc-est USE-INDEX itmdctst-09 WHERE 
           ...
           IF AVAIL docum-est THEN DO:
              ...
              FOR FIRST int_ds_docto_wms WHERE  
                        int_ds_docto_wms.doc_numero_n = INT(docum-est.nro-docto) AND
