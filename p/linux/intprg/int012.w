...
/********************************************************************************
** Programa: int012 - Importaá∆o de Notas de Entrada do Toturial/Sysfarma
**
** Versao : 12 - 09/02/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT012 2.12.01.AVB}
...
DEFINE FRAME fPage2
     ...
     IMAGE-8 AT ROW 3.5 COL 47.25 WIDGET-ID 28
     IMAGE-9 AT ROW 4.5 COL 32 WIDGET-ID 32
     IMAGE-10 AT ROW 4.5 COL 47.25 WIDGET-ID 34
     IMAGE-11 AT ROW 5.5 COL 32 WIDGET-ID 40
     IMAGE-12 AT ROW 5.5 COL 47.25 WIDGET-ID 38
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int012rp.p}
