...
int_ds_cfop_natur_oper.cod_emitente ~
...
DEFINE FRAME f-main
     int_ds_cfop_natur_oper.nen_cfop_n AT ROW 1.17 COL 15 COLON-ALIGNED WIDGET-ID 10
          VIEW-AS FILL-IN 
          SIZE 7 BY .88
     int_ds_cfop_natur_oper.nep_cstb_icm_n AT ROW 2.17 COL 15 COLON-ALIGNED HELP
          "C¢digo da situaá∆o tribut†ria p/ ICMS" WIDGET-ID 12
          VIEW-AS FILL-IN 
          SIZE 3.29 BY .88
     int_ds_cfop_natur_oper.cod_estabel AT ROW 3.17 COL 15 COLON-ALIGNED HELP
          "C¢digo do estabelecimento (Utilize ? para TODOS)" WIDGET-ID 4
          VIEW-AS FILL-IN 
          SIZE 7.29 BY .88
     int_ds_cfop_natur_oper.cod_emitente AT ROW 4.17 COL 15 COLON-ALIGNED HELP
          "C¢digo do fornecedor (Utilize ? para TODOS)" WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 12.29 BY .88
     c-fm-codigo AT ROW 5.25 COL 15 COLON-ALIGNED WIDGET-ID 48
     int_ds_cfop_natur_oper.dt_inicio_validade AT ROW 6.25 COL 15 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 11.29 BY .88
     int_ds_cfop_natur_oper.nat_operacao AT ROW 8.08 COL 15.57 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 10.57 BY .88
     c-cod-cfop AT ROW 9.08 COL 15.57 COLON-ALIGNED HELP
          "C¢digo Fiscal de Operaá‰es e Prestaá‰es a partir de 01/01/2003." WIDGET-ID 32
     cb-trib-icms AT ROW 10.17 COL 15.57 COLON-ALIGNED WIDGET-ID 38
     cd-trib-pis AT ROW 11.5 COL 15.57 COLON-ALIGNED WIDGET-ID 42
     c-cfop AT ROW 1.17 COL 22 COLON-ALIGNED NO-LABEL WIDGET-ID 46
     c-nome AT ROW 3.17 COL 22.29 COLON-ALIGNED NO-LABEL WIDGET-ID 16
     c-nome-emit AT ROW 4.17 COL 27.29 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     c-denominacao AT ROW 8.08 COL 26 COLON-ALIGNED NO-LABEL WIDGET-ID 18
     c-Familia AT ROW 5.25 COL 29 COLON-ALIGNED NO-LABEL WIDGET-ID 50
     cb-trib-ipi AT ROW 10.17 COL 57 COLON-ALIGNED WIDGET-ID 36
     cd-trib-cofins AT ROW 11.5 COL 57 COLON-ALIGNED WIDGET-ID 40
     int_ds_cfop_natur_oper.nep_cstb_ipi_n AT ROW 5.25 COL 74 COLON-ALIGNED NO-LABEL WIDGET-ID 52 FORMAT ">>>>>>>9"
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     rt-key AT ROW 1 COL 1
     rt-mold AT ROW 7.5 COL 1
...
/* Settings for THIS-PROCEDURE
   Type: SmartViewer
   External Tables: int_ds_cfop_natur_oper
...
------------------------------------------------------------------------------*/
    ...
    c-fm-codigo:sensitive in FRAME f-main = no.
...
------------------------------------------------------------------------------*/
    ...
    if adm-new-record = yes then do:
        c-fm-codigo:sensitive in FRAME f-main = yes.
    end.
    else do:
        c-fm-codigo:sensitive in FRAME f-main = no.
    end.
