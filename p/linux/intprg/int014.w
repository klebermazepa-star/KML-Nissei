...
&GLOBAL-DEFINE page0Widgets   btQueryJoins btReportsJoins btExit btHelp ~
                              btOK btCancel BtExcluir btHelp2 btSelecao btAtualiza c-intervalo rs-consulta
...
&Scoped-define QUERY-STRING-brNotaEntradaProduto FOR EACH tt-int_ds_nota_entrada_produto NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-brNotaEntradaProduto OPEN QUERY brNotaEntradaProduto FOR EACH tt-int_ds_nota_entrada_produto NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-brNotaEntradaProduto ~
tt-int_ds_nota_entrada_produto
&Scoped-define FIRST-TABLE-IN-QUERY-brNotaEntradaProduto tt-int_ds_nota_entrada_produto
...
btOK btCancel btExcluir btHelp2 
...
DEFINE BUTTON btExcluir 
     LABEL "Excluir" 
     SIZE 10 BY 1 TOOLTIP "Excluir nota para integrar documento novamente".
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brNotaEntradaProduto wWindow _STRUCTURED
  QUERY brNotaEntradaProduto NO-LOCK DISPLAY
      tt-int_ds_nota_entrada_produt.nep_sequencia_n COLUMN-LABEL "Seq" FORMAT ">>>,>>>,>>9":U
            WIDTH 9.57
      tt-int_ds_nota_entrada_produt.nep_produto_n FORMAT ">>>>>>>>9":U
      fnItem(tt-int_ds_nota_entrada_produt.nep_produto_n) @ c-desc-item COLUMN-LABEL "Descri‡Æo" FORMAT "X(65)":U
            WIDTH 63.43
      tt-int_ds_nota_entrada_produt.nep_quantidade_n FORMAT ">>>,>>>,>>9.99":U
            WIDTH 12
      tt-int_ds_nota_entrada_produt.nep_valorbruto_n FORMAT ">>>,>>>,>>>,>>9.99999":U
            WIDTH 13.57
      tt-int_ds_nota_entrada_produt.nep_lote_s FORMAT "x(20)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brNotaLojaItem wWindow _STRUCTURED
  QUERY brNotaLojaItem NO-LOCK DISPLAY
      tt-int_ds_nota_loja_item.sequencia FORMAT "x(2)":U
      tt-int_ds_nota_loja_item.produto FORMAT "x(6)":U
      fnItem(int(tt-int_ds_nota_loja_item.produto)) @ c-desc-item COLUMN-LABEL "Descri‡Æo Item" FORMAT "X(65)":U
            WIDTH 42.86
      tt-int_ds_nota_loja_item.quantidade FORMAT "->>>,>>>,>>9.99":U
      tt-int_ds_nota_loja_item.preco_unit FORMAT "->>>,>>>,>>9.99":U
      tt-int_ds_nota_loja_item.desconto FORMAT "->>>,>>>,>>9.99":U
      tt-int_ds_nota_loja_item.preco_liqu FORMAT "->>>,>>>,>>9.99":U
      tt-int_ds_nota_loja_item.datavalidade FORMAT "99/99/9999":U
      tt-int_ds_nota_loja_item.datafabricacao FORMAT "99/99/9999":U
      tt-int_ds_nota_loja_item.lote FORMAT "x(10)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 132.29 BY 6.33
         FONT 1.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brNotaSaidaItem wWindow _STRUCTURED
  QUERY brNotaSaidaItem NO-LOCK DISPLAY
      tt-int_ds_nota_saida_item.nsp_sequencia_n COLUMN-LABEL "Seq" FORMAT ">>>,>>>,>>9":U
            WIDTH 9.57
      tt-int_ds_nota_saida_item.nsp_produto_n FORMAT ">>>>>>>>9":U
      fnItem(tt-int_ds_nota_saida_item.nsp_produto_n) @ c-desc-item COLUMN-LABEL "Descri‡Æo" FORMAT "X(65)":U
            WIDTH 56.14
      tt-int_ds_nota_saida_item.nsp_quantidade_n FORMAT ">>>,>>>,>>9.99":U
            WIDTH 8
      tt-int_ds_nota_saida_item.nsp_valorbruto_n FORMAT ">>>,>>>,>>>,>>9.99999":U
            WIDTH 12.57
      tt-int_ds_nota_saida_item.nsp_lote_s FORMAT "x(20)":U WIDTH 14
      tt-int_ds_nota_saida_item.nsp_caixa_n FORMAT ">>>>>>>>>9":U
            WIDTH 6.57
      tt-int_ds_nota_saida_item.ped_codigo_n FORMAT ">>>>>>>>9":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS SIZE 132.29 BY 6.33
         FONT 1.
...
DEFINE FRAME fpage0
     ...
     btExcluir AT ROW 23.63 COL 24 WIDGET-ID 30
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         FONT 1
         CANCEL-BUTTON btExcluir WIDGET-ID 100.
...
/* Settings for THIS-PROCEDURE
   ...
   Temp-Tables and Buffers:
      ...
      END-FIELDS.
      TABLE: tt-int_ds_nota_entrada_produto T "?" NO-UNDO emsesp int_ds_nota_entrada_produto
...
/* Query rebuild information for BROWSE brNotaEntradaProduto
     _TblList          = "Temp-Tables.tt-int_ds_nota_entrada_produto"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
...
DO:
    RUN utp\ut-msgs.p (INPUT "SHOW",
                       INPUT 27100,
                       INPUT "Deseja Eliminar o Registro? ").

    EMPTY TEMP-TABLE tt2-int_ds_nota_entrada.
    ...
    IF RETURN-VALUE = "YES" THEN DO:
        ...
        BROWSE brNotaEntrada:FETCH-SELECTED-ROW(1)no-error.   
            ...
            FOR FIRST b-int_ds_nota_entrada OF tt-int_ds_nota_entrada:
                ...
                BUFFER-COPY  tt-int_ds_nota_entrada TO tt2-int_ds_nota_entrada.
                FIND FIRST tt2-int_ds_nota_entrada NO-ERROR.
                IF AVAIL tt2-int_ds_nota_entrada THEN
                    ASSIGN tt2-int_ds_nota_entrada.tipo_movto = 3.

                FOR EACH b-int_ds_nota_entrada_produt OF b-int_ds_nota_entrada:
                    DELETE b-int_ds_nota_entrada_produt. 
                END. 
            
                FOR EACH b-int_ds_nota_entrada_dup OF b-int_ds_nota_entrada:
            ...
            FOR FIRST tt2-int_ds_nota_entrada:
    
                BUFFER-COPY  tt2-int_ds_nota_entrada TO b-int_ds_nota_entrada.
    
                FOR EACH b-int_ds_nota_entrada OF tt2-int_ds_nota_entrada:

                    FOR EACH NDD_ENTRYINTEGRATION WHERE
                        STRING(NDD_ENTRYINTEGRATION.CNPJEMIT)           = string(DEC(b-int_ds_nota_entrada.nen_cnpj_origem_s))
                        AND string(NDD_ENTRYINTEGRATION.serie)          = string(b-int_ds_nota_entrada.nen_serie_s)
                        AND string(NDD_ENTRYINTEGRATION.DOCUMENTNUMBER)  = string(b-int_ds_nota_entrada.nen_notafiscal_n):
