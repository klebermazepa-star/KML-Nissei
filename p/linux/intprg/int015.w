...
/********************************************************************************
** Programa: int015 - Cadastro de->para Tipo edido X Nat. Opera‡Æo 
**                    Tutorial/PRS -> Datasul
**
** Versao : 12 - 03/03/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT015 2.06.02.AVB}
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_INT015-viewer ( 3.08 , 3.72 ) NO-ERROR.
       /* Size in UIB:  ( 17.04 , 92.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/INT015-query.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = intprg/int015-zoom.w,
                     ProgVaPara = intprg/int015-vapara.w,
                     ProgIncMod = ,
                     Implantar = no':U ,
             OUTPUT h_INT015-query ).
       RUN set-position IN h_INT015-query ( 2.75 , 90.57 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_INT015-viewer ).

       /* Links to SmartQuery h_INT015-query. */
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_INT015-query ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_INT015-query ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_INT015-query ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "INT015" "2.06.02.AVB"}
