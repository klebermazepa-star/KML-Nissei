...
&Scoped-Define ENABLED-FIELDS int_ds_loja_cond_pag.CONDIPAG 
...
&Scoped-Define DISPLAYED-FIELDS int_ds_loja_cond_pag.CONDIPAG 
...
DEFINE FRAME d-vapara
     int_ds_loja_cond_pag.CONDIPAG AT ROW 1.75 COL 21 COLON-ALIGNED WIDGET-ID 2
          LABEL "Cond Pagto SYS"
          VIEW-AS FILL-IN 
          SIZE 5 BY .88
     bt-ok AT ROW 4.25 COL 2.14
     bt-cancela AT ROW 4.25 COL 13
     bt-ajuda AT ROW 4.25 COL 36
     rt-button AT ROW 4 COL 1
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "V  Para int_ds_loja_cond_pag"
...
/* SETTINGS FOR FILL-IN int_ds_loja_cond_pag.CONDIPAG IN FRAME d-vapara
   EXP-LABEL                                                            */
...
ON GO OF FRAME d-vapara /* V  Para int_ds_loja_cond_pag */
DO:
  find first int_ds_loja_cond_pag no-lock where 
      int_ds_loja_cond_pag.condipag = input frame {&frame-name} int_ds_loja_cond_pag.condipag
      no-error.
  if  not avail int_ds_loja_cond_pag then do:
      {utp/ut-table.i custom int_ds_loja_cond_pag 1}
      run utp/ut-msgs.p (input "show":U,
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(int_ds_loja_cond_pag).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para int_ds_loja_cond_pag */
DO:  
...
------------------------------------------------------------------------------*/
  IF AVAILABLE int_ds_loja_cond_pag THEN 
    DISPLAY int_ds_loja_cond_pag.CONDIPAG 
      WITH FRAME d-vapara.
  ENABLE rt-button int_ds_loja_cond_pag.CONDIPAG bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
