...
/* SETTINGS FOR FILL-IN cEspecie IN FRAME F-Main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN int_ds_loja_cond_pag.COD-COND-PAG IN FRAME F-Main
   EXP-LABEL                                                            */
...
ON F5 OF int_ds_loja_cond_pag.cod_cond_pag IN FRAME F-Main /* Cond Pagto Datasul */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL int_ds_loja_cond_pag.cod_cond_pag V-table-Win
ON LEAVE OF int_ds_loja_cond_pag.cod_cond_pag IN FRAME F-Main /* Cond Pagto Datasul */
DO:
...
&Scoped-define SELF-NAME int_ds_loja_cond_pag.COD-ESP
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL int_ds_loja_cond_pag.COD-ESP V-table-Win
ON F5 OF int_ds_loja_cond_pag.cod_esp IN FRAME F-Main /* Especie */
OR MOUSE-SELECT-DBLCLICK OF int_ds_loja_cond_pag.cod_esp in frame {&FRAME-NAME} DO:
        {include/zoomvar.i &prog-zoom=adzoom/z01ad103.w
                                &campo=int_ds_loja_cond_pag.cod_esp
                                &campozoom=cod-esp}
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL int_ds_loja_cond_pag.COD-ESP V-table-Win
ON LEAVE OF int_ds_loja_cond_pag.cod_esp IN FRAME F-Main /* Especie */
DO:
    cEspecie:screen-value in frame {&frame-name} = "".
    for first esp-doc 
        fields (cod-esp descricao)
        no-lock where
        esp-doc.cod-esp = input frame {&FRAME-NAME} int_ds_loja_cond_pag.cod_esp.
        display esp-doc.descricao @ cEspecie with frame {&FRAME-NAME}.
    end.
END.
...
&Scoped-define SELF-NAME int_ds_loja_cond_pag.COD-PORTADOR
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL int_ds_loja_cond_pag.COD-PORTADOR V-table-Win
ON F5 OF int_ds_loja_cond_pag.cod_portador IN FRAME F-Main /* Portador */
OR MOUSE-SELECT-DBLCLICK OF int_ds_loja_cond_pag.cod_portador in frame {&FRAME-NAME} DO:
        {include/zoomvar.i &prog-zoom=adzoom/z01ad209.w
                                &campo=int_ds_loja_cond_pag.cod_portador
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL int_ds_loja_cond_pag.COD-PORTADOR V-table-Win
ON LEAVE OF int_ds_loja_cond_pag.cod_portador IN FRAME F-Main /* Portador */
DO:
