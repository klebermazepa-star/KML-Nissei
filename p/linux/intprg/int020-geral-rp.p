...
def temp-table tt-int_ds_nota_loja-1 like int_ds_nota_loja
...
procedure pi-importa:
    ...
    EMPTY TEMP-TABLE tt-int_ds_nota_loja-1.

    FOR EACH estabelec /* WHERE estabelec.cod-estabel = "014"
        ...
        for each int_ds_nota_loja no-lock USE-INDEX sit_cnpj_emiss where 
                 ...
                 int_ds_nota_loja.emissao     >= 08/01/2018 and
                 int_ds_nota_loja.emissao     <= 08/18/2018    
            ...
            FOR FIRST tt-int_ds_nota_loja-1 WHERE 
                tt-int_ds_nota_loja-1.rowid-nota-loja = ROWID(int_ds_nota_loja): END.
            IF NOT AVAIL tt-int_ds_nota_loja-1 THEN DO:
               CREATE tt-int_ds_nota_loja-1.
               BUFFER-COPY int_ds_nota_loja TO tt-int_ds_nota_loja-1.
               ASSIGN tt-int_ds_nota_loja-1.rowid-nota-loja = ROWID(int_ds_nota_loja).
            END.
            
        end.
    END.

    FOR EACH tt-int_ds_nota_loja-1 USE-INDEX data:
        FOR FIRST int_ds_nota_loja WHERE ROWID(int_ds_nota_loja) = tt-int_ds_nota_loja-1.rowid-nota-loja NO-LOCK:
        END.
