...
/********************************************************************************
** Programa: int020-geral.w - EmissÆo de notas fiscais a partir de CUPONS PRS
**
** Versao : 12 - 18/03/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT020-geral 2.12.01.AVB}

CREATE WIDGET-POOL.
current-language = current-language.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT020-geral
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int020-geral-rp.p}
