...
for first ems2log.empresa fields (razao-social) no-lock where
    ems2log.empresa.ep-codigo = param-global.empresa-prin: end.

/* bloco principal do programa */
assign	c-programa 	    = "INT026RP"
        c-versao	    = "2.12"
        c-revisao	    = ".02.AVB"
        c-empresa       = ems2log.empresa.razao-social
