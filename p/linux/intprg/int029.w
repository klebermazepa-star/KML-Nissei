...
/********************************************************************************
** Programa: INT029 - Relat¢rio Conciliaá∆o Notas de Entrada Loja
**
** Versao : 12 - 11/10/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT029 2.12.01.AVB}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT029
&GLOBAL-DEFINE Version        2.12.01.AVB
&GLOBAL-DEFINE VersionLayout  1

&GLOBAL-DEFINE Folder         YES
&GLOBAL-DEFINE InitialPage    1
&GLOBAL-DEFINE FolderLabels   Seleá∆o, ParÉmetros, Geraá∆o
...
dt-movto-fim dt-movto-ini nro-docto-fim nro-docto-ini serie-docto-fim serie-docto-ini estado-fim estado-ini
&GLOBAL-DEFINE page4Widgets   rs-tipo-nota tg-pendentes
...
DEFINE VARIABLE dt-movto-fim AS DATE FORMAT "99/99/9999" 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .79.

DEFINE VARIABLE dt-movto-ini AS DATE FORMAT "99/99/9999" 
     LABEL "Dt Entrada":R12 
     VIEW-AS FILL-IN 
     SIZE 9.29 BY .79.

DEFINE VARIABLE estado-fim AS CHARACTER FORMAT "x(4)" INITIAL "ZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 4.72 BY .79.
...
DEFINE VARIABLE rs-tipo-nota AS INTEGER 
     VIEW-AS RADIO-SET VERTICAL
     RADIO-BUTTONS 
          "Compras", 1,
"Transferencias", 3,
"Ambos", 5
     SIZE 19.57 BY 3 NO-UNDO.
...
DEFINE FRAME fPage4
     rs-tipo-nota AT ROW 2.33 COL 6 NO-LABEL WIDGET-ID 2
     tg-pendentes AT ROW 6.25 COL 4 WIDGET-ID 18
     " Tipo Nota" VIEW-AS TEXT
          SIZE 8 BY .54 AT ROW 1.54 COL 5.57 WIDGET-ID 8
     RECT-13 AT ROW 1.79 COL 4 WIDGET-ID 6
...
DEFINE FRAME fPage2
     ...
     dt-movto-ini AT ROW 2.5 COL 20 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" WIDGET-ID 6
     dt-movto-fim AT ROW 2.5 COL 49 COLON-ALIGNED HELP
          "Data de emiss∆o da nota fiscal" NO-LABEL WIDGET-ID 14
     serie-docto-ini AT ROW 3.5 COL 24.29 COLON-ALIGNED WIDGET-ID 24
     serie-docto-fim AT ROW 3.5 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 30
     nro-docto-ini AT ROW 4.5 COL 19.29 COLON-ALIGNED WIDGET-ID 22
     nro-docto-fim AT ROW 4.5 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 36
     cod-emitente-ini AT ROW 5.5 COL 17.29 COLON-ALIGNED WIDGET-ID 20
     cod-emitente-fim AT ROW 5.5 COL 49 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     estado-ini AT ROW 6.58 COL 24.57 COLON-ALIGNED HELP
          "Unidade da Federaá∆o" WIDGET-ID 50
     estado-fim AT ROW 6.58 COL 49 COLON-ALIGNED HELP
          "Unidade da Federaá∆o" NO-LABEL WIDGET-ID 52
     ...
     IMAGE-13 AT ROW 6.58 COL 32 WIDGET-ID 46
     IMAGE-14 AT ROW 6.58 COL 47.29 WIDGET-ID 48
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 7 ROW 2.81
         SIZE 76.86 BY 10.15
...
------------------------------------------------------------------------------*/
    ...
    assign  dt-movto-ini = date(month(today),1,year(today))
            dt-movto-fim = today.
END PROCEDURE.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario          = c-seg-usuario
           ...
           tt-param.dt-movto-fim     = input frame fPage2 dt-movto-fim
           tt-param.dt-movto-ini     = input frame fPage2 dt-movto-ini
           ...
           tt-param.estado-fim       = input frame fPage2 estado-fim 
           tt-param.estado-ini       = input frame fPage2 estado-ini
           tt-param.i-tipo-nota      = input frame fPage4 rs-tipo-nota
           tt-param.l-pendentes      = INPUT FRAME fpage4 tg-pendentes.
    ...
    {report/rprun.i intprg/int029rp.p}
