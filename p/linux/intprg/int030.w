...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brLog wWindow _STRUCTURED
  QUERY brLog NO-LOCK DISPLAY
      tt-int_ds_log.origem FORMAT "x(8)":U WIDTH 9.43
      tt-int_ds_log.chave FORMAT "x(50)":U WIDTH 14.43
      tt-int_ds_log.situacao FORMAT "9":U
      tt-int_ds_log.dt_ocorrencia FORMAT "99/99/9999":U
      tt-int_ds_log.hr_ocorrencia FORMAT "x(8)":U WIDTH 8
      tt-int_ds_log.cod_programa FORMAT "x(20)":U WIDTH 11
      tt-int_ds_log.dt_movto FORMAT "99/99/9999":U
      tt-int_ds_log.cod_usuario FORMAT "x(12)":U
      tt-int_ds_log.cod_usuario_msg COLUMN-LABEL "Usu†rio Respons†vel" FORMAT "x(12)":U
            WIDTH 15
      tt-int_ds_log.desc_ocorrencia FORMAT "x(500)":U WIDTH 500
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
