...
&Scoped-define INTERNAL-TABLES int_ds_origem

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_origem NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_origem NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_origem
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_origem
