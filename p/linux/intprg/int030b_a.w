...
*******************************************************************************/
{include/i-prgvrs.i INT030B_A 2.09.00.001}
...
DEFINE FRAME f-cad
     bt-ok AT ROW 8.58 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 8.58 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 8.58 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 8.58 COL 78.14
     rt-button AT ROW 8.42 COL 2
...
DO:
{include/salvapai.i h_int030b-v01}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.33 , 1.72 ) NO-ERROR.
       RUN set-size IN h_folder ( 6.92 , 89.29 ) NO-ERROR.
       ...
       RUN set-position IN h_int030b-v01 ( 2.71 , 2.14 ) NO-ERROR.
       ...
       RUN set-position IN h_int030b-q01 ( 1.25 , 68.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_int030b-v01 ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "INT030B_A" "9.99.99.999"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_int030b-q01 (INPUT v-row-table). 
