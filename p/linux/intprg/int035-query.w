...
*******************************************************************************/
{include/i-prgvrs.i INT035-QUERY 1.00.00.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-pedido ~
      WHERE int-ds-pedido.situacao = 3 NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-pedido ~
      WHERE int-ds-pedido.situacao = 3 NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-pedido
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-pedido
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.int-ds-pedido"
     _Options          = "NO-LOCK"
     _Where[1]         = "emsesp.int-ds-pedido.situacao = 3"
