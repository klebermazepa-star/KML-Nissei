...
*******************************************************************************/
{include/i-prgvrs.i INT035-Zoom 1.00.00.AVB}
...
DEFINE VARIABLE h_int035-brwzoom AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     bt-implantar AT ROW 14.07 COL 2
     bt-ok AT ROW 15.37 COL 3
     bt-cancela AT ROW 15.37 COL 14
     bt-ajuda AT ROW 15.37 COL 79
...
/* SETTINGS FOR BUTTON bt-implantar IN FRAME f-zoom
   NO-ENABLE                                                            */
...
ON END-ERROR OF w-pesquisa /* Pesquisa de Pedidos PRS */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa de Pedidos PRS */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Pedidos' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.63 ) NO-ERROR.
       RUN set-size IN h_folder ( 12.90 , 88.63 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/int035-brwzoom.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_int035-brwzoom ).
       RUN set-position IN h_int035-brwzoom ( 3.13 , 5.50 ) NO-ERROR.
       /* Size in UIB:  ( 10.07 , 80.13 ) */

       /* Links to SmartBrowser h_int035-brwzoom. */
       RUN add-link IN adm-broker-hdl ( h_int035-brwzoom , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_int035-brwzoom ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "INT035-Zoom" "1.00.00.AVB"}
