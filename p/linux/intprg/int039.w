...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i int039 MFP}
&ENDIF
...
&GLOBAL-DEFINE page2Fields  c-estabel-ini c-estabel-fim periodo-ini periodo-fim i-pedido-ini i-pedido-fim rs-tipo rs-tipo-ped
...
DEFINE FRAME fPage2
     ...
     rs-tipo AT ROW 8.04 COL 22 NO-LABEL WIDGET-ID 14
