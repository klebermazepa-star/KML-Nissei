...
DO i-cont = 1 TO 36:
    CASE i-cont:
        ...
        WHEN 14 THEN RUN pi-cria-balanco(INPUT i-cont, INPUT "BALANCO MANUAL FILIAL - PERMITE CONSOLIDAÄ«O").  
        ...
        when 30 THEN RUN pi-cria-balanco(INPUT i-cont, input "BALANÄO CD Œ ROTATIVO").
    END CASE.
END.
*/
...
procedure valida-pedido:
    ...
    for first ser-estab no-lock where
        ...
        if ser-estab.forma-emis <> 1 /* autom†tica */ then do:
            assign i-erro = 34
                   c-informacao = "Pedido: " + c-nr-pedcli + " - Est: " + c-cod-estabel + " - SÇrie: " + c-serie
                   l-movto-com-erro = yes.
            run gera-log. 
            return.
        end.
