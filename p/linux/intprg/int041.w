...
/********************************************************************************
** Programa:  - EmissÆo de notas fiscais a partir de pedidos nota de Retorno
**                    Notas nÆo podem ser mais canceladas devido ao per¡odo estipulado pelo SEFAZ.  
**
** Versao : 1 - 12/2016 - ResultPro
**
********************************************************************************/
{include/i-prgvrs.i int041 2.12.01.AVB}
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        int041
...
DEFINE FRAME fPage2
     c-estabel-ini AT ROW 2 COL 27.86 COLON-ALIGNED HELP
          "" WIDGET-ID 2
          LABEL "Estabelecimento":R15
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int041rp.p}
