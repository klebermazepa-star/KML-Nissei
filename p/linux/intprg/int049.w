...
/********************************************************************************
** Programa: int049 - Listagem Pedidos X Notas fiscais
**
** Versao : 12 - 14/09/2016
**
********************************************************************************/
{include/i-prgvrs.i INT049 2.12.01.AVB}
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT049
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int049rp.p}
