/********************************************************************************
******************************************************************************/
{include/i-prgvrs.i int064RP 2.06.00.001}  
{include/i_fnctrad.i}
/******************************************************************************
**
**       PROGRAMA: INT063RP
...
IF tt-param.l-reducaoz THEN
   RUN pi-ncm-reducaoZ.

IF tt-param.l-nfce THEN
   RUN pi-ncm-NFC-e.
    ...
    FOR EACH tt-est-ncm-pis-cofins NO-lOCK
        ...
        IF FIRST-OF(tt-est-ncm-pis-cofins.cod-estabel) THEN DO:
            ASSIGN dTot-vl-tot-item          = 0
                   ...
                   dTot-val-base-calc-cofins = 0
                   dTot-val-cofins           = 0.
            ASSIGN chWorksheet:Range("A" + STRING(xlinha)):VALUE  = "Filial " + trim(tt-est-ncm-pis-cofins.cod-estabel) + ":"
                   chWorkSheet:range("A" + STRING(xlinha)):Font:Bold = TRUE.
            ASSIGN chWorksheet:Range("B" + STRING(xlinha)):VALUE  = "Opera‡Æo"
                   chWorkSheet:range("B" + STRING(xlinha)):Font:Bold = TRUE.
            ASSIGN chWorksheet:Range("C" + STRING(xlinha)):VALUE  = "Valor Cont bil"
                   chWorkSheet:range("C" + STRING(xlinha)):Font:Bold = TRUE.
            ASSIGN chWorksheet:Range("D" + STRING(xlinha)):VALUE  = "Base PIS"
                   chWorkSheet:range("D" + STRING(xlinha)):Font:Bold = TRUE.
            ASSIGN chWorksheet:Range("E" + STRING(xlinha)):VALUE  = "Valor PIS"
                   chWorkSheet:range("E" + STRING(xlinha)):Font:Bold = TRUE.
            ASSIGN chWorksheet:Range("F" + STRING(xlinha)):VALUE  = "Base COFINS"
                   chWorkSheet:range("F" + STRING(xlinha)):Font:Bold = TRUE.
            ASSIGN chWorksheet:Range("G" + STRING(xlinha)):VALUE  = "Valor COFINS"
                   chWorkSheet:range("G" + STRING(xlinha)):Font:Bold = TRUE .
            ASSIGN xlinha = xlinha + 1.
        end.
        ...
        IF last-of(tt-est-ncm-pis-cofins.aba) THEN DO:
            ASSIGN chWorksheet:Range("A" + STRING(xlinha)):VALUE  = tt-est-ncm-pis-cofins.cod-estabel.
            ASSIGN chWorksheet:Range("B" + STRING(xlinha)):VALUE  = tt-est-ncm-pis-cofins.aba.
            ASSIGN chWorksheet:Range("C" + STRING(xlinha)):VALUE  = vl-tot-item .
            ASSIGN chWorksheet:Range("D" + STRING(xlinha)):VALUE  = vl-basepis.
            ASSIGN chWorksheet:Range("E" + STRING(xlinha)):VALUE  = vl-pis .
            ASSIGN chWorksheet:Range("F" + STRING(xlinha)):VALUE  = vl-basecofins .
            ASSIGN chWorksheet:Range("G" + STRING(xlinha)):VALUE  = vl-cofins.
            ASSIGN xlinha = xlinha + 1.
        end.

        IF LAST-OF(tt-est-ncm-pis-cofins.cod-estabel) THEN DO:
             ASSIGN chWorksheet:Range("A" + STRING(xlinha)):VALUE  = "Totais Filial " + trim(tt-est-ncm-pis-cofins.cod-estabel) + ":"
                    chWorkSheet:range("A" + STRING(xlinha)):Font:Bold = TRUE.
             ASSIGN chWorksheet:Range("B" + STRING(xlinha)):VALUE  = ""
                    chWorkSheet:range("B" + STRING(xlinha)):Font:Bold = TRUE.
             ASSIGN chWorksheet:Range("C" + STRING(xlinha)):VALUE  = dTot-vl-tot-item 
                    chWorkSheet:range("C" + STRING(xlinha)):Font:Bold = TRUE.
             ASSIGN chWorksheet:Range("D" + STRING(xlinha)):VALUE  = dTot-val-base-calc-pis
                    chWorkSheet:range("D" + STRING(xlinha)):Font:Bold = TRUE.
             ASSIGN chWorksheet:Range("E" + STRING(xlinha)):VALUE  = dTot-val-pis 
                    chWorkSheet:range("E" + STRING(xlinha)):Font:Bold = TRUE.
             ASSIGN chWorksheet:Range("F" + STRING(xlinha)):VALUE  = dTot-val-base-calc-cofins 
                    chWorkSheet:range("F" + STRING(xlinha)):Font:Bold = TRUE.
             ASSIGN chWorksheet:Range("G" + STRING(xlinha)):VALUE  = dTot-val-cofins
                    chWorkSheet:range("G" + STRING(xlinha)):Font:Bold = TRUE .
             ASSIGN xlinha = xlinha + 1.
        END.
    END.
...
PROCEDURE pi-ncm-compras:
    ...
    for EACH doc-fiscal FIELDS (ind-sit-doc cod-estabel cod-emitente nat-operacao serie nr-doc-fis dt-docto tipo-nat cod-cfop esp-docto)
       ...
       where doc-fiscal.dt-docto  >= tt-param.data-ini
        ...
        FOR each it-doc-fisc FIELDS (vl-tot-item nat-operacao it-codigo class-fiscal) of doc-fiscal NO-LOCK:
            ...
            FOR first natur-oper FIELDS (nat-operacao tipo-compra especie-doc char-1)
              ...
              AND natur-oper.especie-doc = 'NFE':
               ...
               /* assign vl-aliquotaPIS = dec(substr(item.char-2,31,5)) /*string(dec(substr(item.char-2,31,5)),"99.99")*/
                       vl-BasePIS     =  it-doc-fisc.vl-tot-item + it-doc-fisc.vl-despes-it - dec(substr(it-doc-fisc.char-2,124,14)) /*it-doc-fisc.val-desc-tot*/ 
                ...
                assign vl-aliquotaCOFINS = dec(substr(item.char-2,36,5))
                       vl-BaseCOFINS     = it-doc-fisc.vl-tot-item + it-doc-fisc.vl-despes-it - dec(substr(it-doc-fisc.char-2,124,14)) /*it-doc-fisc.val-desc-tot*/ 
                       vl-COFINS         = (vl-BaseCOFINS * vl-aliquotaCOFINS) / 100
                       TribCOFINS        = 1.  
                if vl-aliquotaCOFINS <= 0 then do:
                ...
                FIND FIRST tt-ncm-pis-cofins
                     WHERE tt-ncm-pis-cofins.aba             = "Compras"
                       ...
                       AND tt-ncm-pis-cofins.cod-cfop        = doc-fiscal.cod-cfop NO-ERROR.
                        ...
                        /*MESSAGE it-doc-fisc.nat-operacao
                            VIEW-AS ALERT-BOX INFO BUTTONS OK.*/
                IF NOT AVAIL tt-ncm-pis-cofins THEN DO:            
                    ...
                    ASSIGN tt-ncm-pis-cofins.aba                   = "Compras"
                           ...
                           tt-ncm-pis-cofins.val-base-calc-pis     = vl-BasePIS  
                           tt-ncm-pis-cofins.val-pis               = vl-PIS
                           tt-ncm-pis-cofins.val-base-calc-cofins  = vl-BaseCOFINS 
                           tt-ncm-pis-cofins.val-cofins            = vl-COFINS
                           .        
                END.
                ELSE DO:
            ...
            FOR first natur-oper FIELDS (nat-operacao tipo-compra especie-doc char-1)
                ...
                /*FIND FIRST tt-ncm-pis-cofins
                     WHERE tt-ncm-pis-cofins.aba             = "Devolu‡Æo de Cliente"
                       AND tt-ncm-pis-cofins.class-fiscal    = it-doc-fisc.class-fiscal
                       AND tt-ncm-pis-cofins.tp-trib-pis     = {ininc/i11in172.i 04 TribPIS} 
                       AND tt-ncm-pis-cofins.tp-trib-cofins  = {ininc/i11in172.i 04 TribCOFINS} NO-ERROR.
                IF NOT AVAIL tt-ncm-pis-cofins THEN DO:
                    CREATE tt-ncm-pis-cofins.
        ...
        where doc-fiscal.dt-docto  >= tt-param.data-ini
         ...
         FOR each it-doc-fisc FIELDS (vl-tot-item nat-operacao it-codigo class-fiscal) of doc-fiscal NO-LOCK:
             ...
             IF doc-fiscal.esp-docto = "NFS" THEN DO:
                 ...
                 /* Redu‡Æo Z */
                 IF estabelec.estado <> 'PR' THEN DO:
...
PROCEDURE calculapiscofins:
        ...
        IF SUBSTRING(natur-oper.char-1,86,1) = '1' THEN do: /*PIS*/
        ...
        IF SUBSTRING(natur-oper.char-1,87,1) = '1' THEN do: /*COFINS*/
           assign vl-aliquotaCOFINS = dec(substr(item.char-2,36,5))
                  vl-BaseCOFINS     = it-doc-fisc.vl-tot-item /*+ it-doc-fisc.vl-despes-it - dec(substr(it-doc-fisc.char-2,124,14))*/ /*it-doc-fisc.val-desc-tot*/ 
                  vl-COFINS         = (vl-BaseCOFINS * vl-aliquotaCOFINS) / 100
                  TribCOFINS        = 1.  
        ...
        FIND FIRST tt-est-ncm-pis-cofins
            ...
            IF NOT AVAIL tt-est-ncm-pis-cofins THEN DO:            
                ...
                ASSIGN tt-est-ncm-pis-cofins.aba                   = aba
                       ...
                       tt-est-ncm-pis-cofins.vl-tot-item           = it-doc-fisc.vl-tot-item
                       tt-est-ncm-pis-cofins.nat-operacao          = it-doc-fisc.nat-operacao 
                       tt-est-ncm-pis-cofins.cod-cfop              = doc-fiscal.cod-cfop
                       tt-est-ncm-pis-cofins.val-base-calc-pis     = vl-BasePIS  
                       tt-est-ncm-pis-cofins.val-pis               = vl-PIS
                       tt-est-ncm-pis-cofins.val-base-calc-cofins  = vl-BaseCOFINS 
                       tt-est-ncm-pis-cofins.val-cofins            = vl-COFINS
