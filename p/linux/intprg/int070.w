...
*******************************************************************************/
{include/i-prgvrs.i INT070 2.00.00.000}  /*** 010009 ***/
...
DEF VAR l-csv              AS LOGICAL NO-UNDO.

{include/i-imdef.i}
{cdp/cdcfgmat.i} /* Preprocessadores fun‡äes materiais     */
...
DEFINE BUTTON bt-dir-exporta 
     IMAGE-UP FILE "adeicon/open.bmp":U
     LABEL "Button 1" 
     SIZE 4 BY 1 TOOLTIP "Selecione o diret¢rio para Exporta‡Æo".
...
DEFINE VARIABLE c-dir-exporta AS CHARACTER FORMAT "X(35)":U 
     VIEW-AS FILL-IN 
     SIZE 40 BY .88 NO-UNDO.

DEFINE VARIABLE c-fm-cod-fim AS CHARACTER FORMAT "X(8)":U INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 NO-UNDO.

DEFINE VARIABLE c-fm-cod-ini AS CHARACTER FORMAT "X(8)":U 
     LABEL "Fam¡lia" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 NO-UNDO.

DEFINE VARIABLE c-fm-com-fim AS CHARACTER FORMAT "X(8)":U INITIAL "ZZZZZZZZ" 
     VIEW-AS FILL-IN 
     SIZE 9 BY .88 NO-UNDO.

DEFINE VARIABLE c-fm-com-ini AS CHARACTER FORMAT "X(8)":U 
...
DEFINE VARIABLE i-ge-cod-fim AS INTEGER FORMAT ">9":U INITIAL 99 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 NO-UNDO.

DEFINE VARIABLE i-ge-cod-ini AS INTEGER FORMAT ">9":U INITIAL 0 
     LABEL "Grupo Estoque" 
     VIEW-AS FILL-IN 
     SIZE 3 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-par
     rs-acao AT ROW 2.29 COL 5.72 NO-LABEL WIDGET-ID 10
     i-ge-cod-ini AT ROW 1.42 COL 30.29 COLON-ALIGNED WIDGET-ID 26
     i-ge-cod-fim AT ROW 1.42 COL 57.29 COLON-ALIGNED NO-LABEL WIDGET-ID 34
     c-fm-cod-ini AT ROW 2.42 COL 30.29 COLON-ALIGNED WIDGET-ID 36
     c-fm-cod-fim AT ROW 2.42 COL 57.29 COLON-ALIGNED NO-LABEL WIDGET-ID 44
     c-fm-com-ini AT ROW 3.42 COL 30.29 COLON-ALIGNED WIDGET-ID 46
     c-fm-com-fim AT ROW 3.42 COL 57.29 COLON-ALIGNED NO-LABEL WIDGET-ID 50
     c-item-ini AT ROW 4.42 COL 30.29 COLON-ALIGNED WIDGET-ID 22
     c-item-fim AT ROW 4.42 COL 57.29 COLON-ALIGNED NO-LABEL WIDGET-ID 24
     text-entrada-2 AT ROW 5.96 COL 18.14 NO-LABEL WIDGET-ID 8
     c-dir-exporta AT ROW 6.83 COL 15.57 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     text-entrada AT ROW 9 COL 18 NO-LABEL
     bt-dir-exporta AT ROW 6.79 COL 57.57 WIDGET-ID 4
     c-arquivo-entrada AT ROW 9.92 COL 17.57 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-arquivo-entrada AT ROW 9.88 COL 57.57 HELP
          "Escolha do nome do arquivo"
     RECT-8 AT ROW 9.38 COL 16
     RECT-10 AT ROW 6.29 COL 16 WIDGET-ID 6
     RECT-12 AT ROW 2 COL 3 WIDGET-ID 16
     IMAGE-1 AT ROW 4.42 COL 49.72 WIDGET-ID 18
     IMAGE-2 AT ROW 4.42 COL 56 WIDGET-ID 20
     IMAGE-4 AT ROW 1.42 COL 49.72 WIDGET-ID 30
     IMAGE-5 AT ROW 1.42 COL 56 WIDGET-ID 32
     IMAGE-8 AT ROW 2.42 COL 49.72 WIDGET-ID 42
     IMAGE-9 AT ROW 3.42 COL 49.72 WIDGET-ID 48
     IMAGE-11 AT ROW 2.42 COL 56 WIDGET-ID 54
     IMAGE-12 AT ROW 3.42 COL 56 WIDGET-ID 56
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.57 BY 10.38
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Exporta‡Æo/Importa‡Æo Carac. T‚cnicas Itens"
         HEIGHT             = 14.71
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Exporta‡Æo/Importa‡Æo Carac. T‚cnicas Itens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Exporta‡Æo/Importa‡Æo Carac. T‚cnicas Itens */
DO:
...
&Scoped-define FRAME-NAME f-pg-par
&Scoped-define SELF-NAME bt-dir-exporta
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-dir-exporta C-Win
ON CHOOSE OF bt-dir-exporta IN FRAME f-pg-par /* Button 1 */
DO:
  ...
  run utp/ut-dir.p(input "Selecione o Diret¢rio.",
                   output c-dir,
                   output l-cancelado).
  if not l-cancelado THEN DO: 
     if  length(c-dir) > 3 
     and substr(c-dir,length(c-dir),1) <> "~\" THEN
         assign c-dir-exporta:screen-value = (c-dir + "~\") . 
     else 
         assign c-dir-exporta:screen-value = c-dir . 
  END.
END.
...
DO:
    ...
    IF INPUT FRAME f-pg-par rs-acao = 1 THEN                                      
       ASSIGN c-arquivo-entrada:SENSITIVE IN FRAME f-pg-par  = NO
              bt-arquivo-entrada:SENSITIVE IN FRAME f-pg-par = NO
              c-dir-exporta:SENSITIVE IN FRAME f-pg-par      = YES
              bt-dir-exporta:SENSITIVE IN FRAME f-pg-par     = YES
              c-item-ini:SENSITIVE IN FRAME f-pg-par         = YES
              c-item-fim:SENSITIVE IN FRAME f-pg-par         = YES
              i-ge-cod-ini:SENSITIVE IN FRAME f-pg-par       = YES
              i-ge-cod-fim:SENSITIVE IN FRAME f-pg-par       = YES
              c-fm-cod-ini:SENSITIVE IN FRAME f-pg-par       = YES
              c-fm-cod-fim:SENSITIVE IN FRAME f-pg-par       = YES
              c-fm-com-ini:SENSITIVE IN FRAME f-pg-par       = YES
              c-fm-com-fim:SENSITIVE IN FRAME f-pg-par       = YES.              
    ELSE
        ASSIGN c-arquivo-entrada:SENSITIVE IN FRAME f-pg-par  = YES
               bt-arquivo-entrada:SENSITIVE IN FRAME f-pg-par = YES
               c-dir-exporta:SENSITIVE IN FRAME f-pg-par      = NO
               bt-dir-exporta:SENSITIVE IN FRAME f-pg-par     = NO
               c-item-ini:SENSITIVE IN FRAME f-pg-par         = NO
               c-item-fim:SENSITIVE IN FRAME f-pg-par         = NO
               i-ge-cod-ini:SENSITIVE IN FRAME f-pg-par       = NO 
               i-ge-cod-fim:SENSITIVE IN FRAME f-pg-par       = NO
               c-fm-cod-ini:SENSITIVE IN FRAME f-pg-par       = NO
               c-fm-cod-fim:SENSITIVE IN FRAME f-pg-par       = NO
               c-fm-com-ini:SENSITIVE IN FRAME f-pg-par       = NO
               c-fm-com-fim:SENSITIVE IN FRAME f-pg-par       = NO.              
END.
...
{utp/ut9000.i "INT070" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY rs-acao i-ge-cod-ini i-ge-cod-fim c-fm-cod-ini c-fm-cod-fim 
          c-fm-com-ini c-fm-com-fim c-item-ini c-item-fim c-dir-exporta 
          c-arquivo-entrada 
      WITH FRAME f-pg-par IN WINDOW C-Win.
  ENABLE rs-acao i-ge-cod-ini i-ge-cod-fim c-fm-cod-ini c-fm-cod-fim 
         c-fm-com-ini c-fm-com-fim c-item-ini c-item-fim c-dir-exporta 
         bt-dir-exporta c-arquivo-entrada bt-arquivo-entrada RECT-8 RECT-10 
         RECT-12 IMAGE-1 IMAGE-2 IMAGE-4 IMAGE-5 IMAGE-8 IMAGE-9 IMAGE-11 
         IMAGE-12 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    IF INPUT FRAME f-pg-par rs-acao = 1 THEN DO:
       ASSIGN l-csv = NO.
       IF INPUT FRAME f-pg-par c-dir-exporta MATCHES "*csv*" THEN
          ASSIGN l-csv = YES.
       IF l-csv = NO THEN DO:
          MESSAGE "ExtensÆo do Arquivo de Sa¡da deve ser .CSV" 
              VIEW-AS ALERT-BOX INFO BUTTONS OK.
          apply 'entry' to c-dir-exporta in frame f-pg-par.                
          return error.
       END.
    END.

    IF INPUT FRAME f-pg-par rs-acao = 2 THEN DO:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.arq-saida       = INPUT FRAME f-pg-par c-dir-exporta
           tt-param.item-ini        = INPUT FRAME f-pg-par c-item-ini
           tt-param.item-fim        = INPUT FRAME f-pg-par c-item-fim
           tt-param.ge-cod-ini      = INPUT FRAME f-pg-par i-ge-cod-ini     
           tt-param.ge-cod-fim      = INPUT FRAME f-pg-par i-ge-cod-fim     
           tt-param.fam-cod-ini     = INPUT FRAME f-pg-par c-fm-cod-ini
           tt-param.fam-cod-fim     = INPUT FRAME f-pg-par c-fm-cod-fim
           tt-param.fam-com-ini     = INPUT FRAME f-pg-par c-fm-com-ini
           tt-param.fam-com-fim     = INPUT FRAME f-pg-par c-fm-com-fim.
    ...
    {include/i-imrun.i intprg/int070rp.p}
