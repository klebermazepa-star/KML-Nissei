/**********************************************************************************************
**
**  Programa: int090rpw - Gera‡Æo e integra‡Æo dos dados fiscais dos itens - Datasul -> Procfit
**
**********************************************************************************************/
...
ASSIGN tt-param.cod-estab-ini    = "" 
       ...
       tt-param.it-codigo-fim    = "ZZZZZZZZZZZZZZZZZZZZ" 
       tt-param.tg-pr            = YES     
       tt-param.tg-sp            = YES 
       tt-param.tg-sc            = YES 
       tt-param.tg-pr-dest       = YES 
       tt-param.tg-sp-dest       = YES 
       tt-param.tg-sc-dest       = YES 
       tt-param.ge-codigo-ini    = 0
       tt-param.ge-codigo-fim    = 999 
       tt-param.fm-codigo-ini    = "" 
       tt-param.fm-codigo-fim    = "ZZZZZZZZZZ" 
       tt-param.clas-fiscal-ini  = "" 
       tt-param.clas-fiscal-fim  = "9999999999" 
       tt-param.cst-ini          = 0  
       tt-param.cst-fim          = 999 
       tt-param.com-subst-tribut = YES
       tt-param.sem-subst-tribut = YES
       tt-param.forc-integ       = NO
       tt-param.arquivo = "INT090.txt"
       tt-param.destino = 3
