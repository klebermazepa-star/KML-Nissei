/************************************************************************************
** Programa: INT110-13RP.P - Faturamento de Pedidos CD->Lojas do Tutorial/Sysfarma
**
** Geraá∆o Notas Fiscais SêRIE 13 
**
** Vers∆o: 12 - 08/11/2016 - Alessandro V Baccin
************************************************************************************/

/* include de controle de versao */
{include/i-prgvrs.i int110-13rp 2.12.01.AVB}
...
IF tt-param.arquivo = "" THEN 
    ASSIGN tt-param.arquivo = "int110-13.txt"
           tt-param.destino = 3
           tt-param.data-exec = TODAY
           tt-param.hora-exec = TIME.

ASSIGN tt-param.serie = "13"
       c-prog-log     = "int110-13rp.p".
...
DO TRANS:
   ...
   END.
   ASSIGN cst_mon_fat_serie.serie_13 = YES.
...
DO TRANS:
   ...
   IF AVAIL cst_mon_fat_serie THEN DO:
      ASSIGN cst_mon_fat_serie.serie_13 = NO.
      RELEASE cst_mon_fat_serie.
   END.
END.
