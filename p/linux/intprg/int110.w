...
/********************************************************************************
** Programa: int010 - Faturamento de pedidos de Transferência do PRS
**
** Versao : 12 - 08/11/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT110 2.12.01.AVB}
...
&GLOBAL-DEFINE page4Fields    i-pedido c-serie
...
DEFINE VARIABLE c-serie AS CHARACTER FORMAT "x(5)":U INITIAL "" 
     LABEL "S‚rie" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME fPage4
     ...
     c-serie AT ROW 3.75 COL 9 COLON-ALIGNED HELP
          "S‚rie" WIDGET-ID 2
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/int110rp.p}
