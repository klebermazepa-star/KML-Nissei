    ...
    do transaction:
        ...
        for each tt-ped-venda-imp:
            ...
            IF AVAIL bint_ds_pedido THEN DO:
               ...
               ASSIGN cst_monitor_fat.dt_ini_fat   = TODAY
                      cst_monitor_fat.hr_ini_fat   = TIME
                      cst_monitor_fat.ped_codigo_n = bint_ds_pedido.ped_codigo_n
                      cst_monitor_fat.dt_ger_ped   = bint_ds_pedido.dt_geracao
                      cst_monitor_fat.hr_ger_ped   = bint_ds_pedido.hr_geracao
                      l-criou-mon-fat              = YES.
            END.
            ...
            for first wt-docto where
                ...
                */
                ...
                IF l-criou-mon-fat = YES THEN DO:
                   ASSIGN cst_monitor_fat.cod_estabel = c-estab-mon
