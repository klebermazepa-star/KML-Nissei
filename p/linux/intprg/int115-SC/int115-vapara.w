...
*******************************************************************************/
{include/i-prgvrs.i INT115VP 2.12.01.AVB}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_tp-pedido bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_tp-pedido 
...
DEFINE VARIABLE c_tp-pedido AS CHARACTER FORMAT "X(2)" 
     LABEL "Tipo Pedido" 
...
DEFINE FRAME d-vapara
     c_tp-pedido AT ROW 1.75 COL 12 COLON-ALIGNED WIDGET-ID 110
     bt-ok AT ROW 4.5 COL 2.14
     bt-cancela AT ROW 4.5 COL 13
     bt-ajuda AT ROW 4.5 COL 76.29
     rt-button AT ROW 4.25 COL 1.29
     SPACE(0.56) SKIP(0.07)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "V  Para Tipo Pedido"
...
ON GO OF FRAME d-vapara /* V  Para Tipo Pedido */
DO:
FIND int-ds-tipo-pedido NO-LOCK
    WHERE int-ds-tipo-pedido.tp-pedido EQ INPUT FRAME {&FRAME-NAME} c_tp-pedido NO-ERROR.

IF NOT AVAILABLE int-ds-tipo-pedido THEN DO:
    {utp/ut-table.i emsesp int-ds-tipo-pedido 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int-ds-tipo-pedido).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Tipo Pedido */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_tp-pedido 
      WITH FRAME d-vapara.
  ENABLE rt-button c_tp-pedido bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "INT115VP" "2.12.01.AVB"}

  assign c_tp-pedido:list-item-pairs = "0,0".
  for each int-ds-tipo-pedido no-lock:
      c_tp-pedido:ADD-LAST(int-ds-tipo-pedido.descricao,int-ds-tipo-pedido.tp-pedido).
  end.
  c_tp-pedido:DELETE("0,0") no-error.
