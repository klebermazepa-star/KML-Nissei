...
DEFINE VARIABLE h_int115-browser-zoom AS HANDLE NO-UNDO.
...
ON END-ERROR OF w-pesquisa /* Pesquisa deTipo Pedido */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa deTipo Pedido */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/int115-browser-zoom.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_int115-browser-zoom ).
       RUN set-position IN h_int115-browser-zoom ( 3.00 , 6.00 ) NO-ERROR.
       /* Size in UIB:  ( 10.17 , 80.00 ) */

       /* Links to SmartBrowser h_int115-browser-zoom. */
       RUN add-link IN adm-broker-hdl ( h_int115-browser-zoom , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_int115-browser-zoom ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
