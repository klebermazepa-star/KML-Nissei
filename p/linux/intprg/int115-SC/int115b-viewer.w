...
&Scoped-Define DISPLAYED-FIELDS int-ds-tp-trib-natur-oper.uf-origem ~
...
&Scoped-Define DISPLAYED-OBJECTS tp-pedido cd-trib-icm cNCM cNatSaiEst ~
cNatSaiInter cNatEntEst cNatEntInter cNatSaiEstNAO cNatSaiInterNAO ~
cNatEntEstNAO cNatEntInterNAO 

/* Custom List Definitions                                              */
/* ADM-CREATE-FIELDS,ADM-ASSIGN-FIELDS,ADM-MODIFY-FIELDS,List-4,List-5,List-6 */
&Scoped-define ADM-CREATE-FIELDS int-ds-tp-trib-natur-oper.class-fiscal 
...
DEFINE FRAME f-main
     tp-pedido AT ROW 1.75 COL 17 COLON-ALIGNED WIDGET-ID 110
     ...
     int-ds-tp-trib-natur-oper.uf-origem AT ROW 4 COL 17 COLON-ALIGNED HELP
          ...
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     int-ds-tp-trib-natur-oper.class-fiscal AT ROW 5 COL 17 COLON-ALIGNED WIDGET-ID 198
          LABEL "NCM" FORMAT "9999.99.99"
          VIEW-AS FILL-IN 
          SIZE 11.14 BY .88
     cNCM AT ROW 5 COL 28 COLON-ALIGNED NO-LABEL WIDGET-ID 196
     int-ds-tp-trib-natur-oper.nat-saida-est AT ROW 7.71 COL 17 COLON-ALIGNED WIDGET-ID 158
          LABEL "Nat. Estadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatSaiEst AT ROW 7.71 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 192
     int-ds-tp-trib-natur-oper.nat-saida-inter AT ROW 8.71 COL 17 COLON-ALIGNED WIDGET-ID 160
          LABEL "Nat. Interestadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatSaiInter AT ROW 8.71 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 138
     int-ds-tp-trib-natur-oper.nat-entrada-est AT ROW 11.5 COL 17 COLON-ALIGNED WIDGET-ID 154
          LABEL "Nat. Estadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatEntEst AT ROW 11.5 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 142
     int-ds-tp-trib-natur-oper.nat-entrada-inter AT ROW 12.5 COL 17 COLON-ALIGNED WIDGET-ID 156
          LABEL "Nat. Interestadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatEntInter AT ROW 12.5 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 140
     int-ds-tp-trib-natur-oper.nat-saida-est-nao-contrib AT ROW 15.25 COL 17 COLON-ALIGNED WIDGET-ID 180
          LABEL "Nat. Estadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatSaiEstNAO AT ROW 15.25 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 168
     int-ds-tp-trib-natur-oper.nat-saida-inter-nao-contrib AT ROW 16.25 COL 17 COLON-ALIGNED WIDGET-ID 182
          LABEL "Nat. Interestadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatSaiInterNAO AT ROW 16.25 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 170
     int-ds-tp-trib-natur-oper.nat-entrada-est-nao-contrib AT ROW 19 COL 17 COLON-ALIGNED WIDGET-ID 184
          LABEL "Nat. Estadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatEntEstNAO AT ROW 19 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 164
     int-ds-tp-trib-natur-oper.nat-entrada-inter-nao-contrib AT ROW 20 COL 17 COLON-ALIGNED WIDGET-ID 186
          LABEL "Nat. Interestadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatEntInterNAO AT ROW 20 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 166
     ...
     "Sa°das NAO Contribuinte" VIEW-AS TEXT
          SIZE 22 BY .67 AT ROW 14 COL 4 WIDGET-ID 176
     "Entradas NAO Contribuinte" VIEW-AS TEXT
          SIZE 23 BY .67 AT ROW 17.75 COL 4 WIDGET-ID 178
     "Entradas p/ Contribuinte" VIEW-AS TEXT
          SIZE 21 BY .67 AT ROW 10.25 COL 4 WIDGET-ID 146
...
DEFINE FRAME f-main
     ...
     RECT-24 AT ROW 10.5 COL 2 WIDGET-ID 144
     RECT-23 AT ROW 14.25 COL 2 WIDGET-ID 172
     RECT-25 AT ROW 18 COL 2 WIDGET-ID 174
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1 SCROLLABLE  WIDGET-ID 100.
