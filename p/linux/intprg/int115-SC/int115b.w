...
DEFINE FRAME f-cad
     bt-ok AT ROW 21.5 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 21.5 COL 13.57 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 21.5 COL 24.14 HELP
          "Cancela"
     bt-ajuda AT ROW 21.5 COL 81.72
     rt-button AT ROW 21.33 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 92 BY 22.04 WIDGET-ID 100.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_int115b-query ( 20.83 , 71.00 ) NO-ERROR.
