...
&Scoped-Define ENABLED-OBJECTS rt-button c_tp_pedido bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_tp_pedido 
...
DEFINE VARIABLE c_tp_pedido AS CHARACTER FORMAT "X(2)" 
     LABEL "Tipo Pedido" 
...
DEFINE FRAME d-vapara
     c_tp_pedido AT ROW 1.75 COL 12 COLON-ALIGNED WIDGET-ID 110
...
DO:
FIND int_ds_tipo_pedido NO-LOCK
    WHERE int_ds_tipo_pedido.tp_pedido EQ INPUT FRAME {&FRAME-NAME} c_tp_pedido NO-ERROR.

IF NOT AVAILABLE int_ds_tipo_pedido THEN DO:
    {utp/ut-table.i custom int_ds_tipo_pedido 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int_ds_tipo_pedido).
END.
...
------------------------------------------------------------------------------*/
  DISPLAY c_tp_pedido 
      WITH FRAME d-vapara.
  ENABLE rt-button c_tp_pedido bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  assign c_tp_pedido:list-item-pairs = "0,0".
  for each int_ds_tipo_pedido no-lock:
      c_tp_pedido:ADD-LAST(int_ds_tipo_pedido.descricao,int_ds_tipo_pedido.tp_pedido).
  end.
  c_tp_pedido:DELETE("0,0") no-error.
