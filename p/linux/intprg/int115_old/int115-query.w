...
*******************************************************************************/
{include/i-prgvrs.i INT115-Query.w 2.12.01.001}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-tp-trib-natur-oper NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-tp-trib-natur-oper NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-tp-trib-natur-oper
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-tp-trib-natur-oper
...
<FOREIGN-KEYS>
tp-pedido||y|mgesp.int-ds-tp-trib-natur-oper.tp-pedido
cd-trib-icm||y|mgesp.int-ds-tp-trib-natur-oper.cd-trib-icm
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "tp-pedido,cd-trib-icm"':U).
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.int-ds-tp-trib-natur-oper"
     _Options          = "NO-LOCK"
...
------------------------------------------------------------------------------*/
    ...
    define input parameter i-cd-trib-icm as integer no-undo.
    ...
    run intprg/INT115a.p (  input  c-operacao       ,
                            ...
                            input  if c-tp-pedido <> "" then c-tp-pedido else ?,
                            input  if i-cd-trib-icm <> 0 then i-cd-trib-icm else ?,
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "cd-trib-icm" "int-ds-tp-trib-natur-oper" "cd-trib-icm"}
