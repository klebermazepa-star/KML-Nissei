...
*******************************************************************************/
{include/i-prgvrs.i V01INT115 2.04.00.AVB}
...
int-ds-tp-trib-natur-oper.cd-trib-icm int-ds-tp-trib-natur-oper.uf-destino ~
int-ds-tp-trib-natur-oper.uf-origem int-ds-tp-trib-natur-oper.cod-emitente ~
...
DEFINE FRAME d-vapara
     int-ds-tp-trib-natur-oper.tp-pedido AT ROW 1.25 COL 10.43 WIDGET-ID 110
          ...
          DROP-DOWN-LIST
          SIZE 45 BY 1
     int-ds-tp-trib-natur-oper.cd-trib-icm AT ROW 2.5 COL 20 COLON-ALIGNED
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .88
...
/* SETTINGS FOR FILL-IN int-ds-tp-trib-natur-oper.class-fiscal IN FRAME d-vapara
   EXP-FORMAT                                                           */
/* SETTINGS FOR COMBO-BOX int-ds-tp-trib-natur-oper.tp-pedido IN FRAME d-vapara
   ALIGN-L                                                              */
...
DO:
  find first int-ds-tp-trib-natur-oper no-lock where 
      int-ds-tp-trib-natur-oper.tp-pedido = input frame {&frame-name} int-ds-tp-trib-natur-oper.tp-pedido and
      int-ds-tp-trib-natur-oper.cd-trib-icm = input frame {&frame-name} int-ds-tp-trib-natur-oper.cd-trib-icm
      no-error.
  if  not avail int-ds-tp-trib-natur-oper then do:
      {utp/ut-table.i emsesp int-ds-tp-trib-natur-oper 1}
      run utp/ut-msgs.p (input "show":U,
                         input 2,
                         input RETURN-VALUE).
      return no-apply.
  end.
  assign p-row-tabela = rowid(int-ds-tp-trib-natur-oper).
END.
...
------------------------------------------------------------------------------*/
  IF AVAILABLE int-ds-tp-trib-natur-oper THEN 
    DISPLAY int-ds-tp-trib-natur-oper.tp-pedido int-ds-tp-trib-natur-oper.cd-trib-icm 
      WITH FRAME d-vapara.
  ENABLE rt-button int-ds-tp-trib-natur-oper.tp-pedido 
         int-ds-tp-trib-natur-oper.cd-trib-icm bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "V01INT115" "2.04.00.000"}
