...
*******************************************************************************/
{include/i-prgvrs.i ZINT115 2.06.01.AVB}
...
DEFINE VARIABLE h_INT115-browser AS HANDLE NO-UNDO.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/INT115-browser.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_INT115-browser ).
       /* Position in AB:  ( 3.00 , 4.00 ) */
       /* Size in UIB:  ( 15.17 , 80.14 ) */

       /* Links to  h_INT115-browser. */
       RUN add-link IN adm-broker-hdl ( h_INT115-browser , 'State':U , THIS-PROCEDURE ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "ZINT115" "2.06.01.AVB"}
