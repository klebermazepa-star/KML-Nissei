...
/********************************************************************************
** Programa: INT115 - Cadastro de->para Tipo edido X Nat. Opera‡Æo 
**                    Tutorial/PRS -> Datasul
**
** Versao : 12 - 03/03/2016 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT115 2.06.02.AVB}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Naturezas de Opera‡Æo X Tipo Tributa‡Æo"
         HEIGHT             = 22.21
         WIDTH              = 100.43
         MAX-HEIGHT         = 29.92
         MAX-WIDTH          = 219.43
         VIRTUAL-HEIGHT     = 29.92
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Naturezas de Opera‡Æo X Tipo Tributa‡Æo */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Naturezas de Opera‡Æo X Tipo Tributa‡Æo */
DO:
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 84.72 ) NO-ERROR.
       ...
       RUN set-position IN h_INT115-viewer ( 3.00 , 4.29 ) NO-ERROR.
       /* Size in UIB:  ( 19.67 , 92.00 ) */
       ...
       RUN set-position IN h_INT115-query ( 2.75 , 90.57 ) NO-ERROR.
       /* Size in UIB:  ( 1.71 , 10.43 ) */
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_INT115-viewer ).
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "INT115" "2.06.02.AVB"}
