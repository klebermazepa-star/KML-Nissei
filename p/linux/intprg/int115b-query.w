...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_tp_trib_natur_oper NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_tp_trib_natur_oper NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_tp_trib_natur_oper
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_tp_trib_natur_oper
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "custom.int_ds_tp_trib_natur_oper"
     _Options          = "NO-LOCK"
