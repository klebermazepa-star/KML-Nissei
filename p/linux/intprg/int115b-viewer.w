...
&Scoped-define ADM-CREATE-FIELDS int_ds_tp_trib_natur_oper.class_fiscal 
...
DEFINE FRAME f-main
     ...
     int_ds_tp_trib_natur_oper.uf_origem AT ROW 4 COL 17 COLON-ALIGNED HELP
          "Unidade da federaá∆o origem (somente para exceá‰es)" WIDGET-ID 188
          VIEW-AS FILL-IN 
          SIZE 4 BY .88
     int_ds_tp_trib_natur_oper.class_fiscal AT ROW 5 COL 17 COLON-ALIGNED WIDGET-ID 198
          LABEL "NCM" FORMAT "9999.99.99"
          VIEW-AS FILL-IN 
          SIZE 11.14 BY .88
     cNCM AT ROW 5 COL 28 COLON-ALIGNED NO-LABEL WIDGET-ID 196
     int_ds_tp_trib_natur_oper.nat_saida_est AT ROW 7.71 COL 17 COLON-ALIGNED WIDGET-ID 158
          LABEL "Nat. Estadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatSaiEst AT ROW 7.71 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 192
     int_ds_tp_trib_natur_oper.nat_saida_inter AT ROW 8.71 COL 17 COLON-ALIGNED WIDGET-ID 160
          LABEL "Nat. Interestadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatSaiInter AT ROW 8.71 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 138
     int_ds_tp_trib_natur_oper.nat_entrada_est AT ROW 11.5 COL 17 COLON-ALIGNED WIDGET-ID 154
          LABEL "Nat. Estadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatEntEst AT ROW 11.5 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 142
     int_ds_tp_trib_natur_oper.nat_entrada_inter AT ROW 12.5 COL 17 COLON-ALIGNED WIDGET-ID 156
          LABEL "Nat. Interestadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatEntInter AT ROW 12.5 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 140
     int_ds_tp_trib_natur_oper.nat_saida_est_nao_contrib AT ROW 15.25 COL 17 COLON-ALIGNED WIDGET-ID 180
          LABEL "Nat. Estadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatSaiEstNAO AT ROW 15.25 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 168
     int_ds_tp_trib_natur_oper.nat_saida_inter_nao_contrib AT ROW 16.25 COL 17 COLON-ALIGNED WIDGET-ID 182
          LABEL "Nat. Interestadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatSaiInterNAO AT ROW 16.25 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 170
     int_ds_tp_trib_natur_oper.nat_entrada_est_nao_contrib AT ROW 19 COL 17 COLON-ALIGNED WIDGET-ID 184
          LABEL "Nat. Estadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
     cNatEntEstNAO AT ROW 19 COL 27 COLON-ALIGNED NO-LABEL WIDGET-ID 164
     int_ds_tp_trib_natur_oper.nat_entrada_inter_nao_contrib AT ROW 20 COL 17 COLON-ALIGNED WIDGET-ID 186
          LABEL "Nat. Interestadual"
          VIEW-AS FILL-IN 
          SIZE 10 BY .88
...
/* SETTINGS FOR RADIO-SET cd-trib-icm IN FRAME f-main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN int_ds_tp_trib_natur_oper.class-fiscal IN FRAME f-main
...
/* SETTINGS FOR COMBO-BOX tp_pedido IN FRAME f-main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN int_ds_tp_trib_natur_oper.uf-origem IN FRAME f-main
   EXP-HELP                                                             */
...
ON F5 OF int_ds_tp_trib_natur_oper.class_fiscal IN FRAME f-main /* NCM */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL int_ds_tp_trib_natur_oper.class_fiscal V-table-Win
ON LEAVE OF int_ds_tp_trib_natur_oper.class_fiscal IN FRAME f-main /* NCM */
DO:
