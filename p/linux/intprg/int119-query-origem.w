...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-tp-nat-origem NO-LOCK
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-tp-nat-origem NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-tp-nat-origem
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-tp-nat-origem
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.int-ds-tp-nat-origem"
     _Options          = "NO-LOCK"
