...
*******************************************************************************/
{include/i-prgvrs.i INT120VP 1.12.00.AVB}
...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-mod-pedido bt-ok bt-cancela ~
bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-mod-pedido 
...
DEFINE VARIABLE c_cod-mod-pedido AS CHARACTER FORMAT "x(12)":U 
     LABEL "Cod Mod Pedido" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod-mod-pedido AT ROW 2 COL 21 COLON-ALIGNED WIDGET-ID 2
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V  Para Modalidade Pedido"
...
ON GO OF FRAME d-vapara /* V  Para Modalidade Pedido */
DO:
FIND int-ds-mod-pedido NO-LOCK
    WHERE int-ds-mod-pedido.cod-mod-pedido EQ INPUT FRAME {&FRAME-NAME} c_cod-mod-pedido NO-ERROR.

IF NOT AVAILABLE int-ds-mod-pedido THEN DO:
    {utp/ut-table.i emsesp int-ds-mod-pedido 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(int-ds-mod-pedido).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para Modalidade Pedido */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-mod-pedido 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-mod-pedido bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "INT120VP" "1.12.00.AVB"}
