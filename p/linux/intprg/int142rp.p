...
for each int_ds_nota_entrada no-lock where
    ...
    */
    ...
    for each int_ds_nota_entrada_produt no-lock where
        ...
        each int_dp_nota_entrada_ret-item of int_ds_nota_entrada_produt*/
        query-tuning(no-lookahead):
        ...
        /*c-class-fiscal = trim(string(int_ds_nota_entrada_produt.nep-ncm-n,"99999999")).*/
        for first item 
...
procedure PiGeraMovimento:
    ...
    for each tt-movto
        ...
        FOR FIRST tt-item-doc-est-nova where 
            ...
            tt-item-doc-est-nova.it-codigo         = tt-movto.it-codigo AND
            tt-item-doc-est-nova.nat-operacao      = tt-docum-est-nova.nat-operacao AND
            tt-item-doc-est-nova.nat-of            = tt-movto.nat-operacao    AND       
