...
{include/i-prgvrs.i INT149 9.99.99.999}
...
DEFINE FRAME f-pg-sel
     ...
     c-data-ini AT ROW 3.67 COL 22 COLON-ALIGNED WIDGET-ID 10
     c-data-fim AT ROW 3.67 COL 41 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     IMAGE-5 AT ROW 3.67 COL 33.72 WIDGET-ID 14
     IMAGE-6 AT ROW 3.67 COL 39.86 WIDGET-ID 16
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Altera N£mero S‚rie da Contigˆncia"
         HEIGHT             = 15
         WIDTH              = 81
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Altera N£mero S‚rie da Contigˆncia */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Altera N£mero S‚rie da Contigˆncia */
DO:
...
{utp/ut9000.i "INT149" "9.99.99.999"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-estab-fim c-data-ini c-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-5 IMAGE-6 IMAGE-11 IMAGE-12 c-estab-ini c-estab-fim c-data-ini 
         c-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i intprg/int149rp.p}
