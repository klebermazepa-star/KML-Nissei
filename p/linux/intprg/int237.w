...
/********************************************************************************
** Programa: int237 - Importa‡Æo notas fiscais de saida Loja Procfit - CANCELAMENTO
**
** Versao : 12 - 20/03/2018 - Alessandro V Baccin
**
********************************************************************************/
{include/i-prgvrs.i INT237 2.12.01.AVB}
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
CREATE WIDGET-POOL.

/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        INT237
...
do on error undo, return error on stop  undo, return error:
    ...
    {report/rprun.i intprg/INT237rp.p}
