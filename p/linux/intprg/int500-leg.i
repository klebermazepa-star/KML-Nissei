    ...
    field cEANTrib as dec format "99999999999999"
    ...
    def temp-table ttProtNFe no-undo xml-node-name 'ProtNfe'
    ...
    field ttInfProt as int xml-node-type "hidden"
    field Id as char format "x(44)" xml-node-type "attribute"
    field ChNFe as char format "x(60)". 
    ...
    ttCobr, ttFat, ttDup, ttInfAdic, ttCompra, ttmed, ttProtNFe ,ttInfProt , ttExporta  
    ...
    data-relation cf for ttInfProt ,ttProtNFe relation-fields(ttInfProt,ttInfProt) nested
