...
PROCEDURE pi-IntegracaoNDD:
    ...
    FOR EACH NDD_ENTRYINTEGRATION NO-LOCK  WHERE    
             ...
             NDD_ENTRYINTEGRATION.status_         = 1 /* campo status pendente */ AND
             NDD_ENTRYINTEGRATION.ENTRYINTEGRATIONID = 3129771
