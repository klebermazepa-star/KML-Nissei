...
*******************************************************************************/
{include/i-prgvrs.i int500_cfop_new_leg 2.06.00.001}

CREATE WIDGET-POOL.
CURRENT-LANGUAGE = CURRENT-LANGUAGE.
/* Preprocessors Definitions ---                                      */
&GLOBAL-DEFINE Program        int500_cfop_new_leg
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           &endif
           tt-param.dt-trans-ini    = 01/01/2016    
           tt-param.dt-trans-fin    = 12/31/9999    
           tt-param.i-nro-docto-ini = "0" 
           tt-param.i-nro-docto-fin = "99999999" 
    ...
    {report/rprun.i intprg/int500rp_cfop_new_leg.p}
