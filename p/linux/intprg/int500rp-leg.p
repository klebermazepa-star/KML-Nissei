...
DEF VAR i-vicmsDeson  like  int-ds-it-docto-xml.vicmsstret.
...
PROCEDURE pi-IntegracaoNDD:
    ...
    FOR FIRST NDD_ENRYINTEGRATION_new_LEG NO-LOCK WHERE
             NDD_ENRYINTEGRATION_new_LEG.ENTRYINTEGRATION_new_legid = 70 AND  
        ...
        IF NDD_ENRYINTEGRATION_new_LEG.serie = 10 THEN 
           NEXT.
  ...
  EMPTY TEMP-TABLE ttcompra.
   ...
   THEN DO:
    ...
    FOR EACH ttprod:
       ...
       /* ASSIGN tt-it-docto-xml.vicmsDeson = i-vicmsDeson.  Precisa criar campo na tabela int-ds-it-docto-xml */ 
       ...
       THEN DO:
          FIND FIRST ITEM NO-LOCK WHERE
                     ITEM.it-codigo  = item-fornec.it-codigo NO-ERROR.
