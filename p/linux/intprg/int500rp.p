...
PROCEDURE pi-notas-pepsico:
   ...
   FOR EACH int_ds_docto_xml WHERE
            int_ds_docto_xml.tipo_docto = 4 AND 
            int_ds_docto_xml.tipo_estab = 1 AND 
            int_ds_docto_xml.chnfe      = ? query-tuning(no-lookahead):
         ...
         FOR EACH int_ds_it_docto_xml WHERE 
               ...
               FOR FIRST serie NO-LOCK WHERE
                         serie.serie = int_ds_it_docto_xml.serie query-tuning(no-lookahead):    
               END.
         ...
         FOR FIRST serie NO-LOCK WHERE
                   serie.serie = int_ds_docto_xml.serie query-tuning(no-lookahead):              
         END.

         IF NOT AVAIL serie THEN DO: 
            ASSIGN int_ds_docto_xml.serie = string(int(int_ds_docto_xml.serie),"999")
                   tt-docto-xml.serie     = int_ds_docto_xml.serie. 
         END.
