...
PROCEDURE pi-IntegracaoNDD:
    ...
    FOR EACH int-ds-nota-entrada WHERE 
        rowid(int-ds-nota-entrada) = tt-param.r-rowid and
        int-ds-nota-entrada.tipo-nota <> 3 and
        int-ds-nota-entrada.nen-conferida <> 2,
        ...
        IF  AVAIL tt-docto-xml AND 
           (de-vprod <> de-vl-bruto-int or
            ...
            if avail emitente then
                display can-find (first docum-est no-lock where
                        ...
                        trim(int-ds-nota-entrada.nen-serie-s) format "X(5)"
                        trim(string(int-ds-nota-entrada.nen-notafiscal-n,">>>9999999")) format "X(12)"
            ...
            FOR EACH tt-it-docto-xml WHERE
                ...
                display tt-it-docto-xml.sequencia 
                        ...
                        tt-it-docto-xml.vDesc                          
                        tt-it-docto-xml.vprod - tt-it-docto-xml.vDesc column-label "Liquido" format "->>>,>>>,>>9.99"
                        tt-it-docto-xml.vbc-icms                       
                        tt-it-docto-xml.vicms                          
                        tt-it-docto-xml.vbc-ipi                        
                        tt-it-docto-xml.vipi                           
                        tt-it-docto-xml.vicmsst                        
                        tt-it-docto-xml.vbcst                          
                        tt-it-docto-xml.vOutro                         
                        tt-it-docto-xml.vbc-pis                        
                        tt-it-docto-xml.vpis                           
                        tt-it-docto-xml.vbc-cofins                     
                        tt-it-docto-xml.vcofins                        
                        tt-it-docto-xml.vicmsdeson
