...
PROCEDURE pi-IntegracaoNDD:
    ...
    FOR EACH docum-est WHERE docum-est.cod-chave-aces-nf-eletro = "",
        ...
        IF  AVAIL tt-docto-xml THEN do:
            ...
            IF tt-docto-xml.chNfe <> "" THEN DO:
                docum-est.cod-chave-aces-nf-eletro = tt-docto-xml.chNfe.
                for first doc-fiscal where 
                    ...
                    assign doc-fiscal.cod-chave-aces-nf-eletro = docum-est.cod-chave-aces-nf-eletro.
                END.
            END.
        end.
