...
*******************************************************************************/
{include/i-prgvrs.i int510b-query 1.12.00.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_it_docto_xml no-lock WHERE rowid(int_ds_it_docto_xml) = v-row-item QUERY-TUNING(NO-LOOKAHEAD)
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY {&SELF-NAME} FOR EACH int_ds_it_docto_xml no-lock WHERE rowid(int_ds_it_docto_xml) = v-row-item QUERY-TUNING(NO-LOOKAHEAD).
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_it_docto_xml
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_it_docto_xml
...
/* Query rebuild information for QUERY Query-Main
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH int_ds_it_docto_xml no-lock WHERE rowid(int_ds_it_docto_xml) = v-row-item.
     _END_FREEFORM
     _Options          = "NO-LOCK"
