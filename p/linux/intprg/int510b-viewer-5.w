...
*******************************************************************************/
{include/i-prgvrs.i int510b-viewer-5 1.12.00.AVB}
...
&Scoped-Define ENABLED-FIELDS int_ds_it_docto_xml.cst_ipi ~
int_ds_it_docto_xml.pipi int_ds_it_docto_xml.vbc_ipi ~
...
&Scoped-Define DISPLAYED-FIELDS int_ds_it_docto_xml.cst_ipi ~
int_ds_it_docto_xml.pipi int_ds_it_docto_xml.vbc_ipi ~
int_ds_it_docto_xml.vipi int_ds_it_docto_xml.vtottrib 
...
DEFINE FRAME f-main
     int_ds_it_docto_xml.cst_ipi AT ROW 2 COL 15 COLON-ALIGNED WIDGET-ID 40
          VIEW-AS FILL-IN 
          SIZE 3.14 BY .88
     int_ds_it_docto_xml.pipi AT ROW 3 COL 15 COLON-ALIGNED WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .88
     int_ds_it_docto_xml.vbc_ipi AT ROW 4 COL 15 COLON-ALIGNED WIDGET-ID 16
          LABEL "Base IPI"
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_it_docto_xml.vipi AT ROW 5 COL 15 COLON-ALIGNED WIDGET-ID 30
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_it_docto_xml.vtottrib AT ROW 6 COL 15 COLON-ALIGNED WIDGET-ID 34
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
...
/* SETTINGS FOR FILL-IN int_ds_it_docto_xml.vbc_ipi IN FRAME f-main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN int_ds_it_docto_xml.vtottrib IN FRAME f-main
   NO-ENABLE                                                            */
...
------------------------------------------------------------------------------*/
    ...
    if i-sit-re >= 10 and i-sit-re <> 60 then do:
        ...
        assign custom.int_ds_it_docto_xml.cst_ipi  :sensitive in frame f-Main = no  
               custom.int_ds_it_docto_xml.pipi     :sensitive in frame f-Main = no  
               custom.int_ds_it_docto_xml.vbc_ipi  :sensitive in frame f-Main = no  
               custom.int_ds_it_docto_xml.vipi     :sensitive in frame f-Main = no
               custom.int_ds_it_docto_xml.vtottrib :sensitive in frame f-Main = no. 
    end.
