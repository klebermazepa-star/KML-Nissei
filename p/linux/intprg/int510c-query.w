...
*******************************************************************************/
{include/i-prgvrs.i INT510c-query 1.12.00.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_docto_xml_dup NO-LOCK INDEXED-REPOSITION QUERY-TUNING(NO-LOOKAHEAD)
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_docto_xml_dup NO-LOCK INDEXED-REPOSITION QUERY-TUNING(NO-LOOKAHEAD).
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_docto_xml_dup
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_docto_xml_dup
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "custom.int_ds_docto_xml_dup"
