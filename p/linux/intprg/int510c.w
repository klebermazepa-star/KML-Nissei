...
DEFINE FRAME f-cad
     bt-ok AT ROW 9.33 COL 2.63 HELP
          "Salva e sai"
     bt-save AT ROW 9.33 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 9.33 COL 23.63 HELP
          "Cancela"
     bt-ajuda AT ROW 9.33 COL 70.75
     rt-button AT ROW 9.17 COL 1.63
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  '':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.53 , 2.00 ) NO-ERROR.
       ...
       RUN set-position IN h_INT510c-viewer ( 3.13 , 14.50 ) NO-ERROR.
       /* Size in UIB:  ( 4.53 , 49.00 ) */
