...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _STRUCTURED
  QUERY br-table NO-LOCK DISPLAY
      ...
      int_ds_it_docto_xml.it_codigo FORMAT "x(16)":U WIDTH 13.57
      ...
      int_ds_it_docto_xml.vDesc FORMAT ">>>>,>>>,>>9.99999":U WIDTH 9.57
      ...
      int_ds_it_docto_xml.vicmsst COLUMN-LABEL "Vlr ST" FORMAT ">>>>,>>>,>>9.99999":U
            WIDTH 7.43
      int_ds_it_docto_xml.vPMC FORMAT ">>>>,>>>,>>9.99999":U
...
"int_ds_it_docto_xml.it_codigo" ? ? "character" ? ? ? ? ? ? no ? no no "13.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"int_ds_it_docto_xml.ncm" ? ">>>>>>>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   = custom.int_ds_it_docto_xml.cfop
     _FldNameList[7]   > custom.int_ds_it_docto_xml.cst_icms
"int_ds_it_docto_xml.cst_icms" ? ? "integer" ? ? ? ? ? ? no ? no no "7.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > custom.int_ds_it_docto_xml.nat_operacao
"int_ds_it_docto_xml.nat_operacao" ? ? "character" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   = custom.int_ds_it_docto_xml.numero_ordem
     _FldNameList[10]   > custom.int_ds_it_docto_xml.Lote
"int_ds_it_docto_xml.Lote" ? ? "character" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > custom.int_ds_it_docto_xml.qCom_forn
"int_ds_it_docto_xml.qCom_forn" "Qtde" ? "decimal" ? ? ? ? ? ? no ? no no "6.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > custom.int_ds_it_docto_xml.uCom_forn
"int_ds_it_docto_xml.uCom_forn" ? ? "character" ? ? ? ? ? ? no ? no no "2.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[13]   > custom.int_ds_it_docto_xml.vUnCom
"int_ds_it_docto_xml.vUnCom" ? ? "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[14]   = custom.int_ds_it_docto_xml.qCom
     _FldNameList[15]   = custom.int_ds_it_docto_xml.uCom
     _FldNameList[16]   > custom.int_ds_it_docto_xml.vDesc
"int_ds_it_docto_xml.vDesc" ? ? "decimal" ? ? ? ? ? ? no ? no no "9.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[17]   > custom.int_ds_it_docto_xml.vbc_ipi
"int_ds_it_docto_xml.vbc_ipi" "Base IPI" ? "decimal" ? ? ? ? ? ? no ? no no "10.29" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[18]   > custom.int_ds_it_docto_xml.pipi
"int_ds_it_docto_xml.pipi" "% IPI" ? "decimal" ? ? ? ? ? ? no ? no no "4" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[19]   > custom.int_ds_it_docto_xml.vipi
"int_ds_it_docto_xml.vipi" "Vlr IPI" ? "decimal" ? ? ? ? ? ? no ? no no "5.14" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[20]   > custom.int_ds_it_docto_xml.vbc_icms
"int_ds_it_docto_xml.vbc_icms" "Base ICMS" ? "decimal" ? ? ? ? ? ? no ? no no "8.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[21]   > custom.int_ds_it_docto_xml.predBc
...
"int_ds_it_docto_xml.picms" "% ICMS" ? "decimal" ? ? ? ? ? ? no ? no no "5.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[23]   > custom.int_ds_it_docto_xml.vicms
"int_ds_it_docto_xml.vicms" "Vlr ICMS" ? "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[24]   > custom.int_ds_it_docto_xml.vicmsdeson
"int_ds_it_docto_xml.vicmsdeson" "Vlr ICMS Deson" ? "decimal" ? ? ? ? ? ? no ? no no "10.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[25]   > custom.int_ds_it_docto_xml.vbcst
"int_ds_it_docto_xml.vbcst" "Base ST" ? "decimal" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
"int_ds_it_docto_xml.picmsst" "% ST" ? "decimal" ? ? ? ? ? ? no ? no no "4.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[27]   > custom.int_ds_it_docto_xml.vicmsst
"int_ds_it_docto_xml.vicmsst" "Vlr ST" ? "decimal" ? ? ? ? ? ? no ? no no "7.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[28]   = custom.int_ds_it_docto_xml.vPMC
     _FldNameList[29]   > custom.int_ds_it_docto_xml.pmvast
"int_ds_it_docto_xml.pmvast" "% VaST" ? "decimal" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[30]   > custom.int_ds_it_docto_xml.vbc_pis
"int_ds_it_docto_xml.vbc_pis" "Vlr Base PIS" ? "decimal" ? ? ? ? ? ? no ? no no "8.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[31]   > custom.int_ds_it_docto_xml.ppis
"int_ds_it_docto_xml.ppis" "% PIS" ? "decimal" ? ? ? ? ? ? no ? no no "4.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[32]   > custom.int_ds_it_docto_xml.vpis
"int_ds_it_docto_xml.vpis" "Vlr PIS" ? "decimal" ? ? ? ? ? ? no ? no no "8.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[33]   > custom.int_ds_it_docto_xml.vbc_cofins
"int_ds_it_docto_xml.vbc_cofins" "Base Cofins" ? "decimal" ? ? ? ? ? ? no ? no no "10.86" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[34]   > custom.int_ds_it_docto_xml.pcofins
"int_ds_it_docto_xml.pcofins" "% Cofins" ? "decimal" ? ? ? ? ? ? no ? no no "6.43" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[35]   > custom.int_ds_it_docto_xml.vcofins
"int_ds_it_docto_xml.vcofins" "Vlr Cofins" ? "decimal" ? ? ? ? ? ? no ? no no "9" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[36]   > custom.int_ds_it_docto_xml.vOutro
"int_ds_it_docto_xml.vOutro" ? ? "decimal" ? ? ? ? ? ? no ? no no "11.57" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[37]   > custom.int_ds_it_docto_xml.vProd
"int_ds_it_docto_xml.vProd" ? ? "decimal" ? ? ? ? ? ? no ? no no "13.72" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
