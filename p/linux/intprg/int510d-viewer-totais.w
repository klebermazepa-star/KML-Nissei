...
DEFINE FRAME f-main
     int_ds_docto_xml.vbc AT ROW 2.21 COL 8.86 NO-LABEL WIDGET-ID 44
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.valor_icms AT ROW 2.21 COL 23.43 COLON-ALIGNED NO-LABEL WIDGET-ID 32
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.valor_ipi AT ROW 2.21 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 34
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.vbc_cst AT ROW 2.21 COL 56.72 COLON-ALIGNED NO-LABEL WIDGET-ID 46
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.valor_st AT ROW 2.21 COL 73.57 COLON-ALIGNED NO-LABEL WIDGET-ID 42
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.valor_mercad AT ROW 2.21 COL 90.14 COLON-ALIGNED NO-LABEL WIDGET-ID 36
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.tot_desconto AT ROW 2.21 COL 107 COLON-ALIGNED NO-LABEL WIDGET-ID 110
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.vNF AT ROW 2.21 COL 123.57 COLON-ALIGNED NO-LABEL WIDGET-ID 48 FORMAT ">,>>>,>>>,>>>,>>9.99999"
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     ...
     int_ds_docto_xml.valor_pis AT ROW 6.42 COL 8.86 NO-LABEL WIDGET-ID 116
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.valor_cofins AT ROW 6.42 COL 23.72 COLON-ALIGNED NO-LABEL WIDGET-ID 112
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.valor_outras AT ROW 6.42 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 180
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int_ds_docto_xml.valor_icms_des AT ROW 6.42 COL 56.72 COLON-ALIGNED NO-LABEL WIDGET-ID 192
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
...
------------------------------------------------------------------------------*/
  ...
  if avail int_ds_docto_xml then do:
      for each int_ds_it_docto_xml no-lock where
          ...
          int_ds_it_docto_xml.serie         = int_ds_docto_xml.serie QUERY-TUNING(NO-LOOKAHEAD):
          assign 
