...
&Scoped-define QUERY-STRING-br-table FOR EACH int-ds-docto-xml WHERE         int-ds-docto-xml.cnpj >= c-cnpjorigem-ini     and int-ds-docto-xml.cnpj <= c-cnpjorigem-fim     and int-ds-docto-xml.serie >= c-serie-ini     and int-ds-docto-xml.serie <= c-serie-fim     and dec(int-ds-docto-xml.nNF) >= i-notafiscal-ini     and dec(int-ds-docto-xml.nNF) <= i-notafiscal-fim     and int-ds-docto-xml.cod-emitente >= i-emitente-ini     and int-ds-docto-xml.cod-emitente <= i-emitente-fim     and int-ds-docto-xml.situacao = 5     and int-ds-docto-xml.tipo-nota <> 3     and int-ds-docto-xml.CNPJ-dest = "79430682025540" /* 973 */     ~{&SORTBY-PHRASE} INDEXED-REPOSITION
...
OPEN QUERY {&SELF-NAME} FOR EACH int-ds-docto-xml WHERE
    ...
    and int-ds-docto-xml.situacao = 5
