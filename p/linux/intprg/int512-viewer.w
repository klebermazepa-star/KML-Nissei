...
------------------------------------------------------------------------------*/
    ...
    if int-ds-docto-xml.situacao <> 3 and
       ...
       int-ds-docto-xml.cod-emitente <> 0 then do:
        ...
        for each int-ds-docto-xml-log-compras EXCLUSIVE of int-ds-docto-xml-compras
            query-tuning(no-lookahead):
            delete int-ds-docto-xml-log-compras.
        end.
        for each int-ds-doc-erro exclusive-lock where
            ...
            int-ds-doc-erro.tipo-nota    = int-ds-docto-xml.tipo-nota
            query-tuning(no-lookahead):
            if not can-find(int-ds-docto-xml-log-compras no-lock where 
                int-ds-docto-xml-log-compras.serie          = int-ds-docto-xml-compras.serie        and
                int-ds-docto-xml-log-compras.nNF            = int-ds-docto-xml-compras.nNF          and
                int-ds-docto-xml-log-compras.cod-emitente   = int-ds-docto-xml-compras.cod-emitente and
                int-ds-docto-xml-log-compras.tipo-nota      = int-ds-docto-xml-compras.tipo-nota    and
                int-ds-docto-xml-log-compras.cod-erro       = int-ds-doc-erro.cod-erro)
            then do:
                create  int-ds-docto-xml-log-compras.
                assign  int-ds-docto-xml-log-compras.serie          = int-ds-docto-xml-compras.serie       
                        int-ds-docto-xml-log-compras.nNF            = int-ds-docto-xml-compras.nNF         
                        int-ds-docto-xml-log-compras.cod-emitente   = int-ds-docto-xml-compras.cod-emitente
                        int-ds-docto-xml-log-compras.tipo-nota      = int-ds-docto-xml-compras.tipo-nota   
                        int-ds-docto-xml-log-compras.cod-erro       = int-ds-doc-erro.cod-erro.
                assign  int-ds-docto-xml-log-compras.descricao      = int-ds-doc-erro.descricao
                        int-ds-docto-xml-log-compras.tipo-erro      = int-ds-doc-erro.tipo-erro.
            end.
        end.
