...
*******************************************************************************/
{include/i-prgvrs.i INT520-query 1.12.01.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_nota_entrada ~
      WHERE int_ds_nota_entrada.situacao >= 5 ~
 AND  ~
int_ds_nota_entrada.situacao < 9 NO-LOCK INDEXED-REPOSITION query-tuning(no-lookahead)
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_nota_entrada ~
      WHERE int_ds_nota_entrada.situacao >= 5 ~
 AND  ~
int_ds_nota_entrada.situacao < 9 NO-LOCK INDEXED-REPOSITION query-tuning(no-lookahead).
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_nota_entrada
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_nota_entrada
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "int_ds_nota_entrada"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "int_ds_nota_entrada.situacao >= 5
 AND 
int_ds_nota_entrada.situacao < 9"
