...
def temp-table tt-int-ds-nota-loja-9 like int-ds-nota-loja
...
procedure pi-importa:
    ...
    EMPTY TEMP-TABLE tt-int-ds-nota-loja-9.

    FOR EACH estabelec USE-INDEX codigo WHERE 
             estabelec.cod-estabel >= int-ds-ger-cupom.cod-estab-ini-9 AND
             estabelec.cod-estabel <= int-ds-ger-cupom.cod-estab-fim-9 NO-LOCK:
        ...
        for each int-ds-nota-loja no-lock USE-INDEX sit_cnpj_emiss where 
            ...
            FOR FIRST tt-int-ds-nota-loja-9 WHERE 
                tt-int-ds-nota-loja-9.rowid-nota-loja = ROWID(int-ds-nota-loja): END.
            IF NOT AVAIL tt-int-ds-nota-loja-9 THEN DO:
                CREATE tt-int-ds-nota-loja-9.
                BUFFER-COPY int-ds-nota-loja TO tt-int-ds-nota-loja-9.
                ASSIGN tt-int-ds-nota-loja-9.rowid-nota-loja = ROWID(int-ds-nota-loja).
            END.

        end.
    END.

    FOR EACH tt-int-ds-nota-loja-9 USE-INDEX data:
        FOR FIRST int-ds-nota-loja WHERE ROWID(int-ds-nota-loja) = tt-int-ds-nota-loja-9.rowid-nota-loja NO-LOCK:
        END.
