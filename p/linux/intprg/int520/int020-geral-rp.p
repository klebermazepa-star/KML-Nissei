/********************************************************************************
** Programa: INT020-1RP - Geracao notas fiscais a partir de Cupom Fiscal PRS
**
** Versao : 12 - 20/03/2016 - Alessandro V Baccin
**
********************************************************************************/
/* include de controle de versao */
{include/i-prgvrs.i INT020-1RP 2.12.01.AVB}
{cdp/cdcfgdis.i}
...
def temp-table tt-int-ds-nota-loja-1 like int-ds-nota-loja
...
DEFINE NEW GLOBAL SHARED TEMP-TABLE tt-fat-duplic-boleto NO-UNDO LIKE tt-fat-duplic
...
procedure pi-importa:
    ...
    EMPTY TEMP-TABLE tt-int-ds-nota-loja-1.

    FOR EACH estabelec USE-INDEX codigo NO-LOCK:

        for each int-ds-nota-loja no-lock USE-INDEX sit_cnpj_emiss where 
                 int-ds-nota-loja.situacao    = 1 AND
                 int-ds-nota-loja.emissao     >= 09/01/2016 and
                 int-ds-nota-loja.emissao     <= 09/01/2016    
            ...
            FOR FIRST tt-int-ds-nota-loja-1 WHERE 
                tt-int-ds-nota-loja-1.rowid-nota-loja = ROWID(int-ds-nota-loja): END.
            IF NOT AVAIL tt-int-ds-nota-loja-1 THEN DO:
               CREATE tt-int-ds-nota-loja-1.
               BUFFER-COPY int-ds-nota-loja TO tt-int-ds-nota-loja-1.
               ASSIGN tt-int-ds-nota-loja-1.rowid-nota-loja = ROWID(int-ds-nota-loja).
            END.
            
        end.
    END.

    FOR EACH tt-int-ds-nota-loja-1 USE-INDEX data:
        FOR FIRST int-ds-nota-loja WHERE ROWID(int-ds-nota-loja) = tt-int-ds-nota-loja-1.rowid-nota-loja NO-LOCK:
        END.
