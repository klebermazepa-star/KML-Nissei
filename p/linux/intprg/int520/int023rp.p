        ...
        if first-of(estabelec.estado) then do:
           for each unid-feder no-lock where 
               ...
               for each bitem no-lock where 
                        bitem.class-fiscal = item.class-fiscal AND bITEM.ge-codigo <> 40 AND bitem.ge-codigo < 80:
...
procedure pi-cria-int-ds:
    ...
    if p-it-codigo <> "" then do:
       ...
       if avail item-uf then do:    
          ...
          IF int-ds-ncm-produto.estado = "SC" AND
          ...
          IF int-ds-ncm-produto.estado = "PR" AND
          ...
          IF int-ds-ncm-produto.estado = "SP" AND 
...
/*           END. */
          ...
          AND item-uf.estado          = "PR" THEN DO:
              IF int-ds-ncm-produto.icms_saida_st = 18 THEN DO:
              ...
              IF int-ds-ncm-produto.icms_saida_st = 25 THEN DO:
              ...
              IF int-ds-ncm-produto.icms_saida_st = 12 THEN DO:
