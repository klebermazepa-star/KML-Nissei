...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90 BY 14.25 WIDGET-ID 100.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _XFTR "SmartWindowCues" w-cadpaifilho-ambos _INLINE
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Tributado|Isento|Cesta B sica|ST|Outros|Nenhum' + ',
                     FOLDER-TAB-TYPE = 2':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 5.71 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 9.50 , 89.29 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       ...
       RUN set-position IN h_int115-browser-tributado ( 8.00 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.25 , 85.00 ) */
    ...
    WHEN 2 THEN DO:
       ...
       RUN set-position IN h_int115-browser-isento ( 8.00 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.25 , 85.00 ) */
    ...
    WHEN 3 THEN DO:
       ...
       RUN set-position IN h_int115-browser-cesta ( 8.00 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.25 , 85.00 ) */
    ...
    WHEN 4 THEN DO:
       ...
       RUN set-position IN h_int115-browser-st ( 8.00 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.25 , 85.00 ) */
    ...
    END. /* Page 4 */
      WHEN 5 THEN DO:
         ...
         RUN set-position IN h_int115-browser-outros ( 8.00 , 4.00 ) NO-ERROR.
         /* Size in UIB:  ( 6.25 , 85.00 ) */
    ...
    WHEN 6 THEN DO:
       ...
       RUN set-position IN h_int115-browser-nenhum ( 8.00 , 4.00 ) NO-ERROR.
       /* Size in UIB:  ( 6.25 , 85.00 ) */
