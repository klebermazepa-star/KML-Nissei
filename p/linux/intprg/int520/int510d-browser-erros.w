...
&Scoped-define INTERNAL-TABLES int-ds-doc-erro

/* Define KEY-PHRASE in case it is used by any query. */
&Scoped-define KEY-PHRASE TRUE

/* Definitions for BROWSE br-table                                      */
&Scoped-define FIELDS-IN-QUERY-br-table int-ds-doc-erro.tipo-erro int-ds-doc-erro.cod-erro int-ds-doc-erro.descricao   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH int-ds-doc-erro no-lock where     int-ds-doc-erro.serie-docto  = int-ds-docto-xml.serie AND     int-ds-doc-erro.cod-emitente = int-ds-docto-xml.cod-emitente AND     int-ds-doc-erro.CNPJ         = int-ds-docto-xml.CNPJ AND     int-ds-doc-erro.nro-docto    = int-ds-docto-xml.nNF AND     int-ds-doc-erro.tipo-nota    = int-ds-docto-xml.tipo-nota     by int-ds-doc-erro.cod-erro
&Scoped-define OPEN-QUERY-br-table OPEN QUERY {&SELF-NAME} FOR EACH int-ds-doc-erro no-lock where     int-ds-doc-erro.serie-docto  = int-ds-docto-xml.serie AND     int-ds-doc-erro.cod-emitente = int-ds-docto-xml.cod-emitente AND     int-ds-doc-erro.CNPJ         = int-ds-docto-xml.CNPJ AND     int-ds-doc-erro.nro-docto    = int-ds-docto-xml.nNF AND     int-ds-doc-erro.tipo-nota    = int-ds-docto-xml.tipo-nota     by int-ds-doc-erro.cod-erro.
&Scoped-define TABLES-IN-QUERY-br-table int-ds-doc-erro
&Scoped-define FIRST-TABLE-IN-QUERY-br-table int-ds-doc-erro
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _FREEFORM
  QUERY br-table NO-LOCK DISPLAY
      int-ds-doc-erro.tipo-erro COLUMN-LABEL "Tipo" FORMAT "x(12)":U
      int-ds-doc-erro.cod-erro COLUMN-LABEL "Erro" FORMAT ">>>>>9":U
      int-ds-doc-erro.descricao FORMAT "x(300)":U
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-table
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH int-ds-doc-erro no-lock where
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "int-ds-doc-erro"}
