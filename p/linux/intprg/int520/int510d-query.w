...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-docto-xml ~
      WHERE  int-ds-docto-xml.tipo-nota <> 3 ~
 AND int-ds-docto-xml.CNPJ-dest = "79430682025540" ~
 AND int-ds-docto-xml.situacao = 9 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-docto-xml ~
      WHERE  int-ds-docto-xml.tipo-nota <> 3 ~
 AND int-ds-docto-xml.CNPJ-dest = "79430682025540" ~
 AND int-ds-docto-xml.situacao = 9 NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-docto-xml
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-docto-xml
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.int-ds-docto-xml"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = " emsesp.int-ds-docto-xml.tipo-nota <> 3
 AND emsesp.int-ds-docto-xml.CNPJ-dest = ""79430682025540""
 AND emsesp.int-ds-docto-xml.situacao = 9"
