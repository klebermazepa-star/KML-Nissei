...
*******************************************************************************/
{include/i-prgvrs.i int510d-viewer-totais 1.12.00.AVB}
...
&Scoped-Define ENABLED-FIELDS int-ds-docto-xml.vbc ~
int-ds-docto-xml.valor-icms int-ds-docto-xml.valor-ipi ~
int-ds-docto-xml.vbc-cst int-ds-docto-xml.valor-st ~
int-ds-docto-xml.valor-mercad int-ds-docto-xml.tot-desconto ~
int-ds-docto-xml.vNF int-ds-docto-xml.valor-pis ~
int-ds-docto-xml.valor-cofins int-ds-docto-xml.valor-outras ~
...
&Scoped-Define DISPLAYED-FIELDS int-ds-docto-xml.vbc ~
int-ds-docto-xml.valor-icms int-ds-docto-xml.valor-ipi ~
int-ds-docto-xml.vbc-cst int-ds-docto-xml.valor-st ~
int-ds-docto-xml.valor-mercad int-ds-docto-xml.tot-desconto ~
int-ds-docto-xml.vNF int-ds-docto-xml.valor-pis ~
...
DEFINE FRAME f-main
     int-ds-docto-xml.vbc AT ROW 2.21 COL 8.86 NO-LABEL WIDGET-ID 44
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.valor-icms AT ROW 2.21 COL 23.43 COLON-ALIGNED NO-LABEL WIDGET-ID 32
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.valor-ipi AT ROW 2.21 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 34
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.vbc-cst AT ROW 2.21 COL 56.72 COLON-ALIGNED NO-LABEL WIDGET-ID 46
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.valor-st AT ROW 2.21 COL 73.57 COLON-ALIGNED NO-LABEL WIDGET-ID 42
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.valor-mercad AT ROW 2.21 COL 90.14 COLON-ALIGNED NO-LABEL WIDGET-ID 36
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.tot-desconto AT ROW 2.21 COL 107 COLON-ALIGNED NO-LABEL WIDGET-ID 110
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.vNF AT ROW 2.21 COL 123.57 COLON-ALIGNED NO-LABEL WIDGET-ID 48 FORMAT ">,>>>,>>>,>>>,>>9.99999"
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     ...
     int-ds-docto-xml.valor-pis AT ROW 6.42 COL 8.86 NO-LABEL WIDGET-ID 116
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.valor-cofins AT ROW 6.42 COL 23.72 COLON-ALIGNED NO-LABEL WIDGET-ID 112
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.valor-outras AT ROW 6.42 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 180
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     int-ds-docto-xml.valor-icms-des AT ROW 6.42 COL 56.72 COLON-ALIGNED NO-LABEL WIDGET-ID 192
          VIEW-AS FILL-IN 
          SIZE 16.14 BY .88
     tot-tot-pis-it AT ROW 7.58 COL 8.86 NO-LABEL WIDGET-ID 166
     tot-cofins-it AT ROW 7.58 COL 23.72 COLON-ALIGNED NO-LABEL WIDGET-ID 168
     tot-outras-it AT ROW 7.58 COL 40.29 COLON-ALIGNED NO-LABEL WIDGET-ID 190
     tot-icms-des AT ROW 7.58 COL 56.72 COLON-ALIGNED NO-LABEL WIDGET-ID 196
...
DEFINE FRAME f-main
     ...
     "Itens:" VIEW-AS TEXT
          SIZE 5.29 BY .67 AT ROW 7.58 COL 1.43 WIDGET-ID 150
     "Vl COFINS" VIEW-AS TEXT
          SIZE 11 BY .67 AT ROW 5.58 COL 26.57 WIDGET-ID 136
     "Itens:" VIEW-AS TEXT
...
/* SETTINGS FOR FILL-IN tot-valor-it IN FRAME f-main
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN int-ds-docto-xml.valor-pis IN FRAME f-main
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN int-ds-docto-xml.vbc IN FRAME f-main
   ALIGN-L EXP-LABEL                                                    */
/* SETTINGS FOR FILL-IN int-ds-docto-xml.vNF IN FRAME f-main
   EXP-FORMAT                                                           */
...
------------------------------------------------------------------------------*/
  ...
  if avail int-ds-docto-xml then do:
      for each int-ds-it-docto-xml no-lock where
          ...
          tot-outras-it           = tot-outras-it          + fnTrataNuloDec( int-ds-it-docto-xml.vOutro  )
      ...
      if  tot-outras-it           = fnTrataNuloDec(int-ds-docto-xml.valor-outras)
          then int-ds-docto-xml.valor-outras:bgcolor in frame f-Main = ?. else int-ds-docto-xml.valor-outras:bgcolor in frame f-Main = 14.
      if  tot-icms-des            = fnTrataNuloDec(int-ds-docto-xml.valor-icms-des)
          then int-ds-docto-xml.valor-icms-des:bgcolor in frame f-Main = ?. else int-ds-docto-xml.valor-icms-des:bgcolor in frame f-Main = 14.
  end.
