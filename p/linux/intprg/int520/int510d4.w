...
DEF INPUT PARAM p-row-int-ds-docto-xml AS ROWID NO-UNDO.
...
&Scoped-define INTERNAL-TABLES int-ds-log-recusa-docto-xml

/* Definitions for BROWSE br-hist                                       */
&Scoped-define FIELDS-IN-QUERY-br-hist int-ds-log-recusa-docto-xml.cod-usuario int-ds-log-recusa-docto-xml.dt-ocorrencia int-ds-log-recusa-docto-xml.hr-ocorrencia fn-tipo-log() @ c-tipo-log int-ds-log-recusa-docto-xml.desc-ocorrencia   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-hist   
&Scoped-define SELF-NAME br-hist
&Scoped-define QUERY-STRING-br-hist FOR EACH int-ds-log-recusa-docto-xml OF int-ds-docto-xml
&Scoped-define OPEN-QUERY-br-hist OPEN QUERY {&SELF-NAME} FOR EACH int-ds-log-recusa-docto-xml OF int-ds-docto-xml.
&Scoped-define TABLES-IN-QUERY-br-hist int-ds-log-recusa-docto-xml
&Scoped-define FIRST-TABLE-IN-QUERY-br-hist int-ds-log-recusa-docto-xml
...
DEFINE QUERY br-hist FOR 
      int-ds-log-recusa-docto-xml SCROLLING.
&ANALYZE-RESUME
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-hist d-vapara _FREEFORM
  QUERY br-hist NO-LOCK DISPLAY
      int-ds-log-recusa-docto-xml.cod-usuario 
    int-ds-log-recusa-docto-xml.dt-ocorrencia 
    int-ds-log-recusa-docto-xml.hr-ocorrencia 
    fn-tipo-log() @ c-tipo-log COLUMN-LABEL "Tipo" FORMAT "X(10)" WIDTH 8
    int-ds-log-recusa-docto-xml.desc-ocorrencia
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
/* Query rebuild information for BROWSE br-hist
     _START_FREEFORM
OPEN QUERY {&SELF-NAME} FOR EACH int-ds-log-recusa-docto-xml OF int-ds-docto-xml.
     _END_FREEFORM
...
------------------------------------------------------------------------------*/
  ...
  IF  p-row-int-ds-docto-xml <> ?
  THEN DO:
      FOR FIRST int-ds-docto-xml NO-LOCK
          WHERE ROWID(int-ds-docto-xml) = p-row-int-ds-docto-xml:
    
          OPEN QUERY br-hist FOR EACH int-ds-log-recusa-docto-xml OF int-ds-docto-xml.
      END.
  END.
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "int-ds-log-recusa-docto-xml"}
...
------------------------------------------------------------------------------*/
  ...
  IF  int-ds-log-recusa-docto-xml.log-recusa = YES 
  THEN
      RETURN "Recusa NF".
  ELSE
      RETURN "Aceite NF".
