...
&Scoped-define INTERNAL-TABLES int-ds-nota-entrada

/* Definitions for QUERY Query-Main                                     */
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-nota-entrada ~
      WHERE int-ds-nota-entrada.situacao = 5 NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-nota-entrada ~
      WHERE int-ds-nota-entrada.situacao = 5 NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-nota-entrada
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-nota-entrada
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.int-ds-nota-entrada"
     _Options          = "NO-LOCK INDEXED-REPOSITION"
     _Where[1]         = "emsesp.int-ds-nota-entrada.situacao = 5"
