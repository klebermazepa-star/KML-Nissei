...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-nota-entrada-produto NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-nota-entrada-produto NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-nota-entrada-produto
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-nota-entrada-produto
...
<FOREIGN-KEYS>
ped-codigo-n||y|emsesp.int-ds-nota-entrada-produto.ped-codigo-n
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.int-ds-nota-entrada-produto"
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/sndkycas.i "ped-codigo-n" "int-ds-nota-entrada-produto" "ped-codigo-n"}
