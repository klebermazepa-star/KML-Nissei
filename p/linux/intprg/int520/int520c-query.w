...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-nota-entrada-dup NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-nota-entrada-dup NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-nota-entrada-dup
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-nota-entrada-dup
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "emsesp.int-ds-nota-entrada-dup"
