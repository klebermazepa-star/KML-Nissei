...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int-ds-it-docto-xml WHERE int-ds-it-docto-xml.cod-emitente = int-ds-docto-xml.cod-emitente ~
...
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int-ds-it-docto-xml WHERE int-ds-it-docto-xml.cod-emitente = int-ds-docto-xml.cod-emitente ~
  AND int-ds-it-docto-xml.serie = int-ds-docto-xml.serie ~
  AND int-ds-it-docto-xml.nNF = int-ds-docto-xml.nNF ~
  AND int-ds-it-docto-xml.tipo-nota = int-ds-docto-xml.tipo-nota NO-LOCK.
&Scoped-define TABLES-IN-QUERY-Query-Main int-ds-it-docto-xml
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int-ds-it-docto-xml
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Options          = "NO-LOCK"
     _JoinCode[1]      = "emsesp.int-ds-it-docto-xml.cod-emitente = emsesp.int-ds-docto-xml.cod-emitente
