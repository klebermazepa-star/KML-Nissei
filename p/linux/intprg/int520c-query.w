...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_nota_entrada_dup NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_nota_entrada_dup NO-LOCK INDEXED-REPOSITION query-tuning(no-lookahead).
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_nota_entrada_dup
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_nota_entrada_dup
...
/* Query rebuild information for QUERY Query-Main
     _TblList          = "custom.int_ds_nota_entrada_dup"
