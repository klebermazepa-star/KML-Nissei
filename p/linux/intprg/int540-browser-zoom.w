...
&Scoped-define FIELDS-IN-QUERY-br-table int_ds_docto_xml.cnpj int_ds_docto_xml.cod_emitente fnRazaoSocial(int_ds_docto_xml.cod_emitente) @ int_ds_docto_xml.xNome int_ds_docto_xml.nNF int_ds_docto_xml.serie int_ds_docto_xml.cod_estab int_ds_docto_xml.dEmi int_ds_docto_xml.num_pedido int_ds_docto_xml.tipo_nota int_ds_docto_xml.cfop   
&Scoped-define ENABLED-FIELDS-IN-QUERY-br-table   
&Scoped-define SELF-NAME br-table
&Scoped-define QUERY-STRING-br-table FOR EACH int_ds_docto_xml WHERE         int_ds_docto_xml.cnpj >= c-cnpjorigem-ini     and int_ds_docto_xml.cnpj <= c-cnpjorigem-fim     and int_ds_docto_xml.serie >= c-serie-ini     and int_ds_docto_xml.serie <= c-serie-fim     and dec(int_ds_docto_xml.nNF) >= i-notafiscal-ini     and dec(int_ds_docto_xml.nNF) <= i-notafiscal-fim     and int_ds_docto_xml.cod_emitente >= i-emitente-ini     and int_ds_docto_xml.cod_emitente <= i-emitente-fim     and int_ds_docto_xml.situacao <> 3     and int_ds_docto_xml.situacao <> 9     and int_ds_docto_xml.tipo_nota <> 3     and int_ds_docto_xml.CNPJ_dest <> "79430682025540" /* 973 */     ~{&SORTBY-PHRASE} INDEXED-REPOSITION
...
<FOREIGN-KEYS>
num_pedido||y|custom.int_ds_docto_xml.num_pedido
</FOREIGN-KEYS> 
<EXECUTING-CODE>
**************************
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION-FORWARD fnRazaoSocial B-table-Win 
FUNCTION fnRazaoSocial RETURNS CHARACTER
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS br-table B-table-Win _FREEFORM
  QUERY br-table NO-LOCK DISPLAY
      ...
      fnRazaoSocial(int_ds_docto_xml.cod_emitente) @ int_ds_docto_xml.xNome column-label "RazÆo Social" 
      int_ds_docto_xml.nNF
      int_ds_docto_xml.serie FORMAT "x(3)":U
      int_ds_docto_xml.cod_estab
...
OPEN QUERY {&SELF-NAME} FOR EACH int_ds_docto_xml WHERE
    ...
    and dec(int_ds_docto_xml.nNF) >= i-notafiscal-ini
    and dec(int_ds_docto_xml.nNF) <= i-notafiscal-fim
    ...
    and int_ds_docto_xml.CNPJ_dest <> "79430682025540" /* 973 */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _FUNCTION fnRazaoSocial B-table-Win 
FUNCTION fnRazaoSocial RETURNS CHARACTER
...
------------------------------------------------------------------------------*/
    ...
    for first emitente no-lock where emitente.cod-emitente = p-cod-emitente:
