...
DO:
{include/okpai.i h_INT540-viewer}
END.
...
DO:
{include/salvapai.i h_INT540-viewer}
 END.
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_INT540-viewer ( 2.75 , 3.00 ) NO-ERROR.
       ...
       RUN set-position IN h_INT540-query ( 12.75 , 141.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_INT540-viewer ).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_INT540-query (INPUT v-row-table). 
