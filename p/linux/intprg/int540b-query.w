...
*******************************************************************************/
{include/i-prgvrs.i INT540b-query 1.12.00.AVB}
...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_it_docto_xml no-lock WHERE rowid(int_ds_it_docto_xml) = v-row-item
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY {&SELF-NAME} FOR EACH int_ds_it_docto_xml no-lock WHERE rowid(int_ds_it_docto_xml) = v-row-item.
