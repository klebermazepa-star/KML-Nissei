...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡ÆoParƒmetros NDD"
         HEIGHT             = 9.07
         WIDTH              = 99.5
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 113.5
...
ON END-ERROR OF w-cadsim /* Manuten‡ÆoParƒmetros NDD */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡ÆoParƒmetros NDD */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             OUTPUT h_p-cadsim ).
       RUN set-position IN h_p-cadsim ( 1.33 , 27.25 ) NO-ERROR.
       /* Size in UIB:  ( 1.27 , 28.00 ) */
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Edge-Pixels = 0,
                     ...
                     Right-to-Left = First-On-Left':U ,
             OUTPUT h_p-exihel ).
       RUN set-position IN h_p-exihel ( 1.33 , 83.00 ) NO-ERROR.
       ...
       RUN set-position IN h_int560-viewer ( 3.40 , 1.00 ) NO-ERROR.
       ...
       RUN set-position IN h_int560-query ( 5.00 , 92.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_p-cadsim , 'TableIO':U , h_int560-viewer ).
