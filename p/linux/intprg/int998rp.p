/********************************************************************************
*******************************************************************************/
{include/i-prgvrs.i int998RP 2.06.00.001}  
{include/i_fnctrad.i}
/******************************************************************************
**
**       PROGRAMA: int998RP
...
DEF VAR  vl-aliquotaPIS    like it-doc-fisc.aliq-pis.
DEF VAR  vl-BasePIS        like tt-ncm-pis-cofins.val-base-calc-pis.
DEF VAR  vl-PIS            like tt-ncm-pis-cofins.val-pis.  
DEF VAR  TribPIS           AS INTEGER INIT 1.
DEF VAR  vl-aliquotaCOFINS like it-doc-fisc.aliq-cofins.
DEF VAR  vl-BaseCOFINS     like tt-ncm-pis-cofins.val-base-calc-cofins. 
DEF VAR  vl-COFINS         like tt-ncm-pis-cofins.val-cofins.
DEF VAR  TribCOFINS        AS INTEGER INIT 1.
...
PROCEDURE pi-gera-relatorio:
    ...
    chWorkBook      = chExcel:WorkBooks:ADD(search("layout\Modelo_int998.xls")). /*Adiciona a primeira aba*/
       ...
       /* assign vl-aliquotaPIS = dec(substr(item.char-2,31,5)) /*string(dec(substr(item.char-2,31,5)),"99.99")*/
        ...
        /*FIND FIRST tt-ncm-pis-cofins
             WHERE tt-ncm-pis-cofins.aba             = "Compras"
               ...
               AND tt-ncm-pis-cofins.tp-trib-cofins  = {ininc/i11in172.i 04 TribCOFINS /*it-doc-fisc.cd-trib-cofins*/ } NO-ERROR.
...
PROCEDURE pi-ncm-devol-cliente:
    ...
    for each doc-fiscal no-lock USE-INDEX ch-registro
       where doc-fiscal.cod-estab >= tt-param.estab-ini
        ...
        each it-doc-fisc of doc-fiscal no-lock
       where it-doc-fisc.class-fiscal >= tt-param.ncm-ini
         and it-doc-fisc.class-fiscal <= tt-param.ncm-fim AND it-doc-fisc.vl-tot-item > 0,
        first natur-oper
        where natur-oper.nat-operacao = it-doc-fisc.nat-operacao 
          and natur-oper.tipo-compra = 3 
