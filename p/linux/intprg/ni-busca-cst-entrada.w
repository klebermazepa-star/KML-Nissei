...
*******************************************************************************/
{include/i-prgvrs.i ni-busca-cst-entrada 2.00.00.001}
...
&IF "{&EMSFND_VERSION}" >= "1.00" &THEN
    {include/i-license-manager.i ni-busca-cst-entrada MPD}
&ENDIF
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Geraá∆o dados SPED - CST Sa°da"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 28.33
         MAX-WIDTH          = 195.14
...
ON END-ERROR OF w-relat /* Geraá∆o dados SPED - CST Sa°da */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Geraá∆o dados SPED - CST Sa°da */
DO:
...
DO:
    ...
    ASSIGN c-arquivo:SCREEN-VALUE IN FRAME f-pg-imp = SESSION:TEMP-DIRECTORY + "ni-busca-cst-entrada.txt".
...
DO:
   ...
   THEN
       ASSIGN c-arquivo:SCREEN-VALUE     IN FRAME f-pg-imp = SESSION:TEMP-DIRECTORY + "ni-busca-cst-entrada.txt"
              c-arquivo-ncm:SCREEN-VALUE IN FRAME f-pg-sel = SESSION:TEMP-DIRECTORY + "ncm-faltante-item-entrada.txt".
   ELSE
       ASSIGN c-arquivo:SCREEN-VALUE     IN FRAME f-pg-imp = "ni-busca-cst-entrada.txt"
              c-arquivo-ncm:SCREEN-VALUE IN FRAME f-pg-sel = "ncm-faltante-item-entrada.txt".
END.
...
{utp/ut9000.i "ni-busca-cst-entrada" "2.00.00.001"}
...
DO  ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
    ...
    ASSIGN c-arquivo:SCREEN-VALUE     IN FRAME f-pg-imp = "ni-busca-cst-entrada.txt".
    ASSIGN c-arquivo-ncm:SCREEN-VALUE IN FRAME f-pg-sel = "ncm-faltante-item-entrada.txt".
...
------------------------------------------------------------------------------*/
    ...
    /*     {include/i-imrun.i intprg/ni-busca-cst-entrada-rp.p} */
    
        {include/i-rprun.i intprg/ni-busca-cst-entrada-rp.p}

        IF  input frame f-pg-imp rs-execucao = 1
        THEN
            RUN utp/ut-msgs.p (INPUT "show",
                               INPUT 15825,
                               INPUT "Execuá∆o Finalizada").
