...
*******************************************************************************/
{include/i-prgvrs.i NI-IMP-ITEM-FORNEC 2.00.00.000}  /*** 010009 ***/
...
{include/i-imdef.i}
{cdp/cdcfgmat.i} /* Preprocessadores funá‰es materiais     */
...
DEFINE FRAME f-pg-par
     bt-arquivo-entrada AT ROW 3.21 COL 43.86 HELP
          "Escolha do nome do arquivo"
     c-arquivo-entrada AT ROW 3.25 COL 4 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     bt-layout AT ROW 10 COL 2 WIDGET-ID 2
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o Item x Fornecedor"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Importaá∆o Item x Fornecedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o Item x Fornecedor */
DO:
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL bt-layout C-Win
ON CHOOSE OF bt-layout IN FRAME f-pg-par /* Layout Importaá∆o */
DO:
  DOS SILENT START "\\192.168.200.52\datasul\_custom_homol\layout\layout-item-fornec.xlsx".
END.
...
{utp/ut9000.i "NI-IMP-ITEM-FORNEC" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-8 bt-arquivo-entrada c-arquivo-entrada bt-layout 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    {include/i-imrun.i intprg/ni-imp-item-fornec-rp.p}
