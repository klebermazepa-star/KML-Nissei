...
*******************************************************************************/
{include/i-prgvrs.i NI0101-Z1 2.00.00.000}  /*** 010010 ***/
...
DEFINE VARIABLE h_b03ad101 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-zoom
     ...
     bt-ok AT ROW 16.5 COL 2.72
     bt-cancela AT ROW 16.5 COL 15.29
     bt-ajuda AT ROW 16.5 COL 66.14
     rt-button AT ROW 16.17 COL 1.57
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa Lead Time Fornecedor por Estabelecimento"
         HEIGHT             = 17
         WIDTH              = 79
         MAX-HEIGHT         = 21.38
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-pesquisa /* Pesquisa Lead Time Fornecedor por Estabelecimento */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa Lead Time Fornecedor por Estabelecimento */
DO:
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Lead Time' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 1.17 , 1.57 ) NO-ERROR.
       RUN set-size IN h_folder ( 13.67 , 77.86 ) NO-ERROR.
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/ni0101-b1.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b03ad101 ).
       RUN set-position IN h_b03ad101 ( 2.71 , 3.29 ) NO-ERROR.
       /* Size in UIB:  ( 11.38 , 74.72 ) */

       /* Links to SmartBrowser h_b03ad101. */
       RUN add-link IN adm-broker-hdl ( h_b03ad101 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_b03ad101 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NI0101-Z1" "2.00.00.000"}
