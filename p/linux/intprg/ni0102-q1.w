...
&Scoped-define QUERY-STRING-Query-Main FOR EACH int_ds_fornecedor_linha NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH int_ds_fornecedor_linha NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main int_ds_fornecedor_linha
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main int_ds_fornecedor_linha
