...
*******************************************************************************/
{include/i-prgvrs.i NI0102-Z1 2.00.00.000}  /*** 010010 ***/
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-pesquisa ASSIGN
         HIDDEN             = YES
         TITLE              = "Pesquisa Linha por Fornecedor"
         HEIGHT             = 17
         WIDTH              = 79
         MAX-HEIGHT         = 21.38
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-pesquisa /* Pesquisa Linha por Fornecedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-pesquisa w-pesquisa
ON WINDOW-CLOSE OF w-pesquisa /* Pesquisa Linha por Fornecedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/ni0102-b1.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_b03ad101 ).
       RUN set-position IN h_b03ad101 ( 2.71 , 3.29 ) NO-ERROR.
       /* Size in UIB:  ( 11.50 , 74.72 ) */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NI0102-Z1" "2.00.00.000"}
