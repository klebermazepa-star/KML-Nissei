...
{include/i-prgvrs.i NI0102 2.00.00.000}
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Linha por Fornecedor"
         HEIGHT             = 6.92
         WIDTH              = 90
         MAX-HEIGHT         = 17
         MAX-WIDTH          = 90
...
ON END-ERROR OF w-cadsim /* Manuten‡Æo Linha por Fornecedor */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Manuten‡Æo Linha por Fornecedor */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/ni0102-v1.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_V02IN047 ).
       RUN set-position IN h_V02IN047 ( 2.75 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 5.04 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/ni0102-q1.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = intprg/ni0102-z1.w,
                     ProgVaPara = intprg/ni0102-g1.w,
                     ProgIncMod = ':U ,
             OUTPUT h_Q01IN047 ).
...
------------------------------------------------------------------------------*/
  ...
  /* Dispatch standard ADM method.                             */
  {utp/ut9000.i "NI0102" "2.00.00.000"}
