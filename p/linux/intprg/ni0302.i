...
FOR EACH tt-itens-validos:
    DELETE tt-itens-validos.
END.

for each tt-data,
    EACH tt-estab,
    each doc-fiscal fields ( cod-estabel serie nr-doc-fis cod-emitente vl-cont-doc
...
FOR EACH tt-itens-validos NO-LOCK
