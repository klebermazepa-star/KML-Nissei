...
*******************************************************************************/
{include/i-prgvrs.i NI0305 2.00.00.000}  /*** 010009 ***/
...
DEFINE FRAME f-pg-par
     ...
     c-arquivo-entrada AT ROW 3.25 COL 4 HELP
          "Nome do arquivo de destino do relat¢rio" NO-LABEL
     tg-atualiza AT ROW 5.58 COL 15 WIDGET-ID 2
     text-entrada AT ROW 2.33 COL 4.29 NO-LABEL
     RECT-8 AT ROW 2.67 COL 2.14
     RECT-10 AT ROW 5.29 COL 2.14 WIDGET-ID 4
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 3
         SIZE 76.57 BY 10.38.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o do Custo Unit†rio dos Itens"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Importaá∆o do Custo Unit†rio dos Itens */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o do Custo Unit†rio dos Itens */
DO:
...
{utp/ut9000.i "NI0305" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-8 RECT-10 bt-arquivo-entrada c-arquivo-entrada tg-atualiza 
      WITH FRAME f-pg-par IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           tt-param.atualiza        = input frame f-pg-par tg-atualiza.
    ...
    {include/i-imrun.i intprg/ni0305rp.p}
