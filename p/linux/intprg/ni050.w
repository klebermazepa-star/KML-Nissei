...
*******************************************************************************/
{include/i-prgvrs.i ni050 2.00.00.000}  /*** 010009 ***/
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Importaá∆o Alternativo/Equivalància"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF C-Win /* Importaá∆o Alternativo/Equivalància */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Importaá∆o Alternativo/Equivalància */
DO:
...
DO:
  DOS SILENT START "\\192.168.200.52\datasul\_custom_homol\layout\layout-alternativo.xlsx".
END.
...
{utp/ut9000.i "ni050" "2.00.00.000"}
...
do  on error undo, return error
    ...
    {include/i-imrun.i intprg/ni050rp.p}
