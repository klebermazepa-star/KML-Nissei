...
*******************************************************************************/
{include/i-prgvrs.i NICR001 2.06.00.001}
...
DEFINE VARIABLE h_nicr001-b01-3 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr001-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr001-v01 AS HANDLE NO-UNDO.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadpaifilho-ambos ASSIGN
         HIDDEN             = YES
         TITLE              = "Manuten‡Æo Portador x Agrupador"
         HEIGHT             = 15.58
         WIDTH              = 90
         MAX-HEIGHT         = 21.21
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-cadpaifilho-ambos /* Manuten‡Æo Portador x Agrupador */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-ambos w-cadpaifilho-ambos
ON WINDOW-CLOSE OF w-cadpaifilho-ambos /* Manuten‡Æo Portador x Agrupador */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr001-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr001-v01 ).
       RUN set-position IN h_nicr001-v01 ( 2.58 , 1.86 ) NO-ERROR.
       /* Size in UIB:  ( 3.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Portadores' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       ...
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'Initial-Lock = NO-LOCK,
                     ...
                     MessageNum = 0,
                     MessageParam = ':U ,
             OUTPUT h_nicr001-b01-3 ).
       RUN set-position IN h_nicr001-b01-3 ( 7.38 , 2.14 ) NO-ERROR.
       /* Size in UIB:  ( 8.58 , 85.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr001-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'ProgPesquisa = intprg/nicr001-z01.w,
                     ProgVaPara = intprg/nicr001-g01.w,
                     ProgIncMod = intprg\nicr001a.w,
                     Implantar = no':U ,
             OUTPUT h_nicr001-q01 ).
       RUN set-position IN h_nicr001-q01 ( 1.04 , 67.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_nicr001-v01. */
       RUN add-link IN adm-broker-hdl ( h_nicr001-q01 , 'Record':U , h_nicr001-v01 ).
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'TableIO':U , h_nicr001-v01 ).

       /* Links to SmartFolder h_folder. */
       RUN add-link IN adm-broker-hdl ( h_folder , 'Page':U , THIS-PROCEDURE ).

       /* Links to BrowserCadastro2 h_nicr001-b01-3. */
       RUN add-link IN adm-broker-hdl ( h_nicr001-q01 , 'Record':U , h_nicr001-b01-3 ).

       /* Links to SmartQuery h_nicr001-q01. */
       RUN add-link IN adm-broker-hdl ( h_p-cadpai , 'State':U , h_nicr001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-exihel , 'State':U , h_nicr001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'Navigation':U , h_nicr001-q01 ).
       RUN add-link IN adm-broker-hdl ( h_p-navega , 'State':U , h_nicr001-q01 ).
       ...
       RUN adjust-tab-order IN adm-broker-hdl ( h_p-exihel ,
             h_p-cadpai , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr001-v01 ,
             h_p-exihel , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_folder ,
             h_nicr001-v01 , 'AFTER':U ).
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr001-b01-3 ,
             h_folder , 'AFTER':U ).
    END. /* Page 0 */
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NICR001" "2.06.00.001"}
