...
DEFINE VARIABLE h_nicr001-q02 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr001-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 4.63 COL 2.72 HELP
          "Salva e sai"
     bt-save AT ROW 4.63 COL 13.14 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 4.63 COL 23.72 HELP
          "Cancela"
     bt-ajuda AT ROW 4.63 COL 79.29
     rt-button AT ROW 4.46 COL 1.72
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1.04
         SIZE 91.14 BY 16.96 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadsim ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Portador Agrupador"
         HEIGHT             = 5.04
         WIDTH              = 90.43
         MAX-HEIGHT         = 26.75
         MAX-WIDTH          = 146.29
...
ON END-ERROR OF w-cadsim /* Inclui/Modifica Portador Agrupador */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadsim w-cadsim
ON WINDOW-CLOSE OF w-cadsim /* Inclui/Modifica Portador Agrupador */
DO:
...
DO:
{include/salvafil.i h_nicr001-v02}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr001-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr001-v02 ).
       RUN set-position IN h_nicr001-v02 ( 1.08 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 3.25 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr001-q03.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_nicr001-q02 ).
       RUN set-position IN h_nicr001-q02 ( 1.13 , 73.29 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_nicr001-v02. */
       RUN add-link IN adm-broker-hdl ( h_nicr001-q02 , 'Record':U , h_nicr001-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TableIO':U , h_nicr001-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr001-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "XX9999B" "9.99.99.999"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_nicr001-v02 (input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_nicr001-q02(input v-row-table).
