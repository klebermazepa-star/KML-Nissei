...
DEFINE TEMP-TABLE tt-fatura-loja
    ...
    FIELD vl-cupom      LIKE cst-nota-fiscal.valor-dinheiro
...
PROCEDURE pi-gera-titulo-dinheiro:
    ...
    /*Transaá∆o, pois, implanta tudo ou nada*/
    bloco_trans:
        ...
        BREAK BY tt-fatura-loja.cod-estab 
            ...
            IF FIRST-OF(tt-fatura-loja.cod-espec) THEN DO:
                ...
                RUN pi-traduz-estab(INPUT v_cod_matriz_trad_org_ext,
                                    INPUT STRING(tt-fatura-loja.cod-estab), /*Estabelecimento EMS 2*/
                ...
                ASSIGN c_cod_refer = "".
                RUN pi_retorna_sugestao_referencia (INPUT  "DH",
                                                    INPUT  TODAY,
                                                    OUTPUT c_cod_refer,
                                                    INPUT  "tit_acr",
                ...
                ASSIGN tt_integr_acr_lote_impl.tta_cod_empresa        = c-empresa-ems-5 /*ObrigatΩrio*/
                       ...
                       tt_integr_acr_lote_impl.tta_cod_estab_ext      = STRING(tt-fatura-loja.cod-estab) /*ObrigatΩrio*/ 
                       tt_integr_acr_lote_impl.tta_dat_transacao      = tt-fatura-loja.dat-emissao
            ...
            IF tt-fatura-loja.r-fatduplic <> ? THEN DO:
                FIND FIRST fat-duplic EXCLUSIVE-LOCK
                     WHERE ROWID(fat-duplic) = tt-fatura-loja.r-fatduplic NO-ERROR.
            ...
            IF LAST-OF(tt-fatura-loja.cod-espec) THEN DO:
                ...
                ASSIGN c-cod-titulo = "DINH" + REPLACE(STRING(tt-fatura-loja.dat-emissao,"99/99/99"),"/","").

                FIND LAST tit_acr
                    WHERE tit_acr.cod_estab       = tt-fatura-loja.cod-estab
                      AND tit_acr.cod_espec_docto = "DI"
                      AND tit_acr.cod_ser_docto   = tt-fatura-loja.serie
                ...
                ASSIGN tt_integr_acr_item_lote_impl_8.ttv_rec_lote_impl_tit_acr      = RECID(tt_integr_acr_lote_impl)
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_cdn_cliente                = tt-fatura-loja.cod-emitente /*ObrigatΩrio*/
                       tt_integr_acr_item_lote_impl_8.tta_num_seq_refer              = 1
                       tt_integr_acr_item_lote_impl_8.tta_cod_espec_docto            = "DI" /*ObrigatΩrio*/ /*Duplicata*/  /*"AN"*/
                       tt_integr_acr_item_lote_impl_8.tta_ind_tip_espec_docto        = "2" /*ObrigatΩrio*/ /*"3"*/  /*Antecipaªío*/
                       tt_integr_acr_item_lote_impl_8.tta_cod_ser_docto              = tt-fatura-loja.serie
                       tt_integr_acr_item_lote_impl_8.tta_cod_portad_ext             = string(tt-fatura-loja.cod-portador) /*ObrigatΩrio*/ 
                       tt_integr_acr_item_lote_impl_8.tta_cod_modalid_ext            = "6" /*string(nota-fiscal.modalidade)   /*ObrigatΩrio*/ */
                       tt_integr_acr_item_lote_impl_8.tta_cod_tit_acr                = c-cod-titulo   /*ObrigatΩrio*/ 
                       tt_integr_acr_item_lote_impl_8.tta_cod_parcela                = STRING(i-cod-parcela,"99") /*ObrigatΩrio*/
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_dat_vencto_tit_acr         = tt-fatura-loja.dat-vencto /*ObrigatΩrio*/ /*tt-fat-duplic.dt-venciment*/
                       tt_integr_acr_item_lote_impl_8.tta_dat_prev_liquidac          = tt-fatura-loja.dat-vencto /*ObrigatΩrio*/ /*tt-fat-duplic.dt-venciment*/
                       tt_integr_acr_item_lote_impl_8.tta_dat_emis_docto             = tt-fatura-loja.dat-emissao /*tt-nota-fiscal.dt-emis-nota*/
                       tt_integr_acr_item_lote_impl_8.tta_des_text_histor            = "Integraá∆o Faturamento EMS 2 com Contas - Receber EMS 5" 
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_val_tit_acr                = d-vl-tot-tit /*ObrigatΩrio*/
                       tt_integr_acr_item_lote_impl_8.tta_val_liq_tit_acr            = d-vl-tot-tit /*ObrigatΩrio*/
                       tt_integr_acr_item_lote_impl_8.tta_des_obs_cobr               = "T°tulo do agrupamento das cupons fiscais de dinheiro do dia " + STRING(tt-fatura-loja.dat-emissao,"99/99/9999").
                ...
                ASSIGN tt_integr_acr_aprop_ctbl_pend.ttv_rec_item_lote_impl_tit_acr  = tt_integr_acr_item_lote_impl_8.ttv_rec_item_lote_impl_tit_acr
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_plano_cta_ctbl          = "PADRAO"     /*ObrigatΩrio*/  /*sch-param-vpi.cod-plano-cta-ctbl*/    /*'schulz'*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_cta_ctbl                = "91102005" /*ObrigatΩrio*/
                       ...
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_unid_negoc              = "000" /*ObrigatΩrio*/ /*c-unid-negoc*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_unid_negoc_ext          = "" /*c-unid-negoc*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_plano_ccusto            = "" /* "PADRAO" ObrigatΩrio*/ /*sch-param-vpi.cod-plano-ccusto*/      /*''*/ 
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto                  = "" /*"00697" ObrigatΩrio*/ /*sch-param-vpi.cod-ccusto*/   
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto_ext              = ""                                  /*''*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ        = "105" /*ObrigatΩrio*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_fluxo_financ_ext        = ""
                       tt_integr_acr_aprop_ctbl_pend.tta_log_impto_val_agreg         = NO
                       tt_integr_acr_aprop_ctbl_pend.tta_val_aprop_ctbl              = tt_integr_acr_item_lote_impl_8.tta_val_tit_acr. /*ObrigatΩrio*/
    
                ASSIGN d-vl-tot-tit = 0.
            
                /*Inicio atualizaá∆o EMS 5*/
                ...
                IF CAN-FIND(FIRST tt_log_erros_atualiz) THEN DO:
                    ...
                    IF AVAIL tt_integr_acr_item_lote_impl_8 THEN DO:
                        RUN pi-cria-tt-erro(INPUT tt_integr_acr_item_lote_impl_8.tta_num_seq_refer,
                                            ...
                                            INPUT "Estab/Especie/Serie/Titulo/Parcela/Cliente/Portador : " +  STRING(tt-fatura-loja.cod-estab) + "/" +
                                                                                                              STRING(tt_integr_acr_item_lote_impl_8.tta_cod_espec_docto) + "/" +
                                                                                                              STRING(tt_integr_acr_item_lote_impl_8.tta_cod_ser_docto) + "/" +
                                                                                                              STRING(tt_integr_acr_item_lote_impl_8.tta_cod_tit_acr) + "/" +
                                                                                                              STRING(tt_integr_acr_item_lote_impl_8.tta_cod_parcela) + "/" +
                ...
                ELSE DO:
                    ...
                    FOR EACH tt_integr_acr_item_lote_impl_8 NO-LOCK:
                        ...
                        ASSIGN tt-tit-criados.cod_estab          = tt-fatura-loja.cod-estab
                            ...
                            FOR EACH tt-fatura-loja-aux: 
                                ...
                                FOR FIRST fat-duplic
                                    ...
                                    ASSIGN tit_acr_cartao.cod_admdra             = ""
                                           ...
                                           tit_acr_cartao.num_cupom              = cst-nota-fiscal.nr-nota-fis
                                           tit_acr_cartao.cartao-manual          = cst-nota-fiscal.cartao-manual
                                        .
...
/*               BY tt-fatura-loja.dat-vencto */
            ...
            IF FIRST-OF(tt-fatura-loja.cod-espec) THEN DO:
                ...
                ASSIGN c_cod_refer = "".
                RUN pi_retorna_sugestao_referencia (INPUT  "CE",
                                                    INPUT  TODAY,
                                                    OUTPUT c_cod_refer,
                                                    INPUT  "tit_acr",
                                                    INPUT  STRING(tt-fatura-loja.cod-estab)).
            ...
            IF LAST-OF(tt-fatura-loja.cod-espec) THEN DO:
                ...
                ASSIGN c-cod-titulo = "CHEQ" + REPLACE(STRING(tt-fatura-loja.dat-emissao,"99/99/99"),"/","").

                FIND LAST tit_acr
                    WHERE tit_acr.cod_estab       = tt-fatura-loja.cod-estab
                      AND tit_acr.cod_espec_docto = "CE"
                      AND tit_acr.cod_ser_docto   = tt-fatura-loja.serie
                      AND tit_acr.cod_tit_acr     = c-cod-titulo  NO-LOCK NO-ERROR.
                IF AVAIL tit_acr THEN DO:
                    ASSIGN i-cod-parcela = INT(tit_acr.cod_parcela) + 1.
                ...
                ASSIGN tt_integr_acr_item_lote_impl_8.ttv_rec_lote_impl_tit_acr      = RECID(tt_integr_acr_lote_impl)
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_cdn_cliente                = tt-fatura-loja.cod-emitente /*ObrigatΩrio*/
                       tt_integr_acr_item_lote_impl_8.tta_num_seq_refer              = 1
                       tt_integr_acr_item_lote_impl_8.tta_cod_espec_docto            = "CE" /*ObrigatΩrio*/ /*Duplicata*/  /*"AN"*/
                       tt_integr_acr_item_lote_impl_8.tta_ind_tip_espec_docto        = "2" /*ObrigatΩrio*/ /*"3"*/  /*Antecipaªío*/
                       tt_integr_acr_item_lote_impl_8.tta_cod_ser_docto              = tt-fatura-loja.serie
                       tt_integr_acr_item_lote_impl_8.tta_cod_portad_ext             = string(tt-fatura-loja.cod-portador) /*ObrigatΩrio*/ 
                       tt_integr_acr_item_lote_impl_8.tta_cod_modalid_ext            = "6" /*string(nota-fiscal.modalidade)   /*ObrigatΩrio*/ */
                ...
                ASSIGN tt_integr_acr_aprop_ctbl_pend.ttv_rec_item_lote_impl_tit_acr  = tt_integr_acr_item_lote_impl_8.ttv_rec_item_lote_impl_tit_acr
                       ...
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto                  = "" /*"00697" ObrigatΩrio*/ /*sch-param-vpi.cod-ccusto*/   
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto_ext              = ""                                  /*''*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ        = "145" /*ObrigatΩrio*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_fluxo_financ_ext        = ""
                       tt_integr_acr_aprop_ctbl_pend.tta_log_impto_val_agreg         = NO
                       tt_integr_acr_aprop_ctbl_pend.tta_val_aprop_ctbl              = tt_integr_acr_item_lote_impl_8.tta_val_tit_acr. /*ObrigatΩrio*/
                    ...
                    FOR EACH tt_integr_acr_item_lote_impl_8 NO-LOCK:
                        ...
                        IF AVAIL tit_acr THEN DO:
                            FOR EACH tt-fatura-loja-aux: 
                                ...
                                FOR FIRST fat-duplic
                                    WHERE ROWID(fat-duplic) = tt-fatura-loja-aux.r-fatduplic NO-LOCK,
                                    FIRST cst-fat-duplic OF fat-duplic EXCLUSIVE-LOCK,
                                    FIRST nota-fiscal EXCLUSIVE-LOCK
                                    WHERE nota-fiscal.cod-estabel  = fat-duplic.cod-estabel
                                      AND nota-fiscal.serie        = fat-duplic.serie      
                                      AND nota-fiscal.nr-fatura    = fat-duplic.nr-fatura,
                                    ...
                                    ASSIGN cst-fat-duplic.num-id-tit-acr = tit_acr.num_id_tit_acr.
    ...
    DO TRANSACTION ON ERROR UNDO:
        ...
        BREAK BY tt-fatura-loja.cod-estab   
            ...
            IF FIRST-OF(tt-fatura-loja.cod-espec)    THEN DO:
                ...
                ASSIGN c_cod_refer = "".
                RUN pi_retorna_sugestao_referencia (INPUT  "CC",
                                                    INPUT  TODAY,
                                                    OUTPUT c_cod_refer,
                                                    INPUT  "tit_acr",
                                                    INPUT  STRING(tt-fatura-loja.cod-estab)).
            ...
            IF LAST-OF(tt-fatura-loja.cod-espec)  THEN DO:
                ...
                ASSIGN c-cod-titulo = tt-fatura-loja.prefixo + REPLACE(STRING(tt-fatura-loja.dat-emissao,"99/99/99"),"/","").

                FIND LAST tit_acr
                    WHERE tit_acr.cod_estab       = tt-fatura-loja.cod-estab
                      AND tit_acr.cod_espec_docto = "CC"
                      AND tit_acr.cod_ser_docto   = tt-fatura-loja.serie
                      AND tit_acr.cod_tit_acr     = c-cod-titulo  NO-LOCK NO-ERROR.
                IF AVAIL tit_acr THEN DO:
                    ASSIGN i-cod-parcela = INT(tit_acr.cod_parcela) + 1.
                ...
                ASSIGN tt_integr_acr_item_lote_impl_8.ttv_rec_lote_impl_tit_acr      = RECID(tt_integr_acr_lote_impl)
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_cdn_cliente                = tt-fatura-loja.cod-emitente /*ObrigatΩrio*/
                       tt_integr_acr_item_lote_impl_8.tta_num_seq_refer              = 1
                       tt_integr_acr_item_lote_impl_8.tta_cod_espec_docto            = "CC" /*ObrigatΩrio*/ /*Duplicata*/  /*"AN"*/
                       tt_integr_acr_item_lote_impl_8.tta_ind_tip_espec_docto        = "2" /*ObrigatΩrio*/ /*"3"*/  /*Antecipaªío*/
                       tt_integr_acr_item_lote_impl_8.tta_cod_ser_docto              = tt-fatura-loja.serie
                       tt_integr_acr_item_lote_impl_8.tta_cod_portad_ext             = string(tt-fatura-loja.cod-portador) /*ObrigatΩrio*/ 
                       tt_integr_acr_item_lote_impl_8.tta_cod_modalid_ext            = "6" /*string(nota-fiscal.modalidade)   /*ObrigatΩrio*/ */
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_dat_prev_liquidac          = tt-fatura-loja.dat-vencto /*ObrigatΩrio*/ /*tt-fat-duplic.dt-venciment*/
                       tt_integr_acr_item_lote_impl_8.tta_dat_emis_docto             = tt-fatura-loja.dat-emissao /*tt-nota-fiscal.dt-emis-nota*/
                       tt_integr_acr_item_lote_impl_8.tta_des_text_histor            = "Integraá∆o Faturamento EMS2 com Contas Receber - EMS5" 
                       tt_integr_acr_item_lote_impl_8.tta_cod_cond_pagto             = ""
                       tt_integr_acr_item_lote_impl_8.tta_val_cotac_indic_econ       = 1
                       tt_integr_acr_item_lote_impl_8.tta_ind_sit_bcia_tit_acr       = "1"
                       tt_integr_acr_item_lote_impl_8.tta_ind_ender_cobr             = "1"
                ...
                ASSIGN tt_integr_acr_aprop_ctbl_pend.ttv_rec_item_lote_impl_tit_acr  = tt_integr_acr_item_lote_impl_8.ttv_rec_item_lote_impl_tit_acr
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_plano_cta_ctbl          = "PADRAO"     /*ObrigatΩrio*/  /*sch-param-vpi.cod-plano-cta-ctbl*/    /*'schulz'*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_cta_ctbl                = tt-fatura-loja.conta /*ObrigatΩrio*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_cta_ctbl_ext            = "" /*sch-param-vpi.cod-cta-ctbl*/          /*"1121995"*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_sub_cta_ctbl_ext        = "" /*sch-param-vpi.cod-ccusto*/ 
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_unid_negoc              = "000" /*ObrigatΩrio*/ /*c-unid-negoc*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_unid_negoc_ext          = "" /*c-unid-negoc*/
                       ...
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto                  = "" /*"00697" ObrigatΩrio*/ /*sch-param-vpi.cod-ccusto*/   
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto_ext              = ""                                  /*''*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ        = "120" /*ObrigatΩrio*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_fluxo_financ_ext        = ""
                       tt_integr_acr_aprop_ctbl_pend.tta_log_impto_val_agreg         = NO
                       tt_integr_acr_aprop_ctbl_pend.tta_val_aprop_ctbl              = tt_integr_acr_item_lote_impl_8.tta_val_tit_acr. /*ObrigatΩrio*/
                        ...
                        IF AVAIL tit_acr THEN DO:
                            FOR EACH tt-fatura-loja-aux: 
                                ...
                                FOR FIRST fat-duplic
                                    ...
                                    ASSIGN vlTaxaCartao = vlTaxaCartao + cst-fat-duplic.taxa-admin.
    
                                    CREATE tit_acr_cartao.
                                    ASSIGN tit_acr_cartao.num_id_tit_acr         = tit_acr.num_id_tit_acr
                                           tit_acr_cartao.num_seq                = iNumSeq
                                           tit_acr_cartao.cod_admdra             = IF cst-fat-duplic.adm-cartao = ? THEN "" ELSE cst-fat-duplic.adm-cartao
                                           tit_acr_cartao.cod_autoriz_cartao_cr  = IF cst-fat-duplic.autorizacao = "" OR cst-fat-duplic.autorizacao = ? THEN "0" ELSE cst-fat-duplic.autorizacao 
                                           tit_acr_cartao.cod_comprov_vda        = IF cst-fat-duplic.nsu-num = "" OR cst-fat-duplic.nsu-num = ? THEN "0" ELSE cst-fat-duplic.nsu-num
                                           tit_acr_cartao.cod_empresa            = tit_acr.cod_empresa
                                           tit_acr_cartao.cod_estab              = tit_acr.cod_estab
                                           tit_acr_cartao.cod_parc               = tit_acr.cod_parcela 
                                           tit_acr_cartao.dat_atualiz            = TODAY
                                           ...
                                           tit_acr_cartao.hra_atualiz            = REPLACE(STRING(TIME, "HH:MM:SS"), ":","")
                                           tit_acr_cartao.val_comprov_vda        = fat-duplic.vl-parcela
                                           tit_acr_cartao.val_des_admdra         = cst-fat-duplic.taxa-admin
                                           tit_acr_cartao.num_cupom              = cst-nota-fiscal.nr-nota-fis
                                           tit_acr_cartao.cartao-manual          = cst-nota-fiscal.cartao-manual
                                        .
    ...
    DO TRANSACTION ON ERROR UNDO:
        ...
        BREAK BY tt-fatura-loja.cod-estab   
            ...
            IF FIRST-OF(tt-fatura-loja.cod-espec)    THEN DO:
                ...
                ASSIGN c_cod_refer = "".
                RUN pi_retorna_sugestao_referencia (INPUT  "CD",
                                                    INPUT  TODAY,
                                                    OUTPUT c_cod_refer,
                                                    INPUT  "tit_acr",
                                                    INPUT  STRING(tt-fatura-loja.cod-estab)).
            ...
            IF LAST-OF(tt-fatura-loja.cod-espec)  THEN DO:
                ...
                FIND LAST tit_acr
                    WHERE tit_acr.cod_estab       = tt-fatura-loja.cod-estab
                      AND tit_acr.cod_espec_docto = "CD"
                      AND tit_acr.cod_ser_docto   = tt-fatura-loja.serie
                      AND tit_acr.cod_tit_acr     = c-cod-titulo  NO-LOCK NO-ERROR.
                IF AVAIL tit_acr THEN DO:
                    ASSIGN i-cod-parcela = INT(tit_acr.cod_parcela) + 1.
                ...
                ASSIGN tt_integr_acr_item_lote_impl_8.ttv_rec_lote_impl_tit_acr      = RECID(tt_integr_acr_lote_impl)
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_cdn_cliente                = tt-fatura-loja.cod-emitente /*ObrigatΩrio*/
                       tt_integr_acr_item_lote_impl_8.tta_num_seq_refer              = 1
                       tt_integr_acr_item_lote_impl_8.tta_cod_espec_docto            = "CD" /*ObrigatΩrio*/ /*Duplicata*/  /*"AN"*/
                       tt_integr_acr_item_lote_impl_8.tta_ind_tip_espec_docto        = "2" /*ObrigatΩrio*/ /*"3"*/  /*Antecipaªío*/
                       tt_integr_acr_item_lote_impl_8.tta_cod_ser_docto              = tt-fatura-loja.serie
                       tt_integr_acr_item_lote_impl_8.tta_cod_portad_ext             = string(tt-fatura-loja.cod-portador) /*ObrigatΩrio*/ 
                       tt_integr_acr_item_lote_impl_8.tta_cod_modalid_ext            = "6" /*string(nota-fiscal.modalidade)   /*ObrigatΩrio*/ */
                ...
                ASSIGN tt_integr_acr_aprop_ctbl_pend.ttv_rec_item_lote_impl_tit_acr  = tt_integr_acr_item_lote_impl_8.ttv_rec_item_lote_impl_tit_acr
                       ...
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto                  = "" /*"00697" ObrigatΩrio*/ /*sch-param-vpi.cod-ccusto*/   
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto_ext              = ""                                  /*''*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ        = "135" /*ObrigatΩrio*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_fluxo_financ_ext        = ""
                       tt_integr_acr_aprop_ctbl_pend.tta_log_impto_val_agreg         = NO
                       tt_integr_acr_aprop_ctbl_pend.tta_val_aprop_ctbl              = tt_integr_acr_item_lote_impl_8.tta_val_tit_acr. /*ObrigatΩrio*/

                IF tt-fatura-loja.prefixo = "REDE" THEN
                     ASSIGN tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ = "130".
                ELSE IF tt-fatura-loja.prefixo = "CIEL" THEN
                     ASSIGN tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ = "125".
    ...
    DO TRANSACTION ON ERROR UNDO:
        ...
        BREAK BY tt-fatura-loja.cod-estab   
            ...
            IF FIRST-OF(tt-fatura-loja.cod-espec)    THEN DO:
                ...
                ASSIGN c_cod_refer = "".
                RUN pi_retorna_sugestao_referencia (INPUT  "PO",
                                                    INPUT  TODAY,
                                                    OUTPUT c_cod_refer,
                                                    INPUT  "tit_acr",
                                                    INPUT  STRING(tt-fatura-loja.cod-estab)).
            ...
            IF LAST-OF(tt-fatura-loja.cod-espec)  THEN DO:
                ...
                FIND LAST tit_acr
                    WHERE tit_acr.cod_estab       = tt-fatura-loja.cod-estab
                      AND tit_acr.cod_espec_docto = "PO"
                      AND tit_acr.cod_ser_docto   = tt-fatura-loja.serie
                      AND tit_acr.cod_tit_acr     = c-cod-titulo  NO-LOCK NO-ERROR.
                IF AVAIL tit_acr THEN DO:
                    ASSIGN i-cod-parcela = INT(tit_acr.cod_parcela) + 1.
                ...
                ASSIGN tt_integr_acr_item_lote_impl_8.ttv_rec_lote_impl_tit_acr      = RECID(tt_integr_acr_lote_impl)
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_cdn_cliente                = tt-fatura-loja.cod-emitente /*ObrigatΩrio*/
                       tt_integr_acr_item_lote_impl_8.tta_num_seq_refer              = 1
                       tt_integr_acr_item_lote_impl_8.tta_cod_espec_docto            = "PO" /*ObrigatΩrio*/ /*Duplicata*/  /*"AN"*/
                       tt_integr_acr_item_lote_impl_8.tta_ind_tip_espec_docto        = "2" /*ObrigatΩrio*/ /*"3"*/  /*Antecipaªío*/
                       tt_integr_acr_item_lote_impl_8.tta_cod_ser_docto              = tt-fatura-loja.serie
                       tt_integr_acr_item_lote_impl_8.tta_cod_portad_ext             = string(tt-fatura-loja.cod-portador) /*ObrigatΩrio*/ 
                       tt_integr_acr_item_lote_impl_8.tta_cod_modalid_ext            = "6" /*string(nota-fiscal.modalidade)   /*ObrigatΩrio*/ */
                ...
                ASSIGN tt_integr_acr_aprop_ctbl_pend.ttv_rec_item_lote_impl_tit_acr  = tt_integr_acr_item_lote_impl_8.ttv_rec_item_lote_impl_tit_acr
                       ...
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto                  = "" /*"00697" ObrigatΩrio*/ /*sch-param-vpi.cod-ccusto*/   
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto_ext              = ""                                  /*''*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ        = "110" /*ObrigatΩrio*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_fluxo_financ_ext        = ""
                       tt_integr_acr_aprop_ctbl_pend.tta_log_impto_val_agreg         = NO
                       tt_integr_acr_aprop_ctbl_pend.tta_val_aprop_ctbl              = tt_integr_acr_item_lote_impl_8.tta_val_tit_acr. /*ObrigatΩrio*/
                            ...
                            FOR EACH tt-fatura-loja-aux: 
                                ...
                                FOR FIRST fat-duplic
                                    ...
                                    ASSIGN tit_acr_cartao.num_id_tit_acr         = tit_acr.num_id_tit_acr
                                           ...
                                           tit_acr_cartao.cod_admdra             = IF cst-fat-duplic.adm-cartao = ? THEN "" ELSE cst-fat-duplic.adm-cartao
                                           tit_acr_cartao.cod_autoriz_cartao_cr  = IF cst-fat-duplic.autorizacao = "" OR cst-fat-duplic.autorizacao = ? THEN "0" ELSE cst-fat-duplic.autorizacao 
                                           tit_acr_cartao.cod_comprov_vda        = IF cst-fat-duplic.nsu-numero = "" OR cst-fat-duplic.nsu-numero = ? THEN "0" ELSE cst-fat-duplic.nsu-numero
                                           tit_acr_cartao.cod_empresa            = tit_acr.cod_empresa
                                           tit_acr_cartao.cod_estab              = tit_acr.cod_estab
                                           tit_acr_cartao.cod_parc               = tit_acr.cod_parcela 
                                           tit_acr_cartao.dat_atualiz            = TODAY
    ...
    DO TRANSACTION ON ERROR UNDO:
        ...
        BREAK BY tt-fatura-loja.cod-estab   
            ...
            IF LAST-OF(tt-fatura-loja.cod-espec)  THEN DO:
                ...
                FIND LAST tit_acr
                    WHERE tit_acr.cod_estab       = tt-fatura-loja.cod-estab
                      AND tit_acr.cod_espec_docto = "DZ"
                      AND tit_acr.cod_ser_docto   = tt-fatura-loja.serie
                      AND tit_acr.cod_tit_acr     = c-cod-titulo  NO-LOCK NO-ERROR.
                IF AVAIL tit_acr THEN DO:
                    ASSIGN i-cod-parcela = INT(tit_acr.cod_parcela) + 1.
                ...
                ASSIGN tt_integr_acr_item_lote_impl_8.ttv_rec_lote_impl_tit_acr      = RECID(tt_integr_acr_lote_impl)
                       ...
                       tt_integr_acr_item_lote_impl_8.tta_cdn_cliente                = tt-fatura-loja.cod-emitente /*ObrigatΩrio*/
                       tt_integr_acr_item_lote_impl_8.tta_num_seq_refer              = 1
                       tt_integr_acr_item_lote_impl_8.tta_cod_espec_docto            = "DZ" /*ObrigatΩrio*/ /*Duplicata*/  /*"AN"*/
                       tt_integr_acr_item_lote_impl_8.tta_ind_tip_espec_docto        = "2" /*ObrigatΩrio*/ /*"3"*/  /*Antecipaªío*/
                       tt_integr_acr_item_lote_impl_8.tta_cod_ser_docto              = tt-fatura-loja.serie
                       tt_integr_acr_item_lote_impl_8.tta_cod_portad_ext             = string(tt-fatura-loja.cod-portador) /*ObrigatΩrio*/ 
                       tt_integr_acr_item_lote_impl_8.tta_cod_modalid_ext            = "6" /*string(nota-fiscal.modalidade)   /*ObrigatΩrio*/ */
                ...
                ASSIGN tt_integr_acr_aprop_ctbl_pend.ttv_rec_item_lote_impl_tit_acr  = tt_integr_acr_item_lote_impl_8.ttv_rec_item_lote_impl_tit_acr
                       ...
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto                  = "" /*"00697" ObrigatΩrio*/ /*sch-param-vpi.cod-ccusto*/   
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_ccusto_ext              = ""                                  /*''*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_tip_fluxo_financ        = "155" /*ObrigatΩrio*/
                       tt_integr_acr_aprop_ctbl_pend.tta_cod_fluxo_financ_ext        = ""
                       tt_integr_acr_aprop_ctbl_pend.tta_log_impto_val_agreg         = NO
                       tt_integr_acr_aprop_ctbl_pend.tta_val_aprop_ctbl              = tt_integr_acr_item_lote_impl_8.tta_val_tit_acr. /*ObrigatΩrio*/
...
PROCEDURE pi-carrega-movto-dinheiro:
    ...
    FOR EACH fat-duplic
       ...
       FIRST cst-fat-duplic OF fat-duplic NO-LOCK,
       FIRST nota-fiscal NO-LOCK
       WHERE nota-fiscal.cod-estabel  = fat-duplic.cod-estabel
         AND nota-fiscal.serie        = fat-duplic.serie      
         AND nota-fiscal.nr-fatura    = fat-duplic.nr-fatura
         AND nota-fiscal.dt-emis      = tt-param.c-data-limite
       ...
       WHERE estabelec.cod-estabel = nota-fiscal.cod-estabel
        ...
        ASSIGN tt-fatura-loja.cod-estab    = nota-fiscal.cod-estabel
               ...
               tt-fatura-loja.cod-portador = cst-fat-duplic.cod-portador
...
PROCEDURE pi-carrega-movto-farmacia:
    ...
    FOR EACH fat-duplic
       ...
       WHERE portador-agrupador.cod-portador = STRING(fat-duplic.int-1)
         AND portador-agrupador.cod-emitente >= tt-param.c-cliente-ini
         AND portador-agrupador.cod-emitente <= tt-param.c-cliente-fim NO-LOCK:
        ...
        ASSIGN tt-fatura-loja.cod-estab    = nota-fiscal.cod-estabel
               tt-fatura-loja.serie        = nota-fiscal.serie
               tt-fatura-loja.nro-cupom    = nota-fiscal.nr-nota-fis
               tt-fatura-loja.cod-emitente = portador-agrupador.cod-emitente
               tt-fatura-loja.dat-emissao  = fat-duplic.dt-emissao  
               tt-fatura-loja.dat-vencto   = fat-duplic.dt-venciment
               tt-fatura-loja.cod-portador = cst-fat-duplic.cod-portador
               tt-fatura-loja.cod-espec    = fat-duplic.cod-esp
               tt-fatura-loja.vl-cupom     = fat-duplic.vl-parcela
               tt-fatura-loja.prefixo      = portador-agrupador.prefixo
               tt-fatura-loja.conta        = fat-duplic.ct-recven
               tt-fatura-loja.r-fatduplic  = ROWID(fat-duplic).
    END.
...
PROCEDURE pi-traduz-empresa:
    ...
    IF p-empresa-ems5 = "" THEN DO:
        ASSIGN c-erro = "Matriz Traduªío Empresa Nío Cadastrada. Empresa: " + string(p-empresa-ems2).
    ...
    IF CAN-FIND(FIRST tt_log_erros_alter_tit_acr) THEN DO:
        ...
        IF AVAIL tt_alter_tit_acr_base_5 THEN DO:
            RUN pi-cria-tt-erro(INPUT 1,
                                INPUT 17006,
                                INPUT "Estab/Especie/Titulo: " + string(tt_alter_tit_acr_base_5.tta_cod_estab) + "/" + STRING(tit_acr.cod_espec_docto) + "/" + STRING(tit_acr.cod_tit_acr) + " , apresentou os erros abaixo.",
                                INPUT "Estab/Especie/Titulo: " + string(tt_alter_tit_acr_base_5.tta_cod_estab) + "/" + STRING(tit_acr.cod_espec_docto) + "/" + STRING(tit_acr.cod_tit_acr) + " , apresentou os erros abaixo.").                
        END.
