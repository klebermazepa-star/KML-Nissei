...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SEPARATORS MULTIPLE SIZE 117.72 BY 8.83
...
DEFINE FRAME F-Main
     ...
     bt-carrega-tit AT ROW 5.92 COL 120.29 WIDGET-ID 34
     ...
     cb-convenio AT ROW 6 COL 107.29 COLON-ALIGNED NO-LABEL WIDGET-ID 52
     br-tit-acr AT ROW 7.17 COL 2.29 WIDGET-ID 200
     bt-filtro AT ROW 7.21 COL 120.29 WIDGET-ID 28
     bt-marca AT ROW 8.21 COL 120.29 WIDGET-ID 36
     bt-desmarca AT ROW 9.21 COL 120.29 WIDGET-ID 38
     bt-incluir AT ROW 10.17 COL 120.29 WIDGET-ID 40
...
DO:
  ...
  IF AVAIL b-cst_nota_fiscal THEN DO:
      IF tt-tit-acr-sel.receita = "Com Receita" THEN DO:
          ASSIGN b-cst_nota_fiscal.tipo_venda = 1.
      END.
      ELSE IF tt-tit-acr-sel.receita = "Sem Receita" THEN DO:
          ASSIGN b-cst_nota_fiscal.tipo_venda = 2.
      END.
      ELSE IF tt-tit-acr-sel.receita = "Ambos" THEN DO:
          ASSIGN b-cst_nota_fiscal.tipo_venda = 3.
      END.
   ...
   WHERE cst_nota_fiscal.cod_estabel = tit_acr.cod_estab           
    ...
    IF NOT AVAIL tt-tit-acr THEN DO:
       ...
       /* INICIO - Alteraá∆o SM... para inclus∆o da informaá∆o de Venda com Receita para o Convànio */
        IF cst_nota_fiscal.tipo_venda = 1 THEN DO:
            ASSIGN tt-tit-acr.receita = "Com Receita".
        END.
        ELSE IF cst_nota_fiscal.tipo_venda = 2 THEN DO:
            ASSIGN tt-tit-acr.receita = "Sem Receita".
        END.
        ELSE IF cst_nota_fiscal.tipo_venda = 3 OR cst_nota_fiscal.tipo_venda = 0 OR cst_nota_fiscal.tipo_venda = ? THEN DO:
