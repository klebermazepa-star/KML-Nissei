...
{include/i-prgvrs.i NICR003A 2.06.00.001}
...
DEFINE VARIABLE c-estab-ini AS CHARACTER FORMAT "X(5)":U INITIAL "973" 
...
DEFINE FRAME f-relat
     ...
     im-pg-imp AT ROW 1.5 COL 18.14
...
DEFINE FRAME f-pg-sel
     ...
     c-dt-emissao AT ROW 2.63 COL 17.86 COLON-ALIGNED WIDGET-ID 18
     c-cliente-ini AT ROW 3.67 COL 17.86 COLON-ALIGNED WIDGET-ID 2
     c-cliente-fim AT ROW 3.67 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     IMAGE-3 AT ROW 3.67 COL 32.57 WIDGET-ID 6
     IMAGE-4 AT ROW 3.67 COL 38.72 WIDGET-ID 8
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
         SIZE 72.86 BY 10.63 WIDGET-ID 100.
...
ON END-ERROR OF w-relat /* Geraá∆o T°tulo Convànio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Geraá∆o T°tulo Convànio */
DO:
...
{utp/ut9000.i "NICR003A" "2.06.00.001"}
...
assign c-dt-emissao:screen-value in frame f-pg-sel = string(date(today - 1),"99/99/9999").
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-dt-emissao c-cliente-ini c-cliente-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-3 IMAGE-4 c-estab-ini c-dt-emissao c-cliente-ini c-cliente-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    {include/i-rprun.i intprg/nicr003arp.p}
