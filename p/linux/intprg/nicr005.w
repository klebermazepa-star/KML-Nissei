...
{include/i-prgvrs.i NICR005 9.99.99.999}
...
DEFINE VARIABLE c-dt-emissao-fim AS DATE FORMAT "99/99/9999":U 
     VIEW-AS FILL-IN 
     SIZE 9.43 BY .88 NO-UNDO.

DEFINE VARIABLE c-dt-emissao-ini AS DATE FORMAT "99/99/9999":U 
     LABEL "Data Emiss∆o" 
     VIEW-AS FILL-IN 
     SIZE 9.43 BY .88 NO-UNDO.
...
DEFINE VARIABLE c-portador-fim AS INTEGER FORMAT ">>>>>>9":U INITIAL 9999999 
     VIEW-AS FILL-IN 
     SIZE 7.29 BY .88 NO-UNDO.

DEFINE VARIABLE c-portador-ini AS INTEGER FORMAT ">>>>>>9":U INITIAL 0 
     LABEL "Portador" 
     VIEW-AS FILL-IN 
     SIZE 7.29 BY .88 NO-UNDO.
...
DEFINE VARIABLE tg-cupom-agrupados AS LOGICAL INITIAL no 
     LABEL "Dinheiro/Cart∆o/Outros" 
     VIEW-AS TOGGLE-BOX
     SIZE 23 BY .83 NO-UNDO.

DEFINE VARIABLE tg-cupom-convenio AS LOGICAL INITIAL no 
     LABEL "Convànio" 
     VIEW-AS TOGGLE-BOX
...
DEFINE FRAME f-pg-sel
     c-estab-ini AT ROW 1.63 COL 24 COLON-ALIGNED
     c-estab-fim AT ROW 1.63 COL 40 COLON-ALIGNED NO-LABEL
     c-cliente-ini AT ROW 2.63 COL 17.86 COLON-ALIGNED WIDGET-ID 2
     c-cliente-fim AT ROW 2.63 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     c-portador-ini AT ROW 3.63 COL 23 COLON-ALIGNED WIDGET-ID 10
     c-portador-fim AT ROW 3.63 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 12
     c-dt-emissao-ini AT ROW 4.58 COL 20.86 COLON-ALIGNED WIDGET-ID 26
     c-dt-emissao-fim AT ROW 4.58 COL 40 COLON-ALIGNED NO-LABEL WIDGET-ID 28
     tg-cupom-agrupados AT ROW 7.67 COL 6 WIDGET-ID 18
     tg-cupom-convenio AT ROW 8.63 COL 6 WIDGET-ID 20
     "Executar Devoluá‰es de" VIEW-AS TEXT
          SIZE 17.14 BY .67 AT ROW 6.83 COL 2.86 WIDGET-ID 24
     IMAGE-1 AT ROW 1.63 COL 32.57
     IMAGE-2 AT ROW 1.63 COL 38.86
     IMAGE-3 AT ROW 2.63 COL 32.57 WIDGET-ID 6
     IMAGE-4 AT ROW 2.63 COL 38.86 WIDGET-ID 8
     IMAGE-5 AT ROW 3.63 COL 32.57 WIDGET-ID 14
     IMAGE-6 AT ROW 3.63 COL 38.86 WIDGET-ID 16
     RECT-10 AT ROW 7.17 COL 1.43 WIDGET-ID 22
     IMAGE-7 AT ROW 4.58 COL 32.57 WIDGET-ID 30
     IMAGE-8 AT ROW 4.58 COL 38.86 WIDGET-ID 32
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.83
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-relat ASSIGN
         HIDDEN             = YES
         TITLE              = "Geraá∆o Devoluá∆o Cupom ACR"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 33.83
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-relat /* Geraá∆o Devoluá∆o Cupom ACR */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Geraá∆o Devoluá∆o Cupom ACR */
DO:
...
{utp/ut9000.i "NICR005" "9.99.99.999"}
...
assign c-dt-emissao-ini:screen-value in frame f-pg-sel = string(date(today - 1),"99/99/9999").
assign c-dt-emissao-fim:screen-value in frame f-pg-sel = string(date(today - 1),"99/99/9999").
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY c-estab-ini c-estab-fim c-cliente-ini c-cliente-fim c-portador-ini 
          c-portador-fim c-dt-emissao-ini c-dt-emissao-fim tg-cupom-agrupados 
          tg-cupom-convenio 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-3 IMAGE-4 IMAGE-5 IMAGE-6 RECT-10 IMAGE-7 
         IMAGE-8 c-estab-ini c-estab-fim c-cliente-ini c-cliente-fim 
         c-portador-ini c-portador-fim c-dt-emissao-ini c-dt-emissao-fim 
         tg-cupom-agrupados tg-cupom-convenio 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    ASSIGN tt-param.c-estab-ini         = INPUT FRAME f-pg-sel c-estab-ini
           ...
           tt-param.c-cliente-ini       = INPUT FRAME f-pg-sel c-cliente-ini
           tt-param.c-cliente-fim       = INPUT FRAME f-pg-sel c-cliente-fim
           tt-param.c-portador-ini      = INPUT FRAME f-pg-sel c-portador-ini
           tt-param.c-portador-fim      = INPUT FRAME f-pg-sel c-portador-fim
           tt-param.c-data-emissao-ini  = INPUT FRAME f-pg-sel c-dt-emissao-ini
           tt-param.c-data-emissao-fim  = INPUT FRAME f-pg-sel c-dt-emissao-fim
           tt-param.l-cupons-agrup      = INPUT FRAME f-pg-sel tg-cupom-agrupados
           tt-param.l-cupons-conv       = INPUT FRAME f-pg-sel tg-cupom-convenio
    ...
    {include/i-rprun.i intprg/nicr005rp.p}
