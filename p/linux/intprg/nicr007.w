...
{include/i-prgvrs.i NICR007 9.99.99.999}
...
DEFINE VARIABLE fi-data-ini AS DATE FORMAT "99/99/9999":U INITIAL ? 
     LABEL "Data Furo" 
     VIEW-AS FILL-IN 
     SIZE 11.86 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     fi-estab-ini AT ROW 2.25 COL 24.86 COLON-ALIGNED WIDGET-ID 2
     fi-estab-fim AT ROW 2.25 COL 41.29 COLON-ALIGNED NO-LABEL WIDGET-ID 4
     fi-data-ini AT ROW 3.21 COL 22 COLON-ALIGNED WIDGET-ID 8
     fi-data-fim AT ROW 3.21 COL 41.29 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     IMAGE-1 AT ROW 2.25 COL 36.14 WIDGET-ID 74
     IMAGE-2 AT ROW 2.25 COL 40.14 WIDGET-ID 76
     IMAGE-15 AT ROW 3.21 COL 36.14 WIDGET-ID 78
     IMAGE-16 AT ROW 3.21 COL 40.14 WIDGET-ID 80
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
...
ON END-ERROR OF w-relat /* Integraá∆o Furo Caixa */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-relat w-relat
ON WINDOW-CLOSE OF w-relat /* Integraá∆o Furo Caixa */
DO:
...
{utp/ut9000.i "NICR007" "2.06.00.001"}
...
/*     APPLY "MOUSE-SELECT-CLICK" TO im-pg-imp IN FRAME f-relat. */
    ASSIGN fi-data-ini:SCREEN-VALUE IN FRAME f-pg-sel = STRING(01/01/0001,"99/99/9999").
    ASSIGN fi-data-fim:SCREEN-VALUE IN FRAME f-pg-sel = STRING(12/31/9999,"99/99/9999").
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY fi-estab-ini fi-estab-fim fi-data-ini fi-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE IMAGE-1 IMAGE-2 IMAGE-15 IMAGE-16 fi-estab-ini fi-estab-fim 
         fi-data-ini fi-data-fim 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
           ...
           .
    ASSIGN tt-param.estab-ini = INPUT FRAME f-pg-sel fi-estab-ini
           tt-param.estab-fim = INPUT FRAME f-pg-sel fi-estab-fim
           tt-param.data-ini  = INPUT FRAME f-pg-sel fi-data-ini
           tt-param.data-fim  = INPUT FRAME f-pg-sel fi-data-fim
        .
    ...
    {include/i-rprun.i intprg/nicr007rp.p}
