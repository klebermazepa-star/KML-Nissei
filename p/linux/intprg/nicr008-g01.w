...
&Scoped-Define ENABLED-OBJECTS rt-button RECT-1 c_cod_estab ~
c_cod_espec_docto c_cod_ser_docto c_cod_tit_acr c_cod_parcela bt-ok ~
bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod_estab c_cod_espec_docto ~
c_cod_ser_docto c_cod_tit_acr c_cod_parcela 
...
DEFINE VARIABLE c_cod_espec_docto AS CHARACTER FORMAT "x(3)":U 
     LABEL "Esp‚cie Documento" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_estab AS CHARACTER FORMAT "x(5)":U 
     LABEL "Estabelecimento" 
     VIEW-AS FILL-IN 
     SIZE 7 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_parcela AS CHARACTER FORMAT "x(02)":U 
     LABEL "Parcela" 
     VIEW-AS FILL-IN 
     SIZE 4 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_ser_docto AS CHARACTER FORMAT "x(3)":U 
     LABEL "S‚rie Documento" 
     VIEW-AS FILL-IN 
     SIZE 5 BY .88 NO-UNDO.

DEFINE VARIABLE c_cod_tit_acr AS CHARACTER FORMAT "x(10)":U 
     LABEL "T¡tulo" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod_estab AT ROW 1.33 COL 30 COLON-ALIGNED WIDGET-ID 2
     c_cod_espec_docto AT ROW 2.29 COL 30 COLON-ALIGNED WIDGET-ID 4
     c_cod_ser_docto AT ROW 3.25 COL 30 COLON-ALIGNED WIDGET-ID 6
     c_cod_tit_acr AT ROW 4.21 COL 30 COLON-ALIGNED WIDGET-ID 8
     c_cod_parcela AT ROW 5.17 COL 30 COLON-ALIGNED WIDGET-ID 10
     bt-ok AT ROW 6.79 COL 2.14
     bt-cancela AT ROW 6.79 COL 13
     bt-ajuda AT ROW 6.79 COL 58
     rt-button AT ROW 6.54 COL 1
     RECT-1 AT ROW 1.08 COL 1.57 WIDGET-ID 12
     SPACE(0.56) SKIP(1.70)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "V  Para T¡tulo ACR"
...
ON GO OF FRAME d-vapara /* V  Para T¡tulo ACR */
DO:
FIND tit_acr NO-LOCK
    WHERE tit_acr.cod_estab EQ INPUT FRAME {&FRAME-NAME} c_cod_estab
      AND tit_acr.cod_espec_docto EQ INPUT FRAME {&FRAME-NAME} c_cod_espec_docto
      AND tit_acr.cod_ser_docto EQ INPUT FRAME {&FRAME-NAME} c_cod_ser_docto
      AND tit_acr.cod_tit_acr EQ INPUT FRAME {&FRAME-NAME} c_cod_tit_acr
      AND tit_acr.cod_parcela EQ INPUT FRAME {&FRAME-NAME} c_cod_parcela NO-ERROR.

IF NOT AVAILABLE tit_acr THEN DO:
    {utp/ut-table.i emscad tit_acr 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(tit_acr).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V  Para T¡tulo ACR */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod_estab c_cod_espec_docto c_cod_ser_docto c_cod_tit_acr 
          c_cod_parcela 
      WITH FRAME d-vapara.
  ENABLE rt-button RECT-1 c_cod_estab c_cod_espec_docto c_cod_ser_docto 
         c_cod_tit_acr c_cod_parcela bt-ok bt-cancela bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
