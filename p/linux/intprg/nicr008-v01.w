...
&Scoped-Define ENABLED-FIELDS tit_acr.cod_estab tit_acr.cod_espec_docto ~
tit_acr.cod_ser_docto tit_acr.cod_tit_acr tit_acr.cod_parcela ~
tit_acr.cdn_cliente 
&Scoped-define ENABLED-TABLES tit_acr
&Scoped-define FIRST-ENABLED-TABLE tit_acr
&Scoped-Define ENABLED-OBJECTS rt-key 
&Scoped-Define DISPLAYED-FIELDS tit_acr.cod_estab tit_acr.cod_espec_docto ~
tit_acr.cod_ser_docto tit_acr.cod_tit_acr tit_acr.cod_parcela ~
tit_acr.cdn_cliente 
&Scoped-define DISPLAYED-TABLES tit_acr
&Scoped-define FIRST-DISPLAYED-TABLE tit_acr
&Scoped-Define DISPLAYED-OBJECTS fi-estab fi-nome-emit 
...
cod_portador||y|ems5.tit_acr.cod_portador
...
num_id_movto_cta_corren||y|ems5.tit_acr.num_id_movto_cta_corren
...
RUN set-attribute-list (
    'Keys-Accepted = ,
     Keys-Supplied = "cod_banco,cod_cart_bcia,cod_portador,cod_cta_corren,cod_empresa,cod_espec_docto,cod_estab,nom_abrev,cod_grp_clien,cod_indic_econ,num_id_movto_cta_corren,cod_refer"':U).
/**************************
</EXECUTING-CODE> */
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
DEFINE FRAME f-main
     tit_acr.cod_estab AT ROW 1.25 COL 24 COLON-ALIGNED WIDGET-ID 6
          VIEW-AS FILL-IN 
          SIZE 9.14 BY .88
     fi-estab AT ROW 1.25 COL 33.57 COLON-ALIGNED NO-LABEL WIDGET-ID 14
     tit_acr.cod_espec_docto AT ROW 2.25 COL 24 COLON-ALIGNED WIDGET-ID 4
          LABEL "Esp‚cie"
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .88
     tit_acr.cod_ser_docto AT ROW 2.25 COL 40.57 COLON-ALIGNED WIDGET-ID 10
          LABEL "S‚rie"
          VIEW-AS FILL-IN 
          SIZE 7.14 BY .88
     tit_acr.cod_tit_acr AT ROW 2.25 COL 62.14 COLON-ALIGNED WIDGET-ID 12
          VIEW-AS FILL-IN 
          SIZE 14.14 BY .88
     tit_acr.cod_parcela AT ROW 2.25 COL 76.57 COLON-ALIGNED NO-LABEL WIDGET-ID 8
          VIEW-AS FILL-IN 
          SIZE 4.57 BY .88
     tit_acr.cdn_cliente AT ROW 3.25 COL 24 COLON-ALIGNED WIDGET-ID 2
          VIEW-AS FILL-IN 
          SIZE 13.72 BY .88
     fi-nome-emit AT ROW 3.25 COL 38.14 COLON-ALIGNED NO-LABEL WIDGET-ID 16
...
/* SETTINGS FOR FILL-IN tit_acr.cod_espec_docto IN FRAME f-main
   EXP-LABEL                                                            */
/* SETTINGS FOR FILL-IN tit_acr.cod_ser_docto IN FRAME f-main
   EXP-LABEL                                                            */
...
------------------------------------------------------------------------------*/
    ...
    IF AVAIL tit_acr THEN DO:
        ...
        IF AVAIL estabelecimento THEN DO:
            ASSIGN fi-estab:SCREEN-VALUE IN FRAME {&FRAME-NAME} = estabelecimento.nom_pessoa.
        END.

        FIND FIRST cliente NO-LOCK
            WHERE cliente.cdn_cliente = tit_acr.cdn_cliente NO-ERROR.
        IF AVAIL cliente THEN DO:
            ASSIGN fi-nome-emit:SCREEN-VALUE IN FRAME {&FRAME-NAME} = ems5.cliente.nom_pessoa.
        END.
    END.
