...
&Scoped-define QUERY-STRING-Query-Main FOR EACH vale-manual NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH vale-manual NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main vale-manual
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main vale-manual
