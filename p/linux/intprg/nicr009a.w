...
*******************************************************************************/
{include/i-prgvrs.i NICR009A 9.99.99.999}
...
DEFINE VARIABLE h_nicr009-v02 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 15.25 COL 3.14 HELP
          "Salva e sai"
     bt-save AT ROW 15.25 COL 14.14 HELP
          "Salva e cria novo registro"
     bt-cancela AT ROW 15.25 COL 25.14 HELP
          "Cancela"
     bt-ajuda AT ROW 15.25 COL 78.14
     rt-button AT ROW 15.08 COL 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 97.72 BY 20.29 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-incmdp ASSIGN
         HIDDEN             = YES
         TITLE              = "Inclui/Modifica Vale Funcion rio"
         HEIGHT             = 15.29
         WIDTH              = 97
         MAX-HEIGHT         = 22
         MAX-WIDTH          = 114.29
...
ON END-ERROR OF w-incmdp /* Inclui/Modifica Vale Funcion rio */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-incmdp w-incmdp
ON WINDOW-CLOSE OF w-incmdp /* Inclui/Modifica Vale Funcion rio */
DO:
...
DO:
{include/salvapai.i h_nicr009-v02}
 END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr009-v02.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr009-v02 ).
       RUN set-position IN h_nicr009-v02 ( 1.25 , 2.00 ) NO-ERROR.
       /* Size in UIB:  ( 13.75 , 96.00 ) */
       ...
       RUN set-position IN h_nicr009-q01 ( 1.00 , 61.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.63 , 7.72 ) */

       /* Links to SmartViewer h_nicr009-v02. */
       RUN add-link IN adm-broker-hdl ( h_nicr009-q01 , 'Record':U , h_nicr009-v02 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TABLEIO':U , h_nicr009-v02 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr009-v02 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NICR009A" "9.99.99.999"}
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_nicr009-q01 (INPUT v-row-table). 
