...
PROCEDURE pi_verifica_codigo_convenio:
    ...
    if c_especie = "CV" then do:
        FIND FIRST cst-nota-fiscal NO-LOCK
             WHERE cst-nota-fiscal.cod-estabel = c_estab 
               AND cst-nota-fiscal.serie       = c_serie 
               AND cst-nota-fiscal.nr-nota-fis = c_titulo    NO-ERROR.
                                ...
                                FOR FIRST b2_movto_tit_acr no-lock
                                    where b2_movto_tit_acr.cod_estab            = bf_movto_tit_acr.cod_estab_tit_acr_pai
                                     ...
                                     IF AVAIL b2_tit_acr THEN DO:
                                         ...
                                         FOR FIRST cst-nota-fiscal NO-LOCK                                              
                                             WHERE cst-nota-fiscal.cod-estabel = b2_tit_acr.cod_estab           
                                               AND cst-nota-fiscal.serie       = b2_tit_acr.cod_ser_docto 
                                               AND cst-nota-fiscal.nr-nota-fis = b2_tit_acr.cod_tit_acr:
