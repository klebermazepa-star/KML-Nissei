...
&Scoped-Define ENABLED-OBJECTS rt-button c_cod-estabel c_serie ~
c_nr-nota-fis bt-ok bt-cancela bt-ajuda 
&Scoped-Define DISPLAYED-OBJECTS c_cod-estabel c_serie c_nr-nota-fis 
...
DEFINE VARIABLE c_nr-nota-fis AS CHARACTER FORMAT "x(16)":U 
     LABEL "Nr Nota" 
     VIEW-AS FILL-IN 
     SIZE 16 BY .88 NO-UNDO.

DEFINE VARIABLE c_serie AS CHARACTER FORMAT "x(5)":U 
     LABEL "Serie" 
     VIEW-AS FILL-IN 
...
DEFINE FRAME d-vapara
     c_cod-estabel AT ROW 1.17 COL 29.14 COLON-ALIGNED WIDGET-ID 2
     c_serie AT ROW 2.17 COL 29.14 COLON-ALIGNED WIDGET-ID 4
     c_nr-nota-fis AT ROW 3.17 COL 29.14 COLON-ALIGNED WIDGET-ID 6
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "V† Para Nota - Cart∆o Manual"
...
ON GO OF FRAME d-vapara /* V† Para Nota - Cart∆o Manual */
DO:
FIND cst_nota_fiscal NO-LOCK
    WHERE cst_nota_fiscal.cod_estabel EQ INPUT FRAME {&FRAME-NAME} c_cod-estabel
      AND cst_nota_fiscal.serie EQ INPUT FRAME {&FRAME-NAME} c_serie
      AND cst_nota_fiscal.nr_nota_fis EQ INPUT FRAME {&FRAME-NAME} c_nr-nota-fis NO-ERROR.

IF NOT AVAILABLE cst_nota_fiscal THEN DO:
    {utp/ut-table.i emsesp cst_nota_fiscal 1}
    RUN utp/ut-msgs.p(INPUT "show",
                      INPUT 2,
                      INPUT RETURN-VALUE).
    RETURN NO-APPLY.
END.
ASSIGN p-row-tabela = ROWID(cst_nota_fiscal).
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL d-vapara d-vapara
ON WINDOW-CLOSE OF FRAME d-vapara /* V† Para Nota - Cart∆o Manual */
DO:  
...
------------------------------------------------------------------------------*/
  DISPLAY c_cod-estabel c_serie c_nr-nota-fis 
      WITH FRAME d-vapara.
  ENABLE rt-button c_cod-estabel c_serie c_nr-nota-fis bt-ok bt-cancela 
         bt-ajuda 
      WITH FRAME d-vapara.
  VIEW FRAME d-vapara.
