...
&Scoped-define QUERY-STRING-Query-Main FOR EACH cst_nota_fiscal ~
      WHERE cst_nota_fiscal.cartao_manual = TRUE NO-LOCK, ~
      EACH nota-fiscal WHERE nota-fiscal.cod-estabel = cst_nota_fiscal.cod_estabel ~
  AND nota-fiscal.serie = cst_nota_fiscal.serie ~
  AND nota-fiscal.nr-nota-fis = cst_nota_fiscal.nr_nota_fis ~
      AND nota-fiscal.dt-cancela = ? ~
   NO-LOCK INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH cst_nota_fiscal ~
      WHERE cst_nota_fiscal.cartao_manual = TRUE NO-LOCK, ~
      EACH nota-fiscal WHERE nota-fiscal.cod-estabel = cst_nota_fiscal.cod_estabel ~
  AND nota-fiscal.serie = cst_nota_fiscal.serie ~
  AND nota-fiscal.nr-nota-fis = cst_nota_fiscal.nr_nota_fis ~
      AND nota-fiscal.dt-cancela = ? ~
   NO-LOCK INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main cst_nota_fiscal nota-fiscal
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main cst_nota_fiscal
&Scoped-define SECOND-TABLE-IN-QUERY-Query-Main nota-fiscal
...
/* Query rebuild information for QUERY Query-Main
     ...
     _Where[1]         = "emsesp.cst_nota_fiscal.cartao_manual = TRUE"
