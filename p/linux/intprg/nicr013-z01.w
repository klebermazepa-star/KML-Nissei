...
DEFINE VARIABLE h_nicr013-b03 AS HANDLE NO-UNDO.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             ...
             INPUT  'FOLDER-LABELS = ':U + 'Nota Fiscal' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
    ...
    WHEN 1 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr013-b03.w':U ,
             INPUT  FRAME f-zoom:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr013-b03 ).
       RUN set-position IN h_nicr013-b03 ( 2.58 , 6.29 ) NO-ERROR.
       /* Size in UIB:  ( 11.83 , 80.14 ) */

       /* Links to SmartBrowser h_nicr013-b03. */
       RUN add-link IN adm-broker-hdl ( h_nicr013-b03 , 'State':U , THIS-PROCEDURE ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr013-b03 ,
             h_folder , 'AFTER':U ).
    END. /* Page 1 */
