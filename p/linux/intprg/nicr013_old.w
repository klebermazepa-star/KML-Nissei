...
DEFINE FRAME f-cad
    ...
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         ...
         AT COL 1 ROW 1
         SIZE 90 BY 24.42 WIDGET-ID 100.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW w-cadpaifilho-filho ASSIGN
         HIDDEN             = YES
         TITLE              = "Manutená∆o Portador Cart∆o Manual"
         HEIGHT             = 24.46
         WIDTH              = 90.57
         MAX-HEIGHT         = 33
         MAX-WIDTH          = 228.57
...
ON END-ERROR OF w-cadpaifilho-filho /* Manutená∆o Portador Cart∆o Manual */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL w-cadpaifilho-filho w-cadpaifilho-filho
ON WINDOW-CLOSE OF w-cadpaifilho-filho /* Manutená∆o Portador Cart∆o Manual */
DO:
...
------------------------------------------------------------------------------*/
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       ...
       RUN set-position IN h_nicr013-v01 ( 2.50 , 1.72 ) NO-ERROR.
       /* Size in UIB:  ( 11.00 , 88.57 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'adm/objects/folder.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'FOLDER-LABELS = ':U + 'Cond. Pagto' + ',
                     FOLDER-TAB-TYPE = 1':U ,
             OUTPUT h_folder ).
       RUN set-position IN h_folder ( 13.75 , 1.00 ) NO-ERROR.
       RUN set-size IN h_folder ( 11.50 , 90.00 ) NO-ERROR.
       ...
       RUN set-position IN h_nicr013-q01 ( 1.00 , 65.00 ) NO-ERROR.
       ...
       RUN add-link IN adm-broker-hdl ( h_nicr013-q01 , 'Record':U , h_nicr013-q01 ).
