...
&Scoped-define QUERY-STRING-Query-Main FOR EACH fat-duplic WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION
&Scoped-define OPEN-QUERY-Query-Main OPEN QUERY Query-Main FOR EACH fat-duplic WHERE ~{&KEY-PHRASE} NO-LOCK ~
    ~{&SORTBY-PHRASE} INDEXED-REPOSITION.
&Scoped-define TABLES-IN-QUERY-Query-Main fat-duplic
&Scoped-define FIRST-TABLE-IN-QUERY-Query-Main fat-duplic
