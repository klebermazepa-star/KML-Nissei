...
*******************************************************************************/
{include/i-prgvrs.i NICR013B 9.99.99.999}
...
DEFINE VARIABLE h_nicr013b-q01 AS HANDLE NO-UNDO.
DEFINE VARIABLE h_nicr013b-v01 AS HANDLE NO-UNDO.
...
DEFINE FRAME f-cad
     bt-ok AT ROW 8.71 COL 2.57 HELP
          "Salva e sai"
     bt-save AT ROW 8.71 COL 13 HELP
          "Salva e cria novo"
     bt-cancela AT ROW 8.71 COL 23.57 HELP
          "Cancela"
     bt-ajuda AT ROW 8.71 COL 70.72
     rt-button AT ROW 8.54 COL 1.57
...
DO:
{include/okfil.i h_nicr013b-v01}
END.
...
DO:
{include/salvafil.i h_nicr013b-v01}
END.
  ...
  CASE adm-current-page: 
    ...
    WHEN 0 THEN DO:
       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr013b-v01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  'Layout = ':U ,
             OUTPUT h_nicr013b-v01 ).
       RUN set-position IN h_nicr013b-v01 ( 1.17 , 2.72 ) NO-ERROR.
       /* Size in UIB:  ( 6.00 , 77.00 ) */

       RUN init-object IN THIS-PROCEDURE (
             INPUT  'intprg/nicr013b-q01.w':U ,
             INPUT  FRAME f-cad:HANDLE ,
             INPUT  '':U ,
             OUTPUT h_nicr013b-q01 ).
       RUN set-position IN h_nicr013b-q01 ( 1.00 , 1.00 ) NO-ERROR.
       /* Size in UIB:  ( 1.75 , 8.00 ) */

       /* Links to SmartViewer h_nicr013b-v01. */
       RUN add-link IN adm-broker-hdl ( h_nicr013b-q01 , 'Record':U , h_nicr013b-v01 ).
       RUN add-link IN adm-broker-hdl ( THIS-PROCEDURE , 'TABLEIO':U , h_nicr013b-v01 ).

       /* Adjust the tab order of the smart objects. */
       RUN adjust-tab-order IN adm-broker-hdl ( h_nicr013b-v01 ,
...
------------------------------------------------------------------------------*/
  ...
  {utp/ut9000.i "NICR013B" "9.99.99.999"}

  /* Dispatch standard ADM method.                             */
  RUN dispatch IN THIS-PROCEDURE ( INPUT 'initialize':U ) .

  run pi-atualiza-parent in h_nicr013b-v01(input v-row-parent).
...
/*------------------------------------------------------------------------------
  ...
  Notes:       
------------------------------------------------------------------------------*/
  RUN pi-reposiciona-query IN h_nicr013b-q01 (input v-row-table).
