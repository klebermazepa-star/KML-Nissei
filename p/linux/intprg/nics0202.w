...
*******************************************************************************/
{include/i-prgvrs.i NICS0202 2.00.00.000}  /*** 010019 ***/
...
&Scoped-define INTERNAL-TABLES estrutura estabelec item familia

/* Definitions for FRAME f-pg-par                                       */
&Scoped-define QUERY-STRING-f-pg-par FOR EACH estrutura SHARE-LOCK, ~
      EACH estabelec WHERE TRUE /* Join to estrutura incomplete */ SHARE-LOCK
&Scoped-define OPEN-QUERY-f-pg-par OPEN QUERY f-pg-par FOR EACH estrutura SHARE-LOCK, ~
      EACH estabelec WHERE TRUE /* Join to estrutura incomplete */ SHARE-LOCK.
&Scoped-define TABLES-IN-QUERY-f-pg-par estrutura estabelec
&Scoped-define FIRST-TABLE-IN-QUERY-f-pg-par estrutura
&Scoped-define SECOND-TABLE-IN-QUERY-f-pg-par estabelec
...
&Scoped-Define ENABLED-OBJECTS IMAGE-3 IMAGE-4 rs-classif 
...
DEFINE VARIABLE rs-classif AS INTEGER 
     ...
     RADIO-BUTTONS 
          "Grupo Estoque e C¢digo do Item", 1,
"Familia e C¢digo do Item", 2,
"C¢digo do Item", 3,
"Descriá∆o do Item", 4
...
DEFINE FRAME f-pg-cla
     rs-classif AT ROW 2.88 COL 20 HELP
          "Classificaá∆o para emiss∆o do relat¢rio" NO-LABEL
     IMAGE-3 AT ROW 3.17 COL 46
     IMAGE-4 AT ROW 3.17 COL 51
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         HIDDEN             = YES
         TITLE              = "Relaá∆o Preáos Unit†rios"
         HEIGHT             = 15
         WIDTH              = 81.14
         MAX-HEIGHT         = 22.33
         MAX-WIDTH          = 114.29
...
/* Query rebuild information for FRAME f-pg-par
     _TblList          = "mgcad.estrutura,mgcad.estabelec WHERE mgcad.estrutura ..."
     _Query            is OPENED
*/  /* FRAME f-pg-par */
&ANALYZE-RESUME
...
ON END-ERROR OF C-Win /* Relaá∆o Preáos Unit†rios */
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL C-Win C-Win
ON WINDOW-CLOSE OF C-Win /* Relaá∆o Preáos Unit†rios */
DO:
...
{utp/ut9000.i "NICS0202" "2.00.00.000"}
...
------------------------------------------------------------------------------*/
  ENABLE im-pg-cla im-pg-sel im-pg-par im-pg-imp bt-executar bt-cancelar 
         bt-ajuda 
  ...
  ENABLE IMAGE-3 IMAGE-4 rs-classif 
      WITH FRAME f-pg-cla IN WINDOW C-Win.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-cla}
  DISPLAY rs-destino c-arquivo rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW C-Win.
  ENABLE RECT-7 RECT-12 rs-destino bt-config-impr bt-arquivo c-arquivo 
         rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW C-Win.
...
do  on error undo, return error
    ...
    assign  tt-param.desc-classifica = entry((tt-param.classifica - 1) * 2 + 1, rs-classif:radio-buttons 
                                                                                in frame f-pg-cla).
    ...
    {include/i-rprun.i intprg/nics0202rp.p}
...
------------------------------------------------------------------------------*/
  ...
  {src/adm/template/snd-list.i "estrutura"}
