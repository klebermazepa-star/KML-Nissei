...
ch-planilha:range("I" + STRING(i-linha)):VALUE                 = "M‚dio " + STRING(da-medio-ant,"99/99/9999").
ch-planilha:range("I" + STRING(i-linha)):Borders(7):LineStyle  = 1.
ch-planilha:range("I" + STRING(i-linha)):Borders(7):Weight     = 3.

ch-planilha:range("J" + STRING(i-linha)):VALUE                 = "M‚dio " + STRING(param-estoq.mensal-ate,"99/99/9999").
...
FOR EACH tt-excel USE-INDEX ITEM: 
    ...
    ch-planilha:range("I" + STRING(i-linha)):VALUE = tt-excel.medio-ant. 
    ch-planilha:range("J" + STRING(i-linha)):NumberFormat = "###.###.##0,0000".                               
    ch-planilha:range("J" + STRING(i-linha)):VALUE = tt-excel.medio-atu.  
