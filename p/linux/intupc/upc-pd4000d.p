/******************************************************************************
**
**     Programa: UPC-PD4000D
**
**     Objetivo: Chamada UPC no programa PD4000D para validaá∆o de Pedidos
**
...
for first ped-venda fields (tp-pedido)
    ...
    if valid-handle(h-btDeleteItem) and ped-venda.tp-pedido <> "1"
    then do:
        apply "CHOOSE" to h-btDeleteItem. 
    end.
    else do:
