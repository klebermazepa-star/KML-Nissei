/**************************************************************************
**
**   re1005b.i - Include de definicoes da temp-table tt-movto
**
**                da API ceapi001.p - Criada para melhoria de performance.
**
**               Esta include deve ser mantida igual a ceapi001.i
**************************************************************************/

{cdp/cdcfgmat.i}

def {1} shared temp-table tt-movto  NO-UNDO
