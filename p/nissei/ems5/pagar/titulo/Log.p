...
&scoped-define tableName cst_tit_ap_log
...
&IF DEFINED(EXCLUDE-getDataVinculo) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE getDataVinculo Procedure 
PROCEDURE getDataVinculo :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define output parameter data_vinculo_ as date no-undo.

    do {&throws}:
        assign
            data_vinculo_ = tt{&tableName}.data_vinculo.
    end.
...
&IF DEFINED(EXCLUDE-getHoraVinculo) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE getHoraVinculo Procedure 
PROCEDURE getHoraVinculo :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define output parameter hora_vinculo_ as character no-undo.

    do {&throws}:
        assign
            hora_vinculo_ = tt{&tableName}.hora_vinculo.
    end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE getUsuario Procedure 
...
/*------------------------------------------------------------------------------
  ...
  Notes:
------------------------------------------------------------------------------*/
    define output parameter cod_usuario_ as character no-undo.

    do {&throws}:
        assign
            cod_usuario_ = tt{&tableName}.cod_usuario.
    end.
...
&IF DEFINED(EXCLUDE-getValorDesconto) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE getValorDesconto Procedure 
PROCEDURE getValorDesconto :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define output parameter val_desconto_ as decimal no-undo.

    do {&throws}:
        assign
            val_desconto_ = tt{&tableName}.val_desconto.
    end.
...
&IF DEFINED(EXCLUDE-isImpresso) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE isImpresso Procedure 
PROCEDURE isImpresso :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define output parameter impresso_ as logical no-undo.

    do {&throws}:
        assign
            impresso_ = tt{&tableName}.impresso.
    end.
...
&IF DEFINED(EXCLUDE-isVinculado) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE isVinculado Procedure 
PROCEDURE isVinculado :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define output parameter vinculado_ as logical no-undo.

    do {&throws}:
        assign
            vinculado_ = tt{&tableName}.vinculado.
    end.
...
&IF DEFINED(EXCLUDE-setDataVinculo) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setDataVinculo Procedure 
PROCEDURE setDataVinculo :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define input  parameter data_vinculo_ as date no-undo.

    do {&throws}:
        assign
            tt{&tableName}.data_vinculo = data_vinculo_.
    end.
...
&IF DEFINED(EXCLUDE-setHoraVinculo) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setHoraVinculo Procedure 
PROCEDURE setHoraVinculo :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define input  parameter hora_vinculo_ as character no-undo.

    do {&throws}:
        assign
            tt{&tableName}.hora_vinculo = hora_vinculo_.
    end.
...
&IF DEFINED(EXCLUDE-setImpresso) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setImpresso Procedure 
PROCEDURE setImpresso :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define input  parameter impresso_ as logical no-undo.

    do {&throws}:
        assign
            tt{&tableName}.impresso = impresso_.
    end.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setUsuario Procedure 
...
/*------------------------------------------------------------------------------
  ...
  Notes:
------------------------------------------------------------------------------*/
    define input  parameter cod_usuario_ as character no-undo.

    do {&throws}:
        assign
            tt{&tableName}.cod_usuario = cod_usuario_.
    end.
...
&IF DEFINED(EXCLUDE-setValorDesconto) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setValorDesconto Procedure 
PROCEDURE setValorDesconto :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define input  parameter val_desconto_ as decimal no-undo.

    do {&throws}:
        assign
            tt{&tableName}.val_desconto = val_desconto_.
    end.
...
&IF DEFINED(EXCLUDE-setVinculado) = 0 &THEN

&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE setVinculado Procedure 
PROCEDURE setVinculado :
/*------------------------------------------------------------------------------
  Purpose:
  Parameters:  <none>
  Notes:
------------------------------------------------------------------------------*/
    define input  parameter vinculado_ as logical no-undo.

    do {&throws}:
        assign
            tt{&tableName}.vinculado = vinculado_.
    end.
