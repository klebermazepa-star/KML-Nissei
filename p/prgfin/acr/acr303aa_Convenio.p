        ...
        IF tt_titulos_em_aberto_acr.tta_cod_espec_docto = "CV" THEN DO:
            ...
            FOR FIRST cst_nota_fiscal NO-LOCK  USE-INDEX nota
                ...
                IF AVAIL int_ds_convenio THEN DO:
                    ...
                    FIND FIRST emitente
                         WHERE emitente.cgc = int_ds_convenio.cnpj NO-LOCK NO-ERROR.
                    IF AVAIL cliente THEN DO:
                        ASSIGN tt_titulos_em_aberto_acr.ttv_cod_cliente  = STRING(emitente.cod-emitente)
                               tt_titulos_em_aberto_acr.ttv_nome_cliente = emitente.nome-emit .
                    END.
                END.
            END.
        END.
