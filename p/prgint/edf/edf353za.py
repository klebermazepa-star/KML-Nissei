...
def var v_cod_sist_nac_bcio_fav
    as character
    format "x(8)":U
    label "C½digo Sist Bancÿrio"
    column-label "C½digo Sist Bancÿrio"
    no-undo.
        ...
        then do: /* --- DETALHE ---*/
           ...
           /* Tratamento Tipo de Pagamento*/
            ...
            then do:
                ...
                /* localiza a instrucao de cobranca para saber seý implantacao/alteracao ou estorno */
                ...
                if avail ocor_bcia_bco then do:
                    if ocor_bcia_bco.ind_tip_ocor_bcia = "Implanta»’o" /*l_implantacao*/   then
                        assign v_ind_tip_instruc = '0'. /* implantacao */
                    else
                        if ocor_bcia_bco.ind_tip_ocor_bcia begins "Altera»’o" /*l_alteracao*/ 
                    ...
                    assign v_ind_tip_instruc = '0'. /* sempre ser˜ implantacao */
