...
IF AVAIL b-item THEN DO:
    ...
    IF v_cdn_empres_usuar = "10" THEN DO:
        ...
        numero = INTEGER(b-item.it-codigo) NO-ERROR.
        IF ERROR-STATUS:ERROR THEN RETURN.

        FOR EACH integra-item WHERE integra-item.it-codigo = b-item.it-codigo EXCLUSIVE-LOCK:
            DELETE integra-item.
        END.
     
        CREATE integra-item.
        ASSIGN integra-item.it-codigo    = b-item.it-codigo
