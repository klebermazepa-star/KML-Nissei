...
IF p-ind-event = "altera_nosso_numero" THEN DO:
    ...
    IF AVAIL portad_edi THEN DO:
        ...
        END.
        IF (tit_acr.cod_portador = "34103" OR
            tit_acr.cod_portador = "34101" ) /* ITAU */ AND
           tit_acr.cod_cart_bcia = "SIM"
        THEN DO:
                    ...
                    IF NOT AVAIL int_ds_fat_conv_site THEN DO:
                        ...
                        FOR FIRST cst_nota_fiscal NO-LOCK                                              
                            ...
                            ASSIGN int_ds_fat_conv_site.cnpj               = IF AVAIL cliente THEN cliente.cod_id_feder ELSE ""
                                   ...
                                   int_ds_fat_conv_site.val_parcela        = bf_tit_acr.val_saida_subst_nf_dupl
                            ...
                            ASSIGN int_ds_fat_conv_site.indterminal        = cst_nota_fiscal.indterminal
                                   ...
                                   int_ds_fat_conv_site.caixa              = cst_nota_fiscal.caixa             
                                   int_ds_fat_conv_site.loja               = cst_nota_fiscal.loja              
                                   int_ds_fat_conv_site.movimento          = IF cst_nota_fiscal.data_emis_ori <> ? THEN cst_nota_fiscal.data_emis_ori ELSE int_ds_fat_conv_site.dat_cupom 
                                   int_ds_fat_conv_site.venda              = cst_nota_fiscal.venda     
                                .
