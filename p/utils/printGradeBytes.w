...
*******************************************************************************/
{include/i-prgvrs.i printGradeBytes 2.04.00.001}
...
DEFINE VARIABLE iColunas AS INTEGER FORMAT ">>9":U INITIAL 160 
     LABEL "N£mero de colunas a imprimir" 
     VIEW-AS FILL-IN 
     SIZE 4.43 BY .88 NO-UNDO.

DEFINE VARIABLE iLinhas AS INTEGER FORMAT ">>9":U INITIAL 62 
     LABEL "N£mero de linhas a imprimir" 
     VIEW-AS FILL-IN 
     SIZE 4.43 BY .88 NO-UNDO.

DEFINE VARIABLE iRegua AS INTEGER FORMAT "9":U INITIAL 5 
     LABEL "R‚gua a cada quantas linhas" 
     VIEW-AS FILL-IN 
     SIZE 4.43 BY .88 NO-UNDO.
...
DEFINE FRAME f-pg-sel
     iLinhas AT ROW 1.25 COL 26 COLON-ALIGNED
     iColunas AT ROW 2.25 COL 26 COLON-ALIGNED
     iRegua AT ROW 3.25 COL 26 COLON-ALIGNED
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 3 ROW 2.85
         SIZE 76.86 BY 10.62
...
{utp/ut9000.i "printGradeBytes" "2.04.00.001"}
...
------------------------------------------------------------------------------*/
  ...
  DISPLAY iLinhas iColunas iRegua 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  ENABLE iLinhas iColunas iRegua 
      WITH FRAME f-pg-sel IN WINDOW w-relat.
  {&OPEN-BROWSERS-IN-QUERY-f-pg-sel}
  DISPLAY rs-destino c-arquivo rs-execucao 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
  ENABLE rs-destino bt-config-impr bt-arquivo c-arquivo RECT-7 RECT-9 
      WITH FRAME f-pg-imp IN WINDOW w-relat.
...
do on error undo, return error on stop  undo, return error:
    ...
    assign tt-param.usuario         = c-seg-usuario
        ...
        tt-param.iLinhas  = input frame f-pg-sel iLinhas
        tt-param.iColunas = input frame f-pg-sel iColunas
        tt-param.iRegua   = input frame f-pg-sel iRegua
        .
    ...
    {include/i-rprun.i utils/printGradeBytesRp.p}
